...
Partial Class vipin_forms_photo_upload_report1_35d063e46646
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim crSections As Sections
    Dim report As New ReportDocument
    Dim UserAll(), BranchAll() As String
    Dim UserCode, BranchId, fdtt As Integer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        fdtt = Me.Request.QueryString("fdt")
        dt2 = oh.ExecuteDataSet("select p.emp_code as employee_code, e.emp_name, p.photo  from macdms.hrm_emp_ph_certi p, employee_master e,hrm_emp_upload h  where p.emp_code = e.emp_code  and h.emp_code=e.emp_code  and h.status_id in(0)  and e.emp_code = " & Me.Request.QueryString("fdt") & "").Tables(0)
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            oh.ExecuteNonQuery("photo_upload_new_proc_h", parcol)
            ...
            'cl_script1.Append("window.open('Photo_verify.aspx','_self');")

            'Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "inv", cl_script1.ToString, True)
            'Response.Redirect("Photo_verify.aspx")
            'dd1()
            


            'MsgBox(parcol(3).Value, MsgBoxStyle.Exclamation, "Alert")
            'Response.Write(parcol(3).Value)
    ...
    End Sub
    Sub dd1()
        Server.Transfer("Photo_verify.aspx")
