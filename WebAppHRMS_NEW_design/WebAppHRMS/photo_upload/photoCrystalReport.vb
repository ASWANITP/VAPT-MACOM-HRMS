...
Public Class photoCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.photoCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedphotoCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As photoCrystalReport = New photoCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
