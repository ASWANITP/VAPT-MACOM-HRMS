<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_Punch_Approval_Form.aspx.vb" Inherits="WebAppHRMS.AnyTimePunching_New_hrm_Punch_Regular_Form_96f032a99538" title="Untitled Page" %>
            ...
            <tr>
                <td colspan="3" style="height: 26px">
                    <strong><span style="font-size: 14pt; color: #cc3300; text-decoration: underline">Punch
                        Regularisation Approval</span></strong></td>
            </tr>
            <tr>
