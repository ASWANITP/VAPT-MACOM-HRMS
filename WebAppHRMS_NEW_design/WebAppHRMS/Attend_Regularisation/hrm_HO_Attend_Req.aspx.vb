...
Partial Class AnyTimePunching_New_hrm_HO_Attend_Req_9ae765539276
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dt1 = oh.ExecuteDataSet("select a.emp_code from employee_master a where a.emp_code=" & User(0) & " and a.branch_id=0 and a.status_id=1").Tables(0)
        ...
        'End If
        '**************************
        dt2 = oh.ExecuteDataSet("select e.emp_code || '*' || e.emp_name || '*' || d.m_time || '*' ||b.in_time from daily_attend d, time_tab b, employee_master e where d.emp_code = e.emp_code and d.m_time<>'TOUR' and d.m_time<>'COMPEN' and e.branch_id = d.m_branch and d.m_shift = b.shift_id and d.m_time > b.in_time and e.emp_code > 10000 and d.m_branch =0 and d.emp_code=" & User(0) & " and not exists (select r.requested_by from hrm_anytimepunching_reg r where r.status_id = 0 and to_date(r.requested_dt) = to_date(sysdate) and r.not_punch is null and d.emp_code=r.requested_by) order by d.emp_code").Tables(0)
