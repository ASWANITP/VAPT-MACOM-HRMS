...
Partial Class Attend_Regularisation_No_Date_check__Attend_Regularisation_hrm_Rpt_Attend_HW_5d62251a6581
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If cas = 1 Then
            Me.Response.Redirect("Rpt_Attend_Regular_Status.aspx?fromdt=" & Format(CDate(frm_str), "dd/MMM/yyyy") & "&todt=" & Format(CDate(to_str), "dd/MMM/yyyy"))
        ElseIf cas = 2 Then
            Me.Response.Redirect("hrm_Rpt_Attend_HW1.aspx?fromdt=" & Format(CDate(frm_str), "dd/MMM/yyyy") & "&todt=" & Format(CDate(to_str), "dd/MMM/yyyy"))
        End If
    End Sub
End Class
