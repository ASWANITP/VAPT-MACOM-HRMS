<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="BlockDtlsCancel.aspx.vb" Inherits="WebAppHRMS.BlockALert_BlockDtlsCancel_04c2c9dd8826" title="Punch Block Details in a Date of an Employee" %>
...
//   if(document.getElementById(cont[0]+"txtEmpCode").value != "")
//   {
      document.getElementById(cont[0]+"txtEmpCode").value = document.getElementById(cont[0]+"txt_hide").value;
...
function cmdExit_onclick() 
{
   window.open('../home.aspx','_self');
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 92%; font-family: 'Bookman Old Style'; font-variant: small-caps;">
            <tr>
                ...
                <td style="width: 23%; text-align: left">
                    <asp:TextBox ID="txtEmpCode"   runat="server" Style="font-family: 'Bookman Old Style';
                        text-align: left" TabIndex="1" MaxLength="6" ReadOnly="True"></asp:TextBox></td>
                <td style="width: 23%; text-align: left">
                ...
                <td style="width: 23%; text-align: left">
                    <asp:TextBox ID="txtBlockDate" onkeyup="CheckDate()" onchange="Fill_Dateto()" runat="server" Style="font-family: 'Bookman Old Style';
                        text-align: center; cursor: hand;" TabIndex="0"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 23%; text-align: left">
                    &nbsp;Employee Name</td>
            ...
            <tr>
                ...
                <td colspan="3" style="text-align: left">
                    <asp:TextBox ID="txt_Remarks" runat="server" MaxLength="200" Width="715px"></asp:TextBox></td>
            </tr>
    ...
    <asp:HiddenField ID="txt_hide" runat="server" />
</asp:Content>
