<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_Acc_block_release_Sanct.aspx.vb" Inherits="WebAppHRMS.Block_Release_For_Accounts_hrm_Acc_block_release_Sanct_aa5fcb4c8981" title="Untitled Page" %>
...
function ddlOnchange()
{
    ...
    else
    {
         ...
         document.getElementById(con[0]+"hdnEcode").value=document.getElementById(con[0]+"ddlEcode").value;
         callserver("1$"+document.getElementById(con[0]+"hdnReqDt").value+"$"+document.getElementById(con[0]+"hdnEcode").value+"$"+document.getElementById(con[0]+"hdnSanct").value,1); 
    }
}
...
// ]]>
    ...
    <div style="text-align: center">
        ...
        <asp:HiddenField ID="hdnSanct" runat="server" />
        ...
        <table border="1" style="width: 80%">
            <tr>
                ...
                <td style="width: 40%; text-align: left;">
                    <asp:DropDownList ID="ddlEcode" runat="server" Width="99%" onchange="ddlOnchange()">
                    </asp:DropDownList></td>
            </tr>
            <tr id="row1">
                <td colspan="2">
                    ...
                    <asp:Button ID="btn_view" runat="server" Style="position: relative" Text="Acknowledgement "
                        Width="120px" />
                </td>
            </tr>
            <tr>
