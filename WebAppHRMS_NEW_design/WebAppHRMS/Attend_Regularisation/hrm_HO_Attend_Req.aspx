<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_HO_Attend_Req.aspx.vb" Inherits="WebAppHRMS.AnyTimePunching_New_hrm_HO_Attend_Req_9ae765539276" title="Untitled Page" %>
   ...
   //debugger;
   ...
   
    {
        for(i=0;i<ar;i++)
       {
        ...
        st1=st1+"<tr  bgcolor='MistyRose'><td><small>"+coun+"</td><td><small>"+st3[0]+"</td><td><small>"+st3[1]+"</td><td><small>"+st3[2]+"</td><td><small>"+st3[3]+"</td><td><input type='checkbox' id='chkm_"+i+"' name='txtm_"+i+"'></td><td><input type='textbox' id='txt_"+i+"' name='txt_"+i+"' style='text-transform:capitalize' maxlength='100'></td></tr>"          
       }
        st=st+"<table id='mytable' border=1 width='100%'><tr  bgcolor='#CCDDEE' style='font-size:85%'><td><b>SLNO</b></td><td><b>&nbsp;EMP&nbsp;CODE&nbsp;</b></td><td><b>&nbsp;&nbsp;EMP&nbsp;NAME&nbsp;&nbsp;</b></td><td><b>&nbsp;&nbsp;PUNCHING&nbsp;TIME&nbsp;&nbsp;</b></td><td><b>&nbsp;ACTUAL&nbsp;TIME&nbsp;&nbsp;</b></td><td><b>&nbsp;MARK IF REGULARISING ONLY </b></td><td><b>REMARKS</b></td></tr>"
