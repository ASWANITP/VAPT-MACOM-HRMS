...
Partial Class Attentance_Reg_Comb_Report_hrm_atten_reg_late_non_report_7e50fe611583
    ...
    Protected Sub btnConfirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConfirm.Click
        ...
        Server.Transfer("hrm_atten_reg_web_rpt.aspx?Fdt=" & txtFdate.Text & "&Tdt=" & Me.txtTdate.Text)
    End Sub
End Class
