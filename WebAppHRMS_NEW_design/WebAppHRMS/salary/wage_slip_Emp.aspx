        ...
        <table border="1" style="width: 100%;">
            ...
            <tr>
                ...
                <td colspan="2" style="text-align: left">
                    ...
                    <cc1:CalendarExtender ID="CalendarExtender1" Format="dd-MMM-yyyy" TargetControlID="TxtFromdt" runat="server"></cc1:CalendarExtender>
                </td>
                <td colspan="1" style="text-align: left" align="right">
                    ...
                    TO DATE:</td>
                <td colspan="1" style="text-align: left">
                    <cc1:CalendarExtender ID="CalendarExtender2" Format="dd-MMM-yyyy" TargetControlID="TxtTodate" runat="server"></cc1:CalendarExtender>
