...
Partial Class Transfer_Promotion_Receival_b29f60bc6478
        ...
        Else
            ...
            If Page.IsPostBack <> True Then
                ...
                If z > 0 Then
                    ...
                    dt1 = oh.ExecuteDataSet("select tp.emp_code     from trans_prom tp, employ_firm ef where tp.recv_status = 0   and tp.status = 1   and ef.emp_code = tp.emp_code    and ef.firm_id = '" & Session("firm_id") & "'").Tables(0)
                ...
                Else
                    ...
                    dt2 = oh.ExecuteDataSet("select tp.emp_code    from trans_prom tp,employ_firm ef where tp.recv_status = 0 and tp.emp_code = ef.emp_code and ef.firm_id = '" & Session("firm_id") & "'   and tp.status = 2").Tables(0)
