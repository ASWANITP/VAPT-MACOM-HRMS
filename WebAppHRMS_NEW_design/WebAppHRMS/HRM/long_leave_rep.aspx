<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="~/HRM/long_leave_rep.aspx.vb" Inherits="WebAppHRMS.specificempattend_atterepo_cbd380486716" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1" align="center" style="width: 731px; height: 217px">
            <tr>
                <td colspan="4">
                    <asp:ScriptManager ID="ScriptManager1" runat="server">
                    </asp:ScriptManager>
                    <strong style="background-color: #ffcc33"><span style="font-size: 14pt">LONG LEAVE
            ...
            <tr style="display: none">
                ...
                <td colspan="2" style="height: 42px; text-align: left">&nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:TextBox ID="TextBox1" runat="server" ReadOnly="true" Width="225px" MaxLength="6"></asp:TextBox></td>
            </tr>
            <tr>
                ...
                <td style="width: 123px; height: 39px">&nbsp;<asp:TextBox ID="TextBox3" runat="server" onkeyup="return correct('TextBox3',event)"></asp:TextBox>
            ...
            <tr>
                ...
                <td colspan="2" style="height: 44px">&nbsp;<asp:Button ID="Button2" runat="server" Text="EXIT" Width="133px" /></td>
            </tr>
        </table>
    </div>
</asp:Content>
