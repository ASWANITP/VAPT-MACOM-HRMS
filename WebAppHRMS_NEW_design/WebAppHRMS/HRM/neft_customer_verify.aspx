  ...
  if (Hidden_chk=='')
  {
   ...
   return false;
    ...
    <table border="0" id="tableCursor01" align="center" style="font-family: 'Courier New'; width: 90%">
        ...
        <tr style="width: 100%">
            <td colspan="2" style="border-right: darkgray thin solid; border-top: darkgray thin solid; border-left: darkgray thin solid; border-bottom: darkgray thin solid; font-family: 'Times New Roman'; height: 25px; background-color: peachpuff; text-align: center">
    ...
    &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" TargetControlID="txtEmpCode" FilterType="Numbers"></cc1:FilteredTextBoxExtender>
    ...
    <asp:HiddenField ID="Hdn_chbx_cnt" runat="server" />
    <asp:HiddenField ID="Hidd_choice" runat="server" />
