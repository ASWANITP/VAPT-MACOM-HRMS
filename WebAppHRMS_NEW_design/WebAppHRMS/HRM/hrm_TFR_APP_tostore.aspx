...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 80%">
            <tr>
                <td colspan="2" style="text-align: center; height: 24px;">Select Appointment / Transfer</td>
            ...
            <tr>
                <td colspan="2" style="text-align: center">Select Appointment / Transfer Date</td>
                <td colspan="2" style="text-align: left">
                    <asp:TextBox ID="txtDate" runat="server" Width="65%" onkeyup="DateCheck()" onblur="check_date('txtDate')"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="2" style="height: 26px">Select Employees</td>
