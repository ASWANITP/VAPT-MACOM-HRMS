...
Partial Class specificempattend_atterepo_cbd380486716
                    ...
                    Else
                        ...
                        If Session("firm_id") = 8 Then
                            ...
                            If Me.TextBox1.Text = user(0) Then
                                Server.Transfer("longleavereport.aspx?&fdt=" & Me.TextBox2.Text & "&tdt=" & Me.TextBox3.Text & "&emp=" & Me.TextBox1.Text)
                            Else
