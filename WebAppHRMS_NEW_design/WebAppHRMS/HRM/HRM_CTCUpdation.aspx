        ...
        <table border="1" style="width: 47%; height: 56px; text-align: left">
            ...
            <tr id="rw2">
                ...
                <td style="width: 5%; text-align: left; height: 28px;">
                    <label style="color: Blue;" id="GFG"></label>
                </td>
            ...
            <tr>
                <td colspan="3" style="text-align: center">&nbsp;<asp:Button ID="Button1" runat="server" Text="Confirm" Width="68px" /><asp:Button ID="Button3" runat="server" Text="Confirm" OnClientClick="delconfirm()" />
