<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Movement_Recommend_MacomV.aspx.vb" Inherits="WebAppHRMS.Employee_Punching_Movement_Recommend_Macom_33cdcf157521" %>
                ...
                <td colspan="4" style="height: 41px; text-align: center; width: 780px;">
                    <strong><span style="font-size: 15pt; color: #cc0099; font-weight: bold; font-family: 'Courier New'; text-decoration: underline;">
                        <span style="color: #cc0000"><span style="font-family: Agency FB"><span style="font-size: 16pt">
                            <strong><span style="text-decoration: underline">MOVEMENT &nbsp;RECOMMENDATION</span></strong></span></span></span><%--<asp:ScriptManager id="ScriptManager1" runat="server">
                    </asp:ScriptManager>--%>
                    </span></strong>
                </td>
            </tr>
            ...
            <tr style="font-size: 12pt">
                <td colspan="4" style="height: 13px; text-align: center; width: 780px;">
                    ...
                    <table border="0" style="width: 784px; height: 79px;">
                        <tr>
                            <td style="width: 116px; height: 29px; text-align: left">
                            ...
                            <td colspan="3" style="height: 29px; text-align: left">
                                <input id="EMP_CODE" readonly="readonly" style="width: 172px; font-weight: normal; font-size: 11pt; font-family: 'Courier New'; height: 25px;" type="text" runat="server" /></td>
                        </tr>
                        <tr>
                            <td style="width: 116px; height: 29px; text-align: left">
                                <span style="font-size: 11pt; font-family: Courier New"><strong>APPLIED DATE</strong></span></td>
                            <td colspan="3" style="height: 29px; text-align: left">
                                <input id="Txt_emp" readonly="readonly" style="width: 172px; font-weight: normal; font-size: 11pt; font-family: 'Courier New'; height: 25px;" type="text" runat="server" /></td>
                        </tr>
                        <tr>
                            <td style="width: 116px; text-align: left; height: 27px;">
                                <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"><strong>DEPARTMENT</strong></span></td>
                            <td style="width: 186px; text-align: left; height: 27px;">
                                <input id="Txt_dep" runat="server" style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'; width: 394px; height: 20px;" type="text" readonly="readOnly" /></td>
                ...
                <td style="width: 186px; text-align: left; height: 13px;">
                ...
                <td colspan="4" style="height: 9px; text-align: center; width: 780px;">
                    <table border="0" style="width: 782px; height: 79px;">
                        <tr>
                            ...
                            <td style="text-align: left; height: 27px; width: 554px;" colspan="4">
                                <asp:TextBox ID="Txt_fdt" runat="server" Width="119px" onkeyPress="return clr('Txt_fdt')" Font-Size="Small" Style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'" ReadOnly="True"></asp:TextBox><span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"></span></td>
                        </tr>
                     ...
                     <span style="font-size: 11pt;font-weight: normal; font-family: Courier New"><strong>MOVEMENT TYPE&nbsp;</strong></span></td>
                       ...
                       <td colspan="3" style="height: 29px; text-align: left">
                     <input id="Txt_movtype" readonly="readonly" style="width: 571px; font-weight: normal; font-size: 11pt; font-family: 'Courier New';" type="text" runat="server" /></td>          
                                
                                
                               <%-- <asp:DropDownList ID="ddl_movtype" runat="server" Width="224px">
                        ...
                        <tr>
                            ...
                            <td style="width: 56px; text-align: left; height: 27px;">
                            ...
                            <td style="width: 74px; text-align: left; height: 27px;">
                        ...
                        <table style="width: 462px">
                            <tr>
                                <td style="width: 2227px; height: 31px; text-align: left;">
                                    <asp:Button ID="cmd_confirm" OnClientClick="return tourcliclick()" runat="server" Text="RECOMMEND" Width="111px" Height="29px" /></td>
