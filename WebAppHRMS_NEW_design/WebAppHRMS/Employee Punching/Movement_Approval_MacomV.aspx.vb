...
Partial Class Employee_Punching_Movement_Approval_Macom_242346793984
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim dt, dt1, dt2, dtj, ceo, depp, dtr, dth As New DataTable
    Dim sf() As String
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If dt1.Rows(0)(0) > 0 Then
                dt = oh.ExecuteDataSet("select '----SELECT----', '0' as empcode from dual union select t.emp_code || '~' || t.emp_name as ID, t.emp_code || '~' || t.reqst_dt || '~' || t.exit_time || '~' || t.entry_time || '~' || d.dep_name || '~' || t.place || '~' || t.purpose || '~' || t.rec_usr || '~' || t.aprv_usr as Details from TBL_MOVEMENT_MST t, employee_master s, department_mst d where t.aprv_usr = s.emp_code and d.dep_id = s.department_id and t.status_id = 1 and t.reqst_dt = to_date(sysdate) and t.aprv_usr = " & User(0) & "").Tables(0)
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        Try
            ...
            Dim sq178 As String = "update TBL_MOVEMENT_MST s set s.status_id = 2, s.approve_by = :apprcode, s.approve_dt = sysdate where s.emp_code = :code and s.aprv_usr =: apprcode and s.status_id = 1"
    ...
    Protected Sub New_Reject_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles New_Reject.Click
        ...
        Else
            ...
            Try
                ...
                Dim sq178 As String = "update TBL_MOVEMENT_MST s set s.status_id = 3, s.approve_by = :apprcode, s.approve_dt = sysdate, s.rej_reason = :reason where s.emp_code = :code and s.aprv_usr = :apprcode and s.status_id = 1"
