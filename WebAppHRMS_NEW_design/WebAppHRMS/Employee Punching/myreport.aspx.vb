...
Partial Class Employee_Punching_myreport_d89366872043
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        dts1 = oh.ExecuteDataSet("select query from mactech.hrm_report_master where firm_id=99 and query_id=135").Tables(0)
        ...
        tt1.Text = "<b><font size=2>&nbsp;&nbsp;&nbsp;EMPLOYEE&nbsp;MOVEMENT&nbsp;REPORT&nbsp;</font></b>"
        tt.Controls.Add(tt1)
        ...
        strs = strd(0).Replace("empcode", sf(0))
        ...
        For Each dr In dt.Rows
            ...
            End If
            If dr(9) = "Approved" And entrytime < dF1 Then
                v10.Text = "<font size=2;font color=red>&nbsp;" & dr(9) & "-<a href='print_movment.aspx?c=" & dr(1) & "&d=" & dr(0) & "&ex=" & dr(3) & "&en=" & dr(4) & "'>Download</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            End If
