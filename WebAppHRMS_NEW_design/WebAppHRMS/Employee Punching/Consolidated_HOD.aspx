<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Consolidated_HOD.aspx.vb" Inherits="WebAppHRMS.Employee_Punching_Consolidated_HOD_1231ede26564" %>
...
// ]]>
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="margin: 0px auto;">
                ...
                <td colspan="4" style="height: 41px; text-align: center;">
                    <strong><span style="font-size: 15pt; color: #cc0099; font-weight: bold; font-family: 'Courier New'; text-decoration: underline;">
                        <span style="color: #cc0000"><span style="font-family: Agency FB"><span style="font-size: 16pt">
                            <strong><span style="text-decoration: underline">COSOLIDATED REPORT</span></strong>
                        </span></span></span>
            ...
            <tr>
                <td style="width: 6%; height: 4px"></td>
                <td style="width: 9%; height: 4px; text-align: left"></td>
                <td style="width: 6%; height: 4px"></td>
                <td style="width: 10%; height: 4px; text-align: left"></td>
            </tr>
            <tr>

                <asp:GridView ID="Gridallemp" HorizontalAlign="Center" runat="server">
                </asp:GridView>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4" style="height: 14px">
                    <center>
                        <asp:Button ID="confirm_btn" runat="server" Font-Names="Times New Roman" Font-Size="Medium"
                            Text="CONFIRM" />
                        &nbsp;
