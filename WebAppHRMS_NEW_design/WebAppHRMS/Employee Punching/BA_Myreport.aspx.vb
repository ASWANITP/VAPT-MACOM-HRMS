...
Partial Class Employee_Punching_BA_Myreport_2a1568595342
    Inherits System.Web.UI.Page
    Dim dt, dts As New DataTable
    Dim dr As DataRow
    Dim str, strs, sf, frm, firm, fdt, tdt, emp, strs1, strs2 As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        dts1 = oh.ExecuteDataSet("select query from mactech.hrm_report_master where firm_id=99 and query_id=213").Tables(0)
        ...
        tt1.Text = "<b><font size=2>BUSINESS ANALYST&nbsp;&nbsp;EMPLOYEE&nbsp;MOVEMENT&nbsp;REPORT&nbsp;</font></b>"
        tt.Controls.Add(tt1)
        ...
        subcell2.HorizontalAlign = HorizontalAlign.Right
        ...
        f8.Text = "<b><font size=2>&nbsp;&nbsp;RECOMMENDER&nbsp;&nbsp;</font></b>"
        ...
        'sf = Request.QueryString.Get("emp")
        ''fdt = Request.QueryString.Get("fdt")
        ''tdt = Request.QueryString.Get("tdt")
        ''strs = strd(0).Replace("empcode", sf).Replace("frmdt", fdt).Replace("to_dt", tdt)
        ...
        For Each dr In dt.Rows
            ...
            v1.ColumnSpan = 1
            v1.HorizontalAlign = HorizontalAlign.Right
            ...
            'If dr(9) = "Approved" And entrytime > dF1 Then
            '    'v10.Text = "<font size=2;font color=green>&nbsp;" & dr(9) & "-<a href='print_movment.aspx?c=" & dr(1) & "&d=" & dr(0) & "&ex=" & dr(3) & "&en=" & dr(4) & "'>Download</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"

            '    v10.Text = "<font size=2;font color=green>&nbsp;"
            '    '& dr(9) & "-<a href='print_movment.aspx?c=" & dr(1) & "&d=" & dr(0) & "&ex=" & dr(3) & "&en=" & dr(4) & "'>Download</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"

            'End If
            'If dr(9) = "Recommended" And entrytime > dF1 Then
            '    v10.Text = "<font size=2;font color=green>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If
            'If dr(9) = "Applied" And entrytime > dF1 Then
            '    v10.Text = "<font size=2;font color=black>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If
            'If dr(9) = "Rejected" And entrytime > dF1 Then
            '    v10.Text = "<font size=2;font color=red>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If
            'If dr(9) = "Canceled" And entrytime > dF1 Then
            '    v10.Text = "<font size=2;font color=red>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If

            'If (entrytime < dF1) Then
            '    v10.Text = "<font size=2;font color=red>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If
            'If dr(9) = "Approved" And entrytime < dF1 Then
            '    v10.Text = "<font size=2;font color=red>&nbsp;"
            '    '& dr(9) & "-<a href='print_movment.aspx?c=" & dr(1) & "&d=" & dr(0) & "&ex=" & dr(3) & "&en=" & dr(4) & "'>Download</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If


            ' ''old days movement in red color------shima'
            'If dr(9) = "Approved" And dr(0) <> dF2 Then
            '    v10.Text = "<font size=2;font color=red>&nbsp;"
            '    '& dr(9) & "-<a href='print_movment.aspx?c=" & dr(1) & "&d=" & dr(0) & "&ex=" & dr(3) & "&en=" & dr(4) & "'>Download</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If


            'If dr(9) = "Recommended" And dr(0) <> dF2 Then

            '    v10.Text = "<font size=2;font color=red>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If
            'If dr(9) = "Canceled" And dr(0) <> dF2 Then
            '    v10.Text = "<font size=2;font color=red>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If
            'If dr(9) = "Applied" And dr(0) <> dF2 Then
            '    v10.Text = "<font size=2;font color=red>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If
            'If dr(9) = "Rejected" And dr(0) <> dF2 Then
            '    v10.Text = "<font size=2;font color=red>&nbsp;" & dr(9) & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            'End If
