...
// ]]>
    ...
    <script type="text/javascript">
        function toggleBalanceFields() {
            var ddl = document.getElementById('<%= ddl_movtype.ClientID %>');
        var balanceTimeField = document.getElementById('<%= Txt_BalanceTimee.ClientID %>');
        var balanceCountField = document.getElementById('<%= Txt_BalanceCountt.ClientID %>');

            if (ddl.value === "2") { // Official
                balanceTimeField.disabled = true;
                balanceCountField.disabled = true;
                balanceTimeField.value = "";
                balanceCountField.value = "";
            } else if (ddl.value === "1") { // Personal
                balanceTimeField.disabled = false;
                balanceCountField.disabled = false;
            }
        }
    ...
    <script language="javascript" type="text/javascript">
        ...
        function checkMovementTime() {
            var exitTimeStr = document.getElementById('<%= Txt_FromTime.ClientID %>').value;
            var entryTimeStr = document.getElementById('<%= Txt_ToTime.ClientID %>').value;

            if (exitTimeStr === "" || entryTimeStr === "") {
                return true; // do nothing if times are empty
            }

            var exitTime = parseTime(exitTimeStr);
            var entryTime = parseTime(entryTimeStr);

            if (exitTime && entryTime) {
                var diffMinutes = Math.abs((entryTime - exitTime) / (1000 * 60));
                if (diffMinutes < 30) {
                    alert("Minimum 30 minutes for Movement Time");
                    return false; // prevent form submission
                }
            }
            return true; // allow form to submit if condition is met
        }

        function parseTime(timeStr) {
            var pattern = /^(\d{1,2}):(\d{2})\s?(AM|PM|am|pm)$/;
            var match = timeStr.match(pattern);
        ...
        var fromTime = document.getElementById('<%= Txt_FromTime.ClientID %>').value;
        var toTime = document.getElementById('<%= Txt_ToTime.ClientID %>').value;

        if (fromTime && toTime && fromTime !== "00:00 AM" && toTime !== "00:00 AM") {
            // Call server method via AJAX
            PageMethods.GetBalanceAndCount(fromTime, toTime, onBalanceSuccess);
        }
    }

    function onBalanceSuccess(result) {
        if (result) {
            document.getElementById('<%= Txt_BalanceTime.ClientID %>').value = result.remainingTime;
            document.getElementById('<%= Txt_BalanceCount.ClientID %>').value = result.remainingCount;
        }
    }
                    ...
                    <table border="1" style="width: 762px; height: 79px;">
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="height: 13px; text-align: left">
                               <asp:DropDownList ID="ddl_movtype" runat="server" Width="214px" AutoPostBack="False" onchange="toggleBalanceFields()"></asp:DropDownList>
                            </td>
                        ...
                        <tr>
                            <td style="width: 155px; height: 8px; text-align: left;">
                                <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"><strong>EXIT TIME</strong></span></td>
                            ...
                            <td style="height: 8px; text-align: left; width: 132px;">
                                <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"><strong>ENTRY TIME</strong></span></td>
                        ...
                        <tr>
                            <td style="width: 193px; height: 13px; text-align: left;">
                                <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"><strong>TOTAL TIME </strong></span>
                        ...
                        <!-- Balance Time
                        <tr>
                        <td><label for="Txt_BalanceTime">Balance Time(mins):</label></td>
                        <td>
                                <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';">
                        <asp:TextBox ID="Txt_BalanceTime" runat="server" ReadOnly="true" Width="100px"
                        Style="font-family: 'Courier New'; font-size: 11pt; margin-left: 0px;"></asp:TextBox>
                            </span>
                         </td>
                        </tr> -->
  ...
  <tr>
      <td style="width: 193px; height: 13px; text-align: left;">
          <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"><strong>BALANCE TIME(MINS): </strong></span>
          <%--  <asp:Label ID="Label1"  runat="server" Text="Invaled time" Visible="false"></asp:Label>--%>
      </td>
      <td style="text-align: left; height: 13px;" colspan="3">
          <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';">
              <asp:TextBox ID="Txt_BalanceTimee" runat="server" ReadOnly="true"  onkeypress="return isNumberKey(2)" Width="117px" MaxLength="9" Style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'" Height="29px"></asp:TextBox></span></td>
  </tr>

                        <!-- Balance Count 
                       <tr>
                       <td><label for="Txt_BalanceCount">Applied Count:</label></td>
                       <td>
                       <asp:TextBox ID="Txt_BalanceCount" runat="server" ReadOnly="true" Width="100px"
                      Style="font-family: 'Courier New'; font-size: 11pt; margin-left: 0px;"></asp:TextBox>
                       </td>
                       </tr>-->
 ...
 <tr>
    <td style="width: 193px; height: 13px; text-align: left;">
        <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"><strong>APPLIED COUNT: </strong></span>
        <%--  <asp:Label ID="Label1"  runat="server" Text="Invaled time" Visible="false"></asp:Label>--%>
    </td>
    <td style="text-align: left; height: 13px;" colspan="3">
        <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';">
            <asp:TextBox ID="Txt_BalanceCountt" runat="server"  ReadOnly="true"  onkeypress="return isNumberKey(2)" Width="117px" MaxLength="9" Style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'" Height="29px"></asp:TextBox></span></td>
</tr>
                        ...
                        <tr>
                            ...
                            <%--<input id="Txt_fdt" runat="server" Autopostback="True"style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'; width: 217px;" type="text" readonly="readOnly" />--%>
                               &nbsp;<span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"></span>
                </td>
                    ...
                    &nbsp;<table>
                        <tr>
                            <td style="width: 100px">
                                <center>
                                    <asp:Button ID="cmd_confirm" runat="server" Text="CONFIRM" Width="105px" Height="29px" OnClientClick="return checkMovementTime();" /></center>
                            </td>
                            <td style="width: 100px">
                                <center />
