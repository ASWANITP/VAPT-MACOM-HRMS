...
Partial Class Employee_Punching_Movement_Approval_CEO_149998143325
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim dt, dt1, dt2, dtj, ceo, depp, dtr As New DataTable
    Dim sf() As String
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If fid = 28 Then
            If Not IsPostBack Then
                'Access checking 5188  CEO
                Dim str As String = "select count(*) from form_accessibility s where s.form_id=5188 and s.emp_id=" & User(0) & ""
                'Access checking 5187 OP Head
                Dim str1 As String = "select count(*) from form_accessibility s where s.form_id=5187 and s.emp_id=" & User(0) & ""
                dtr = oh.ExecuteDataSet(str1).Tables(0)
                dt = oh.ExecuteDataSet(str).Tables(0)
                If (dtr.Rows(0)(0) > 0) Then
                    Response.Redirect("Movement_Approval_OPHead.aspx")
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        Try
            ...
            oh.ExecuteNonQuery(" hrm_movement_san", parameter)
