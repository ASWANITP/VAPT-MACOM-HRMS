...
Public Class Crptdepartmentwisepl3
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Crptdepartmentwisepl3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.Crptdepartmentwisepl3.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_dpt() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrptdepartmentwisepl3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptdepartmentwisepl3 = New Crptdepartmentwisepl3()
        rpt.Site = Me.Site
        Return rpt
    End Function
