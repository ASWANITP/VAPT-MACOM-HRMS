...
Public Class Crptevenotpunching
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.Crptevenotpunching.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptevenotpunching
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptevenotpunching = New Crptevenotpunching()
        rpt.Site = Me.Site
        Return rpt
    End Function
