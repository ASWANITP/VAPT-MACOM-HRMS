...
Public Class employ_area_branch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.employ_area_branch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedemploy_area_branch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As employ_area_branch = New employ_area_branch()
        rpt.Site = Me.Site
        Return rpt
    End Function
