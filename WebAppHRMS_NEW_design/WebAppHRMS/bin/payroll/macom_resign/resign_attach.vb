...
Public Class resign_attach
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.resign_attach.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedresign_attach
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As resign_attach = New resign_attach()
        rpt.Site = Me.Site
        Return rpt
    End Function
