...
Public Class MusterRollCrystal2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.MusterRollCrystal2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMusterRollCrystal2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MusterRollCrystal2 = New MusterRollCrystal2()
        rpt.Site = Me.Site
        Return rpt
    End Function
