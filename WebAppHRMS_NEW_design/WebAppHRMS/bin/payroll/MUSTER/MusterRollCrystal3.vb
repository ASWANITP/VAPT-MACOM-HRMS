...
Public Class MusterRollCrystal3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.MusterRollCrystal3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMusterRollCrystal3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MusterRollCrystal3 = New MusterRollCrystal3()
        rpt.Site = Me.Site
        Return rpt
    End Function
