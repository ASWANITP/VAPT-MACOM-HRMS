...
Public Class new_block_branch
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.new_block_branch.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednew_block_branch
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As new_block_branch = New new_block_branch()
        rpt.Site = Me.Site
        Return rpt
    End Function
