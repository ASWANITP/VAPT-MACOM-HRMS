...
Public Class crpt_leave_pl28
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.crpt_leave_pl28.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_leave_pl28
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_leave_pl28 = New crpt_leave_pl28()
        rpt.Site = Me.Site
        Return rpt
    End Function
