...
Public Class hrm_atten_reg_late_non_rpt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "hrm_atten_reg_late_non_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.hrm_atten_reg_late_non_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedhrm_atten_reg_late_non_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As hrm_atten_reg_late_non_rpt = New hrm_atten_reg_late_non_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
