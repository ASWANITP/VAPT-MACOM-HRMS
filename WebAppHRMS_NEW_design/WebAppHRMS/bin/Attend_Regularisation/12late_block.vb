...
Public Class Crystal_Report112late_block
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.12late_block.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FIRM1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystal_Report112late_block
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_Report112late_block = New Crystal_Report112late_block()
        rpt.Site = Me.Site
        Return rpt
    End Function
