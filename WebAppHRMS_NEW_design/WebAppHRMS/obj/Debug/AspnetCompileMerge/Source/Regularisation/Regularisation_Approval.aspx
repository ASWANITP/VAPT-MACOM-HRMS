<%@ Page Language="VB" MasterPageFile="~/edp.master"  AutoEventWireup="false" CodeBehind="Regularisation_Approval.aspx.vb" Inherits="WebAppHRMS.Regularisation_Regularisation_Approval_242ed0d59417" %>
       ...
       <%-- <cc1:CalendarExtender ID="CalendarExtender1" Format="dd/MMM/yyyy" TargetControlID="txtDate" runat="server">
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td colspan="2" style="width: 150px; height: 26px; text-align: left">
                    <asp:DropDownList ID="Ddldate" runat="server" Width="126px" AutoPostBack="True">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td colspan="2" style="width: 275px; height: 26px;">
                ...
                <td colspan="2" style="width: 135px; height: 26px;">
                    </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="width: 275px; height: 28px">
                    <strong>Recommend Person</strong></td>
                <td style="width: 244px; height: 28px">
                </td>
                <td colspan="2" style="width: 135px; height: 28px; text-align: left">
                    <asp:TextBox ID="Txtrec" runat="server" ReadOnly="True" Width="215px"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="2" style="width: 275px; height: 28px;">
                    <strong><span style="color: black">Sanction /Reject &nbsp;Reason</span></strong></td>
                <td style="width: 244px; height: 28px;">
                </td>
