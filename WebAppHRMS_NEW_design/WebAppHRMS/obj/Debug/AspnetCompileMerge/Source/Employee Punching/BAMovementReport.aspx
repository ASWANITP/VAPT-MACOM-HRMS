        ...
        <table border="1" style="width: 726px; height: 217px">
            <tr>
                <td colspan="4">
                    ...
                    </asp:ScriptManager><strong style="color:Maroon"><span style="font-size: 14pt ;text-decoration: underline;">BA Movement Report</span></strong></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 126px; height: 39px">
                    TO DATE</td>
            ...
            <tr>
                ...
                <td colspan="2" style="height: 44px">
                    &nbsp;<asp:Button ID="btnext" runat="server" Text="EXIT" Width="133px" /></td>
            </tr>
        </table>
    </div>
</asp:Content>
