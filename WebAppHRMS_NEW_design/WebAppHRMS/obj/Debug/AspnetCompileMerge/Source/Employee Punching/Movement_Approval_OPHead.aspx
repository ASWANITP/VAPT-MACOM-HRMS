<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Movement_Approval_OPHead.aspx.vb" Inherits="WebAppHRMS.Employee_Punching_Movement_Approval_OPHead_2bda143a1379" %>
            ...
            <tr style="color: #000000">
                <td colspan="4" style="height: 9px; text-align: center; width: 780px;"><table border="0" style="width: 782px; height: 79px;">
                    ...
                    <asp:TextBox ID="Txt_From" runat="server" Width="124px" ReadOnly="True" Font-Bold="False" style="cursor: hand; font-weight: normal; font-size: 11pt; font-family: 'Courier New';" Font-Size="Small"></asp:TextBox></strong></td>
                                    <td style="width: 74px; text-align: left">
                                        <strong><span style="font-size: 11pt; font-family: Courier New">
                        TO</span></strong></td>
