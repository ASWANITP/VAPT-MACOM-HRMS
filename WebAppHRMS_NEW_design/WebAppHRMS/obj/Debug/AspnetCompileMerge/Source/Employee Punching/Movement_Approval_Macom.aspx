<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Movement_Approval_Macom.aspx.vb" Inherits="WebAppHRMS.Employee_Punching_Movement_Approval_Macom_242346791301" %>
...
// ]]>
     ...
     <div style="text-align: center">
         <table  border="1" style="margin:0px auto;" >
            <tr>
                <td colspan="4" style="height: 42px; text-align: center; width: 780px;">
            ...
            <tr style="font-size: 12pt">
                <td colspan="4" style="height: 13px; text-align: center; width: 780px;">
                    ...
                    <table border="0" style="width: 784px; height: 79px;">
                        <tr>
                            <td style="width: 400px; height: 29px; text-align: left">
                        ...
                        <tr>
                <td style="width: 400px; text-align: left; height: 27px;">
                ...
                <td colspan="4" style="height: 9px; text-align: center; width: 780px;"><table border="0" style="width: 782px; height: 79px;">
                    <tr>
                        ...
                        <td style="text-align: left; height: 27px; width: 554px;" colspan="4">
                            <asp:TextBox ID="Txt_fdt"  runat="server" Width="147px" onkeyPress="return clr('Txt_fdt')" Font-Size="Small" style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'" ReadOnly="True"></asp:TextBox><span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"></span></td>
                    </tr>
                     <tr>
                 <td style="width: 162px; text-align: left; height: 27px;">
                 <span style="font-size: 11pt;font-weight: normal; font-family: Courier New"><strong>MOVEMENT TYPE&nbsp;</strong></span></td>
                   ...
                   <td colspan="3" style="height: 29px; text-align: left">
                 <input id="Txt_movtype" readonly="readonly" style="width: 147px; font-weight: normal; font-size: 11pt; font-family: 'Courier New';" type="text" runat="server" /></td>          
                            </tr>
                  
                    <tr>
                                    <td style="width: 162px; text-align: left;">
                                        <span style="font-size: 11pt; font-family: Courier New"><strong>EXIT TIME&nbsp;</strong></span></td>
                                    <td style="width: 74px; text-align: left;">
                                        <strong style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'">
                    <asp:TextBox ID="Txt_From" runat="server" Width="147px" ReadOnly="True" Font-Bold="False" style="cursor: hand; font-weight: normal; font-size: 11pt; font-family: 'Courier New';" Font-Size="Small"></asp:TextBox></strong></td>
                                    <td style="width: 74px; text-align: left">
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="width: 554px; height: 13px; text-align: left">
                            <input id="Textplace" runat="server" style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'; width: 571px;" type="text" ReadOnly="True" /></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; height: 13px; width: 554px;" colspan="4">
                            <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';">
                                <asp:TextBox ID="Txt_purp" runat="server" onkeypress="return isNumberKey(2)" Width="571px" MaxLength="80" style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'" ReadOnly="True"></asp:TextBox></span></td>
                    </tr>
                     <tr>
                        <td style="width: 162px; height: 13px; text-align: left;">
                            <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"><strong>
                        ...
                        <td style="text-align: left; height: 13px; width: 554px;" colspan="4">
                            <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';">
                                <asp:TextBox ID="Text_RJTRSN" runat="server" Width="571px" MaxLength="80" style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'" ReadOnly="FALSE"></asp:TextBox></span></td>
                    </tr>
                </table>
                </td>
            </tr>
