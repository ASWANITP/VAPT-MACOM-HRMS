<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="earlygoing_cancel.aspx.vb" Inherits="WebAppHRMS.november_tour_Tour_apply_5ace8aa12470" title="Untitled Page" %>
        ...
        <table border="0" style="width: 642px; height: 331px;">
            <tr>
                <td colspan="4" style="height: 41px; text-align: center; width: 780px;">
                    <strong><span style="font-size: 15pt; color: #cc0099; font-weight: bold; font-family: 'Courier New'; text-decoration: underline;">
                        ...
                        <strong><span style="text-decoration: underline">EARLY-GOING CANCEL</span></strong></span></span></span><asp:ScriptManager id="ScriptManager1" runat="server">
                        </asp:ScriptManager>
                    </span></strong>
                    </td>
            </tr>
                        ...
                        <table style="width: 774px">
                            <tr>
                                <td style="width: 770px; text-align: left">
                                    <span style="font-family: Courier New"><strong>Select Employee</strong></span></td>
                ...
                <td colspan="4" style="height: 9px; text-align: center; width: 780px;"><table border="0" style="width: 782px; height: 79px;">
                    <tr>
                        <td style="width: 193px; text-align: left; height: 27px;">
                            <span style="font-size: 11pt; font-weight: normal; font-family: 'Courier New';"><strong>
                                Early-Going&nbsp;Date</strong></span></td>
                        <td style="text-align: left; height: 27px; width: 554px;" colspan="3">
            ...
            <tr style="color: #000000">
                <td colspan="4" style="height: 25px; width: 780px;">
                    ...
                    <asp:Button ID="cmd_confirm" OnClientClick="return tourcliclick()" runat="server" Text="CANCEL" Width="111px" Height="29px" /></td>
