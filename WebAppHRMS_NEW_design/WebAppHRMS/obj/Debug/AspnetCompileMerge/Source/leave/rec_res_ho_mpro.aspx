<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="rec_res_ho_mpro.aspx.vb" Inherits="WebAppHRMS.leave_rec_res_ho_af599b125807" %>
...
{   
      if((document.getElementById("txt_rej").value)!="")
       {  
        ...
        opener.document.forms[0].action="LEAVE_RECBYHR_MACPRO1.aspx"
        window.opener.cmd_rec_onclick()
        window.close("rec_res_ho_mpro.aspx");
            ...
            <table>
                <tr>
                    <td style="width: 213px">
                        &nbsp;&nbsp; 
                        Enter&nbsp;Reason&nbsp;for&nbsp;Recommend :
                    </td>
                    <td style="width: 100px">
                        <input id="txt_rej" type="text" style="width: 453px; height: 21px;" maxlength="99" /></td>
                </tr>
                <tr>
