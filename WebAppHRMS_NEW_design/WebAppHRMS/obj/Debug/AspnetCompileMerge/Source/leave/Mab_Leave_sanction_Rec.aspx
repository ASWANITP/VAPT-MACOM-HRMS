<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Mab_Leave_sanction_Rec.aspx.vb" Inherits="WebAppHRMS.Leave_Mab_Leave_sanction_Rec_73f1610a5824" title="Untitled Page" %>
...
function check_null()
{
    ...
    {  if((document.getElementById(cont[0]+"txt_name").value)!="")
        {  if((document.getElementById(cont[0]+"hid_rej").value)=="")
            {
            mywin=window.open("Copy_of_rec_res_ho.aspx", "WinC", "width=650,height=120,toolbar=no,location=no,directories=no,status=no,menubar=no, scrollbars=no,resizable=no,copyhistory=no")
  ...
  if (SeleIndex==IntCount) 
   {
    ...
    <div style="text-align: center">
        ...
        <asp:ScriptManager id="ScriptManager1" runat="server">
            ...
            <tr>
                <td colspan="10" style="color: #cc0000; height: 19px"><asp:RadioButton ID="rdbRec1" Checked="true" runat="server" AutoPostBack="True" GroupName="rdboptn"
                        Text="First Recommend" Width="102px" />
                    <asp:RadioButton ID="rdbRec2" runat="server" AutoPostBack="True"  GroupName="rdboptn"
            ...
            <tr id='row1'>
                ...
                <td colspan="5" style="height: 17px; text-align: left">
                    <input id="txt_recom_reason" runat="server" readonly="readonly" style="font-size: 11pt; width: 609px;
                        font-family: 'Courier New'" type="text" maxlength="100" /></td>
            </tr>
            <tr id='row2'>
                <td style="width: 243px; height: 17px; text-align: left">
                    <span style="font-size: 11pt; font-family: Courier New">
                    Recommended By</span></td>
                <td colspan="5" style="height: 17px; text-align: left">
                    <input id="txt_rec_by" runat="server" readonly="readonly" style="font-size: 11pt; width: 609px;
                        font-family: 'Courier New'" type="text" maxlength="100" /></td>
            </tr>
            <tr>
                <td style="width: 243px; height: 17px; text-align: left">
