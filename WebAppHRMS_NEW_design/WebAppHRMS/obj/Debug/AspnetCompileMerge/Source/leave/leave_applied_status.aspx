<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="leave_applied_status.aspx.vb" Inherits="WebAppHRMS.Leave_Module_leave_applied_status_3f8d0f7a8364" title="Untitled Page" %>
            ...
            <tr>
                <td colspan="3" style="text-align: center">
                    ...
                    <input id="Button1" style="width: 68px" type="button" value="EXIT" onclick="return Button1_onclick()" /></td>
                                <td style="width: 100px">
                    <asp:Button ID="cmd_confirm" runat="server" onclientclick="return checkconfirm()" Text="CONFIRM" Width="79px" /></td>
                            </tr>
                        </table>
                    </div>
                </td>
