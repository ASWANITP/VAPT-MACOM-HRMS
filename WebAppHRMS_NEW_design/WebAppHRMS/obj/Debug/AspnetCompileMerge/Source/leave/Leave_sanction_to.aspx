<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Leave_sanction_to.aspx.vb"  EnableEventValidation="false" Inherits="WebAppHRMS.leave_Leave_sanction_242da2288321" title="Untitled Page" %>
...
function check_null()
{
    ...
    {  if((document.getElementById(cont[0]+"txt_name").value)!="")
        {  if((document.getElementById(cont[0]+"hid_rej").value)=="")
            {
            mywin=window.open("rej_res_ho.aspx", "WinC", "width=650,height=520,toolbar=no,location=no,directories=no,status=no,menubar=no, scrollbars=no,resizable=no,copyhistory=no")
 ...
 function check_date()
 {
    ...
    var value2 = document.getElementById(cont[0]+"txt_ParToDt").value;
        ...
        secondDate= Date.parse(date2)
         ...
         dbd = Math.round((secondDate.valueOf()-firstDate.valueOf())/ msPerDay) ;
         //document.getElementById(cont[0]+"txt_par_days").value=dbd+1;
         if (document.getElementById(cont[0]+"txt_todt").value==document.getElementById(cont[0]+"txt_frdt").value)
         {
          document.getElementById(cont[0]+"txt_par_days").value=document.getElementById(cont[0]+"txt_dur").value;
          }
          else
          {
            document.getElementById(cont[0]+"txt_par_days").value=dbd+1;
