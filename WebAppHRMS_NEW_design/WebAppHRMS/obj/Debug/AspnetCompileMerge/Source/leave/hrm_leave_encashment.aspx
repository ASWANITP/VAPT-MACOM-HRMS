...
// ]]>
    ...
    <div style="text-align: center">
        <table border="1" style="width: 52%; height: 1px;">
            ...
            <tr>
                <td colspan="2" style="text-align: left; height: 30px; width: 2098px;">
                    Earned Leave Balance as on 31/Dec/2011 :
                </td>
            ...
            <tr>
                <td colspan="2" style="width: 2098px; text-align: left; height: 30px;">
                    Carry forwarded Earned leave to next year (2012):
                </td>
                <td colspan="2" style="text-align: left; height: 30px;">
            ...
            <tr>
                <td colspan="2" style="width: 2098px; text-align: left">
                    No. of&nbsp; Leave Eligible for Encashment :
                </td>
