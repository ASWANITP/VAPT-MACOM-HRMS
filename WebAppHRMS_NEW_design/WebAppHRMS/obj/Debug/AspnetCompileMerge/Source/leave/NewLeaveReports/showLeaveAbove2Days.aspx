<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="showLeaveAbove2Days.aspx.vb" Inherits="WebAppHRMS.showLeaveAbove2Days_596a53452970" title="Untitled Page" %>
...
// ]]>
    ...
    <div style="text-align: center">
        <br />
        &nbsp;<strong><span style="font-size: 13pt">MORE THAN 2 DAYS LEAVE REPORT<br />
        </span></strong>
        <asp:Label ID="lblDate" runat="server" ForeColor="Navy"></asp:Label><br />
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
            Font-Size="10pt" ForeColor="#333333" GridLines="None" BorderColor="#5D7B9D" BorderStyle="Double" BorderWidth="1px">
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataTextField="leave_count" DataNavigateUrlFields="emp_code"  
                DataNavigateUrlFormatString="LeaveAbove2DaysEmp.aspx?eid={0}" HeaderText="No. Of Leaves"  >
                    <ControlStyle Width="75px" />
                    <ItemStyle Font-Size="13pt" HorizontalAlign="Center" Width="75px" ForeColor="Blue" />
                </asp:HyperLinkField>
    ...
    <asp:Button ID="btnBack" runat="server" Text="Back" Width="133px" OnClientClick="JavaScript:window.history.back(1); return false;" /><br />
        <asp:TextBox ID="txtfrm" runat="server" Visible="False" Width="35px"></asp:TextBox>
        <asp:TextBox ID="txtTo" runat="server" Visible="False" Width="35px"></asp:TextBox><br />
    </div>
