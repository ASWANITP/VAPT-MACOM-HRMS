            ...
            <tr >
                <td colspan="2" style="height: 23px">
                    <div style="text-align: right; background-color: #ffeaff;">
                        &nbsp;<asp:TextBox ID="txt_result" runat="server" Height="66px" ReadOnly="True" Style="font-weight: bold; text-align:left;
                            font-size: 13pt; vertical-align: middle; color: #ff0066; background-color: #ffeaff;
                            border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none;" Width="608px" TextMode="MultiLine"></asp:TextBox>&nbsp;</div>
                </td>
            </tr>
        </table>
        <br />
