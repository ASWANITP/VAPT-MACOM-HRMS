                        ...
                        <table border="1" style="width: 95%; font-family: 'Bookman Old Style';">
                            <tr>
                                ...
                                <td style="width: 11%; height: 7px; text-align: center;">
                                    <asp:TextBox ID="txtEmpCode" onkeyup="return EmpCodeKeyUp()" onchange="return EmpNameFind()" runat="server" Style="font-family: 'Bookman Old Style';
                                        text-align: center" Width="103px"></asp:TextBox></td>
                                <td style="width: 25%; height: 7px; text-align: left;">
                                    &nbsp;Employee Name</td>
                                <td style="width: 25%; height: 7px; text-align: left;">
