<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="leave_appli_to.aspx.vb" EnableEventValidation="false" Inherits="WebAppHRMS.leave_leave_appli_to_4a487d033298" title="Untitled Page" %>
...
function show_oth_reas()
{
    ...
    <%--</TD>--%><td style="width: 100px; height: 1px; text-align: right">
                    <span style="font-size: 11pt; font-family: Courier New">
                        <div style="text-align: center">
                            <table>
                                <tr>
