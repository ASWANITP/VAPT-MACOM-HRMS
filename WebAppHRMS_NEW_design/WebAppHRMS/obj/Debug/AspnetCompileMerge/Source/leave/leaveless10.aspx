...
// -->
    ...
    <div style="text-align: center">
        <table border="1" style="width: 486px">
            ...
            <tr>
                <td style="width: 170px; height: 23px; text-align: right;"><asp:DropDownList ID="DropDownList1" runat="server" Width="166px">
                    <asp:ListItem Value="0">All</asp:ListItem>
                    <asp:ListItem Value="1">REGULAR</asp:ListItem>
                    <asp:ListItem Value="2">REGULARISED</asp:ListItem>
                    <asp:ListItem Value="3">OUTSOURCE</asp:ListItem>
                </asp:DropDownList></td>
                <td style="width: 100px; height: 23px; text-align: left"><asp:DropDownList ID="DropDownList2" runat="server" Width="166px">
                    <asp:ListItem Value="0">ALL</asp:ListItem>
