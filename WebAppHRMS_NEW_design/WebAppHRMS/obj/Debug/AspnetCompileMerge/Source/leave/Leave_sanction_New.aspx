  ...
  if (SeleIndex==IntCount) 
   {
    ...
    <div style="text-align: center">
                    ...
                    <table border="0" style="width: 386px; height: 37px">
                            <tr>
                                <td colspan="2" style="height: 31px">
                                    <input id="cmd_rec" runat="server" onclick="return cmd_rec_onclick()" style="font-size: 12pt;
                                        width: 98px; font-family: 'Courier New'; height: 26px" type="submit" value="RECOMMEND" /></td>
                                <td style="width: 100px; height: 31px;">
                                    <asp:Button ID="cmb_acc" runat="server" Text="SANCTION" Width="101px" /></td>
                                <td style="width: 100px; height: 31px;">
                                    <input id="cmd_reject" onclick="return cmd_reject_onclick()" style="font-size: 12pt;
                                        width: 98px; font-family: 'Courier New'; height: 26px" type="submit" value="REJECT" /></td>
                                <td style="width: 100px; height: 31px;">
        ...
        <div style="text-align: center">
            ...
            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MMM-yyyy" TargetControlID="txt_ParFrDt" >
