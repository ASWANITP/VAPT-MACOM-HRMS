...
<%--
 <form id="form1" runat="server">--%>
    <div style="text-align: center"><table border="1" style="width: 49%; height: 50px;">
    <tr>
   ...
   <%--<asp:Panel ID="Panel1" runat="server" Width="471px">
     ...
     <table border="1" style="width: 49%; height: 104px;">
          <tr> <td style="text-align: left; width: 277px;" colspan="2">Select&nbsp;Head</td>
         ...
         <div style="text-align: center">    </div>    
          <table border="1" style="width: 49%; height: 104px;">
           <tr>
              ...
              <td colspan="4" style="height: 32px"> <asp:TextBox ID="txt_newemp" AutoPostBack="true" runat="server" Width="272px" MaxLength="6" onkeypress="return isNumberKey(3)"></asp:TextBox></td>
            </tr>
            <tr>
               <td colspan="4" style="height: 32px; width: 277px;">Head Name</td>
               <td colspan="4" style="height: 32px"> <asp:TextBox ID="TextBoxname"  AutoPostBack="true" runat="server" Width="272px" ></asp:TextBox></td>
            </tr>
            ...
            <tr>
             <td colspan="4" style="height: 32px; width: 277px;"> Employee Name</td>
               <td colspan="4" style="height: 32px"> <asp:TextBox ID="TextBox1"   runat="server" Width="272px" ></asp:TextBox></td>
            </tr>
         ...
         <div style="text-align: center">      
          ...
          <%-- <tr>
            ...
            <tr>
              ...
              <td>  <asp:DropDownList ID="ddl_currname" AutoPostBack="true" runat="server" Width="272px" Font-Names="Times New Roman" Font-Size="Medium">   </asp:DropDownList></td>
            ...
            <tr>
             <td colspan="4" style="height: 32px; width: 277px;"> New&nbsp;Head&nbsp;Name</td>
               <td colspan="4" style="height: 32px"> <asp:TextBox ID="txt_newname"   runat="server" Width="272px" ></asp:TextBox></td>
            </tr>
