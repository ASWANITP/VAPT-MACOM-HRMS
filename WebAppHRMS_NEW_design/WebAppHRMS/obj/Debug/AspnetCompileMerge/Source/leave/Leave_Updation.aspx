<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Leave_Updation.aspx.vb"
    Inherits="LeaveApplication_Leave_Updation_70eeaa418351" %>
...
if ((event.keyCode > 64 && event.keyCode < 91) || (event.keyCode > 96 && event.keyCode < 123) || event.keyCode == 8||event.keyCode==32)
...
else
   {
    ...
    <div>
        ...
        <table border="1" style="font-size: 10pt; font-family: 'Times New Roman';
            height: 40px">
            <tr>
                <td>
