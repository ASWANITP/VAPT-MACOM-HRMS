<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="compensatory_sanction.aspx.vb" Inherits="WebAppHRMS.leave_early_going_sanction_87bf77ed9385" title="Untitled Page" %>
...
return false;
            ...
            if((document.getElementById(con[0]+"hid_rej").value)=="")
             {
                mywin=window.open("rej_res.aspx", "WinC", "width=500,height=50,toolbar=no,location=no,directories=no,status=no,menubar=no, scrollbars=no,resizable=no,copyhistory=no")
    ...
    <div style="text-align: center">
        <table border="1" style="width: 685px; height: 275px">
            <tr>
                <td colspan="4" style="height: 30px">
                    <span style="font-family: Courier New">
                        <asp:Label ID="Label1" runat="server" Font-Bold="True" BackColor="WhiteSmoke" ForeColor="#C00000" Height="27px" Width="672px"></asp:Label></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 141px; height: 23px; text-align: left"><input id="txt_comp_name" runat="server" style="width: 171px; font-family: 'Courier New';" type="text" readonly="readOnly" /></td>
                <td style="width: 76px; height: 23px; text-align: left">
                    <span style="font-family: Courier New">Compensatory&nbsp;Date</td>
                <td style="width: 72px; height: 23px; text-align: left"><input id="txt_comp_dt" runat="server" style="width: 171px; font-family: 'Courier New';" type="text" readonly="readOnly" /></td>
            </tr>
            <tr>
