<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="new_compen_sanction.aspx.vb" Inherits="WebAppHRMS.leave_early_going_sanction_87bf77ed7425" title="Untitled Page" %>
...
//document.getElementById(con[0]+"cmd_san").style.display='none'
...
// ]]>
    ...
    <div style="text-align: center">
        <table border="1" style="width: 685px; height: 275px">
            ...
            <tr>
                <td style="width: 114px; height: 23px; text-align: left">
                    <span style="font-family: Courier New">Compensatory</span></td>
                ...
                <td style="width: 76px; height: 23px; text-align: left">
                    <span style="font-family: Courier New">Compensatory&nbsp;Date</span></td>
