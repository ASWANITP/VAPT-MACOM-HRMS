<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false"  EnableEventValidation="false" CodeBehind="compensatory.aspx.vb" Inherits="WebAppHRMS.staffaccount_compensatory_030f17465140" title="Untitled Page" %>
...
document.getElementById(cs[0]+"chk_region").style.visibility='hidden';
document.getElementById(cs[0]+"chk_area").style.visibility='hidden';
document.getElementById(cs[0]+"chk_branch").style.visibility='hidden';
document.getElementById(cs[0]+"chk_zone").style.visibility='hidden';
...
document.getElementById(cs[0]+"chk_emp").style.visibility='hidden';
     ...
     if (document.getElementById(cs[0]+"cmb_zone").value==-1)
  {
   alert("Select Zone");
   return false;
  }
...
// document.getElementById("r4").style.display="inline";
            ...
            for(b=0;b<document.getElementById(cs[0]+"ListBox1").options.length;b++)
            {
              if(document.getElementById(cs[0]+"ListBox1").options[b].value==document.getElementById(cs[0]+"cmb_zone").value)
                {
                    alert("Already Added");
                    return false;
                }
            ...
            var option1=document.createElement("OPTION")
            option1.text=option1.text+document.getElementById(cs[0]+"cmb_zone").options[document.getElementById(cs[0]+"cmb_zone").selectedIndex].text;
            option1.value=document.getElementById(cs[0]+"cmb_zone").value;
            if(document.getElementById(cs[0]+"Hidden2").value=="")
            {
              document.getElementById(cs[0]+"Hidden2").value=document.getElementById(cs[0]+"cmb_zone").value;
            }
            else
              {
//            
                document.getElementById(cs[0]+"Hidden2").value=document.getElementById(cs[0]+"Hidden2").value+"#"+document.getElementById(cs[0]+"cmb_zone").value;
              }
...
document.getElementById(cs[0]+"chk_emp").style.visibility='hidden';
     ...
     if (document.getElementById(cs[0]+"cmb_area").value==-1)
  {
   alert("Select Area");
   return false;
  }
...
// document.getElementById("r4").style.display="inline";
            ...
            for(b=0;b<document.getElementById(cs[0]+"ListBox1").options.length;b++)
            {
              if(document.getElementById(cs[0]+"ListBox1").options[b].value==document.getElementById(cs[0]+"cmb_area").value)
                {
                    alert("Already Added");
                    return false;
                }
            ...
            var option1=document.createElement("OPTION")
            option1.text=option1.text+document.getElementById(cs[0]+"cmb_area").options[document.getElementById(cs[0]+"cmb_area").selectedIndex].text;
            option1.value=document.getElementById(cs[0]+"cmb_area").value;
            if(document.getElementById(cs[0]+"Hidden2").value=="")
            {
              document.getElementById(cs[0]+"Hidden2").value=document.getElementById(cs[0]+"cmb_area").value;
            }
            else
              {
//            
                document.getElementById(cs[0]+"Hidden2").value=document.getElementById(cs[0]+"Hidden2").value+"#"+document.getElementById(cs[0]+"cmb_area").value;
              }
...
document.getElementById(cs[0]+"chk_dist").style.visibility='hidden';
document.getElementById(cs[0]+"chk_emp").style.visibility='hidden';
     if (document.getElementById(cs[0]+"cmb_region").value==-1)
  {
   alert("Select Region");
   return false;
  }
...
// document.getElementById("r4").style.display="inline";
            ...
            for(b=0;b<document.getElementById(cs[0]+"ListBox1").options.length;b++)
            {
              if(document.getElementById(cs[0]+"ListBox1").options[b].value==document.getElementById(cs[0]+"cmb_region").value)
                {
                    alert("Already Added");
                    return false;
                }
            ...
            var option1=document.createElement("OPTION")
            option1.text=option1.text+document.getElementById(cs[0]+"cmb_region").options[document.getElementById(cs[0]+"cmb_region").selectedIndex].text;
            option1.value=document.getElementById(cs[0]+"cmb_region").value;
            if(document.getElementById(cs[0]+"Hidden2").value=="")
            {
              document.getElementById(cs[0]+"Hidden2").value=document.getElementById(cs[0]+"cmb_region").value;
            }
            else
              {
//            
                document.getElementById(cs[0]+"Hidden2").value=document.getElementById(cs[0]+"Hidden2").value+"#"+document.getElementById(cs[0]+"cmb_region").value;
              }
...
{
  debugger;
   //var lstbox=document.getElementById(cs[0]+"ListBox1");
  var count; 
    ...
    if(document.getElementById(cs[0]+"ListBox1").options[count].selected) 
     {
      ...
      document.getElementById(cs[0]+"ListBox1").remove(count);
       //alert(document.getElementById(cs[0]+"Hidden2").value)
     } 
  } 
...
document.getElementById(cs[0]+"chk_region").style.visibility='visible';
document.getElementById(cs[0]+"chk_area").style.visibility='visible';
document.getElementById(cs[0]+"chk_branch").style.visibility='visible';
document.getElementById(cs[0]+"chk_zone").style.visibility='visible';
...
document.getElementById(cs[0]+'cmb_zone').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_region').style.visibility='hidden';
...
document.getElementById(cs[0]+'cmb_area').style.visibility='hidden';
...
document.getElementById(cs[0]+"chk_region").checked=false;
document.getElementById(cs[0]+"chk_area").checked=false;
document.getElementById(cs[0]+"chk_branch").checked=false;
document.getElementById(cs[0]+"chk_zone").checked=false;
...
if (document.getElementById(cs[0]+"chk_zone").checked==true)
{
document.getElementById(cs[0]+'cmb_zone').style.visibility='visible';
document.getElementById(cs[0]+'cmb_dist').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_state').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_region').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_branch').style.visibility='hidden';
...
if (document.getElementById(cs[0]+"chk_region").checked==true)
{
document.getElementById(cs[0]+'cmb_region').style.visibility='visible';
document.getElementById(cs[0]+'cmb_dist').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_state').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_zone').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_branch').style.visibility='hidden';
...
if (document.getElementById(cs[0]+"chk_area").checked==true)
{
document.getElementById(cs[0]+'cmb_area').style.visibility='visible';
document.getElementById(cs[0]+'cmb_dist').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_zone').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_region').style.visibility='hidden';
document.getElementById(cs[0]+'cmb_branch').style.visibility='hidden';
...
// ]]>
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 650px; height: 251px">
            <tr>
                <td colspan="4" style="font-family: 'Courier New'; text-align: center; height: 26px; background-color: azure;">
                    <span style="font-weight: bold; font-size: 14pt; color: #cc3333;">COMPENSATORY ADD &amp; ASSIGN</span></td>
            </tr>
            <tr>
                <td colspan="2" style="font-family: 'Courier New'; text-align: right">
                    <asp:CheckBox ID="chk_addcomp"  runat="server" Font-Bold="True" ForeColor="Blue"
                ...
                <td colspan="2" style="width: 265px; font-family: Times New Roman; text-align: left">
                    <asp:CheckBox ID="chk_assigncomp"  runat="server" Font-Bold="True"
                        Font-Names="Courier New" Font-Size="12pt" ForeColor="Blue" Text="ASSIGN COMPENSATORY"
                        Width="234px" /></td>
            </tr>
            <tr>
                        ...
                        <table border="1" style="width: 640px" id="rw1">
                            <tr>
                                <td style="width: 100px; height: 22px">
                                    <strong>
                                    Enter Compensatory</strong></td>
                                <td style="width: 94px; height: 22px; text-align: left">
                                    <asp:TextBox ID="Txt_compen" runat="server" Width="377px"></asp:TextBox></td>
                                <td style="width: 100px; height: 22px">
                                    <asp:Button ID="cmd_addc" runat="server" Text="ADD" Width="113px" BackColor="PaleTurquoise" Font-Bold="True" /></td>
                            </tr>
                        </table>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td colspan="2" style="font-family: 'Courier New'; text-align: right">
                    <strong>
                    Select&nbsp; Compensatory</strong></td>
                <td colspan="2" style="font-family: Times New Roman; text-align: left">
                    <asp:DropDownList ID="cmb_comp" runat="server"  Width="216px" style="font-family: 'Courier New'">
                    </asp:DropDownList></td>
                        </tr>
                        <tr>
                <td style="width: 687px; text-align: right; height: 26px;">
                    <span style="font-family: Courier New"><strong>
                        Comp.Date</strong></span></td>
                <td style="width: 50px; font-family: Times New Roman; height: 26px;">
                    <asp:TextBox ID="txt_dt" runat="server"  onkeyup="da('txt_dt')"  onblur="checkDate('txt_dt')" style="font-family: 'Courier New'" Width="119px"></asp:TextBox></td>
                ...
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_state"   runat="server"  Width="216px" style="font-family: 'Courier New'">
                    </asp:DropDownList></td>
                        </tr>
                        <tr>
                <td colspan="2" style="width: 687px; text-align: left">
                ...
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_dist" runat="server"  Width="216px" style="font-family: 'Courier New'">
                    </asp:DropDownList></td>
                        </tr>
                        <tr>
                <td colspan="2" style="width: 687px; text-align: left">
                ...
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_zone" runat="server"  Width="216px" style="font-family: 'Courier New'">
                    </asp:DropDownList></td>
                        </tr>
                        <tr>
                <td colspan="2" style="width: 687px; text-align: left">
                ...
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_area" runat="server"  Width="216px" style="font-family: 'Courier New'">
                    </asp:DropDownList></td>
                        </tr>
                        <tr>
                <td colspan="2" style="width: 687px; text-align: left">
                ...
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_region" runat="server"  Width="216px" style="font-family: 'Courier New'">
                    </asp:DropDownList></td>
                        </tr>
                        <tr>
                <td colspan="2" style="width: 687px; text-align: left">
                ...
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_branch" runat="server"  Width="216px" style="font-family: 'Courier New'">
                    </asp:DropDownList></td>
                        </tr>
                        <tr>
                <td colspan="2" style="width: 687px; text-align: left">
                ...
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_emp" runat="server"  Width="216px" style="font-family: 'Courier New'">
                    </asp:DropDownList></td>
                        </tr>
                        <tr>
                <td colspan="4">
                    ...
                    <input id="txt_del" type="button"  onclick="del()" value="DELETE" style="font-family: 'Courier New'; font-weight: bold; background-color: gainsboro;" /></td>
                        ...
                        <tr>
                <td colspan="4">
                    <asp:ListBox ID="ListBox1" runat="server" Width="582px" AppendDataBoundItems="True" style="font-family: 'Courier New'" BackColor="AliceBlue" Font-Bold="True" ForeColor="#0000C0" Rows="6"></asp:ListBox></td>
                        </tr>
                        <tr>
                <td colspan="4" style="text-align: center; height: 28px;">
                    &nbsp;<asp:Button ID="cmd_confirm" runat="server"  OnClientClick="return fill()" Text="CONFIRM" style="font-family: 'Courier New'" BackColor="Gainsboro" Font-Bold="True" Width="98px"  />&nbsp;</td>
                        </tr>
                    </table>
                    <div style="text-align: center">
                        <table>
