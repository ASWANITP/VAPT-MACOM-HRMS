    ...
    <div style="text-align: center">
        <table border="1" style="width: 63px; height: 1px">
            ...
            <tr>
                ...
                <td colspan="2" style="height: 1px; width: 412px; text-align: left;"><asp:DropDownList ID="cmb_leaveype" runat="server" Width="350px" Font-Bold="False" style="font-size: 11pt; font-family: 'Courier New'" AutoPostBack="True" BackColor="White">
                </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 243px; text-align: left; height: 22px;">
                    <span style="font-size: 11pt; font-family: Courier New">Post</span></td>
                <td colspan="2" style="height: 22px; width: 412px;  text-align: left;"><asp:DropDownList ID="cmb_post" runat="server" Width="350px" Font-Bold="False" style="font-size: 11pt; font-family: 'Courier New'" AutoPostBack="True" BackColor="White">
                </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 243px; height: 1px; text-align: left">
                    <span style="font-size: 11pt; font-family: Courier New">Branch</span></td>
                <td colspan="2" style="height: 1px; width: 412px; text-align: left;"><asp:DropDownList ID="cmbBranch" runat="server" Width="350px" Font-Bold="False" style="font-size: 11pt; font-family: 'Courier New'" Enabled="False">
                </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 243px; height: 1px; text-align: left">
                    <span style="font-size: 10pt; font-family: Courier New">Department</span></td>
                <td colspan="2" style="height: 1px; text-align: left; width: 412px;"><asp:DropDownList ID="cmb_department" runat="server" Width="350px" Font-Bold="False" style="font-size: 11pt; font-family: 'Courier New'" Enabled="False">
                </asp:DropDownList></td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="text-align: left; height: 17px; width: 412px;">
                    </td>
            </tr>
            <tr id='row1'>
                ...
                <td colspan="3" style="height: 1px; text-align: center">
                    ...
                    <table border="0" style="width: 386px; height: 37px">
                            <tr>
                                ...
                                <td style="width: 100px; height: 31px;"><asp:Button ID="btnReset" runat="server" Height="28px" Text="Reset" Width="96px" /></td>
                                <td style="width: 100px; height: 31px;">
        ...
        <div style="text-align: center">
            ...
            &nbsp;
            &nbsp; &nbsp; &nbsp;
            <asp:TextBox ID="txtSelect" runat="server" Visible="False" Width="1px"></asp:TextBox></div>
        &nbsp; &nbsp; &nbsp;&nbsp;
    </div>
</asp:Content>
