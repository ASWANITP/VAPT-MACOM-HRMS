            ...
            <tr>
                ...
                <td style="width: 100px; height: 13px">
                    <asp:Panel ID="Panel1" runat="server" Height="20px" Width="125px">
                        <asp:TextBox ID="txt_frdt"  runat="server" onkeyup="DateFCheck()"></asp:TextBox></asp:Panel>
                </td>
                <td style="width: 100px; height: 13px">
                    TO Date</td>
                <td style="width: 100px; height: 13px">
                    <asp:Panel ID="Panel2" runat="server" Height="20px" Width="125px">
                        <asp:TextBox ID="txt_todt"   runat="server" onkeyup="DateTCheck()"></asp:TextBox></asp:Panel>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 100px">
                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_frdt" Format="dd/MMM/yyyy">
                    </cc1:CalendarExtender>
                </td>
                <td style="width: 100px">
                </td>
                <td style="width: 100px">
                    <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txt_todt" Format="dd/MMM/yyyy">
                    </cc1:CalendarExtender>
                </td>
            </tr>
            <tr>
