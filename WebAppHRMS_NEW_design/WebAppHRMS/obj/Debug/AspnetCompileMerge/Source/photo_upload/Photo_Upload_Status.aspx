...
// ]]>
    ...
    <asp:Panel ID="Panel1" runat="server" Height="140px" Style="z-index: 100; left: 378px;
        position: absolute; top: 230px" Width="370px" BorderColor="Cyan">
        &nbsp;<br />
        <br />
        <br />
        <br />
        ...
        <br />
        &nbsp;
        <table style="z-index: 104; left: 34px; width: 317px; position: absolute; top: 40px;
            height: 138px" border="5">
            <tr>
