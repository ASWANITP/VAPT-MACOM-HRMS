<%--<%@ Page Language="VB" MasterPageFile="~/edp.master"  AutoEventWireup="false" CodeBehind="Hrm_Add_Post_Macom.aspx.vb" Inherits="payroll_Hrm_Add_Post_Macom_090990d38136" %>--%>
            ...
            <tr>
                <td colspan="5">
                    ...
                    <asp:RadioButton ID="rdb_Cancel" runat="server" Text="Cancel Emp Code" Width="146px" GroupName="a" />
                     ...
                     <asp:RadioButton ID="rdb_level" runat="server" Text="Employee Level" Width="146px" GroupName="a"/> </td>
            </tr>
