...
function Numberonly()
{
    ...
    <div style="text-align: center; height:250; text-align:center;" id="hidden4">
      ...
      <tr>
       <td style="text-align:left"><asp:Label ID="Label1" runat="server" Width="140px" Font-Bold="True" Text="Employee Code"></asp:Label>
       </td> 
       ...
       <td style="text-align:left"><asp:Label ID="Label2" runat="server" Width="140px" Font-Bold="True" Text="Employee Name"></asp:Label>
        ...
        <tr>
       <td style="text-align:left"><asp:Label ID="Label5" runat="server" Width="140px" Font-Bold="True" Text="From Date"></asp:Label>
       </td> 
       <td style="text-align:left">
       ...
       <td style="text-align:left"><asp:Label ID="Label6" runat="server" Width="140px" Font-Bold="True" Text="To Date"></asp:Label>
       </td><td style="text-align:left">
...
<tr>
    <td style="text-align:left">
        ...
        </td><td style="text-align:left"><input type="text" id="txtSource" style="width: 200px" onkeydown = "return (event.keyCode!=13);" tabindex="4" />
        </td>
        <td style="text-align:left"><asp:Label ID="Label4" runat="server" Font-Bold="True" Text="Destination: " Width="140px">
        </asp:Label></td>
        <td colspan="4" style="text-align:left; width: 366px;">
        <input type="text" id="txtDestination" style="width: 200px" onkeydown = "return (event.keyCode!=13);" tabindex="5" /></td></tr>
        <tr><td colspan="2"style="text-align:right">
        <input type="button" value="Get Distance" onclick="GetRoute()" tabindex="6" /></td><td colspan="4" style="text-align:right; width: 366px;">
...
<tr id="disp_map">
    ...
    <%--<td style="height:240px" colspan="2">
        <div id="dvPanel" style="width: 300px; height: 244px; overflow:auto ">
             ...
             <tr>
       <td style="text-align:left"><asp:Label ID="Label7" runat="server" Width="140px" Font-Bold="True" Text="Tour Purpose"></asp:Label>
       </td> 
       <td style="text-align:left">
           &nbsp;<asp:DropDownList ID="cmb_purpose" runat="server" Width="200px" TabIndex="7">
           </asp:DropDownList></td>
       <td style="text-align:left"><asp:Label ID="Label8" runat="server" Width="140px" Font-Bold="True" Text="Purpose"></asp:Label>
       </td><td style="text-align:left">
           <asp:TextBox ID="txt_purpose" runat="server" Width="200px" TabIndex="8"></asp:TextBox>
               ...
               <tr>
       <td style="text-align:left;"><asp:Label ID="Label9" runat="server" Width="140px" Font-Bold="True" Text="Mode"></asp:Label>
       </td> 
       <td style="text-align:left;">
           &nbsp;<asp:DropDownList ID="cmb_mode" runat="server" Width="200px" TabIndex="9">
          
           </asp:DropDownList></td>
       <td style="text-align:left;"><asp:Label ID="Label10" runat="server" Width="140px" Font-Bold="True" Text="Amount"></asp:Label>
       </td><td style="text-align:left;">
           ...
           <tr>
       <td style="text-align:left;"><asp:Label ID="Label11" runat="server" Width="140px" Font-Bold="True" Text="Type"></asp:Label>
       </td> 
       <td style="text-align:left; ">
           &nbsp;<asp:DropDownList ID="cmb_type" runat="server" Width="200px" TabIndex="11">
       ...
       <td style="text-align:center;" colspan="4">
           &nbsp;<input id="Button1" type="button" value="Add" onclick="return Addgrid()" style="width: 56px; height: 24px" tabindex="12" />
           &nbsp;&nbsp;</td> 
       </tr>
        ...
        <input id="hid_sysdate" runat="server" style="width: 1px" type="hidden" />
         <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy" TargetControlID="txt_Fromdt">
        </cc1:CalendarExtender>
        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy" TargetControlID="txt_todt">
        </cc1:CalendarExtender>
