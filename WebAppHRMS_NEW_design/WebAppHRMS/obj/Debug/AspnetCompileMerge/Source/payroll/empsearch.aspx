        ...
        <table border="1" style="width: 52%; font-family: 'Bookman Old Style'; font-variant: small-caps;">
            <tr>
                <td style="width: 35%; text-align: left;">
                    &nbsp;<asp:CheckBox ID="checkEmpCode" onclick="CheckCodeClick()" runat="server" Width="320px" Text=" Enter Employee Code" style="cursor: hand; font-family: 'Bookman Old Style'" /></td>
                <td style="width: 35%; text-align: left;">
            ...
            <tr>
                <td style="width: 35%; text-align: left">
                    &nbsp;<asp:CheckBox ID="checkEmpName" onclick="CheckNameClick()" runat="server" Width="318px" Text=" Enter Name/Part of Name" style="cursor: hand; font-family: 'Bookman Old Style'" /></td>
                <td style="width: 35%; text-align: left">
