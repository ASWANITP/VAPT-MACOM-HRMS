...
// ]]>
    ...
    <asp:ScriptManager id="ScriptManager1" runat="server">
        ...
        <tr style="color: #000000">
            ...
            <td style="width: 123px; color: #000000; height: 2px; text-align: right">
                House Name :&nbsp;
            </td>
        ...
        <tr>
            <td style="width: 154px; height: 6px; text-align: right">
                Post :&nbsp;
            </td>
        ...
        <tr>
            <td style="width: 154px; height: 30px; text-align: right">
                Phone No :&nbsp;
            </td>
            ...
            <td style="width: 123px; height: 30px; text-align: right">
                Contact No :&nbsp;
            </td>
        ...
        <tr>
            <td style="width: 154px; height: 28px; text-align: right">
                Email :
        ...
        <tr>
            <td style="width: 154px; height: 12px; text-align: right">
                Father/Husband : &nbsp;</td>
        ...
        <tr>
            ...
            <td style="width: 100px; text-align: left">
                ...
                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_dob" Format="dd/MMM/yyyy">
    ...
    <table border="1">
        <tr>
            <td style="width: 100px; text-align: right">
                &nbsp;<asp:Button ID="cmd_next" runat="server" Text="NEXT" Width="74px" />&nbsp;
            </td>
            <td style="width: 100px; text-align: left">
                &nbsp;&nbsp;
