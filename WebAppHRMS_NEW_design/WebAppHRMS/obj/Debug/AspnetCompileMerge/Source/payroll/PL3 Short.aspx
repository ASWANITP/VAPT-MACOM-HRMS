<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="PL3 Short.aspx.vb" Inherits="WebAppHRMS.HRM_PL3_Short_29caaa648657" title="Untitled Page" %>
...
//                sender._textbox.set_Value(sender._selectedDate.format(sender._format))
    ...
    <div style="text-align: center">
        <table style="width: 60%; position: relative">
            <tr>
                ...
                <td style="width: 20%; font-weight: bold; color: black; font-style: normal; font-family: 'Times New Roman'; font-variant: normal; text-decoration: none;">
                    DEPARTMENT SHORT</td>
                <td style="width: 20%">
                </td>
            </tr>
            <tr>
                <td style="width: 20%; font-weight: bold; font-family: 'Times New Roman'; height: 8px;">
                    </td>
                <td style="width: 20%; height: 8px;">
                    </td>
                <td style="width: 20%; height: 8px;">
                </td>
            </tr>
            <tr>
                <td style="width: 20%; font-weight: bold; font-family: 'Times New Roman'; height: 26px;">
                    From Date</td>
    ...
    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtdate" Format="dd/MMM/yyyy" OnClientDateSelectionChanged="checkDate">
