<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="EmployeeList_Search.aspx.vb" Inherits="WebAppHRMS.HRM_EmployeeList_Search_8834b9ab4462" title="Untitled Page" %>
...
function CheckCodeClick()
{
   if(document.getElementById(cont[0]+"checkEmpCode").checked == true)
   {
      ...
      document.getElementById(cont[0]+"checkAll").checked = false;
...
{
    if(document.getElementById(cont[0]+"checkAll").checked == true)
{
      document.getElementById(cont[0]+"checkEmpCode").checked = false;
      document.getElementById(cont[0]+"checkEmpName").checked = false;
      document.getElementById(cont[0]+"txtEmpCode").value     = "";
...
//      document.getElementById(cont[0]+"txtEmpName").focus();
   ...
   if(document.getElementById(cont[0]+"checkAll").checked == false)
   {
      document.getElementById(cont[0]+"checkEmpCode").checked = true;
      document.getElementById(cont[0]+"txtEmpCode").disabled  = false;
      document.getElementById(cont[0]+"txtEmpName").value     = "";
...
window.onload = init;
    ...
    <div style="text-align: center">
        <br />
        <table border="1" style="width: 52%; font-family: 'Bookman Old Style'; font-variant: small-caps;" align="center" >     
          <tr>
          <td style="width: 35%; text-align: center; height: 34px;" colspan="3">
          <asp:Label ID="lbl_heading" runat="server" Text="Employee Search : Using Employee Code or Name or All" Width="720px" Font-Bold="True" Font-Underline="True" ></asp:Label>
          </td>
          </tr> 
            <tr>
                <td style="width: 30%; text-align: left;" >
                    &nbsp;<asp:CheckBox ID="checkEmpCode" onclick="CheckCodeClick()" runat="server" Width="280px" Text=" Enter Employee Code" style="cursor: hand; font-family: 'Bookman Old Style'" /></td>
                <td style="width: 35%; text-align: left;">
                    <asp:TextBox ID="txtEmpCode" onkeyup="return EmpCodeKeyUp()" onchange="return EmpCodeFind()" runat="server" MaxLength="6" Style="font-family: 'Bookman Old Style';
                        text-align: center" Width="154px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 30%; text-align: left">
                    &nbsp;<asp:CheckBox ID="checkEmpName" onclick="CheckNameClick()" runat="server" Width="280px" Text=" Enter Name/Part of Name" style="cursor: hand; font-family: 'Bookman Old Style'" /></td>
                <td style="width: 35%; text-align: left">
            ...
            <tr>
            <td style="width: 30%; text-align: left">
            &nbsp;<asp:CheckBox ID="checkAll" onclick="CheckAllClick()" runat="server" Text="All" style="cursor: hand; font-family: 'Bookman Old Style'" />
            </td>
            </tr>
            <tr>
