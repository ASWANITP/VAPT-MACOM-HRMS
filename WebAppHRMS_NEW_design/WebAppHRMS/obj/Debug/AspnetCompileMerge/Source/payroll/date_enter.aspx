        ...
        <table border="1" style="width: 360px; height: 144px">
            <tr>
                <td colspan="4" style="height: 49px">
                    ...
                    </asp:ScriptManager><strong style="background-color: #ffcc33"><span style="font-size: 14pt">EMPLPOYEE DETAILS&nbsp;</span></strong></td>
            </tr>
            <tr>
                ...
                <td style="width: 100px; height: 39px">
                    ...
                    <asp:TextBox ID="txtLeaveFrom" onkeyup="return KeyUps('txtLeaveFrom')" onchange="Fill_Dateto()" runat="server" Style="font-family: 'Bookman Old Style';
                                        text-align: center" Width="152px"></asp:TextBox>
