...
// ]]>
    ...
    <div style="text-align: center; height:250" id="hidden4">
        <table border="1" style="width: 47%; height: 56px; text-align:left">
            ...
            <tr>
                <td colspan="3" style="text-align:center ">
                    &nbsp;<asp:Button ID="Button1" runat="server" Text="Confirm" /><asp:Button ID="Button3" runat="server" Text="Confirm" onclientclick="delconfirm()" /><input id="Button2" runat="server" style="width: 65px" type="button" value="Exit" onclick="return Button2_onclick()" /></td>
            </tr>
            <tr id="un_row">
