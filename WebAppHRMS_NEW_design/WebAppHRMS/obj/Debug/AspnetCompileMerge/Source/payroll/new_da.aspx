...
// ]]>
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 280px; height: 117px">
            ...
            <tr>
                <td colspan="2" style="height: 26px"><asp:Button ID="cmd_confirm" runat="server" Text="CONFIRM" Height="24px" Width="83px" style="cursor: hand" OnClientClick="return dt_check()" />
