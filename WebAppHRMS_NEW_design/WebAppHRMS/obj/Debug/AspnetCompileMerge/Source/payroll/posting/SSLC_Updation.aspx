...
{ 
   ...
   if (SSLCNO=="")
    { alert("Enter the SSLC Certificate No !"); document.getElementById(cont[0]+"txt_SSLC_NO").focus(); return false; }
    
    if (SSLCYR==0)
    { alert("Please Select the Year of Passing !"); document.getElementById(cont[0]+"DDL_year_Pass").focus(); return false; }
    
     if (SSLCST==0)
    { alert("Pleae Select the State of Passing !"); document.getElementById(cont[0]+"DDL_State_Pas").focus(); return false; }
