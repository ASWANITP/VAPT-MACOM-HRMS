     ...
     <div style="text-align: center">
        <table border="1" style="width: 656px; height: 72px; margin: 0 auto;">
            <tr>
                <td colspan="4" style="height: 34px">
                    <strong><span style="font-size: 14pt; color: #990099; font-family: Courier New; text-decoration: underline;">
                        DepartmentHead Approval </span></strong>
                </td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <tr>
                <td style="width: 90px; height: 7px; text-align: left">
                    <span style="font-size: 11pt; font-family: Courier New">New Department Head</span>
                </td>
                <td colspan="3" style="width: 60px; height: 7px; text-align: center;">
                   <asp:TextBox ID="txt_newdptmthead" style="width: 300px; font-family: 'Courier New';" type="text"
                        runat="server" readonly="true" />   
            ...
            <tr>
                <td colspan="5" style="text-align: center; height: 50px;">
                    ...
                    <asp:Button ID="btnapprove" runat="server" Text="APPROVE" Width="140px" height="25px" style="font-family: 'Courier New'" BackColor="Gainsboro" Font-Bold="True" />&nbsp;
                     ...
                     <asp:Button ID="btnrjct" runat="server" Text="REJECT" Width="140px" height="25px" style="font-family: 'Courier New'" BackColor="Gainsboro" Font-Bold="True" />&nbsp;
