...
// ]]>
    ...
    <table style="width: 743px " align="center" border="1">
        <tr>
            <td style="width: 341px; text-align: left; height: 28px;">
                Application No :</td>
            ...
            <td style="width: 197px; text-align: left; height: 28px;">
                Applicants Name :
            </td>
        ...
        <tr>
            <td colspan="2" style="height: 21px; text-align: left">
                Specify relatives, if any ,employed in Manappuram Group :</td>
        ...
        <tr id="row1" style="display:none">
            <td style="width: 341px; text-align: left">
                Employee Name :
            </td>
        ...
        <tr>
            <td colspan="2" style="text-align: left">
                Specify relationship with Directors,if any :</td>
            <td style="width: 197px; text-align: left">
        ...
        <tr  id="row2" style="display:none">
            <td style="width: 341px; height: 21px; text-align: left">
                Director's Name :
            </td>
        ...
        <tr>
            <td style="width: 341px; height: 26px; text-align: left">
                Name :
            </td>
            ...
            <td style="width: 197px; height: 26px; text-align: left">
                Name :
            </td>
        ...
        <tr>
            <td style="width: 341px; height: 13px">
                Any Other Details :
            </td>
