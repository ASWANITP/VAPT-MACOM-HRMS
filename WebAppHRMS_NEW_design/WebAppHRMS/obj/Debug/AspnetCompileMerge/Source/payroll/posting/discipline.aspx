        ...
        <div style="text-align: center">
            <table border="1">
                <caption>
                    ...
                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_frmdate">
                ...
                <tr>
                    ...
                    <td colspan="2" style="width: 171px; height: 28px">
                        <asp:TextBox ID="txt_empcode" runat="server" Width="249px" BackColor="White" BorderColor="#E0E0E0" BorderStyle="Ridge"></asp:TextBox></td>
                </tr>
                <tr>
                    <td colspan="2" style="height: 28px">
                        EmployeeName</td>
                    ...
                    <td colspan="2" style="width: 171px; height: 28px;">
                        <asp:TextBox ID="txt_empname" runat="server" Width="247px" Enabled="False" BorderColor="#E0E0E0" BorderStyle="Ridge"></asp:TextBox></td>
                </tr>
                <tr>
                    ...
                    <td colspan="2" style="width: 171px; height: 37px">
                        <asp:TextBox ID="txt_designation" runat="server" Width="247px" BorderColor="#E0E0E0" BorderStyle="Ridge" Font-Overline="True"></asp:TextBox></td>
                </tr>
                <tr>
                    <td colspan="2" style="height: 28px">
                        Department</td>
                    ...
                    <td colspan="2" style="width: 171px; height: 28px">
                        <asp:TextBox ID="txt_department" runat="server" Width="249px" BorderColor="#E0E0E0" BorderStyle="Ridge"></asp:TextBox></td>
                </tr>
                <tr>
                    <td colspan="2" style="height: 28px">
                        Branchname</td>
                    ...
                    <td colspan="2" style="width: 171px; height: 28px;">
                        <asp:TextBox ID="txt_branchname" runat="server" Width="249px" BorderColor="#E0E0E0" BorderStyle="Ridge"></asp:TextBox></td>
                </tr>
                <tr>
                    <td colspan="2" style="height: 26px">
                        Disciplinary Action Taken By</td>
                ...
                <tr>
                    <td colspan="2" style="height: 26px">
                        Select Disciplinary Action Type</td>
                    <td style="width: 149px; height: 26px;">
                    </td>
                    <td colspan="2" style="width: 171px; height: 26px;">
                ...
                <tr>
                    <td colspan="2" style="height: 18px">
                        Period For Disciplinary Action Taken</td>
                    ...
                    <td colspan="2" style="width: 171px; height: 18px">
                        ...
                        <asp:TextBox ID="txt_frmdate" runat="server" Width="79px" Height="18px" BorderStyle="Dotted"></asp:TextBox></td>
                                    <td style="width: 100px; height: 7px">
                                        To</td>
                                    <td style="width: 100px; height: 7px">
                        <asp:TextBox ID="txt_todate" runat="server" Width="73px" BorderStyle="Dotted"></asp:TextBox></td>
                                </tr>
                            </table>
                        </asp:Panel>
                    </td>
                ...
                <tr>
                    <td colspan="2" style="height: 23px">
                        <asp:Button ID="btn_confirm" runat="server" Height="44px" Text="Confirm" Width="119px" BorderStyle="Dotted" /></td>
