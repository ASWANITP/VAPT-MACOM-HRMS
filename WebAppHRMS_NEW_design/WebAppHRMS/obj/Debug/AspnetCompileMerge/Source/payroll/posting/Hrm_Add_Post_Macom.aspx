<%@ Page Language="VB"  MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Hrm_Add_Post_Macom.aspx.vb" Inherits="WebAppHRMS.payroll_Posting_Hrm_Add_Post_Macom_f1331c5e1802" title=""%>

<%--<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_Add_Post.aspx.vb" Inherits="HRM_SECURITY_hrm_Add_Post" title="Untitled Page" EnableEventValidation="false"  %>--%>
...
//        {alert("Please Enter Correct Employee Code!!!"); document.getElementById(cont[0]+"txt_EmpCode").value="";return false;}
  ...
  case 3:
          alert(arg) ;
          window.open(Hrm_Add_Post_Macom.aspx','_self');
          break; 
  }      
}
...
function disp()
{
    ...
    if(document.getElementById(cont[0]+"Hidden1").value!="")
    {
        ...
        st=st+"<table id='mytable' border='1' width='400px' ><tr><td><small><b>EMP NAME</b></td><td><small><b>D O J</b></td><td><small><b>POST</b></td><td><small><b>DESIGNATION</b></td><td><small><b>DEPARTMENT</b></td><td><small><b>SALARY</b></td><td><small><b>TECHLEAD</b></td><td><b><small>LEVEL</b></td></tr><tr></tr><tr></tr>"
...
{   
        ...
        if (document.getElementById(cont[0]+"rdb_Cancel").checked==true)   
          Status=6;
        if (document.getElementById(cont[0]+"rdb_tl").checked==true) 
         Status=7;
          if (document.getElementById(cont[0]+"rdb_level").checked==true) 
         Status=8;
    ...
    <div style="text-align: center">
        &nbsp;<table border="1" style="width: 59%; height: 147px;">
            ...
            <tr id="row1" style="display:none">
                ...
                <td colspan="5" style="height: auto; width: 800px;">
