...
// ]]>
    ...
    <div style="text-align: center"  runat="server" id="Div1">
        ...
        <table id="tbl_imp" border="1" style="width: 600px; height: 117px" runat="server">
            <tr>
                <td style="width: 573px; text-align: left">
                    Present VDA :
                </td>
                ...
                <td colspan="1" style="width: 69px; text-align: center">
                </td>
            </tr>
            <tr>
                <td style="width: 573px; text-align: left; height: 12px;">
                    Employee Code</td>
            ...
            <tr id="msg_row" runat="server">
                ...
                <div id="ddd">
                 <asp:Label ID="lbl_msg" runat="server" Font-Bold="True" ForeColor="Blue" Width="496px" CssClass="csslab" Font-Size="Small" Font-Underline="True" Height="24px" ></asp:Label>&nbsp;</div>
                    </td>
                <td colspan="1" rowspan="2" style="width: 69px; text-align: left">
                </td>
            </tr>
            <tr>
