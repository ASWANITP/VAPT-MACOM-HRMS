...
var PendingApp  = document.getElementById(cont[0]+"DDLPendApprov").value;
     ...
     if (PendingApp==0)
    { alert("Please Select One Employee !"); document.getElementById(cont[0]+"DDLPendApprov").focus(); return false; }
    
    if (Remarks=="")
    { alert("Please Enter the Reason for Rejecting !"); document.getElementById(cont[0]+"txt_Remarks").focus(); return false; }
...
var Remarks  = document.getElementById(cont[0]+"txt_Remarks").value; 
    ...
    if (Remarks=="")
    { alert("Please Enter theRemarks !"); document.getElementById(cont[0]+"txt_Remarks").focus(); return false; }
