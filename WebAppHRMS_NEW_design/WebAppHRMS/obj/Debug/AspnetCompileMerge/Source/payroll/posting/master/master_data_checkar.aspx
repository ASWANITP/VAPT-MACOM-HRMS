<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="master_data_checkar.aspx.vb"  Inherits="WebAppHRMS.Auction_Listed_pledges_6d02a6ba1950" %>
...
//      document.getElementById("Button1").style.display="inline";
...
else if (document.getElementById("asp").value==3)
  {
  // New condition for rejection 
  document.getElementById("Panel2").innerHTML = "<br><br><br><br><br><br><br><br><br><br><img src='load.gif' alt='Please Wait...' />"; 
  ToServer("1$3", 1); 
  }
  ...
  else if (document.getElementById("asp").value=="")
    {
         document.getElementById("loasp").innerHTML="<span style='color:red;'>*No Data Found!!!!</span>";
//         document.getElementById("Button1").style.display="none";
         ToServer("1$1",1);
...
var Data=arg.split("@")
  ...
  {
//  document.getElementById("asp").value=arg;
...
//      {   
            document.getElementById("rowDel").style.display='inline';                 
            document.getElementById("hdnDelData").value=arg;
            dispe(); 
//      }
  }
}
...
if (st3[5].indexOf("^")>=0)
{
if(st3[5].split('^')[0].indexOf("+")>=0)
x=0;
if(st3[5].split('^')[1].indexOf("+")>=0)
x=1;
if(st3[5].split('^')[2].indexOf("+")>=0)
x=2;
dtt=st3[5].split('^')[x].split('+')[0];
}
else
{
dtt=st3[5];
            ...
            st1=st1+"<tr><td><small>"+st3[0]+"</td><td><small> "+st3[1] +"</td><td><small>"+st3[2] +"</td><td><small>"+st3[3] +"</td><td><small>"+st3[4] +"</td><td><small>"+dtt +"</td><td><small>"+st3[6] +"</td><td><small>"+st3[7] +"</td><td><input type='checkbox' id='chkm_"+k+"' name='txtm_"+k+"'></td></tr>"
        }
        st=st+"<table id='mytable' border='1' width='1000px'  ><tr ><td><small><b>Empcode </b></td><td><small><b>EmpName </b></td><td><small><b>&nbsp;&nbsp;&nbsp;&nbsp;Component&nbsp;&nbsp;&nbsp;</b></td><td><small><b>&nbsp;&nbsp;&nbsp;Effiective&nbsp&nbsp&nbsp date&nbsp;&nbsp;&nbsp;</b></td><td><small><b>Old&nbspData&nbsp;&nbsp;&nbsp;</b></td><td><small><b>New Change&nbsp;&nbsp;&nbsp;</b></td>  <td><small><b>Edited Name </b></td><td><small><b>Edited User </b></td><td><small><b>&nbsp;&nbsp;&nbsp;MARK&nbsp;ALL&nbsp;<input onclick='selectall()' type='checkbox' id='ch'/></b></td></tr>"
        st1=st+st1+"</table>" 
    }
    else
    {  
...
//        }
        ...
        {  
            ...
            for(i=0;i<ar-1;i++)
            {
                ...
                {
                    num=1;
                    document.getElementById("hdnToSendDel").value+=st3[0] + "|" + st3[8]+ "|" + st3[4]+ "|" + st3[5]+ "|" +st3[3]+"*" ;
                }
...
//        }
    ...
    if (num>0)
    {
    ToServer("3$"+document.getElementById("hdnToSendDel").value+"$REJ",3);
    }
    else
    {
...
<body style="text-align: center">
    <form id="form1" runat="server">
            ...
            <table border ="3" style="width:1125px;  font-family: Courier New;">
                <tr>
                ...
                <br/>
                        <strong><span style=" font-size: 11pt; color :Red ; font-family: Times New Roman; background:red;color:White;"><i>EMPLOYEE MASTER DATA/APPROVAL</i></span></strong></td>
                </tr>
                <tr>
                    <td  style=" text-align: left; background-color:Silver;height:35px;">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <%-- 
                        <strong>Select All</strong><input type="checkbox" id="ch"/>
...
<%--            </table>
            ...
            <table border ="3" style="width: 928.5px;  font-family: Courier New; ">--%>
                ...
                <tr id="rowDel">
                    <td colspan="29" style=" text-align: center;  background-color :#fff;">
                        <%--<span style=" font-size: 10pt; color :Red ; font-family: Times New Roman;"><i>Please Select Any Authority To Display Pendings!!!</i></span>--%>
                         <asp:Panel Height="400px" ScrollBars="Auto" ID="Panel2" runat="server" Width="100%">
                         <br/>
                         <br/>
                         <br/>
                         <br/>
                ...
                <tr>
                    <td  style=" text-align: center; background-color:Silver;">
                        ...
                        <asp:Button ID="Button2" runat="server" Font-Bold="true" Text="Exit" Width="74px" /><%--<asp:Button ID="Button2" BorderStyle="Solid" BorderColor="silver" OnClientClick="recommend()" Font-Bold="true"  runat="server" Text="Recommend" />
                        <asp:Button ID="Button3" BorderStyle="Solid" BorderColor="silver" OnClientClick="reject()" Font-Bold="true"  runat="server" Text="Reject" />--%><%-- <asp:Button ID="b1" BorderStyle="Solid" BorderColor="silver" OnClientClick="quit()" Font-Bold="true"  runat="server" Text="Exit" Width="70px" />--%></td>
                </tr>
                
                
                <tr>         
                    
        <td style="HEIGHT: 28px; TEXT-ALIGN: center" colspan="2"><asp:Label id="lbl_mesage" runat="server" Width="410px" Font-Bold="True" ForeColor="Red"></asp:Label>
        ...
        <asp:HiddenField ID="hdnToSendRej" runat="server" />
