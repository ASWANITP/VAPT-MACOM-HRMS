    ...
    <table border="1" style="width: 806px; " align="center">
        ...
        <tr>
            <td colspan="2" style="text-align: right; height: 28px;">
                Name (As given <span style="color: #000000">i</span><span style="color: #ff0000">n SSLC
                ...
                <table border="1" style="width: 330px; height: 208px;">
                    <tr>
                        <td colspan="5" style="text-align: center">
                            <strong><span style="color: #cc3300">
                    ...
                    <tr>
                        <td colspan="2" style="width: 209px; height: 24px; text-align: left">
                        </td>
            ...
            <td colspan="4" style="text-align: center; height: 198px;">
                <div style="text-align: center">
                    <table style="width: 802px" border="1">
                        ...
                        <tr>
                            <td style="width: 139px; text-align: left; height: 16px;">
