...
// ]]>
    ...
    <div style="text-align: center">
        <table border="1" style="width: 383px; height: 177px">
            ...
            <tr>
                <td style="width: 172px; height: 8px; text-align: left">
                    &nbsp;<asp:RadioButton ID="rdb_state" runat="server" GroupName="g" Text="State " Checked="True" /></td>
            ...
            <tr>
                <td style="width: 172px; text-align: left">
                    &nbsp;<asp:RadioButton ID="rdb_district" runat="server" GroupName="g" Text="District" /></td>
            ...
            <tr>
                <td style="width: 172px; text-align: left">
                    &nbsp;<asp:CheckBox ID="chk_post" runat="server" Text="Post Office" /></td>
                <td style="width: 100px; text-align: left">
            ...
            <tr>
                <td colspan="2" style="height: 29px">
                    &nbsp;<input id="cmd_exit" type="button" value="EXIT" onclick="return cmd_exit_onclick()" style="width: 64px" />
                    &nbsp;&nbsp;&nbsp;
