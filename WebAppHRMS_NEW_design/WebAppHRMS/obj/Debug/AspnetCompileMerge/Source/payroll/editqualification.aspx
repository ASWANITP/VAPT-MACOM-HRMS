...
// ]]>
    ...
    <div style="text-align: center">
        <table border="1" style="width: 838px; height: 472px">
            ...
            <tr>
                <td style="text-align: center; height: 206px;" colspan="5">
                    ...
                    <asp:Button ID="cmd_edit" runat="server" Text="EDIT" Width="82px" /></td>
                                <td style="width: 45px">
                    <asp:Button ID="cmd_delete" runat="server" Text="DELETE">
                    </asp:Button></td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txt_addyear"
                        ErrorMessage="Please Enter Year" ValidationExpression="^\d{4}$" Width="137px" Font-Size="Small"></asp:RegularExpressionValidator></td>
                            ...
                            <tr>
                                <td colspan="5">
                    <asp:ListBox ID="ListBox1" runat="server" Height="131px" Width="828px" BackColor="Azure" Font-Bold="True" Rows="7" AutoPostBack="True">
                    </asp:ListBox></td>
                            </tr>
                        </table>
                    </div>
                        ...
                        <table border="1">
                            <tr>
                                <td colspan="2" style="height: 139px">
                                    <asp:ListBox ID="ListBox2" runat="server" BackColor="White" Height="131px" Width="824px" style="background-color: #fff8ff" AutoPostBack="True">
                                    </asp:ListBox>&nbsp;</td>
                            </tr>
                        </table>
                    </div>
            ...
            <tr>
                <td style="width: 233px; height: 23px; text-align: right;">
                    Name of Org :&nbsp;
                </td>
                ...
                <td style="width: 199px; height: 23px; text-align: right;">
                    Designation :&nbsp;
                </td>
            ...
            <tr>
                ...
                <td style="width: 131px; text-align: left;">
                    ...
                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy"
                        TargetControlID="txt_periodfrom">
                ...
                <td colspan="5">
                    <div style="text-align: center">
                        ...
                        <table border="1" style="width: 588px; height: 61px; background-color: #fff1ff">
                            <tr>
                                <td style="width: 157px; height: 16px; text-align: right">
                                    Date Of Joining :
                                </td>
                            ...
                            <tr>
                                <td style="width: 157px; height: 20px; text-align: right">
                                    Branch :</td>
