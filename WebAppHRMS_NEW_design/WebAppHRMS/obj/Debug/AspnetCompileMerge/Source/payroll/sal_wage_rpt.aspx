<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="sal_wage_rpt.aspx.vb" Inherits="WebAppHRMS.salary_report_sal_wage_rpt_c6d7c93b6768" %>
    ...
    <div style="text-align: center; background-color: #ffffff;">
        ...
        <div style="text-align: center">
            <asp:Panel ID="Panel2" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px"
                Height="280px" Width="571px" style="margin: 0 auto; text-align: center; display: flex; justify-content: center;">
            </asp:Panel>
            <br />
            <br />
