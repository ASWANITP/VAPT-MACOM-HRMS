<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="approve_resign_mac.aspx.vb" Inherits="WebAppHRMS.new_approve_resign_7506ce352852" title="Untitled Page" %>
...
<TABLE border=1><TBODY><TR><TD style="WIDTH: 2773px; TEXT-ALIGN: left"><STRONG>Select&nbsp;Employee</STRONG></TD><TD style="TEXT-ALIGN: left" colSpan=3><asp:DropDownList id="cmb_emp" runat="server" Width="582px" AutoPostBack="True">
                    </asp:DropDownList></TD></TR><TR><TD style="HEIGHT: 32px; TEXT-ALIGN: left" colSpan=4><TABLE border=0><TBODY><TR><TD style="HEIGHT: 23px; TEXT-ALIGN: left" colSpan=2><STRONG>Employee&nbsp;Code :</STRONG> <asp:Label id="lbl_code" runat="server" Width="148px" Text="No Empoyee" ForeColor="Navy"></asp:Label></TD><TD style="WIDTH: 392px; HEIGHT: 23px; TEXT-ALIGN: left" colSpan=2><STRONG>Employee&nbsp;Name :</STRONG>&nbsp; <asp:Label id="lbl_name" runat="server" Width="274px" Text="No Employee" ForeColor="Navy"></asp:Label></TD></TR></TBODY></TABLE>&nbsp;&nbsp; </TD></TR><TR><TD style="WIDTH: 2773px; TEXT-ALIGN: left"><STRONG>Resigning&nbsp;Date</STRONG></TD><TD style="TEXT-ALIGN: left" colSpan=3><asp:TextBox id="Txt_rsdt" runat="server" ReadOnly="True"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp; </TD></TR><TR><TD style="WIDTH: 2773px; TEXT-ALIGN: left"><STRONG>Reason&nbsp;for&nbsp;Resigning</STRONG></TD><TD style="TEXT-ALIGN: left" colSpan=3><asp:TextBox id="Txt_rea" runat="server" Width="571px" ForeColor="MediumBlue" TextMode="MultiLine" Wrap="True" Height="58px" ReadOnly="True"></asp:TextBox></TD></TR><TR><TD style="WIDTH: 2773px; HEIGHT: 23px; TEXT-ALIGN: left"><STRONG>Select&nbsp;Relieving&nbsp;Date</STRONG></TD><TD style="HEIGHT: 23px; TEXT-ALIGN: left" colSpan=3><asp:TextBox id="Txt_rdt" onkeypress="return van()" runat="server" AutoPostBack="True"></asp:TextBox> <asp:Label id="lbl1" runat="server" Width="580px"></asp:Label></TD></TR></TBODY></TABLE>
