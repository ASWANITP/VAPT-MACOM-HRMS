...
window.open('../../home.aspx','_self');
 ...
 <tr align="left"><td align ="center"><span style="color: #ff0033" > </span>
 <asp:ScriptManager id="ScriptManager1" runat="server"></asp:ScriptManager>
       <cc1:CalendarExtender ID="CalendarExtender1"
                            runat="server" Format="dd/MMM/yyyy" TargetControlID="Txtdate">
                        </cc1:CalendarExtender>

    <div style="text-align: center" >
        <asp:HiddenField ID="Hidden2" runat="server" />
        <br />
      <b>  <asp:Label ID="Label1" runat="server" ForeColor="Brown" Height="20px" Text="NOTICE PERIOD UPDATION" ></asp:Label>
     </b> <br />
        <br />
        <br />
        <table border="1" style="width: 70%">
            ...
            <tr>
                <td style="width: 170%; text-align: left; height: 28px;" colspan="2">
                   Current Exit Date</td>
                <td style="width:170px; height: 28px;">
                    <asp:TextBox ID="txtcurr" runat="server" Width="180px" ReadOnly="True"></asp:TextBox></td>
               
            </tr>
            <tr>
                <td style="width: 170%; text-align: left"colspan="2" >
                      Proposed Exit Date</td>
               <td style="width: 120%">
