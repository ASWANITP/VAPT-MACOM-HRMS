<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_salary_confirmation.aspx.vb" Inherits="WebAppHRMS.salary_hrm_salary_confirmation_96dc537a5968" title="Untitled Page" %>
...
//         document.getElementById(cont[0]+"hid_code").value=arg1[5];   
  ...
  case 2:
          alert(arg) ;
          window.open('hrm_salary_confirmation.aspx','_self')  ;
          break; 
  }      
}  
  ...
  //debugger;
           ...
           
    {
        for(i=0;i<ar;i++)
       {
        ...
        st=st+"<table id='mytable' border=1 width='100%'><tr  bgcolor='#CCDDEE' style='font-size:85%'><td><b>SLNO</b></td><td><b>&nbsp;EMP&nbsp;CODE&nbsp;</b></td><td><b>&nbsp;&nbsp;EMP&nbsp;NAME&nbsp;&nbsp;</b></td><td><b>&nbsp;OLD&nbsp;CODE&nbsp;</b></td><td><b>&nbsp;&nbsp;ACC&nbsp;NO&nbsp;&nbsp;</b></td><td><b>&nbsp;SALARY&nbsp;&nbsp;</b></td><td><b>&nbsp;ALLOWANCE&nbsp;&nbsp;</b></td><td><b>&nbsp;CHECK&nbsp;ALL&nbsp;<input type=checkbox onclick=checkallfunction() id=chkall name=txt_all /></b></td></tr>"
      ...
      for(i=0;i<ar-1;i++)
       {
         ...
         document.getElementById(cont[0]+"Hidden4").value += st3[0]+ "^" +Verify +"$" ; 
...
// ]]>
    ...
    <div style="text-align: center">
        ...
        <table style="width: 470px" border="1">
            ...
            <tr>
                <td style="text-align: center" colspan="2">
                    &nbsp;<input id="cmd_confirm" onclick="onclickconfirm()" style="width: 87px" type="button" value="CONFIRM" />
        ...
        <input id="hid_dep" runat="server" type="hidden" /></div>
</asp:Content>
