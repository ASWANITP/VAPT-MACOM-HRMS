...
{ 
  ...
  if (EmpCode=="")
    {  alert("Enter Employ Code...!!!"); document.getElementById(cont[0]+"txt_Code").focus();  return false;  }   
  var EmpLength=EmpCode.length;
  if (Math.abs(EmpLength)<5)
     {alert("Employee Code Not a Valid "); document.getElementById(cont[0]+"txt_Code").focus(); return false; }
...
{
    if (isNaN(document.getElementById(cont[0]+"txt_Code").value))
     {document.getElementById(cont[0]+"txt_Code").value=""; return false; } 
