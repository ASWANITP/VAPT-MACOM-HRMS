...
// ]]>
    ...
    <div style="text-align: center">
        <asp:ScriptManager id="ScriptManager1" runat="server">
        </asp:ScriptManager><asp:Panel ID="Panel1" runat="server" Height="174px" Width="841px">
            <br />
            ...
            <div style="text-align: center">
        <input id="cmd_clear" type="button" value="CLEAR" onclick="return Button1_onclick()" style="width: 84px" /><asp:Button ID="cmd_confirm" runat="server" Text="CONFIRM" onclientclick="return checkbeforeconfirm()" TabIndex="14" style="cursor: hand" /><input id="cmd_exit" style="width: 81px; cursor: hand;" type="button" value="EXIT" onclick="return cmd_exit_onclick()" />&nbsp;</div>
            </asp:Panel>
        <br />
        &nbsp;&nbsp;<br />
        &nbsp; &nbsp;&nbsp;
