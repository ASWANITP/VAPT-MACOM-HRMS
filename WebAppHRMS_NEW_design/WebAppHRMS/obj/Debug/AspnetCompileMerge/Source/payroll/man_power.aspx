        ...
        <table border="1" style="width: 646px; height:59px; margin:0px auto;">
           <tr>
                <td colspan="5" style="height: 24px;">
                    <span style="font-size: 14pt; font-family: Courier New"><span style="color: #000000">
                    </span>
                        <p align="center" style="margin-bottom: 0in; line-height: 150%">
                            <font face="Times New Roman, serif"><font size="3"><u><b><font face="Gisha, serif">MANPOWER
                                REQUISITION FORM</font></b></u></font></font></p>
                    </span></td>
            </tr>
           <tr>
                <td colspan="5" style="height: 3px">
                   ...
                   <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy" targetcontrolid="txt_exp_dt">
                    </cc1:CalendarExtender>
            ...
            <tr>
              ...
              <td style="height: 7px; text-align: left;" colspan="2" rowspan="">
                ...
                <td colspan="1" style="width: 4823138px; height: 7px; text-align: left" rowspan="">
                </td>
                <td style="width: 184px; height: 7px; text-align: left;" rowspan="">
                    </td>
            </tr>
            <tr>
   ...
   <%--</tr>--%>
           ...
           <tr>
            ...
            <tr>
                ...
                <td style="height: 1px; text-align: left;" colspan="2">
                    &nbsp;<asp:Label ID="Label10" runat="server" Text="PayScale for the Position" Width="144px"></asp:Label></td>
                <td style="width: 184px; height: 1px; text-align: left">
            ...
            <tr>
                ...
                <td style="height: 1px; text-align: left;" colspan="2">
                    &nbsp;<asp:Label ID="Label13" runat="server" Text="gender" Width="144px"></asp:Label></td>
                <td style="width: 184px; height: 1px; text-align: left">
            ...
            <tr>
                ...
                <td align="left" style="width: 498px; height: 1px; text-align: left">
                    &nbsp;<asp:DropDownList ID="cmb_reason" runat="server" Width="200px" onchange="getitem(event,this)">
                    </asp:DropDownList></td>
                <td style="height: 1px; text-align: left; font-family: 'Courier New';" colspan="2">
                    &nbsp;&nbsp;</td>
                <td style="width: 184px; height: 1px; text-align: left">
                    &nbsp;</td>
            </tr>
            <tr id="row" style="display:none">
                ...
                <td colspan="2" style="font-family: 'Courier New'; height: 1px; text-align: left">
                </td>
                <td style="width: 184px; height: 1px; text-align: left">
                </td>
            </tr>
            <tr>
                <td colspan="5" style="height: 15px">
                    &nbsp;<asp:Button ID="btn_confirm" runat="server" Text="APPLY" Width="151px" OnClientClick="return check_con()" Font-Bold="True" Height="40px"/>&nbsp;
