            ...
            <tr>
                <td colspan="4">
                    <asp:UpdatePanel id="UpdatePanel1" runat="server">
                        <contenttemplate>
<TABLE border=1><TBODY><TR><TD style="WIDTH: 2773px; TEXT-ALIGN: left"><STRONG>&nbsp;Employee Name</STRONG></TD>


<TD style="TEXT-ALIGN: left" colSpan=3><asp:TextBox id="txt_name" runat="server" Width="582px" ReadOnly="true">
                    </asp:TextBox></TD></TR>
                    
                    
                    
                    <TR>
                    <TD style="TEXT-ALIGN: left" colSpan=2><STRONG>Employee&nbsp;Code :</STRONG> <asp:Label id="lbl_code" runat="server" Width="148px" Text="No Empoyee" ForeColor="Navy"></asp:Label></TD>
