...
function btnConfirm_onclick() 
{
   ...
   if (document.getElementById(cont_name[0]+"DropDownList1").value!=0)
   {Reason=document.getElementById(cont_name[0]+"DropDownList1").options[document.getElementById(cont_name[0]+"DropDownList1").selectedIndex].text+ ":" +Reason;}
...
//        count=count+1
        ...
        if(st3[4]==1 )
        { st1=st1+"<tr  bgcolor='#CCDDEE'><td><small>"+st3[1]+"</td><td><small>"+st3[2]+"</td><td><small>"+st3[3]+"</td><td><small>"+st3[4]+"</td><td><small>"+st3[5]+"</td><td><small>-</td><td><small>-</td><td><input type='checkbox' id='chk_"+i+"' name='txt_"+i+"' onclick=chkk('" + i + "','chk_"+i+"')></td><td>-</td></tr>"             } 
      ...
      if(funi==id)
       {
        ...
        if (document.getElementById(cont_name[0]+"hid_check").value!="")
      
             {document.getElementById(cont_name[0]+"hid_check").value=document.getElementById(cont_name[0]+"hid_check").value+at+'^';}
        else
...
if (document.getElementById(cont_name[0]+"RadioButton2").checked==true)
    ...
    <div id="divTotal" style="text-align: center;font-family:'poppins';color:midnightblue;">
        ...
        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy" TargetControlID="TextBox2">
        </cc1:CalendarExtender>
        ...
        <table border="1" style="width: 22%">
            <tr>
                <td style="width: 50%">
                    <input id="btnConfirm" style="width: 88px; cursor: pointer; font-family: 'Book Antiqua';
                        height: 26px" type="button" value="CONFIRM" onfocus="checkWaiting()" onmouseover="checkWaiting()" onclick="return btnConfirm_onclick()"/></td>
                <td style="width: 50%">
                    <input id="btnExit" style="width: 88px; cursor: pointer; font-family: 'Book Antiqua';
