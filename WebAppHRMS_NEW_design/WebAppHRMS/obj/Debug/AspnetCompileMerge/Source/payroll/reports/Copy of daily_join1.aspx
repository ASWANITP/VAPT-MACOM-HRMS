<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Copy of daily_join1.aspx.vb" Inherits="WebAppHRMS.daily_joinning_report_daily_join1_fe4f0c149919" title="Untitled Page" %>
    ...
    <div style="text-align: center">
        <table border="1">
            ...
            <tr>
                ...
                <td style="width: 100px">
                    <asp:Button ID="btn_exit" runat="server" Text="EXIT" Width="105px" /></td>
            </tr>
        </table>
    </div>
</asp:Content>
