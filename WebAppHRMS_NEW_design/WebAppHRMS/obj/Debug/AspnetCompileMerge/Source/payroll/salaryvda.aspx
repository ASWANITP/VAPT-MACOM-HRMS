<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="salaryvda.aspx.vb" Inherits="WebAppHRMS.salaryvda_b9f3103f3404" title="Untitled Page" %>
 ...
 mydate=daym+"/"+montharray[month]+"/"+year
  ...
  <div style="text-align: center">
      ...
      <asp:Panel ID="Panel1" runat="server" BackColor="Transparent" BorderStyle="Solid"
            BorderWidth="1px" Height="300px" Width="393px" BorderColor="Black">
            <br />
            <br />
