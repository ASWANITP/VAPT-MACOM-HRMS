...
if (EffDate=="") 
  { alert("Select Date from Calender ..!!!");  document.getElementById(cont[0]+"txt_Date").focus(); return false; }  
if (document.getElementById(cont[0]+"cmb_Branch").options.length==0)
  { alert("No Branch to Confirm..!!!");  return false; }  
