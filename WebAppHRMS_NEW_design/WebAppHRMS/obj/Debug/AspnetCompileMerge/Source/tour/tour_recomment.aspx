...
window.open('../home.aspx','_self');
    ...
    <div style="text-align: center">
        <table border="1" style="width: 724px; height: 324px">
            <tr>
                <td colspan="3" style="font-weight: bold; font-size: large; text-transform: uppercase;
                    width: 755px; color: crimson; height: 43px; background-color: gold;">
                    TOUR RECOMMENTATION</td>
            </tr>
            <tr>
                <td colspan="3" style="width: 755px; height: 16px">
                    <table border="1" style="width: 750px">
                        ...
                        <tr>
                            ...
                            <td style="width: 62px; height: 23px; text-align: left;">
                        ...
                        <tr>
                            <td style="width: 51px">
                                &nbsp;<asp:Label ID="Label2" runat="server" Text="Name" Width="97px"></asp:Label></td>
                            <td style="width: 94px">
            ...
            <tr>
                <td style="width: 70px">
                    &nbsp;<asp:Label ID="Label9" runat="server" Text="Tour Advance Rs." Width="113px"></asp:Label></td>
            ...
            <tr>
                <td style="width: 70px; height: 23px; background-color: #33ffff; text-align: left;">
                    &nbsp;<asp:Label ID="Label12" runat="server" Text="Recommended By" Width="124px"></asp:Label></td>
            ...
            <tr>
                <td colspan="3" style="width: 755px; text-align: right; height: 13px;">
                </td>
            </tr>
            <tr>
                    ...
                    <div style="text-align: center">
                        <table style="width: 744px">
                            <tr>
                                ...
                                <td style="width: 6px; height: 59px;">
                                </td>
                                <td style="width: 100px; height: 59px;">
                                    </td>
