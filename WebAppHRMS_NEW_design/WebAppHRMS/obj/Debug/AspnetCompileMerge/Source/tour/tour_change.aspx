...
// ]]>
    ...
    <div style="text-align: center">
                            ...
                            <tr>
                                <td colspan="2" style="height: 38px">
                                    <strong><span style="color: #cc0099; text-decoration: underline; font-weight: bold; font-size: 14pt; font-family: 'Courier New';">
                                        ...
                                        </asp:ScriptManager>TOUR DATE CHANGE</span></strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" style="height: 7px; text-align: center">
                                    ...
                                    <table border="1" style="width: 648px; height: 95px">
                                        ...
                                        <tr>
                                            <td style="font-weight: normal; font-size: 11pt; width: 151px; font-family: 'Courier New';
                                                text-align: left">
        ...
        <input id="Hidden1" type="hidden" runat="server" style="width: 1px" />&nbsp;<input id="Hidden2" type="hidden" runat="server" style="width: 1px" /></div>
</asp:Content>
