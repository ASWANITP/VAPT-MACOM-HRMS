...
{ 
    ...
    <div style="text-align: center">
        ...
        <table border="1">
            <tr>
                <td colspan="3" style="font-weight: bold; height: 1px; width: 471px; text-align:center;">
                    SUNDAY LOP CANCELLATION</td>
            </tr>
            <tr>
                <td colspan="3" style="height: 1px; width: 471px;">
                        <table border="1" style="width: 473px">
                            <tr>
                                ...
                                <td style="width: 175px; height: 24px;">
                                  ...
                                  <asp:TextBox ID="txtlopFrom"  runat="server" Style="font-family: 'Bookman Old Style';
                                        text-align: center" Width="131px" Enabled="true" Onchange="changes(this.value)" ></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtlopToDate" runat="server" Style="font-family: 'Bookman Old Style'; padding-left:-20px; margin-left:0px;
                                        text-align: center" Width="131px" onchange="return check_dt(this.value)"  onkeyup="checkerrs()"></asp:TextBox>
        ...
        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy" TargetControlID="txtlopFrom">
        
    </cc1:CalendarExtender>
    <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy" TargetControlID="txtlopToDate">
    </cc1:CalendarExtender>
