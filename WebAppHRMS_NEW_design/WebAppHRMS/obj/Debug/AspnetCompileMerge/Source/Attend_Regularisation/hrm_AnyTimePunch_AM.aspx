<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_AnyTimePunch_AM.aspx.vb" Inherits="WebAppHRMS.AnyTimePunching_New_hrm_AnyTimePunch_RH_671e60db5004" title="Untitled Page" %>
...
// ]]>
    ...
    <input id="hid_area" runat="server" type="hidden" style="width: 1px" />
    <input id="hid_post" runat="server" style="width: 12px" type="hidden" />
    <asp:HiddenField ID="hid_s" runat="server" EnableViewState="False" />
</asp:Content>
