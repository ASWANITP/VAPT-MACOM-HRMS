<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_AnyTime_Approval.aspx.vb" Inherits="WebAppHRMS.AnyTimePunching_New_hrm_AnyTime_Approval_c052bffc6378" title="Untitled Page" %>
...
function disp()
{
    ...
    if(document.getElementById(cont[0]+"Hidden1").value!="")
    {
        ...
        {
            st3=st2[k].split("*")
            st1=st1+"<tr><td><small>"+st3[0]+"</td><td><small>"+st3[1] +"</td><td><small>"+st3[7]+"</td><td><small>"+st3[2]+"</td><td><small>"+st3[3]+"</td><td><small>"+st3[4]+"</td><td><small>"+st3[8]+"</td><td><small>"+st3[9]+"</td><td><small>"+st3[6]+"</td><td><input type='checkbox' id='chkm_"+k+"' name='txtm_"+k+"'></td><td><input type='textbox' id='txt_"+k+"' name='txt_"+k+"' style='text-transform:capitalize' maxlength='100'></td></tr>"
        }
        st=st+"<table id='mytable' border='1'  width='600px' ><tr ><td><small><b>EMP&nbsp;CODE</b></td><td><small><b>&nbsp;&nbsp;&nbsp;EMP&nbsp;NAME&nbsp;&nbsp;&nbsp;</b></td><td><small><b>DESIGNATION</b></td><td><small><b>PUNCHING&nbsp;TIME</b></td><td><small><b>ACTUAL&nbsp;TIME</b></td><td><small><b>&nbsp;&nbsp;&nbsp;REASON&nbsp;&nbsp;&nbsp;</b></td><td><small><b>AM RECOMMENDED REASON</b></td><td><small><b>RM RECOMMENDED REASON</b></td><td><small><b>RH RECOMMENDED REASON</b></td><td><small><b>MARK IF APPROVE ONLY</b></td><td><small><b>REMARKS&nbsp;IF&nbsp;ANY</b></td></tr>"
...
//debugger;
 ...
 { 
  ...
  case 2:
          alert(arg) ;
          window.open('hrm_AnyTime_Approval.aspx','_self');
          break; 
  }      
}
...
// ]]>
        ...
        <table border="1" style="width: 40%">
            <tr>
                ...
                <td style="text-align: left;" colspan="2">
                    <asp:DropDownList ID="cmb_branch" onchange="FillEmployDetails()" runat="server" Font-Names="Times New Roman" Font-Size="Medium"
                        Width="306px">
                    </asp:DropDownList></td>
            </tr>
            <tr id="row1" style="display:none">
                <td colspan="4">
                    <span style="color: #ff0033; text-decoration: underline">Late Punching Employee Details</span><br />
            ...
            <tr id="row2" style="display:none">
                <td colspan="4">
                    <span style="color: #ff0033; text-decoration: underline">Normal Punching Employee Details</span><br />
            ...
            <tr>
                <td colspan="4">
                    <input id="Button1" style="font-size: 12pt; font-family: 'Times New Roman'" type="button"
                        value="CONFIRM" onclick="onclickconfirm()" />
                    &nbsp;
                    <input id="Button2" style="font-size: 12pt; width: 106px; font-family: 'Times New Roman'"
    ...
    <input id="hid_sre" runat="server" style="width: 9px" type="hidden" /><input id="Hidden1"
        runat="server" style="width: 4px" type="hidden" /><input id="Hidden5" runat="server"
            style="width: 12px" type="hidden" /><input id="hid_br" runat="server" style="width: 11px"
                type="hidden" /><input id="Hidden4" runat="server" type="hidden" style="width: 4px" />
