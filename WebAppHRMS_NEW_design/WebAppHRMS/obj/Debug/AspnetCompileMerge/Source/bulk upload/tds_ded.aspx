...
<table border="1" style="border-collapse: collapse; width: 600px; margin: auto;">
            <tr>
                <td colspan="4" style="width: 550px; height: 20px;">
                    <strong style="font-size: 20px;">BULK-EXCEL SALARY UPDATION<br /></strong>
        ...
        <img src="" id="image" alt="" width="216px" height="275px" style="display:none;" align="right"/>--%>
            ...
            <%--         <tr>
              ...
              <asp:HiddenField ID="hid" Value ="0" runat ="server" />
                       ...
                       <asp:Label ID="Label1" runat="server" Text="REMARK :" Width="145px" Height="21px"></asp:Label>   <asp:TextBox ID="TextBox2" runat="server" Width="155px"></asp:TextBox>
                          <b>
                    ...
                    <asp:Button ID="cmd_confirm" runat="server" Text="UPLOAD EXCEL" Width="150px" style="text-align:center;"/><br /><br />
