...
{              
	    ...
	    {	       
	            //alert("vouch_str in body"+vouch_str)    
        ...
        voucher_Ătr=voucher_str+String.fromCharCode(18)      
        if(count==2)
        {
            count+=1;
            voucher_str=voucher_str+String.fromCharCode(10)
...
function voucher_file_creater(input_str,no_voc)
{
    ...
    {  
	    ...
	    if (system_ip=='' && branch_id_vouch1==0)
	    {
	    ...
	    else
	    {
	        ...
	        if(branch_id_vouch1==0 || branch_id_vouch1==1)
	        {
