<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="TA_new.aspx.vb"
    Inherits="TA_TA_new_d8ccc1921082" Title="Untitled Page" %>
...
var hidfield = data;
 ...
 if( hidfield != "")
   ...
   tabledata.emp = dt[0];
   tabledata.date = dt[1];
   tabledata.district = dt[2];
   tabledata.fromplace = dt[3];
   tabledata.toplace = dt[4];
   tabledata.firm = dt[5];
   tabledata.km = dt[6];
   tabledata.rate = dt[7];  
   tabledata.fare = dt[8];
   tabledata.bata = dt[9];
   tabledata.totta = dt[10];
   ak.push(tabledata);
    ...
    <div runat="server" align="center" id="Div3">
        ...
        <table border="1" style="width: 50%; height: 50%">
            ...
            <tr>
                ...
                <td style="width: 100%">
                    <asp:TextBox ID="txt_nmdis" runat="server" Width="110px" AutoPostBack="false" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox></td>
                <td>
                    <asp:TextBox ID="txt_frmpl" runat="server" Width="110px" AutoPostBack="false" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox></td>
                <td>
                    <asp:TextBox ID="txt_topl" runat="server" Width="110px" AutoPostBack="false" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox></td>
                <td>
                    <asp:TextBox ID="txt_firm" runat="server" Width="110px" AutoPostBack="false" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox></td>
                <td>
                    <input type="text" id="txt_km" onchange="return caluculate_fr()" maxlength="4" onkeypress="return isNumberKey(event);"
                        style="width: 90px" /></td>
                <td>
                    <input type="text" id="txt_rate" onchange="return caluculate_fare()" maxlength="4"  onkeypress="return isNumberKey(event);"
                        style="width: 90px" /></td>
                <td>
                    <input type="text" id="txt_fare" readonly="readonly" onkeyup="return calculate_totta()"
                        style="width: 90px" /></td>
                <td>
                    <input type="text" id="txt_bata" onchange="return caluculate_ta()" maxlength="4" onkeypress="return isNumberKey(event);"
                        style="width: 90px" /></td>
                <td>
