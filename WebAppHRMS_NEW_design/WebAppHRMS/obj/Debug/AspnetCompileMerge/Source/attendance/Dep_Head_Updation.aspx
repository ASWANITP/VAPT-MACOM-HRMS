    ...
    <div style="text-align: center">
        <table border="1" style="width: 49%; height: 104px;">
            ...
            <tr>
                <td colspan="2">
                    &nbsp;Sub&nbsp;Department</td>
                <td colspan="2"><asp:DropDownList ID="cmb_Sub" runat="server" onchange="FillDepHead()" Width="272px" Font-Names="Times New Roman" Font-Size="Medium">
                </asp:DropDownList></td>
            </tr>
            <tr>
                <td colspan="2">
                    Current&nbsp;Department&nbsp;Head</td>
                <td style="text-align: left;" colspan="2">
