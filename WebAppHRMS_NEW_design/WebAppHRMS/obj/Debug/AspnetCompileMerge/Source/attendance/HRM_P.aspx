<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="HRM_P.aspx.vb" Inherits="WebAppHRMS.ATTENDANCE_HRM_P_eb004fcf2252" title="Untitled Page" %>
...
<asp:AsyncPostBackTrigger ControlID="txt_ecode" EventName="TextChanged"></asp:AsyncPostBackTrigger>
        ...
        <table>
            <tr>
                ...
                <td style="width: 100px">
                    <input id="Button3" style="width: 81px" type="button" value="EXIT" onclick="return Button3_onclick()" /></td>
                <td style="width: 100px">
                </td>
            </tr>
        </table>
