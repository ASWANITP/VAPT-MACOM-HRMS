<%@ Page Language="VB" MasterPageFile="~/edp.master" EnableEventValidation="false" AutoEventWireup="false" CodeBehind="Individual.aspx.vb" Inherits="WebAppHRMS.Attendence_Report_Present_080605c56196" title="Untitled Page" %>
            ...
            <tr>
                <td colspan="1" style="text-align: center">
                    <asp:UpdatePanel id="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <contenttemplate>
<TABLE><TBODY><TR><TD style="WIDTH: 100px"><asp:RadioButton id="rd_ecode" runat="server" Width="160px" Text="EMPLOYEE CODE" AutoPostBack="True" GroupName="cat"></asp:RadioButton></TD><TD style="WIDTH: 100px"><asp:TextBox id="txt_empcode" runat="server" MaxLength="6"></asp:TextBox></TD></TR></TBODY></TABLE>
</contenttemplate>
                        <triggers>
<asp:AsyncPostBackTrigger ControlID="rd_branch" EventName="CheckedChanged"></asp:AsyncPostBackTrigger>
                ...
                <td colspan="1" style="text-align: center">
                    <asp:UpdatePanel id="UpdatePanel3" runat="server" UpdateMode="Conditional">
                        <contenttemplate>
<TABLE><TR><TD style="WIDTH: 100px"><asp:RadioButton id="rd_branch" runat="server" Width="120px" Text="BRANCH" GroupName="cat" AutoPostBack="True"></asp:RadioButton></TD><TD style="WIDTH: 100px"><asp:DropDownList id="cmb_branch" runat="server" Width="160px" OnSelectedIndexChanged="cmb_branch_SelectedIndexChanged"></asp:DropDownList>
    <cc1:ListSearchExtender ID="ListSearchExtender2" runat="server" Enabled="True" TargetControlID="cmb_branch">
