<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="PresentReportD.aspx.vb" Inherits="WebAppHRMS.Attendence_Report_PresentReportD_31d5029f8983" %>
...
function demo()
{
 ...
 <input type="button"  style="width: 113px" value="Print" id="submit"  onclick="return demo()"/>
        ...
        <asp:Panel ID="Panel_report" runat="server" Height="50px" Width="90%" Wrap="False">
        </asp:Panel>
