        ...
        <table border="1" style="width: 731px; height: 217px">
            <tr>
                <td colspan="4">
                    ...
                    </asp:ScriptManager><strong style="background-color: #ffcc33"><span style="font-size: 14pt">SECURITY ATTENDANCE REGULARISATION</span></strong></td>
            </tr>
            <tr>
    ...
    <asp:ListItem  Value="30" />
     <asp:ListItem  Value="31" />
            ...
            <td colspan="2" style="text-align: left; width: 111px; height: 17px;">
                    <strong>Day Security2<br /></strong></td>
