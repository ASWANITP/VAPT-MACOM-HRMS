...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" Runat="Server">
    <div style="text-align: center">
        <table border="1">
            ...
            <tr>
                <th align="left" style="font: caption; width: 154px; cursor: help; background-color: transparent">
                    Employee ID</th>
                <th align="left" style="width: 159px">
                    <asp:TextBox ID="txt_id" runat="server"></asp:TextBox>
                    <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" AutoComplete="False" Mask="999999" MaskType="Number" TargetControlID="txt_id">
                    </cc1:MaskedEditExtender>
                </th>
            </tr>
            <tr>
                <th align="left" style="font: caption; width: 154px; cursor: help">
                    Employee Name</th>
                <th align="left" style="width: 159px">
                    <asp:TextBox ID="txt_name" runat="server"></asp:TextBox></th>
            </tr>
            <tr>
                <th align="left" style="font: caption; width: 154px; cursor: help; height: 23px">
                    Designation</th>
            ...
            <tr>
                <th align="left" style="font: caption; width: 154px; cursor: help; height: 26px;">
                    Department</th>
