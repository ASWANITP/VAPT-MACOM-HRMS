<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="mfshow_report.aspx.vb"  Inherits="WebAppHRMS.Auction_Listed_pledges_d40b1d3c7726" %>
            ...
            <table border="3" style="width:100%;  font-family: Courier New; height:100%;">
                <tr>
                    <td colspan="29" style="height: 24px; text-align: center; width :100%; background-color :#ffd700;">
                        <strong><span style=" font-size: 14pt; color :Red ; font-family: Times New Roman;"><asp:Label ID="firnm" runat="server" ></asp:Label></span></strong>
                <br>
