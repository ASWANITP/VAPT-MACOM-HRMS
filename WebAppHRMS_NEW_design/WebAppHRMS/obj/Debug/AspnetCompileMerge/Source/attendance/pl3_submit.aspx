    ...
    &nbsp;<table align="center" style="width: 826px; height: 270px;" border="1" id="TABLE1" onclick="return TABLE1_onclick()">
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: center; height: 78px;">
                &nbsp;<asp:Panel ID="pnl_ho" runat="server" Height="50px" Visible="False" Width="150px">
            ...
            <td style="width: 176px; height: 78px;">
            </td>
        </tr>
        <tr>
            <td style="width: 116px; height: 57px;">
            </td>
            ...
            <td style="width: 176px; height: 57px;">
            </td>
        </tr>
                            <tr>
