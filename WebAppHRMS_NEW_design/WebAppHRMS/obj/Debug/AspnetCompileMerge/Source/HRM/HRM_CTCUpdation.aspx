<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="HRM_CTCUpdation.aspx.vb" Inherits="WebAppHRMS.HRM_SECURITY_HRM_AllowanceUpdation_69e46f1d8451" title="Untitled Page" %>
...
{   
    ...
    if(document.getElementById(cs[0]+"hidden1").value!="")
    {
        for(i=0;i<ar;i++)
        {
          ...
          document.getElementById('GFG').innerHTML=st3[1];
        }
    ...
    <div style="text-align: center; height:250" id="hidden4">
        <table border="1" style="width: 47%; height: 56px; text-align:left">
            ...
            <tr id="rw2">
                ...
                <td style="width: 5%; text-align: left; height: 28px;"><label style="color:Blue;" id="GFG"></label></td>
            ...
            <tr>
                <td colspan="3" style="text-align:center ">
                    &nbsp;<asp:Button ID="Button1" runat="server" Text="Confirm" Width="68px" /><asp:Button ID="Button3" runat="server" Text="Confirm" onclientclick="delconfirm()" />
                    <%--<input id="Button2" runat="server" style="width: 65px" type="button" value="Exit" onclick="return Button2_onclick()" />--%>
                    <asp:Button ID="Button2" runat="server" Text="Exit" Height="24px" Width="66px" />
                    </td>
            </tr>
            <tr id="un_row">
