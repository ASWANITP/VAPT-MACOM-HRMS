<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="leave_sele.aspx.vb" Inherits="WebAppHRMS.test_leave_sele_a1f2a89c3813" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function EmpNameFind() {
            if (document.getElementById(cont[0] + "txtEmpCode").value == "" || parseInt(document.getElementById(cont[0] + "txtEmpCode").value) < 5999) {
