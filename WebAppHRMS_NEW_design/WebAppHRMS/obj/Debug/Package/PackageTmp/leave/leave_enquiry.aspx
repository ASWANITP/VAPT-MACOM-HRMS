<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="leave_enquiry.aspx.vb" Inherits="WebAppHRMS.Lima_Leave_leave_enquiry_5f2a6a2c2992" Title="Untitled Page" %>
        ...
        <table border="1">
            ...
            <tr>
                ...
                <td style="width: 100px; font-family: Arial; text-align: left">
                    <input id="txt_reason" runat="server" style="width: 521px" type="text" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="height: 23px">
                    <div style="text-align: center">
                        <asp:TextBox ID="txt_result" runat="server" Height="66px" ReadOnly="True" Style="font-weight: bold; font-size: 13pt; vertical-align: middle; color: #ff0066; background-color: #ffeaff; text-align: center; border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none;"
