        ...
        <table border="1" style="margin: 0px auto;">
            <tr>
                <td colspan="4" style="height: 41px; text-align: center;">
                    <strong><span style="font-size: 15pt; color: #cc0099; font-weight: bold; font-family: 'Courier New'; text-decoration: underline;"><span style="color: #cc0000"><span style="font-family: Agency FB">
            ...
            <tr>
                <td colspan="4" style="height: 4px">SELECT&nbsp;LEAVE&nbsp;DATE</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 6%; height: 4px;">&nbsp;&nbsp;SELECT&nbsp;HEAD&nbsp;&nbsp;</td>
                <td style="width: 9%; text-align: left; height: 4px;">
                    <asp:DropDownList ID="ddltl" runat="server" Width="220px" AutoPostBack="True">
                    </asp:DropDownList>
                </td>
                <td style="width: 6%; height: 4px;">&nbsp;&nbsp;SELECT&nbsp;EMPLOYEE&nbsp;&nbsp;</td>
                <td style="width: 9%; text-align: left; height: 4px;">
