...
<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="leave_appli_to.aspx.vb" EnableEventValidation="false" Inherits="WebAppHRMS.leave_appli_to_4a487d033298" Title="Untitled Page" EnableViewState="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
   <script type="text/javascript" src="../script/leave_applied_to.js"></script>
    ...
    <script type="text/javascript">
        ...
        function proc_leave() {
            ...
            if (id == 1) {
                ...
                if ((document.getElementById(cont[0] + "hdnCasual").value) == 0 || (document.getElementById(cont[0] + "hdnCasual").value) < 0) {
                    document.getElementById(cont[0] + "txt_lcasual").value = document.getElementById(cont[0] + "hdnCasual").value
                    alert("You have no Casual Leave to Apply")
                    document.getElementById(cont[0] + "cmb_ltype").value = 0;
                    return false;
                }
                ...
                if ((document.getElementById(cont[0] + "hdnSick").value) == 0 || (document.getElementById(cont[0] + "hdnSick").value) < 0) {
                    document.getElementById(cont[0] + "txt_lsick").value = document.getElementById(cont[0] + "hdnSick").value
                ...
                //    return false;
                //}
                if ((document.getElementById(cont[0] + "hdnEarned").value) == 0 || (document.getElementById(cont[0] + "hdnEarned").value) < 0) {
                    document.getElementById(cont[0] + "txt_learned").value = document.getElementById(cont[0] + "hdnEarned").value
        ...
        function error_dt() {
            ...
            if ((document.getElementById(cont[0] + "txt_lfdt").value) != "") {
                if ((document.getElementById(cont[0] + "txt_ltodt").value) != "") {
                    arg = 8 + "$" + document.getElementById(cont[0] + "txt_lfdt").value + "$" + document.getElementById(cont[0] + "txt_ltodt").value + "$" + document.getElementById(cont[0] + "cmb_ltype").value
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 656px; height: 72px; border: unset;">
            <tr>
            ...
            <tr>
                ...
                <td style="width: 100px; height: 7px; text-align: center;">
                    <input id="txt_ecode"  EnableViewState="false" style="width: 117px; font-family: 'Courier New';" type="text"  readonly="readOnly" /></td>
                <td style="width: 100px; height: 7px; text-align: left">
                    <span style="font-size: 11pt; font-family: Courier New">Emp Name</span></td>
                <td style="width: 100px; height: 7px; text-align: center;">
                    <input id="txt_ename" style="width: 117px; font-family: 'Courier New';" type="text" readonly="readOnly" /></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 100px; height: 1px; text-align: right">
                    <span style="font-size: 11pt; font-family: Courier New">
                        ...
                        <table>
                            <tr>
                                <td style="width: 100px">Sick</td>
                                <td style="width: 100px">
                                    <input id="txt_lsick" style="width: 31px; height: 16px;"
                                        type="text" readonly="readOnly" runat="server" /></td>
                            </tr>
                        </table>
                    </span>
                ...
                <td style="width: 100px; height: 1px; text-align: right">
                    <span style="font-size: 11pt; font-family: Courier New">
                        <div style="text-align: center">
                            <table>
                                <tr>
                                    <td style="width: 100px; height: 26px">Earned</td>
                                    <td style="width: 100px; height: 26px">
                                        <input id="txt_learned" style="width: 29px; height: 18px;"
                                            type="text" readonly="readOnly" runat="server" /></td>
                                </tr>
                            </table>
                        </div>
            ...
            <tr>
                ...
                <td style="width: 100px; height: 1px; text-align: left;">
                    ...
                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy"
                        TargetControlID="txt_lfdt"></cc1:CalendarExtender>
                </td>
                <td style="width: 100px; height: 1px; text-align: left">
            ...
            <tr id="rrow" style="display: none">
                <td style="width: 100px; height: 1px; text-align: left">
                    <span style="font-size: 10pt; font-family: Courier New">Enter Reason</span></td>
                <td colspan="3" style="height: 1px; text-align: left">
            ...
            <tr id="cr3" style="display: none">
                <td colspan="4" style="height: 1px; text-align: left">
                    ...
                    <table border="0" style="width: 650px; height: 17px" id="tb2">
                        <tr id="cr2">
                            <td style="width: 1258px; height: 1px; text-align: left">
                                <span style="font-size: 10pt; color: #ff0033; font-family: Courier New">
            ...
            <tr>
                <td colspan="4" style="height: 1px; text-align: left">
                    <input id="hid_val" runat="server" style="width: 1px" type="hidden" /></td>
            </tr>
            <tr>
    ...
    <input type="hidden" id="hdnCasual" runat="server" />
    <input type="hidden" id="hdnSick" runat="server"/>
    <input type="hidden" id="hdnEarned" runat="server"/>
    <input type="hidden" id="hdnEcode" runat="server"/>
    <input type="hidden" id="hdnEname" runat="server"/>
