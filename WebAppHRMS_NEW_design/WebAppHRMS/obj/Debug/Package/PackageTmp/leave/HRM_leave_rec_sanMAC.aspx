<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="HRM_leave_rec_sanmac.aspx.vb" Inherits="WebAppHRMS.HRM_SECURITY_HRM_AllowanceUpdation_9a7f00b32376" Title="Leave Recommend/Sanction" %>
...
//document.getElementById('<%= btn1.ClientID %>').style.display="inline";
    ...
    document.getElementById('<%= btn3.ClientID %>').style.display = "inline";
        ...
        function display_check() {
            ...
            st1 += "</tr>";
                ...
                st = st + "<table id='mytable' border=1 style='width:730px; height:auto; text-align:left'><tr  bgcolor='#CCCCEE' style='font-size:85%'><td><b>&nbsp;EMP CODE&nbsp;</b></td><td><b>&nbsp;EMP NAME&nbsp;</b></td><td><b>&nbsp;LEAVE TYPE&nbsp;</b></td><td><b>&nbsp;FROM DATE &nbsp;</b></td><td><b>&nbsp;TO DATE &nbsp;</b></td><td><b>&nbsp;LEAVE DAYS &nbsp;</b></td><td><b>&nbsp;APPLY DATE</b></td><td><b>&nbsp;LEAVE REASON</b></td><td><b>&nbsp;PREVIOUS DETAILS </b></td></>";
      ...
      if (document.getElementById(cs[0] + "chk_add").checked == true) {
        ...
        function disp() {
            ...
            if (document.getElementById(cs[0] + "hidden1").value != "") {
                ...
                st = st + "<table border=1 style='width:730px; height: 36px; text-align:left'><tr  bgcolor='#CCCCEE' style='font-size:85%'><td><b>EMP CODE</b></td><td><b>NAME</b></td><td><b>POST</b></td><td><b>DESIGNATION</b></td><td><b>BRANCH</b></td></tr>"
        ...
        function newpage(code, seqn, auth, type) {
            ...
            if (auth == "100063" && type == 1) {
                ...
                //mywin.moveTo(200, 300);
                //return false;
                mywin = window.open("previous_empdetails.aspx?code=" + code + "&seq=" + seqn + "", "WinC", "width=700,height=520,toolbar=no,location=no,directories=no,status=no,menubar=no, scrollbars=no,resizable=no,copyhistory=no")
                mywin.moveTo(200, 300);
                return false;
            }
        }
    ...
    <div style="text-align: center; height: auto;" id="hidden84">
        <table id='mytable' border="1" style="width: 730px; height: 56px; text-align: left; border: unset;">
            ...
            <tr id="panel_row" style="width:730px; height:auto; text-align:left" >
                <td colspan="3">
