...
<!--
    ...
    <div style="text-align: center">
        <table border="1" style="width: 646px; height: 59px">
            ...
            <tr>
                ...
                <td style="width: 100px; height: 1px; text-align: left">
                    <span style="font-family: Courier New">Compensatory&nbsp;Name</span></td>
            ...
            <tr>
                <td style="width: 100px; height: 1px; text-align: left; font-family: 'Courier New';">State&nbsp;Name</td>
                <td align="left" style="width: 612px; height: 1px; text-align: left">
                    <asp:TextBox ID="txt_st_name" runat="server" Width="117px" ReadOnly="True" Style="font-family: 'Courier New'"></asp:TextBox></td>
                <td style="width: 100px; height: 1px; text-align: left; font-family: 'Courier New';">Expiry&nbsp;Date</td>
                <td style="width: 88px; height: 1px; text-align: left">
            ...
            <tr>
                <td style="width: 100px; height: 1px; text-align: left">Enter&nbsp;Your&nbsp;Email&nbsp;id<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Txt_mail"
    ...
    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy"
        TargetControlID="txt_early_date"></cc1:CalendarExtender>
