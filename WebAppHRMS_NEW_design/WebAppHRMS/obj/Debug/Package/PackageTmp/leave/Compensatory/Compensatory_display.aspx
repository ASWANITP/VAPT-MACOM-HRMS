...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1" style="width: 664px">
            ...
            <tr>
                <td style="width: 314px; height: 28px">Enter Employee:</td>
                ...
                <td colspan="2" style="width: 449px; height: 28px; text-align: left">&nbsp;<input id="Txt_search" style="width: 99px" type="button" value="Search" onclick="return Txt_search_onclick()" /></td>
            </tr>
            <tr>
                <td style="width: 314px; height: 28px">Employee Name</td>
                <td style="width: 102px; height: 28px; text-align: left">
                    <asp:TextBox ID="Txt_name" runat="server" Width="457px" ReadOnly="True"></asp:TextBox></td>
                <td colspan="2" rowspan="4" style="width: 449px; text-align: left"></td>
            </tr>
            <tr>
                <td style="width: 314px; height: 28px">Recommentation</td>
                <td style="width: 102px; height: 28px; text-align: left">
                    <asp:TextBox ID="Txt_rec" runat="server" ReadOnly="true" Width="457px"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 314px">Sanctioning</td>
