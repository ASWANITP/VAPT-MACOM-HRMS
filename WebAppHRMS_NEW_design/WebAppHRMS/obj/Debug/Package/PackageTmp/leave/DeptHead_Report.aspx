<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DeptHead_Report.aspx.vb" Inherits="WebAppHRMS.DeptHead_Report" %>
...
<head runat="server">
    <script type="text/javascript">
        ...
        function exportToExcel() {
            ...
            link.href = url;
            link.download = 'DepartmentHeadStructurereport.xls';
            link.click();
        }


    </script>
    <title>DEPARTMENT STRUCTURE REPORT</title>
...
<body>
    <form id="form1" runat="server">
        <div class="report-header" style="width:100%; /*text-align:center;*/">
            <h2 ><%: Session("firm_name") %></h2>
            <div class="subheader" <%--style="display: inline-block;--%> text-align: center;">
          ...
          <h2 style="text-align:center; font-size:1.4em;"> DEPARTMENT STRUCTURE REPORT </h2>
           </div>
    ...
    <input type="button" class="big-button" value="Export to Excel" onclick="exportToExcel()" /></div><hr /><h3></h3></div>
            ...
            <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" CssClass="table" OnRowDataBound="gvReport_RowDataBound">
    <Columns>
