...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 69%; height: 80px;">
            <tr>
                <td colspan="4" style="height: 27px; text-align: center">
                    <span style="font-size: 14pt">&nbsp;<strong>TOUR SANCTIONED REPORT</strong></span></td>
            </tr>
            <tr id="row1" style="display: none">
                <td style="height: 11px;" colspan="2">Employee code</td>
            ...
            <tr>
                <td style="width: 6%; height: 18px;">&nbsp;&nbsp;From&nbsp;Date&nbsp;&nbsp;</td>
                ...
                <td style="width: 6%; height: 18px;">To&nbsp;Date</td>
