    ...
    <table border="1" style="width: 80%">
        <tr>
            ...
            <td colspan="2" style="text-align: center">
                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_from" Format="dd/MMM/yyyy"></cc1:CalendarExtender>
                &nbsp;<cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txt_to" Format="dd/MMM/yyyy"></cc1:CalendarExtender>
        ...
        <tr>
            <td style="width: 62px">FromDate</td>
            <td style="width: 79px">
