<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="BlockDtlsCancel.aspx.vb" Inherits="WebAppHRMS.BlockALert_BlockDtlsCancel_a77fbab21000" Title="Punch Block Details in a Date of an Employee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function TableFill() {
            ...
            for (i = 0; i < len; i++) {
                ...
                if (st1 == "") {
                    st1 = "<tr style='background-color:PapayaWhip'><td style='text-align=center'>" + sino + "</td><td style='text-align=center'>" + st3[0] + "</td><td style='text-align=left'>" + st3[1] + "</td><td style='text-align=left'>" + st3[2] + "</td><td style='text-align=center'><input type='CheckBox' id='checkRemvBlk" + i + "' value='checkRemvBlk" + i + "' onclick=FuncCheckBlkClick('checkRemvBlk" + i + "','" + st3[3] + "')></td></tr>";
                }
                else {
                    st1 = st1 + "<tr style='background-color:PapayaWhip'><td style='text-align=center'>" + sino + "</td><td style='text-align=center'>" + st3[0] + "</td><td style='text-align=left'>" + st3[1] + "</td><td style='text-align=left'>" + st3[2] + "</td><td style='text-align=center'><input type='CheckBox' id='checkRemvBlk" + i + "' value='checkRemvBlk" + i + "' onclick=FuncCheckBlkClick('checkRemvBlk" + i + "','" + st3[3] + "')></td></tr>";
                }
            }
            st = "<table border=1 width='100%'><tr><td style='text-align=center'><b>Si&nbsp;No</b></td><td ><b>Emp.&nbsp;Code</b></td><td><b>&nbsp;Emp&nbsp;Name&nbsp;</b></td><td><b>Block&nbsp;Reason</b></td><td style='text-align=left'><b>Remove&nbsp;Block</b></td></tr>";
        ...
        function CheckClient() {
            ...
            if (document.getElementById(cont[0] + "txtBlockDate").value == "") {
                alert('Enter Date of Punch Block..!!');
                document.getElementById(cont[0] + "txtBlockDate").focus();
                return false;
            }
            ...
            if (document.getElementById(cont[0] + "hidUserCode").value == "") {
                alert('Session Closed..!! Please ReOpen the Window..!!');
                return false;
            }
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 92%; font-family: 'Bookman Old Style'; font-variant: small-caps;">
            <tr>
                <td style="width: 23%; text-align: left">&nbsp;Type Employee Code</td>
                ...
                <td style="width: 23%; text-align: left">&nbsp;Select Block Date</td>
                <td style="width: 23%; text-align: left">
                    <asp:TextBox ID="txtBlockDate" onkeyup="CheckDate()" onchange="Fill_Dateto()" runat="server" Style="font-family: 'Bookman Old Style'; text-align: center; cursor: hand;"
                        TabIndex="0">
                    </asp:TextBox>
                </td>
            </tr>
            ...
            <tr id="RowHeading" style="display: none">
                <td style="text-align: center; height: 24px;" colspan="4">
                    <strong>Punch Block Details of This Date</strong></td>
            </tr>
            <tr id="RowRmvAll" style="display: none">
                <td colspan="4" style="height: 24px; text-align: center">
                    <asp:CheckBox ID="chkRemoveAll" onclick="FuncCheckBlkAllClick()" runat="server" Text=" Tick to Remove All PunchBlocks of this Employee for this Day at once..!!"
                        Width="752px" Style="cursor: hand" />
                </td>
            </tr>
            <tr id="RowPanel" style="display: none">
                <td style="text-align: center" colspan="4">
                    <asp:Panel ID="panBlockDetails" runat="server" Height="50px" Width="98%">
                    </asp:Panel>
                </td>
            </tr>
            <tr>
    ...
    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy"
        TargetControlID="txtBlockDate"></cc1:CalendarExtender>
</asp:Content>
