...
body {
    background-image: url('../Assets/Images/hrms_bg.jpeg') !important;
    background-size: cover !important;
    background-position: center !important;
    background-repeat: no-repeat !important;
    background-attachment: fixed !important;
    background-color: #C3D9EF !important;
}

.bg-light11 {
    background-color: rgb(30, 51, 74, 0.90) !important; /* Bootstrap blue with 60% opacity */
    border-radius: 8px; /* optional rounded corners */
    margin-top:30px;
    color: #fff;
    box-shadow: rgb(73, 94, 117, 0.80) 0px 1px 4px, rgb(73, 94, 117, 0.80) 0px 0px 0px 3px !important;
            ...
            <div class="container" style="padding-top: 10px;">
                <div class=" ">
                    <div class="d-flext justify-content-center">
                        <div class="card border border-light-subtle rounded-4 opacity w-50 bg-light11" style="border-radius: 12px;">
                            <div class="card-body p-3  ">
                                <div class="row">
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-1" style="color: yellow;">
