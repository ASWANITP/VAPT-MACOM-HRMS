<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_resined_emp_report.aspx.vb" Inherits="WebAppHRMS.Resigned_Emp_hrm_resined_emp_report_c30b36db6006" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy"
            TargetControlID="txtTdate"></cc1:CalendarExtender>
        <table border="1" style="width: 60%">
            <tr>
                <td style="width: 15%; text-align: left">Select From Date</td>
                <td style="width: 15%">
                    <asp:TextBox ID="txtFdate" runat="server" Width="97%" onkeyup="DateFCheck()" onblur="checkFdate('txtFdate')"></asp:TextBox></td>
                <td style="width: 15%; text-align: left">Select To date</td>
                <td style="width: 15%">
                    <asp:TextBox ID="txtTdate" runat="server" Width="97%" onkeyup="DateTCheck()" onblur="checkTdate('txtTdate')"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="4">
