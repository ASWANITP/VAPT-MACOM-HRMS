<%@ Page Language="vb" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Shift_Sanction_COO.aspx.vb" Inherits="WebAppHRMS.Shift_Sanction_COO" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="server">
    ...
    <div id="shiftApprovalFormContainer">
        <table id="tblShiftApproval">
            ...
            <!-- First line manager & department head -->
            <tr>
                <td>
                ...
                <td>
                    <label for="<%= txtDepHeadName.ClientID %>">Department Head</label>
                    <asp:TextBox
                        ID="txtDepHeadName"
                        runat="server"
                        ReadOnly="true"
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox
                        ID="ddlRequestedShift" runat="server"
