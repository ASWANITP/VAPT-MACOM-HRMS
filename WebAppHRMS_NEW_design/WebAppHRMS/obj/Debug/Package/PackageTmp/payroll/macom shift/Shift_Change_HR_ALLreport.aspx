<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Shift_Change_HR_ALLreport.aspx.vb" Inherits="WebAppHRMS.Shift_Change_HR_ALLreport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
          ...
          <h2 style="text-align:center; font-size:1.4em;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ALL EMPLOYEES SHIFT CHANGE DETAILS</h2>
           </div>
    ...
    <input type="button" class="big-button" value="Export to Excel" onclick="exportToExcel()" />
         ...
         <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" Width="100%" BorderWidth="1px" GridLines="None" CssClass="grid">
             ...
             <Columns>
                ...
                <asp:BoundField DataField="shift_request_date" HeaderText="SHIFT REQUEST DATE" />
                <asp:BoundField DataField="shift_id" HeaderText="CHANGED SHIFT TIME" />
                <asp:BoundField DataField="shift_name" HeaderText="SHIFT NAME" />
                <asp:BoundField DataField="DEP_NAME" HeaderText="DEPARTMENT NAME" />
                <asp:BoundField DataField="ENTER_DT" HeaderText="APPROVAL" />
            </Columns>
        </asp:GridView>
