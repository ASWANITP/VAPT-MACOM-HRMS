<%@ Page Language="vb" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Shift_Sanction.aspx.vb" Inherits="WebAppHRMS.Shift_Sanction" %>
        ...
        <table id="tblShiftApproval">
            ...
            <tr>
                <td>
                    ...
                    <asp:TextBox ID="txtOldShift" runat="server"
                        ReadOnly="true" CssClass="scrTextBox" />
                </td>
                <td>
