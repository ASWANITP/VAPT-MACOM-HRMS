<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/edp.master" CodeBehind="Shift_Sanc_TL_repo.aspx.vb" Inherits="WebAppHRMS.Shift_Sanc_TL_repo" %>
...
<div id="shiftFormContainer">
    <span class="scrLabel">
       TEAM LEAD SANCTION SHIFT REPORT
    </span>
  ...
  <div id="shiftFormContainer">
    <span class="scrLabel">
      EMPLOYEE SHIFT CHANGE REQUEST REPORT
    </span>
    ...
    <div class="formField" style="grid-column: 1 / span 2;">
      ...
      <div style="display: flex; gap: 20px; align-items: center;">
        <label>
          <input type="radio" name="empSelect" id="rbAll" value="all" checked/>
          All Employees
        </label>
        <label>
          <input type="radio" name="empSelect" id="rbCode" value="code"/>
          Enter Employee Code
        </label>
      </div>
    </div>
  ...
  <script>
      document.addEventListener("DOMContentLoaded", function () {
          var rbAll = document.getElementById("rbAll"),
              rbCode = document.getElementById("rbCode"),
