<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="date_sele_conso.aspx.vb" Inherits="WebAppHRMS.date_sele_consolidated_report_59f5121e9313" Title="Untitled Page" %>
                ...
                <td style="width: 100%">
                    <div style="text-align: center">
                        <table border="1" style="width: 63%; font-family: 'Bookman Old Style'; height: 72px;">
                            <tr>
                                <td style="width: 25%; height: 7px; text-align: left">&nbsp;From Date</td>
                                ...
                                <td style="width: 25%; height: 7px; text-align: left">&nbsp;To Date</td>
