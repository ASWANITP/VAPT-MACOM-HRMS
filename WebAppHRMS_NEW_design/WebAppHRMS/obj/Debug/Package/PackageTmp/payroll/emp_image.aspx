...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 624px">
            ...
            <tr>
                <td style="width: 182px; text-align: left">Total Marks :
                </td>
                <td style="width: 100px; text-align: left">
            ...
            <tr>
                <td style="width: 182px; text-align: left">Photo :
                </td>
                <td style="width: 100px; text-align: left">
                    <asp:FileUpload ID="FileUpload1" runat="server" Width="378px" /></td>
            </tr>
            <tr>
                <td style="width: 182px; text-align: left">Final
                    Certificate&nbsp; :</td>
                <td style="width: 100px; text-align: left">
