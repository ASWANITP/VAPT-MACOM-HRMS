<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="BlockDtlsCancel.aspx.vb" Inherits="WebAppHRMS.BlockALert_BlockDtlsCancel_bb6b615b8375" Title="Punch Block Details in a Date of an Employee" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table style="margin: auto; width: 80%; border: 1px solid black; text-align: center; font-family: 'Bookman Old Style'; font-variant: small-caps;">

            <%--        <table border="1" style="width: 92%; text-align: center; font-family: 'Bookman Old Style'; font-variant: small-caps;">--%>
            <tr>
                <td colspan="2" style="width: 15px; text-align: left;">&nbsp;Type Employee Code</td>
                ...
                <td colspan="1" style="width: 23%; text-align: left;">
                    ...
                    <asp:TextBox ID="txtEmpCode" onchange="fill1()" onkeyup="CheckEmpCode()" runat="server" Style="font-family: 'Bookman Old Style'; text-align: center"
                        TabIndex="1"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 23%; text-align: left">&nbsp;Employee Name</td>
                <td style="width: 23%; text-align: left">
                    <asp:TextBox ID="txtEmpName" runat="server" Style="font-family: 'Bookman Old Style'; text-align: left"
                        Width="97%" ReadOnly="True"></asp:TextBox></td>
                <td style="width: 23%; text-align: left">&nbsp;Working Branch</td>
                <td style="width: 23%; text-align: left">
                    <asp:TextBox ID="txtEmpBranch" runat="server" Style="font-family: 'Bookman Old Style'; text-align: left"
                        Width="97%" ReadOnly="True"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 23%; text-align: left">&nbsp;Post</td>
                <td style="width: 23%; text-align: left">
                    <asp:TextBox ID="txtEmpPost" runat="server" Style="font-family: 'Bookman Old Style'; text-align: left"
                        Width="97%" ReadOnly="True"></asp:TextBox></td>
                <td style="width: 23%; text-align: left">&nbsp;Curr. Status</td>
                <td style="width: 23%; text-align: left">
                    <asp:TextBox ID="txtEmpStatus" runat="server" Style="font-family: 'Bookman Old Style'; text-align: left"
                        Width="97%" ReadOnly="True"></asp:TextBox></td>
            </tr>


        </table>
        <asp:Label ID="Label1" runat="server" Style="font-family: 'Bookman Old Style'" Width="867px"></asp:Label>
    </div>
    ...
    <%--<table  style="margin:0 auto; display:block;">
        <tr id="RowHeading" style="display: none; text-align: center;">
        ...
        <tr>
            <td colspan="2" style="text-align: center; height: 31px;">
                <asp:Button ID="cmdConfirm" OnClientClick="CheckClient()" runat="server" Style="cursor: hand; font-family: 'Bookman Old Style'; display: none;"
                    Text="Confirm" /></td>
    ...
    <div style="text-align: center;">
        <table style="margin: auto; width: 80%; border: 1px solid black;">
            <tr id="RowHeading" style="text-align: center;">
                <td style="text-align: center; height: 24px;" colspan="4">
                    <strong>Punch Block Details of Today</strong>
                </td>
            </tr>
            <tr id="RowRmvAll" style="text-align: center;">
                <td colspan="4" style="height: 24px; text-align: center;">
                    <asp:CheckBox ID="chkRemoveAll" onclick="FuncCheckBlkAllClick()" runat="server"
                        Text=" Tick to Remove All PunchBlocks of this Employee for this Day at once..!!"
                        Width="752px" />
                </td>
            </tr>
            <tr id="RowPanel" style="text-align: center;">
                <td style="text-align: center;" colspan="4">
                    <asp:Panel ID="panBlockDetails" runat="server">
                    </asp:Panel>
                </td>
            ...
            <tr>
                <td colspan="4" style="text-align: center; height: 31px;">
                    <div style="display: flex; justify-content: center; gap: 15px;">
                        <asp:Button ID="cmdConfirm" OnClientClick="CheckClient()" runat="server"
                            Style="font-family: 'Bookman Old Style';"
                            Text="Confirm" />

                        <input id="cmdExit" style="font-family: 'Bookman Old Style'; width: 61px;"
                            type="button" value="Exit" onclick="return cmdExit_onclick()" />
                    </div>
                </td>
            </tr>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function TableFill() {
            ...
            st = "<table border='1' style='background-color: orange; margin: 0 auto;display:block;'><tr><td style='text-align=center'><b>Si&nbsp;No</b></td><td ><b>Emp.&nbsp;Code</b></td><td><b>&nbsp;Emp&nbsp;Name&nbsp;</b></td><td><b>Block&nbsp;Reason</b></td><td style='text-align=left'><b>Remove&nbsp;Block</b></td></tr>";
            ...
            document.getElementById(cont[0] + 'cmdConfirm').style.display = 'block';
            /*document.getElementById(cont[0] + 'cmdConfirm').style.display = 'none';*/
        ...
        function FuncCheckBlkClick(ChkBx, BlkId) {//debugger;
            //   alert(ChkBx);
            //   alert(BlkId);
            debugger;
