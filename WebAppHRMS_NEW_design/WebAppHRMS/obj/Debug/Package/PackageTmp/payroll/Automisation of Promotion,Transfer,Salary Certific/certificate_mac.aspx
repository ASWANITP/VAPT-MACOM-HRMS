<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="certificate_mac.aspx.vb" Inherits="WebAppHRMS.certorder_b8cc02947300" Title="Untitled Page" %>
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 453px; height: 34px">
            ...
            <tr>
                ...
                <td style="width: 100px">
                    <asp:TextBox ID="txt_dt" onkeydown="return false" ReadOnly="True" runat="server"></asp:TextBox></td>
            </tr>
        </table>
        <br />
        <table border="1">
            <tr>
                <td style="width: 100px; height: 28px;">
                    <asp:Button ID="cmd_appletter" runat="server" Text="Salary Certificate" Width="135px" Style="cursor: hand" /></td>
                <td style="width: 100px; height: 28px;">
