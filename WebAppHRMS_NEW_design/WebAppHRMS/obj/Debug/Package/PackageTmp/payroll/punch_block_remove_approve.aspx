<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/edp.Master" CodeBehind="punch_block_remove_approve.aspx.vb" Inherits="WebAppHRMS.punch_block_remove_approve" %>
    ...
    <div style="text-align: center">
        ...
        <div style="text-align: center">
            <table border="1" style="width: 696px">
                ...
                <tr>
                    <td colspan="2" style="width: 215px">Select Employee</td>
                    <td colspan="2" style="text-align: left">
                        <asp:DropDownList ID="cmb_emp" runat="server" Width="472px" onchange="return fill1()">
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    <td colspan="2" style="width: 215px; text-align: center">Employee&nbsp;Code</td>
                    <td colspan="2" style="text-align: left">
                        <asp:TextBox ID="txt_code" runat="server" ReadOnly="True" Width="200px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td colspan="2" style="width: 215px; text-align: center">Employee&nbsp;Name</td>
                    <td colspan="2" style="text-align: left">
                        <asp:TextBox ID="txt_name" runat="server" Width="200px" ReadOnly="True"></asp:TextBox></td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align: center; width: 215px;">Reason For Blocking</td>
                    <td colspan="2" style="text-align: left">
                ...
                <tr>
                    <td colspan="4">
                        <asp:Button ID="btn_confirm" runat="server" Text="APPROVE" OnClientClick="return fill_dtl()" />
                        <asp:Button ID="btn_reject" runat="server" Text="REJECT" OnClientClick="return fill_dtl()" />
