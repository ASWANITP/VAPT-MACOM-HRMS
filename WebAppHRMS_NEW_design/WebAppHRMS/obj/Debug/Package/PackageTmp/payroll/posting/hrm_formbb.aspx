<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_formbb.aspx.vb" Inherits="WebAppHRMS.Appointment_Order_appointmentorder_e89e90662913" Title="Untitled Page" %>
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 453px; height: 34px">
            <tr style="height: 10px;">
                <td style="width: 180px; height: 10px; text-align: right">Select Employee Code :</td>
            ...
            <tr>
                ...
                <td style="width: 100px">
                    <asp:TextBox ReadOnly="true" ondrag="return false;" ondrop="return false;" ID="txt_dt" runat="server"></asp:TextBox></td>
            </tr>
        </table>
        <br />
        <table border="1">
            <tr>
                <td style="width: 100px; height: 28px;">
                    <asp:Button ID="cmd_appletter" runat="server" Text="Get Form BB" Width="135px" Style="cursor: hand" /></td>
                <td style="width: 100px; height: 28px;">
