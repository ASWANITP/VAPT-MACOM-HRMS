        ...
        <table id="tblShiftApproval">
            <tr>
                <td colspan="2" class="scrCenterCell">
                    <label style="font-size: 16pt; text-align:center">DepartmentHead Change</label>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <label for="DropDownList2">Select New Department Head</label>
                </td>
                <td>
                    <asp:DropDownList ID="DropDownList2" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged"
                        runat="server" AutoPostBack="True" CssClass="scrTextBox">
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2" class="scrButtonCell">
                    <asp:Button ID="btnconfirm" runat="server" Text="CONFIRM" CssClass="scrButton" />&nbsp;
