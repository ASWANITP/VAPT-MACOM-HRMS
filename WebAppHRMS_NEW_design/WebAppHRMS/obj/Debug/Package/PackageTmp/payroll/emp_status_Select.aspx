...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 485px">
            <tr>
                <td style="width: 256px; text-align: left">Select Report Type:
                </td>
            ...
            <tr>
                <td style="width: 256px; text-align: left">Select Employee Type :
                </td>
                <td style="width: 100px; text-align: left;">
                    <asp:DropDownList ID="cmb_type" runat="server" Width="202px">
            ...
            <tr id="row1">
                <td style="width: 256px; text-align: left">Select Joining Type :
                </td>
                <td style="width: 100px; text-align: left">
            ...
            <tr id="row2" style="display: none">
                <td style="width: 256px; text-align: left">Report&nbsp;With&nbsp;Enter&nbsp;dt/&nbsp;Disontinue&nbsp;Date :
                </td>
                <td style="width: 100px; text-align: left">
            ...
            <tr id="row3" style="display: none">
                <td style="width: 256px; height: 23px; text-align: left">Select Firm / Designation :
                </td>
            ...
            <tr>
                <td style="width: 256px; text-align: left">From Date :
                </td>
                <td style="width: 100px; text-align: left">
                    <asp:TextBox ID="txt_fromdt" runat="server"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 256px; text-align: left">To Date :
                </td>
                <td style="width: 100px; text-align: left">
