...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <table border="1" style="width: 846px; height: 239px">
        ...
        <tr>
            <td colspan="2" style="text-align: right">&nbsp;Employee :
            </td>
        ...
        <tr>
            <td colspan="2" style="height: 23px">
                <span style="color: #000000"><span><span style="color: #000000">*</span> <span style="text-decoration: underline">Permanent Ad<span>dress</span></span></span> </span>
            </td>
            <td colspan="2" style="color: #000000; height: 23px">
                <span style="color: #000000; text-decoration: underline"><span style="color: #ff0000">*</span> Present Address</span></td>
        </tr>
        <tr>
            <td style="width: 126px; text-align: right">House Name :&nbsp;
            </td>
            <td style="width: 174px; text-align: left">
                <asp:TextBox ID="txt_house1" runat="server" ReadOnly="True" Width="271px"></asp:TextBox></td>
            <td style="width: 123px; text-align: right">House Name :&nbsp;
            </td>
            <td style="width: 100px; text-align: left">
                <asp:TextBox ID="txt_house2" runat="server" ReadOnly="True" Width="271px"></asp:TextBox></td>
        </tr>
        <tr>
            <td style="width: 126px; text-align: right">State :&nbsp;
            </td>
            <td style="width: 174px; text-align: left">
        ...
        <tr>
            <td style="width: 126px; text-align: right">Pin Code :&nbsp;
            </td>
            <td style="width: 174px; text-align: left">
