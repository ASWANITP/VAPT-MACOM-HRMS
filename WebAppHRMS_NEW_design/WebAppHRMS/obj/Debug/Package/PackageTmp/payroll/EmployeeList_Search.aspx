...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 52%; font-family: 'Bookman Old Style'; font-variant: small-caps;" align="center">
            ...
            <tr>
                <td style="width: 30%; text-align: left;">&nbsp;<asp:CheckBox ID="checkEmpCode" onclick="CheckCodeClick()" runat="server" Width="280px" Text=" Enter Employee Code" Style="cursor: hand; font-family: 'Bookman Old Style'" /></td>
            ...
            <tr>
                <td style="width: 30%; text-align: left">&nbsp;<asp:CheckBox ID="checkEmpName" onclick="CheckNameClick()" runat="server" Width="280px" Text=" Enter Name/Part of Name" Style="cursor: hand; font-family: 'Bookman Old Style'" /></td>
                <td style="width: 35%; text-align: left">
            ...
            <tr>
                <td style="width: 30%; text-align: left">&nbsp;<asp:CheckBox ID="checkAll" onclick="CheckAllClick()" runat="server" Text="All" Style="cursor: hand; font-family: 'Bookman Old Style'" />
                </td>
            </tr>
            <tr>
