<%@ Page Language="VB" MasterPageFile="~/edp.master" ValidateRequest="false" AutoEventWireup="false" CodeBehind="promotion_frm_all.aspx.vb" Inherits="WebAppHRMS.PROMOTION_promotion_frm_16594dbb3835" Title="Untitled Page" %>
            ...
            <table border="1" width="750" id="TABLE1" align="center">
                ...
                <tr>
                    <td style="height: 22px; text-align: left; width: 727px;" colspan="4">
                        <table border="1" width="750">
                            <tr>
                                <td style="width: 100px; text-align: left">Select Employee</td>
                                ...
                                <td style="width: 1px; text-align: left">Name</td>
                            ...
                            <tr>
                                ...
                                <td style="width: 1px; text-align: left">Post Offered</td>
                                <td style="width: 114px; text-align: left">
                                    <asp:TextBox ID="txt_postoffer" runat="server" ReadOnly="True" Width="280px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="width: 100px; height: 28px; text-align: left">Branch Name</td>
                                ...
                                <td style="width: 1px; height: 28px; text-align: left">Department</td>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px; height: 28px; text-align: left">Designation</td>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px; height: 28px; text-align: left">Pay Scale</td>
                                ...
                                <td style="width: 1px; height: 28px; text-align: left">Effective Date</td>
                                <td style="width: 114px; height: 28px; text-align: left">
                                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy"
                                        TargetControlID="txt_effective_date"></cc1:CalendarExtender>
                            ...
                            <tr>
                                ...
                                <td style="width: 1px; height: 28px; text-align: left">Total Salary</td>
                                <td style="width: 114px; height: 28px; text-align: left">
                            ...
                            <tr id="spcl_tr" runat="server">
                                ...
                                <td id="Td1" runat="server" style="width: 311px; height: 28px; text-align: left">Enter amount</td>
                            ...
                            <tr id="Tr1" runat="server">
                                ...
                                <td id="Td3" runat="server" style="width: 311px; height: 28px; text-align: left">Remark</td>
                ...
                <tr>
                    <td colspan="4" style="height: 23px; width: 727px;">
                        ...
                        <asp:Label ID="Lbl_MESSAGE" runat="server" Width="732px" Text="Label" ForeColor="Red"></asp:Label><br />
