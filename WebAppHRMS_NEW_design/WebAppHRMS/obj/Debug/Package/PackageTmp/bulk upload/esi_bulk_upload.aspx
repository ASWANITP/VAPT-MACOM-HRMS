<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="esi_bulk_upload.aspx.vb" Inherits="WebAppHRMS.bulk_upload_esi_bulk_upload_00f340a49990" Title="Untitled Page" %>
        ...
        <table border="1" style="border-collapse: collapse; width: 600px; margin: auto;">
            <tr>
                <td colspan="4" style="width: 550px; height: 20px;">
                    <strong style="font-size: 20px;">BULK-EXCEL ESI UPDATION<br />
                    </strong>
            ...
            <tr>
                <td colspan="4" style="width: 550px">
                    <input style="width: 0.01px; height: 0px; color: black; border-color: black; background-color: #faebd7; float: right; display: none;"
                        type="button" id="bt1"
                        runat="server" />
                    <br />
