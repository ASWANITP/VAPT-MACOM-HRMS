                ...
                <div style="text-align: center">
                    <div style="text-align: center">
                        <table border="1">
                            ...
                            <tr>
                                <td style="width: 175px; height: 23px">Select Employee</td>
                                    ...
                                    <asp:Panel ID="Panel1" runat="server">
                                        <div style="text-align: center">
                                            <table border="1" style="width: 412px">
                                                ...
                                                <tr>
                                                    <td style="width: 100px">SSLC NUMBER</td>
                            ...
                            <tr>
                                <td style="width: 175px">Enter sslc number</td>
                                <td colspan="2">
                                    <asp:TextBox ID="txtsslc" runat="server" Width="181px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="width: 175px; height: 28px">Select Date of Birth</td>
                                <td colspan="2" style="height: 28px">
