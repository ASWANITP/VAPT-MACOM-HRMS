...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <table border="2" style="width: 51%; height: 240px">
        ...
        <tr>
            ...
            <td style="width: 14%; height: 9px">Upload Date</td>
            <td style="width: 14%; height: 9px">
                <asp:TextBox ID="txtdate" runat="server" ReadOnly="True" Style="left: 0px; position: relative; top: 0px"
                    Width="240px"></asp:TextBox></td>
        </tr>
        <tr>
            <td colspan="8">
        ...
        <tr>
            <td style="width: 37%; height: 6px">Employee Photo</td>
