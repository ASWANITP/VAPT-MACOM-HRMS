...
Partial Class lop_cancel_report_e96a1db96427
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'End If
        Dim dts1 As DataTable = oh.ExecuteDataSet("select query from mactech.hrm_report_master where firm_id=99 and query_id=201").Tables(0)
