...
Imports System.Web
Partial Class bulk_upload_uan_bulk_upload_6c58796e8857
        ...
        Try
            ...
            While dr.Read
                ...
                If rowCount = 1 Then
                    If Not IsDBNull(dr(0)) Then
                        empcodes = dr(0)
                    Else
                        empcodes = "" ' or any default value
                    End If

                    If Not IsDBNull(dr(1)) Then
                        uannumber = dr(1)
                    Else
                        uannumber = "" ' or any default value
                    End If
                End If
            ...
            While drs1.Read
                ...
                If rowCount >= 1 Then
                    ...
                    parameter(2) = New OracleParameter("uanno", OracleType.VarChar, 12)
                    parameter(2).Direction = ParameterDirection.Input
                    parameter(2).Value = (uannumber)
                    ...
                    oh.ExecuteNonQuery("HRM_UAN_NO_UPLOAD", parameter)
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Response.Redirect("~/ExcelFile/FormatUan.xlsx")
    End Sub
