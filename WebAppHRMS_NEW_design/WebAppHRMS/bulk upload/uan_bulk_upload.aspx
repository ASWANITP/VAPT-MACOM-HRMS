<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="uan_bulk_upload.aspx.vb" Inherits="WebAppHRMS.bulk_upload_uan_bulk_upload_6c58796e8857" Title="Untitled Page" %>
        ...
        <table border="1" style="border-collapse: collapse; width: 600px; margin: auto;">
            <tr>
                <td colspan="4" style="width: 550px; height: 20px;">
                    <strong style="font-size: 20px;">BULK-EXCEL UAN UPDATION<br />
                    </strong>
                </td>
            </tr>
            <tr>
                <td colspan="4" style="width: 550px">
                    <input style="width: 0.01px; height: 0px; color: #faebd7; border-color: #faebd7; background-color: #faebd7; float: right; display: none;"
                        type="button" id="bt1"
                        runat="server" />
                    <br />
                    ...
                    <form method="post" action="">
                        ...
                        <asp:FileUpload ID="FileUpload1" accept="application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" runat="server" Style="text-align: center; margin-left: 98px;" /><br />
                        <br />
                        <br />
