...
Partial Class bulk_upload_Bulk_Reject_Status_4b46fa276623
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'End If
        Dim dts1 As DataTable = oh.ExecuteDataSet("select query from mactech.hrm_report_master where firm_id=99 and query_id=303").Tables(0)
        ...
        f1.Text = "<b><font size=2>&nbsp;&nbsp;BULK-DATA</font></b>"
        field.Controls.Add(f1)

        f2.ColumnSpan = 1
        f2.HorizontalAlign = HorizontalAlign.Center
        f2.Text = "<b><font size=2>&nbsp;&nbsp;EMPLOYEE COUNT&nbsp;&nbsp;&nbsp;</font></b>"
        ...
        f6.Text = "<b><font size=2>&nbsp;&nbsp;&nbsp;&nbsp;ENTER DATE&nbsp;&nbsp;</font></b>"
        ...
        '                   0            1            2          3       ---------------------------4---------------------------------------------    -----------------------------------------5---------------------------------------- 5   eliminated Boerd of Directors...norm id=32 on 06-12-08           
