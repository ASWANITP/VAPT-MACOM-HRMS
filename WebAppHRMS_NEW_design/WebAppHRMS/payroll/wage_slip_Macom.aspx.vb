...
Partial Class wage_slip_Macom_2f30cef05036
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        If (Me.chk_bran.Checked = True) Then
            Server.Transfer("wage_slip_report_macom.aspx?&br=" & Me.cmb_bran.SelectedValue & "&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 1)
        End If
        If (Me.chk_firm.Checked = True) Then
            Server.Transfer("wage_slip_report_macom.aspx?&fr=" & Me.cmb_firm.SelectedValue & "&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 2)
        End If
        If (Me.chk_emp.Checked = True) Then
            If Me.cmb_emp.SelectedValue <> 0 Then
                ...
                Server.Transfer("wage_slip_report_macom.aspx?&em=" & Me.cmb_emp.SelectedValue & "&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 3)
            Else
        ...
        If (Me.chk_branch.Checked = True) Then
            Server.Transfer("wage_slip_report_macom.aspx?&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 4)
        End If
        If (Me.chk_allfirm.Checked = True) Then
            Server.Transfer("wage_slip_report_macom.aspx?&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 5)
        End If
    End Sub
