...
Partial Class Leave_Details_emp_leave_select_7d01b3034186
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            dt1 = oh.ExecuteDataSet("select m.emp_code from employee_master m where m.firm_id=" & fir & " and m.firm_id in (27) and m.emp_code= " & userid & "").Tables(0)
