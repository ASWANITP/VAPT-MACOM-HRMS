...
Public Class joinCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.joinCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedjoinCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As joinCrystalReport = New joinCrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
