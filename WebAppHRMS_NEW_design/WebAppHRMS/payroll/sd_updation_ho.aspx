            ...
            <ContentTemplate>
                <table style="width: 472px; height: 82px" border="1">
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 120px; height: 28px; text-align: right">Select :</td>
                            <td style="width: 100px; height: 28px; text-align: left">
                                <div style="text-align: left">
                                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" Width="327px" AutoPostBack="True" RepeatDirection="Horizontal">
                        ...
                        <tr>
                            <td style="width: 120px; text-align: right">Department : </td>
            ...
            <tr id="p2">
                <td style="width: 100px; height: 28px;">
                    <asp:Panel ID="Panel2" runat="server" Height="50px" Visible="False" Width="125px">
                        &nbsp;<asp:Button ID="cmd_confirm1" OnClientClick="checkbeforeconfirm()" runat="server" Text="CONFIRM" Width="106px" />
                    </asp:Panel>
                </td>
            </tr>
        </table>
