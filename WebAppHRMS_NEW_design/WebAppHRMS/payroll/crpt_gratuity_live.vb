...
Public Class crpt_gratuity_live
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.crpt_gratuity_live.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_gratuity_live
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_gratuity_live = New crpt_gratuity_live()
        rpt.Site = Me.Site
        Return rpt
    End Function
