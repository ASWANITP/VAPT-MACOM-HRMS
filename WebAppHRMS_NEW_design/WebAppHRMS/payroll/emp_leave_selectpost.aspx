...
<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="emp_leave_selectpost.aspx.vb" Inherits="WebAppHRMS.Leave_Details_emp_leave_select_7d01b3034805" Title="Empwise Leave Details" %>
        ...
        <br />--%>
            ...
            <tr>
                <td style="width: 122px; text-align: left">
                    <strong>Select Choice :</strong></td>
            ...
            <tr>
                ...
                <td style="width: 153px; text-align: left"></td>
            ...
            <table border="1" style="margin: 0px auto;">
                <tr>
                    <td style="width: 61px; text-align: right; height: 7px;">
                        <center>
                            <input id="Cmd_Exit" type="button" value="EXIT" style="width: 100px" onclick="return Cmd_Exit_onclick()" /></center>
                    </td>
                    <td style="width: 105px; text-align: left; height: 7px;">
                        <center>
                            <asp:Button ID="Cmd_Confirm" OnClientClick="return cliclick()" runat="server" Text="CONFIRM" Width="100px" /></center>
                    </td>
                    <td style="width: 105px; text-align: left; height: 7px;">
                        <center>
                            <asp:Button ID="Btedit" runat="server" Text="CLEAR" Width="100px" /></center>
                    </td>
                </tr>
            </table>
