...
Partial Class salaryreport_wage_slip_report_560a62de1605
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("firm_id") = 9 Or Session("firm_id") = 35 Then
            If (Request.QueryString("a") = 1) Then
                dt = oh.ExecuteDataSet("select w.fname,w.ename,w.gunme,w.dsgn,w.mnthstart,w.mnthend,w.workdys,w.basal,w.vda,w.ovtwge,w.grssal,w.totded,w.ntpay,w.brnme,w.fxdta,w.alamt,w.arrsal,w.tds,w.esi,w.pf,w.lop,w.othded,w.ecode,w.lic from wage_dtls_old w where w.brnid=" & Request.QueryString("br") & " and w.fmid='" & Session("firm_id") & "' and w.salcdt=to_date(" & Request.QueryString("dt") & ",'dd/mm/yyyy')").Tables(0)
            End If

            If (Request.QueryString("a") = 2) Then
                dt = oh.ExecuteDataSet("select w.fname,w.ename,w.gunme,w.dsgn,w.mnthstart,w.mnthend,w.workdys,w.basal,w.vda,w.ovtwge,w.grssal,w.totded,w.ntpay,w.brnme,w.fxdta,w.alamt,w.arrsal,w.tds,w.esi,w.pf,w.lop,w.othded,w.ecode,w.lic from wage_dtls_old w where  w.fmid='" & Session("firm_id") & "' and w.salcdt=to_date(" & Request.QueryString("dt") & ",'dd/mm/yyyy')").Tables(0)
            End If
            If (Request.QueryString("a") = 3) Then
                dt = oh.ExecuteDataSet("select w.fname,w.ename,w.gunme,w.dsgn,w.mnthstart,w.mnthend,w.workdys,w.basal,w.vda,w.ovtwge,w.grssal,w.totded,w.ntpay,w.brnme,w.fxdta,w.alamt,w.arrsal,w.tds,w.esi,w.pf,w.lop,w.othded,w.ecode,w.lic from wage_dtls_old w where w.ecode=" & Request.QueryString("em") & "  and w.fmid='" & Session("firm_id") & "' and w.salcdt=to_date(" & Request.QueryString("dt") & ",'dd/mm/yyyy')").Tables(0)
            End If
            If (Request.QueryString("a") = 4) Then
        ...
        Else
            If (Request.QueryString("a") = 1) Then
                dt = oh.ExecuteDataSet("select w.fname,w.ename,w.gunme,w.dsgn,w.mnthstart,w.mnthend,w.workdys,w.basal,w.vda,w.ovtwge,w.grssal,w.totded,w.ntpay,w.brnme,w.fxdta,w.alamt,w.arrsal,w.tds,w.esi,w.pf,w.lop,w.othded,w.ecode from wage_dtls_old w where w.brnid=" & Request.QueryString("br") & " and w.fmid='" & Session("firm_id") & "' and w.salcdt=to_date(" & Request.QueryString("dt") & ",'dd/mm/yyyy')").Tables(0)
            End If

            If (Request.QueryString("a") = 2) Then
                dt = oh.ExecuteDataSet("select w.fname,w.ename,w.gunme,w.dsgn,w.mnthstart,w.mnthend,w.workdys,w.basal,w.vda,w.ovtwge,w.grssal,w.totded,w.ntpay,w.brnme,w.fxdta,w.alamt,w.arrsal,w.tds,w.esi,w.pf,w.lop,w.othded,w.ecode from wage_dtls_old w where  w.fmid='" & Session("firm_id") & "' and w.salcdt=to_date(" & Request.QueryString("dt") & ",'dd/mm/yyyy')").Tables(0)
            End If
            If (Request.QueryString("a") = 3) Then
                dt = oh.ExecuteDataSet("select w.fname,w.ename,w.gunme,w.dsgn,w.mnthstart,w.mnthend,w.workdys,w.basal,w.vda,w.ovtwge,w.grssal,w.totded,w.ntpay,w.brnme,w.fxdta,w.alamt,w.arrsal,w.tds,w.esi,w.pf,w.lop,w.othded,w.ecode from wage_dtls_old w where w.ecode=" & Request.QueryString("em") & "  and w.fmid='" & Session("firm_id") & "' and w.salcdt=to_date(" & Request.QueryString("dt") & ",'dd/mm/yyyy')").Tables(0)
            End If
            If (Request.QueryString("a") = 4) Then
                dt = oh.ExecuteDataSet("select w.fname,w.ename,w.gunme,w.dsgn,w.mnthstart,w.mnthend,w.workdys,w.basal,w.vda,w.ovtwge,w.grssal,w.totded,w.ntpay,w.brnme,w.fxdta,w.alamt,w.arrsal,w.tds,w.esi,w.pf,w.lop,w.othded,w.ecode from wage_dtls_old w where  w.fmid='" & Session("firm_id") & "' and w.salcdt=to_date(" & Request.QueryString("dt") & ",'dd/mm/yyyy')  order by w.brnme").Tables(0)
            End If
