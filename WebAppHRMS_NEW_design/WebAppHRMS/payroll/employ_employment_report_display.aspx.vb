...
Partial Class employ_employment_report_display_d4fefdc05530
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim dt7 As DataTable
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '-------------------------------------------UPDATED FOR MACOM HR JERIN
        ...
        tdr11.Text = "<font size=4><b>    </b></font>"
        ...
        tdr2.Text = "<font size=3 color=red><b> WORKING EMPLOYEES LIST </b></font>"
        ...
        Dim ta51, ta52, ta53, ta54, ta55, ta56, ta60, ta61, ta62, ta63, ta64, ta551, ta57 As New TableCell
        ...
        ta52.Text = "<font size=2><b>BRANCH ID</b></font>"
        ta53.Text = "<font size=2><b>EMPLOY CODE</b></font>"
        ta54.Text = "<font size=2><b>EMPLOYEE NAME</b></font>"
        ta61.Text = "<font size=2><b>QUALIFICATION</b></font>"
        ta62.Text = "<font size=2><b>GENDER</b></font>"
        ta63.Text = "<font size=2><b>DESIGNATION</b></font>"
        ta55.Text = "<font size=2><b>DEPARTMENT</b></font>"
        ta56.Text = "<font size=2><b>POSTOFFERED</b></font>"
        ta57.Text = "<font size=2><b>NATIVE(STATEWISE)</b></font>"
        ...
        Dim sql_str As String = Request.QueryString("sql")
        ...
        For Each dr In dt.Rows
            If branch <> dr(10) Then
                Dim br As New TableRow
                Dim brr As New TableCell
                brr.ColumnSpan = 16
                brr.HorizontalAlign = HorizontalAlign.Center
                brr.Text = "<font size=3 color=blue align=center><b>" & dr(10).ToString & "  </b></font>"
                br.Controls.Add(brr)
                tab.Controls.Add(br)

            End If
            branch = dr(10).ToString
            ...
            Dim lm49, lm51, lm52, lm53, lm54, lm55, lm56, lm60, sbh, bh, abh, lm57 As New TableCell

            bh.Attributes.Add("width", "5%")
            dt7 = oh.ExecuteDataSet("select  to_char(min(a.join_dt)) from employee_master a where a.emp_code in (select e.emp_code from employee_master e,employee_master_dtl em where e.emp_code=em.emp_code and em.new_empcode=" & dr(1) & " union select e.emp_code from employee_master e,employee_master_dtl em,employee_master_dtl em1 where e.emp_code=em.emp_code and em.emp_code=" & dr(1) & " and em.new_empcode is null and em1.new_empcode<>em.emp_code) ").Tables(0)
            ...
            lm51.Text = "<font size=2>" & dt7.Rows(0)(0) & "</font>"
        ...
        Dim llm49, llm51, llm52, llm53, llm54, llm55, llm56, llm60, lsbh, lbh, labh, llm57 As New TableCell
        ...
        llm54.Text = "<font size=2>TOTAL RECORD</font></a>"
        llm5.Controls.Add(llm54)
        ''''''''''''''''''''
        lsbh.ColumnSpan = 1
        lsbh.HorizontalAlign = HorizontalAlign.Left
        lsbh.Text = "<font size=2>" & emp & "</font>"
        llm5.Controls.Add(lsbh)

        lbh.ColumnSpan = 4
        lbh.HorizontalAlign = HorizontalAlign.Left
        lbh.Text = "<font size=2></font>"
        llm5.Controls.Add(lbh)

        labh.ColumnSpan = 2
        labh.HorizontalAlign = HorizontalAlign.Left
        ...
        llm55.ColumnSpan = 1
        llm55.HorizontalAlign = HorizontalAlign.Left

        llm55.Text = "<font size=2> </font>"
        llm5.Controls.Add(llm55)

        llm56.ColumnSpan = 2
        llm56.HorizontalAlign = HorizontalAlign.Left
        llm56.Text = "<font size=2> </font>"
        llm5.Controls.Add(llm56)

        llm57.ColumnSpan = 1
        llm57.HorizontalAlign = HorizontalAlign.Left
        ...
        lin212.ColumnSpan = 16
        lin212.Text = "<a href=employ_employment_details.aspx><font color=blue>BACK</font ></a>"
