...
Partial Class employ_area_branch_display_a7ae3c189786
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        td21.Text = "<font size=2><b> " & Request.QueryString("br") & " </b></font>"
        ...
        tdr2.Text = "<font size=3 color=red><b> </b></font>"
        ...
        Dim ta51, ta52, ta53, ta54, ta55, ta56, ta57, ta58, ta60, ta61, ta62, ta63, ta64, ta551 As New TableCell
        ...
        ta57.Text = "<font size=2><b> SEX</b></font>"
        ta58.Text = "<font size=2><b>DISTRICT</b></font>"
        ...
        For Each dr In dt.Rows
            ...
            Dim lm49, lm51, lm52, lm53, lm54, lm55, lm56, lm60, sbh, bh, abh, lm57, lm58 As New TableCell
        ...
        Dim llm49, llm51, llm52, llm53, llm54, llm55, llm56, llm60, lsbh, lbh, llm57, llm58, labh As New TableCell
        ...
        llm53.Text = "<font size=2> total</font>"
        ...
        lin216.ColumnSpan = 17
        lin216.Text = "<font size=4><b> MALE-" & Request.QueryString("male") & ",FEMALE-" & Request.QueryString("fema") & "</b></font>"
        lin215.Controls.Add(lin216)
        tab.Controls.Add(lin215)
        ...
        lin212.Text = "<a href=employeeListReport.aspx><font color=blue>BACK</font ></a>"
