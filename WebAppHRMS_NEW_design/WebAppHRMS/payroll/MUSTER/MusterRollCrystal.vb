...
Public Class MusterRollCrystal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.MusterRollCrystal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMusterRollCrystal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MusterRollCrystal = New MusterRollCrystal()
        rpt.Site = Me.Site
        Return rpt
    End Function
