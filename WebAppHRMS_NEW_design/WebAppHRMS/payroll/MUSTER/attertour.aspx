<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="attertour.aspx.vb" Inherits="WebAppHRMS.specificempattend_atterepo_099614a55884" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center; color: #626477;">
        <table border="1" style="width: 731px; height: 217px">
            <tr>
                <td colspan="4">
                    <asp:ScriptManager ID="ScriptManager1" runat="server">
                    </asp:ScriptManager>
                    <strong><span style="font-size: 14pt">ATTENDANCE
            ...
            <tr>
                ...
                <td colspan="2" style="height: 44px">&nbsp;
                    <button id="Button2" type="button" style="width: 121px;" onclick="Button2_Click()">EXIT</button></td>
            </tr>
        </table>
    </div>
</asp:Content>
