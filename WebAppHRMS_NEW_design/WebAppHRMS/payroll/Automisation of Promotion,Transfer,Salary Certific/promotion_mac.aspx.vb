...
Partial Class Payroll_promotion_promotion_mac_a2ac504c3533
    ...
    Protected Sub cmd_appletter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_appletter.Click
        dts1 = oh.ExecuteDataSet("select query from hrm_report_master where firm_id=99 and query_id=143").Tables(0)
        Dim str() As String = dts1.Rows(0)(0).ToString.Split("#")
        'Dim _filename As String = (System.Guid.NewGuid.ToString + ".doc")
        Dim _filename As String = ("Promotion Letter-" + Me.cmb_code.SelectedValue + ".doc")
        ...
        If dts2.Rows.Count > 0 Then
            htmlRaw = htmlRaw.Replace("myname", dts2.Rows(0)(0))
            htmlRaw = htmlRaw.Replace("myfa", dts2.Rows(0)(1))
            htmlRaw = htmlRaw.Replace("myadd", dts2.Rows(0)(2))
            htmlRaw = htmlRaw.Replace("mypla", dts2.Rows(0)(3))
            htmlRaw = htmlRaw.Replace("mydis", dts2.Rows(0)(4))
            htmlRaw = htmlRaw.Replace("mystat", dts2.Rows(0)(5))
            htmlRaw = htmlRaw.Replace("myname", dts2.Rows(0)(6))
            htmlRaw = htmlRaw.Replace("mydes", dts2.Rows(0)(7))
            htmlRaw = htmlRaw.Replace("mypost", dts2.Rows(0)(8))
            htmlRaw = htmlRaw.Replace("mynewdes", dts2.Rows(0)(9))
            
            htmlRaw = htmlRaw.Replace("mypost", dts2.Rows(0)(10))
            htmlRaw = htmlRaw.Replace("mycode", dts2.Rows(0)(11))

            htmlRaw = htmlRaw.Replace("mynam", dts2.Rows(0)(12))
            htmlRaw = htmlRaw.Replace("mydes", dts2.Rows(0)(13))
            htmlRaw = htmlRaw.Replace("mypost", dts2.Rows(0)(14))
            htmlRaw = htmlRaw.Replace("mydep", dts2.Rows(0)(15))

            htmlRaw = htmlRaw.Replace("myoldctc", dts2.Rows(0)(16))
            htmlRaw = htmlRaw.Replace("mycode", dts2.Rows(0)(17))
            htmlRaw = htmlRaw.Replace("mynam", dts2.Rows(0)(18))
            htmlRaw = htmlRaw.Replace("mynewdes", dts2.Rows(0)(19))
            htmlRaw = htmlRaw.Replace("mypost", dts2.Rows(0)(20))

            htmlRaw = htmlRaw.Replace("mydep", dts2.Rows(0)(21))
            htmlRaw = htmlRaw.Replace("mynewctc", dts2.Rows(0)(22))
            htmlRaw = htmlRaw.Replace("mydays", dts2.Rows(0)(23))
            htmlRaw = htmlRaw.Replace("mydate", dts2.Rows(0)(24))
            htmlRaw = htmlRaw.Replace("mychief", dts2.Rows(0)(25))
