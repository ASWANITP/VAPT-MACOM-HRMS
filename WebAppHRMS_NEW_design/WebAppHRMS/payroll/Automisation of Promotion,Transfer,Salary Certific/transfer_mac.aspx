<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="transfer_mac.aspx.vb" Inherits="WebAppHRMS.Payroll_Transfer_transfer_mac_5f6c5f242505" %>
        ...
        <table border="1">
            <tr>
                <td style="width: 100px; height: 28px;">
                    <asp:Button ID="cmd_appletter" runat="server" Text="Transfer Letter" Width="135px" Style="cursor: hand" /></td>
                <td style="width: 100px; height: 28px;">
