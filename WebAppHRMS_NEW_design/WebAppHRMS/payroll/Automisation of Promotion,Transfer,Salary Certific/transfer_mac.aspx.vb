...
Partial Class Payroll_Transfer_transfer_mac_5f6c5f242505
    ...
    Protected Sub cmd_appletter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_appletter.Click
        dts1 = oh.ExecuteDataSet("select query from hrm_report_master where firm_id=99 and query_id=144").Tables(0)
        Dim str() As String = dts1.Rows(0)(0).ToString.Split("#")
        'Dim _filename As String = (System.Guid.NewGuid.ToString + ".doc")
        Dim _filename As String = ("Transfer Letter-" + Me.cmb_code.SelectedValue + ".doc")
        ...
        If dts2.Rows.Count > 0 Then
            ...
            htmlRaw = htmlRaw.Replace("myfath", dts2.Rows(0)(2))
            htmlRaw = htmlRaw.Replace("myadd", dts2.Rows(0)(3))
            htmlRaw = htmlRaw.Replace("mypla", dts2.Rows(0)(4))
            htmlRaw = htmlRaw.Replace("mydist", dts2.Rows(0)(5))
            htmlRaw = htmlRaw.Replace("mystate", dts2.Rows(0)(6))
            htmlRaw = htmlRaw.Replace("myname", dts2.Rows(0)(7))
            htmlRaw = htmlRaw.Replace("mydes", dts2.Rows(0)(8))
            htmlRaw = htmlRaw.Replace("mypost", dts2.Rows(0)(9))

            htmlRaw = htmlRaw.Replace("mydep", dts2.Rows(0)(10))
            htmlRaw = htmlRaw.Replace("mydes", dts2.Rows(0)(11))
            htmlRaw = htmlRaw.Replace("mynewpost", dts2.Rows(0)(12))
            htmlRaw = htmlRaw.Replace("mynewdep", dts2.Rows(0)(13))
            htmlRaw = htmlRaw.Replace("mycode", dts2.Rows(0)(14))
            htmlRaw = htmlRaw.Replace("mynam", dts2.Rows(0)(15))
            htmlRaw = htmlRaw.Replace("mydes", dts2.Rows(0)(16))
            htmlRaw = htmlRaw.Replace("mynewpost", dts2.Rows(0)(17))
            htmlRaw = htmlRaw.Replace("mynewdep", dts2.Rows(0)(18))
            htmlRaw = htmlRaw.Replace("mynewctc", dts2.Rows(0)(19))

            htmlRaw = htmlRaw.Replace("mychief", dts2.Rows(0)(20))
            'htmlRaw = htmlRaw.Replace("ctcword", dts2.Rows(0)(22))
            'htmlRaw = htmlRaw.Replace("mybreakup", dts2.Rows(0)(23))
