...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1" style="height: 83px">
            <tr>
                <td style="width: 100px; text-align: right">Select Month
                </td>
            ...
            <tr>
                ...
                <td style="width: 100px; text-align: left">&nbsp;<input id="cmd_exit" style="width: 82px" type="button" value="EXIT" onclick="return cmd_exit_onclick()" /></td>
            </tr>
        </table>
    </div>
    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="MMM/yyyy" TargetControlID="txt_month"></cc1:CalendarExtender>
    <br />
</asp:Content>
