...
Partial Class HRM_SECURITY_hrm_Add_Post_521c77fd3783
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If frm = 8 Then
            Response.Redirect("Hrm_Add_Post_Macom.aspx")
            Exit Sub
        End If
        '---------sh
        If frm = 28 And Me.Session("branch_id") = 3439 Then
            Response.Redirect("Hrm_Add_Post_school.aspx")
            Exit Sub
        End If
        If frm = 28 And Me.Session("branch_id") = 3427 Then
            Response.Redirect("Hrm_Add_Post_school.aspx")
            Exit Sub
        End If
        ...
        '--------sh
        If frm = 24 Then
            Response.Redirect("~/payroll/posting/hrm_Add_Post_MJwell.aspx")
            Exit Sub
        End If
        ...
        Select Case (DataStr(1))
            ...
            Case 3
                ...
                Try
                    ...
                    p(1) = New OracleParameter("Post", OracleType.VarChar, 5)
                    p(1).Value = Post
