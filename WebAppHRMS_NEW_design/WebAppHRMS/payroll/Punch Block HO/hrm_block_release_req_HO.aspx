...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function check_date(Control) {   //alert('a');
            var day1, day2;
            var month1, month2;
            var year1, year2;
    ...
    <div style="text-align: center">
        ...
        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy" TargetControlID="txtDate"></cc1:CalendarExtender>
