        ...
        <div style="text-align: center">
            <div style="text-align: center">
                <table border="1" style="left: 0px; position: relative; top: 0px">
                    <caption>
                        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy" TargetControlID="txt_month"></cc1:CalendarExtender>
                    ...
                    <tr>
                        ...
                        <td style="width: 100px; height: 10px;">
                            <asp:DropDownList ID="br_drop" runat="server" Height="120px" Style="left: 2px; position: relative; top: 0px"
                                Width="219px">
                            </asp:DropDownList></td>
                    ...
                    <tr>
                        <td style="width: 725px; height: 9px;"></td>
                        <td style="width: 100px; height: 9px;"></td>
