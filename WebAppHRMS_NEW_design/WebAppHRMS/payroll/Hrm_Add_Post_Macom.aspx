<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Hrm_Add_Post_Macom.aspx.vb" Inherits="WebAppHRMS.payroll_Hrm_Add_Post_Macom_090990d38136" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function disp() {
            ...
            if (document.getElementById(cont[0] + "Hidden1").value != "") {
                for (kk = 0; kk < ar; kk++) {
                    st3 = st2[kk].split("!")
                    st1 = st1 + "<tr ><td ><small>" + st3[0] + "</td><td><small>" + st3[1] + "</td><td><small>" + st3[2] + "</td><td><small>" + st3[3] + "</td><td><small>" + st3[4] + "</td><td><small>" + st3[5] + "</td><td><small>" + st3[6] + "</td><td><small>" + st3[7] + "</td></tr>"

                }
                st = st + "<table id='mytable' border='1'  ><tr><td><small><b>EMP NAME</b></td><td><small><b>D O J</b></td><td><small><b>POST</b></td><td><small><b>DESIGNATION</b></td><td><small><b>DEPARTMENT</b></td><td><small><b>SALARY</b></td><td><small><b>TECHLEAD</b></td><td><b><small>LEVEL</b></td></tr><tr></tr><tr></tr>"
        ...
        function OnClickRadiotl() {
            var Status = "-66";
            ToServer(Status + "#" + 2, 2);
        }
        function OnClickRadiolvl() {
            var Status = "-77";
            ToServer(Status + "#" + 2, 2);
        }
        ...
        function OnClickConfirm() {
            ...
            if (document.getElementById(cont[0] + "rdb_Join").checked == true)
                Status = 1;
            else if (document.getElementById(cont[0] + "rdb_Post").checked == true)
                Status = 2;
            else if (document.getElementById(cont[0] + "rdb_Desig").checked == true)
                Status = 3;
            else if (document.getElementById(cont[0] + "rdb_Dept").checked == true)
                Status = 4;
            else if (document.getElementById(cont[0] + "rdb_Salary").checked == true)
                Status = 5;
            else if (document.getElementById(cont[0] + "rdb_Cancel").checked == true)
                Status = 6;
            else if (document.getElementById(cont[0] + "rdb_tl").checked == true)
                Status = 7;
            else if (document.getElementById(cont[0] + "rdb_level").checked == true)
                Status = 8;
            else {
                alert("Select Any To Change");
                return false;
            }

            ToData = EmpCode + "%" + Post + "%" + JoinDate + "%" + Salary + "%" + Status + "%" + Post + "%" + Post;
            ToServer(ToData + "#" + 3, 3)
        }
        // ]]>
    </script>
    ...
    <div style="text-align: center">
        &nbsp;<table border="1" style="width: 59%; height: 147px;">
            <tr>
                <td colspan="2">Enter Emp Code</td>
            ...
            <tr>
                <td colspan="5">
                    ...
                    <asp:RadioButton ID="rdb_Cancel" runat="server" Text="Cancel Emp Code" Width="146px" GroupName="a" />
                    <asp:RadioButton ID="rdb_tl" runat="server" Text="TechLead" Width="146px" GroupName="a" />
                    <asp:RadioButton ID="rdb_level" runat="server" Text="Employee Level" Width="146px" GroupName="a" />
                </td>
            </tr>
            <tr id="row4" style="display: none;">
                <td colspan="2" style="height: 8px; text-align: right;">Select&nbsp; &nbsp;</td>
                <td colspan="3" style="text-align: left; height: 8px;">
                    <asp:DropDownList ID="cmb_select" runat="server" Width="364px">
                    </asp:DropDownList></td>
            </tr>
            <tr id="row2" style="display: none;">
                <td colspan="2" style="height: 10px">Select Date</td>
            ...
            <tr id="row3" style="display: none;">
                <td colspan="2" style="height: 10px">Enter Salary</td>
