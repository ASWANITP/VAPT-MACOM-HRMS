...
Public Class One_day_shift_Approval
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        masterPage.Subtitle = "ONEDAY SHIFT APPROVAL"
        ...
        If Not IsPostBack Then
            ...
            Else
                dt4 = oh.ExecuteDataSet("select -1 as request_id, '-----Select-----' as sname, to_date(null) as request_date from dual union all select t.requ_id, e.emp_name || ' --> ' || e.emp_code || '-->' || t.enter_dt || '-->' || 'Req_ID:' || t.requ_id, t.enter_dt from macom_oneday_shift t inner join employee_master e on t.emp_code = e.emp_code and t.status = 0 inner join department_mst d on d.dep_id = e.department_id and d.dep_head = " & sf(0) & " order by request_id").Tables(0)
    ...
    Protected Sub btnRecommend_Click(sender As Object, e As EventArgs) Handles btnRecommend.Click
        ...
        oh.ExecuteNonQuery("hrm_one_day_shift_change_req", parameter)
        ...
        Try
            ...
            script1.Append("window.open('One_day_shift_Approval.aspx','_self');")
