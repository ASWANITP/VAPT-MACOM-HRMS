...
Public Class Shift_Sanction_COO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            dt3 = oh.ExecuteDataSet("select count(*) from employee_master where emp_code=" & sf(0) & " and post_id=107").Tables(0)
            ...
            Else
                ...
                masterPage.Subtitle = "COO SHIFT CHANGE APPROVAL"

                dt4 = oh.ExecuteDataSet("select -1 as request_id, '-----Select-----' as sname, to_date(null) as request_date from dual union all select t.request_id, e.emp_name || ' --> ' || e.emp_code || '-->' || t.req_dt || '-->' || 'Req_ID:' || t.request_id, t.req_dt from mactech.MACOM_SHIFT_CHANGE t inner join mactech.employee_master e on t.emp_code = e.emp_code and t.status = 3 order by request_id").Tables(0)
        ...
        If ddlEmployee.SelectedValue <> "-1" Then
            ...
            Try
                If dt5.Rows.Count > 0 Then
                    ...
                    Me.txtDepHeadName.Text = dt5.Rows(0)(6)
    ...
    Protected Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click
        ...
        Try
            ...
            script1.Append("window.open('Shift_Sanction_COO.aspx','_self');")
    ...
    Protected Sub btnReject_Click(sender As Object, e As EventArgs) Handles btnReject.Click
        ...
        Try
            'If message.StartsWith("SHIFT") = True Then
            script1.Append("alert('" & message & "');")
            script1.Append("window.open('Shift_Sanction_Dephead.aspx','_self');")
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "alertScript", script1.ToString(), True)
