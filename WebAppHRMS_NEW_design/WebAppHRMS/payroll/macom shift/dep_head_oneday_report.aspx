<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dep_head_oneday_report.aspx.vb" Inherits="WebAppHRMS.dep_head_oneday_report" %>
...
<body>
    ...
    <input type="button" class="big-button" value="Export to Excel" onclick="exportToExcel()" />
            ...
            <Columns>
                ...
                <asp:BoundField DataField="tl_code" HeaderText="TL EMPCODE" />
               <asp:BoundField DataField="approve_code" HeaderText="DEPHEAD EMPCODE" />
                <asp:BoundField DataField="EFF_DT" HeaderText="EFFECTIVE DATE" DataFormatString="{0:dd/MMM/yyyy}" />
                <asp:BoundField DataField="enter_dt" HeaderText="REQUEST DATE" DataFormatString="{0:dd/MMM/yyyy}" />
                <asp:BoundField DataField="OLD_SHIFT" HeaderText="PREVIOUS SHIFT" />
                <asp:BoundField DataField="NEW_SHIFT" HeaderText="CURRENT SHIFT" />
                <asp:BoundField DataField="tl_remarks" HeaderText="TL REMARK" />
                <asp:BoundField DataField="approve_remarks" HeaderText="DEP HEAD REMARK" />
