                ...
                <th colspan="6">
                    <div style="padding-left: 10px; padding-right: 10px; padding-top: 5px; padding-bottom: 5px;">
                        <table style="width: 100%; text-align: center; border-style: groove;" id="tbl">
                            <thead>
                                <tr>
                                    <th style="height: 25px; width: 12%; text-decoration: underline; border-bottom: 2px dashed black;">EMPCODE</th>
                                    <th style="height: 25px; width: 20%; text-decoration: underline; border-bottom: 2px dashed black;">NAME</th>

                                    <th style="height: 25px; width: 17%; text-decoration: underline; border-bottom: 2px dashed black;">FROM DATE</th>
                                    <th style="height: 25px; width: 16%; text-decoration: underline; border-bottom: 2px dashed black;">IN TIME</th>
                                    <th style="height: 25px; width: 17%; text-decoration: underline; border-bottom: 2px dashed black;">OUT TIME</th>
                                    <th style="height: 25px; width: 16%; text-decoration: underline; border-bottom: 2px dashed black;">SHIFT</th>
                                    <th style="display: none; height: 25px;">shiftid</th>
                                    <th style="display: none; height: 25px;">depart</th>
                                    <th style="height: 25px; width: 17%; text-decoration: underline; border-bottom: 2px dashed black;">APPROVE
                                        <input type="checkbox" id="chk_bx" onclick="return chk_bx_onclick()" /></th>
                                    &nbsp;&nbsp;&nbsp;
                                        
                                         <th style="height: 25px; width: 17%; text-decoration: underline; border-bottom: 2px dashed black;">REJECT
                                             <input type="checkbox" id="Checkbox1" onclick="return Checkbox1_onclick()" /></th>
                                </tr>
                            </thead>
                            <tbody id="tblbody">
                            </tbody>
