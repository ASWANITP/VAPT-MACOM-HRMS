<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Shift_DepHead_Report.aspx.vb" Inherits="WebAppHRMS.Shift_DepHead_Report" %>
...
<body>
    <form id="form1" runat="server">
         <!-- Page Header -->
        <div class="report-header" style="width:150%">
        ...
        <div>
          ...
          <h2 style="text-align:center; font-size:1.4em;">DEPARTMENT HEAD SANCTION SHIFT REPORT</h2>
           </div>
    ...
    <input type="button" class="big-button" value="Export to Excel" onclick="exportToExcel()" />
      ...
      <asp:GridView ID="gvReport" runat="server" AutoGenerateColumns="False" Width="100%" BorderWidth="1px" GridLines="None" CssClass="grid"> 
            ...
            <Columns>
               ...
               <%-- <asp:BoundField DataField="TL_EMPCODE" HeaderText="TL EMPCODE" />--%>
                <asp:BoundField DataField="EFF_DT" HeaderText="EFFECTIVE DATE" DataFormatString="{0:dd/MMM/yyyy}" />
                <asp:BoundField DataField="REQ_DT" HeaderText="REQUEST DATE" DataFormatString="{0:dd/MMM/yyyy}" />
                <asp:BoundField DataField="OLD_SHIFT" HeaderText="PREVIOUS SHIFT" />
                <asp:BoundField DataField="NEW_SHIFT" HeaderText="CURRENT SHIFT" />
                <asp:BoundField DataField="EMP_REMARK" HeaderText="EMPLOYEE REMARK" />
                <asp:BoundField DataField="TL_REMARK" HeaderText="TL REMARK" />
                <asp:BoundField DataField="DEPHED_REMARK" HeaderText="DEP HEAD REMARK" />
                <asp:BoundField DataField="COO_REMARK" HeaderText="COO REMARK" />
                <asp:BoundField DataField="REJECT_CODE" HeaderText="REJECT CODE" />
                <asp:BoundField DataField="REJECT_REMARK" HeaderText="REJECT REMARKS" />
