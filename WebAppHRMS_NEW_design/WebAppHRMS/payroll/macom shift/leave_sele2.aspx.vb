...
Partial Class new_view_punch_report_de0f30196625
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            mydrop = oh.ExecuteDataSet("select '---SELECT---',0 DEP from dual union all select t.dep_name, T.DEP_ID from department_mst   t where t.dep_head in(100336) ORDER BY DEP").Tables(0)
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        If (Me.DropDownList2.SelectedValue = 0) AndAlso Me.CheckBox1.Checked = True Then
            cl_script9.Append(" alert('Select Any Department');")
            Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "inv", cl_script9.ToString, True)
            Exit Sub
        End If
        ...
        Server.Transfer("shift_rpt.aspx?fdt=" & Me.Txt_fdt.Text & "&tdt=" & Me.Txt_tdt.Text & "&depid=" & ttype & "")
