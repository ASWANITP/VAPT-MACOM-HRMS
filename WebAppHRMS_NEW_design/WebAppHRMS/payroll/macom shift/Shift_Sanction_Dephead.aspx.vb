...
Public Class Shift_Sanction_Dephead
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Else
                ...
                masterPage.Subtitle = "DEPARTMENT HEAD SHIFT CHANGE RECOMMEND"

                dt4 = oh.ExecuteDataSet("select -1 as request_id, '-----Select-----' as sname, to_date(null) as request_date from dual union all select t.request_id, e.emp_name || ' --> ' || e.emp_code || '-->' || t.req_dt || '-->' || 'Req_ID:' || t.request_id, t.req_dt from mactech.MACOM_SHIFT_CHANGE t inner join mactech.employee_master e on t.emp_code = e.emp_code and t.status = 2 inner join mactech.department_mst d on d.dep_id = e.department_id and d.dep_head = " & sf(0) & " order by request_id").Tables(0)
