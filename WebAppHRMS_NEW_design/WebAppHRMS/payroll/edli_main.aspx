...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1" style="width: 367px; height: 151px">
            ...
            <tr>
                <td style="width: 87px; text-align: right">Firm :&nbsp;
                </td>
            ...
            <tr>
                <td style="width: 87px; height: 6px; text-align: right">Report :&nbsp;
                </td>
            ...
            <tr>
                <td style="width: 87px; text-align: right; height: 6px;">&nbsp;<input id="Button1" style="width: 68px" type="button" value="EXIT" onclick="return Button1_onclick()" /></td>
                <td style="width: 100px; height: 6px; text-align: left;">
