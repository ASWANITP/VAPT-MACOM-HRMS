...
Public Class crpt_edli_live
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.crpt_edli_live.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_edli_live
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_edli_live = New crpt_edli_live()
        rpt.Site = Me.Site
        Return rpt
    End Function
