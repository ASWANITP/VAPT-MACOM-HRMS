...
Partial Class salloplive_a11a9a7e8762
        ...
        If (Request.QueryString("st") = 1) Then
            If (Request.QueryString("ca") = 1) Then
                ...
                If (Request.QueryString("a") = 1) Then
                    dt = oh.ExecuteDataSet("select e.emp_code,e.emp_name,sum(case when l.leave_id=1 and l.leave_process_id =1 then l.leave_days else 0 end) as cl,sum(case when l.leave_id=2 and l.leave_process_id =1 then l.leave_days else 0 end) as sl,sum(case when l.leave_id=3 and l.leave_process_id =1 then l.leave_days else 0 end) as el,sum(case when l.leave_id=4 and l.leave_process_id=1 then l.leave_days else 0 end ) as  lop from employee_master e,employ_leave_dtl l,employ_firm f where e.emp_code=f.emp_code and e.emp_code=l.emp_code and l.leave_frdate>= '" & Request.QueryString("fdt") & "' and l.leave_todate<= '" & Request.QueryString("tdt") & "' and l.leave_process_id=1  and e.emp_code between " & Request.QueryString("lf") & " and " & Request.QueryString("lt") & " and e.emp_code>9999 and f.firm_id='" & fd & "' and e.shift_id not in (4,5) and e.emp_type=1 and e.status_id=1 group by e.emp_code,e.emp_name order by e.emp_code").Tables(0)
                End If
                If (Request.QueryString("a") = 2) Then
                    dt = oh.ExecuteDataSet("select e.emp_code,e.emp_name,sum(case when l.leave_id=1 and l.leave_process_id =1 then l.leave_days else 0 end) as cl,sum(case when l.leave_id=2 and l.leave_process_id =1 then l.leave_days else 0 end) as sl,sum(case when l.leave_id=3 and l.leave_process_id =1 then l.leave_days else 0 end) as el,sum(case when l.leave_id=4 and l.leave_process_id=1 then l.leave_days else 0 end ) as  lop from employee_master e,employ_leave_dtl l,employ_firm f where e.emp_code=f.emp_code and e.emp_code=l.emp_code and l.leave_frdate>= '" & Request.QueryString("fdt") & "' and l.leave_todate<= '" & Request.QueryString("tdt") & "' and l.leave_process_id=1  and e.emp_code between " & Request.QueryString("lf") & " and " & Request.QueryString("lt") & " and e.emp_code>9999 and f.firm_id='" & fd & "' and e.shift_id not in (4,5) and e.emp_type=2 and e.status_id=1 group by e.emp_code,e.emp_name order by e.emp_code").Tables(0)
                End If
                If (Request.QueryString("a") = 3) Then
                    dt = oh.ExecuteDataSet("select e.emp_code,e.emp_name,sum(case when l.leave_id=1 and l.leave_process_id =1 then l.leave_days else 0 end) as cl,sum(case when l.leave_id=2 and l.leave_process_id =1 then l.leave_days else 0 end) as sl,sum(case when l.leave_id=3 and l.leave_process_id =1 then l.leave_days else 0 end) as el,sum(case when l.leave_id=4 and l.leave_process_id=1 then l.leave_days else 0 end ) as  lop from employee_master e,employ_leave_dtl l,employ_firm f where e.emp_code=f.emp_code and e.emp_code=l.emp_code and l.leave_frdate>= '" & Request.QueryString("fdt") & "' and l.leave_todate<= '" & Request.QueryString("tdt") & "' and l.leave_process_id=1  and e.emp_code between " & Request.QueryString("lf") & " and " & Request.QueryString("lt") & " and e.emp_code>9999 and f.firm_id='" & fd & "' and e.shift_id not in (4,5) and e.status_id=1 group by e.emp_code,e.emp_name order by e.emp_code").Tables(0)
                End If
