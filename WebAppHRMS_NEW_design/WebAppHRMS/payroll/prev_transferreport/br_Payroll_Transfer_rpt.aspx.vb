...
Partial Class Payroll_Transfer_476aa3947609
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '    details = dtw.Rows(0)(0)
        'Else
        '    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "alert", "alert('No data found!'); window.location.href='br_select_traansfer.aspx';", True)
        '    Exit Sub ' Stops further execution if no data exists
        'End If
        ...
        td0.Text = "<font size=3 color=darkblue>Regd. Office : 'Manappuram House', V/104, valapad-680567 </font>"
        ...
        Dim Sql4 As String = ""
        If Session("firm_id") = 24 Then
            Sql4 = "select post_name,post_id from post_mst_jwell where post_id=" & dd(0) & ""
        Else
            Sql4 = "select post_name,post_id from post_mst where post_id=" & dd(0) & ""
        End If
        ...
        If dtls(8) <> String.Empty Then
            Dim Sql1 As String = ""
            If Session("firm_id") = 24 Then
                Sql1 = "select post_name from post_mst_jwell where post_id=" & dtls(8) & " "
            Else
                Sql1 = "select post_name from post_mst where post_id=" & dtls(8) & " "
            End If
        ...
        dt3 = oh.ExecuteDataSet(sql3).Tables(0)
        Dim Sql5 As String = ""
        Dim dtws As DataTable
        If Session("firm_id") = 24 Then
            dtw = oh.ExecuteDataSet("select bm.state_id from employee_master em,branch_master bm where bm.branch_id=em.branch_id and em.emp_code = " & dtls(1) & "").Tables(0)
            Sql5 = "select nvl(sum(t.value),0) from DA_INDEX_STATEWISE t where t.state = " & dtw.Rows(0)(0) & " and t.to_dt is null and t.firm_id=" & frID & ""
        Else
            Sql5 = "select value from da_index where to_dt is null and firm_id=" & frID & " "
        End If
        ...
        Else
            ...
            td491.ColumnSpan = 70
            td491.HorizontalAlign = HorizontalAlign.Left
            td491.Text = "<font size=3 color=darkblue>&nbsp-&nbsp Only one leave per month&nbsp  &nbsp&nbsp NA   </font>"
            tr171.Controls.Add(td491)
            tb.Controls.Add(tr171)
            ''---------------------------------------------------------------------------------------------
            ...
            td4914.Text = "<font size=3 color=darkblue>&nbsp-&nbsp&nbsp;&nbsp;&nbsp;&nbsp;  " & dt88.Rows(0)(0) & "&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp" & dt88.Rows(0)(1) & "&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbsp&nbsp&nbsp" & dt88.Rows(0)(2) & "&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp  &nbsp&nbsp&nbsp&nbsp&nbsp" & dt88.Rows(0)(3) & "   </font>"
            ...
            td4912.HorizontalAlign = HorizontalAlign.Left
            td4912.Text = "<font size=3 color=darkblue>&nbsp-&nbsp&nbsp&nbsp NA   </font>"
            tr1712.Controls.Add(td4912)
            tb.Controls.Add(tr1712)
            ''-------------------------------------------------------
        End If
        ...
        Dim Sql6 As String = ""
        If (Session("firm_id") = 24) Then
            Sql6 = "select post_name,post_id from post_mst_jwell where post_id=" & dd(0) & ""
        Else
            Sql6 = "select post_name,post_id from post_mst where post_id=" & dd(0) & ""
        End If
        ...
        If (dt1.Rows(0)(1) <= 18 Or dt1.Rows(0)(1) = 101) Then
            ...
            td89.Text = "<font size=3 color=darkblue>Regd. Office : 'Manappuram House', V/104, valapad-680567 </font>"
