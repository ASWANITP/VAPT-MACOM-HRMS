...
Partial Class Maben_Poromotion_promotion_display_report_mab_5c8bccad3625
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("firm_id") = 2 Then
            dt = oh.ExecuteDataSet("select t.from_dt,t.to_dt ,case when t.designation_id is null then '-----' else d.designation end as des,nvl(t.basic_pay,0),case when to_date(t.to_dt) is null then to_date(sysdate)-to_date(t.from_dt)+1 else (to_date(t.to_dt)-to_date(t.from_dt)+1) end  as days,decode(t.status_id,1,'JOINING',7,'PROMOTION',11,'INCREMENT',4,'SUSPENSION') as status,t.approve_remarks as Reason from employ_promotion_dtl t left outer join designation_master d on t.designation_id=d.designation_id where t.emp_code=" & Request.QueryString("emp") & " and  to_date(t.from_dt) between '" & Request.QueryString("f_dt") & "' and '" & Request.QueryString("t_dt") & "'  order by from_dt,status").Tables(0)
        End If
        Dim tb As New Table
        ...
        tc24.Text = "<font size=3><b>REASON FOR PROMOTION</b></font>"
        tr1.Cells.Add(tc24)
        tb.Controls.Add(tr1)
        ...
        For Each dr In dt.Rows
            ...
            tc25.Text = "<font size=3><b>" & dr(6) & "</b></font>"
            tr2.Cells.Add(tc25)
            tb.Controls.Add(tr2)
