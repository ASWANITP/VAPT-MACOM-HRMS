<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="Indiv_payment.aspx.vb" Inherits="WebAppHRMS.Individual_Indiv_payment_03fcc1784821" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1" style="width: 342px; height: 159px">
            <tr>
                <td colspan="3">
                    <strong>EMPLOYEE VERIFICATION</strong></td>
            </tr>
            <tr>
                <td colspan="3">
            ...
            <tr>
                <td style="width: 133px; text-align: left">EmpCode</td>
                <td colspan="2">
                    <input id="txt_eMPCODE" runat="server" type="text" readonly="readOnly" /></td>
            </tr>
            <tr>
                <td style="width: 133px; text-align: left">EmpName</td>
                <td colspan="2">
