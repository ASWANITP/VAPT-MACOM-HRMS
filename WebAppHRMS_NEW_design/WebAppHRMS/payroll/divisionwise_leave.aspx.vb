...
Partial Class leave_above_10_divisionwise_leave_e1b1fb957558
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ElseIf Me.Request.QueryString("status") = 1 Then
            ...
            Else
                str = "select c.division_id,c.DIV_NAME,count(a.emp_code) from employee_master a,branch_detail c,employ_firm f where a.status_id not in (3,5) and a.emp_type=1 and a.emp_code in (select emp_code from employ_leave_dtl where to_date(leave_frdate)>=to_date('1-jan-'||to_char(sysdate,'yyyy')) and leave_process_id in (1,2)having sum(leave_days)>=" & Me.Request.QueryString("leaveno") & " group by emp_code)and a.branch_id=c.BRANCH_ID and c.reg_id=" & Me.Request.QueryString("regionid") & " and a.emp_code=f.emp_code and f.firm_id=" & Session("firm_id") & " group by c.division_id,c.DIV_NAME"
