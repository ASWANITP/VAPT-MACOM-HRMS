...
Partial Class MANJEWEL_RESIG_CAN_Cancel_resign_p_0a80d2df2578
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        parameter(3).Value = Me.Txt_rea.Text
        ...
        If parameter(4).Value = 1 Then
            ...
            cl_script1.Append("window.open('cancel_resign_p.aspx','_self');")
            Exit Sub
        End If
