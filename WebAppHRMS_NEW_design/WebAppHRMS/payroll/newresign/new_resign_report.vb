...
Public Class new_resign_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.new_resign_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednew_resign_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As new_resign_report = New new_resign_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
