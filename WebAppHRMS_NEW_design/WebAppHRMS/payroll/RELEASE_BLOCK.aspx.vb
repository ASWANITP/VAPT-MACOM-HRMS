...
Partial Class RELEASE_BLOCK_7afc91a78273

    Inherits System.Web.UI.Page
    Implements System.Web.UI.ICallbackEventHandler

    Dim str, str1, res As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                dt = oh.ExecuteDataSet("select id ,block from block_master ").Tables(0)
                ...
                dt6 = oh.ExecuteDataSet("select -1,' -Select Employee- ' as emp_name from dual union all select cm.emp_code,cm.emp_code||'-'||cm.emp_name||'- ('||get_emp_block(a.block)||')' as dtl from employee_master cm,attend a where cm.status_id=1  and a.emp_code=cm.emp_code and to_date(a.curr_date)=to_date('" & Me.Txt_dt.Text & "') and cm.shift_id not in (4,5) and a.gun_status=" & Me.cmb_block.SelectedValue & " order by emp_name").Tables(0)
    ...
    Protected Sub Cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Cmd_confirm.Click
        ...
        param(0) = New OracleParameter("pdt", OracleType.DateTime)
        param(0).Direction = ParameterDirection.Input
        param(0).Value = CDate(Me.Txt_dt.Text)

        param(1) = New OracleParameter("emp", OracleType.VarChar, 5000)
        param(1).Direction = ParameterDirection.Input
        param(1).Value = Me.Hidden2.Value
        param(2) = New OracleParameter("bemp", OracleType.Number, 30)
        ...
        oh.ExecuteNonQuery("hrm_block_release", param)

        Dim cl_script0 As New System.Text.StringBuilder
        cl_script0.Append("         alert(' " & param(4).Value & " ');")
        cl_script0.Append("       window.open('RELEASE_BLOCK.aspx','_self');")
