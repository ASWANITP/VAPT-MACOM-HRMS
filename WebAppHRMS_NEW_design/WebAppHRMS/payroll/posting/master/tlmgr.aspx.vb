...
Partial Class salary_report_sal_wage_rpt_9fa947723072
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dt = oh.ExecuteDataSet("select t.eff_date from_dt, lead(t.eff_date-1) over(order by t.eff_date) to_date, to_number(t.change)code, em.emp_name name from master_tracer t left join employee_master em on em.emp_code=to_number(t.change) where t.component like '%TECHLEAD OR MANAGER%' and t.emp_code = " & s & " order by t.eff_date").Tables(0)
        If dt.Rows.Count < 0 Then
            If dt.Rows(0)(0) = 0 Then
                Dim cl_script As New StringBuilder
                cl_script.Append("   alert('TL/MANAGER NOT ASSIGNED') ;")
        ...
        tabc2.Text = "<body align=center color=red><b><font size=3.5> TL or MANAGER ASSIGNED TO EMPLOYEE " & s & "(" & dt1s.Rows(0)(0) & ") </font></b></body>"
        ...
        tabc3v2.Text = "<b><font size=3.5>TL/MANAGER CODE</font></b>"
        ...
        tabc4p.Text = "<b><font size=3.5>TL/MANAGER NAME</font></b>"
