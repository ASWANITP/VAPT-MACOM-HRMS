...
Partial Class Emp_Master_Data_date_wise_report_2bcaa7b19674
    Inherits System.Web.UI.Page
    Implements System.Web.UI.ICallbackEventHandler
    Dim dt, dt1, dt2 As New DataTable
    Dim first, second, third, fdt As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'End If
        fdt = Request.QueryString.Get("date")
        Dim scr As String
        ...
        Try
            ...
            Select Case (x)
                Case "1"
                    ...
                    'dt2 = oh.ExecuteDataSet(vysh(1)).Tables(0)
                    dt1 = oh.ExecuteDataSet("select t.* from mactech.TBL_HR_DAILY_MASTER_REPORT t where to_date(t.report_date) ='" & fdt & "' ").Tables(0)

                    Dim dr As DataRow
                    'first = "<section class='positioned'><div id='mydiv' class='container'><table border='1px'><thead><tr class='header'><th>Emp Code<div>Emp Code</div></th></tr></thead><tbody>"
                    For Each dr In dt1.Rows
                        ...
                        first = "<section class=""positioned""> <div id=""mydiv"" class=""container""> <table border=""1px""> <thead> <tr class=""header""> <th> Emp Code </th> <th> Name </th> <th> Father Name </th> <th> House Name </th> <th> Post Office </th> <th> District </th> <th> State </th> <th> Pincode </th> <th> Landmark </th> <th> DOB </th> <th> DOJ </th> <th> Age </th> <th> Gender </th> <th> Marital Status </th> <th> Blood Group </th> <th> Designation </th> <th> Designation Category </th> <th> Category Code </th> <th> Post Name </th> <th> Department </th> <th> Qualification </th> <th> Department Head </th> <th> First Line Manager </th> <th> Second Line Manager </th> <th> Category </th> <th> Emp Mail </th> <th> Official Mail </th> <th> Contact No. </th> <th> Resident Phone No. </th> <th> Basic Pay </th> <th> VDA </th> <th> Allowance Total </th> <th> Gross Salary </th> <th> Bonus/Exgratia </th> <th> Employer PF </th> <th> Employer ESI </th> <th> Total CTC </th> <th> Other Experience </th> <th> Experience In Macom </th> <th> Total Experience </th> <th> Bank Account No. </th> <th> Bank Name </th> <th> IFSC </th> <th> ESI No. </th> <th> UAN No. </th> <th> Level </th> <th> Position Category </th> <th> ID Proof No. </th> <th> ID Name </th> <th> Pan No. </th> <th> Date Of Resignation Submitted </th> <th> Exit Or Proposed Exit Date </th> <th> Reason For Resignation </th> <th> Special Benefit </th> <th> Skill </th> <th> Other Firm Employee code </th> <th> Increment Date </th> <th> Last Promotion Date </th> <th> Place Of Seating </th> <th> Other Firm DOJ </th> <th> Source </th> <th> Current Job Role Start Date </th> <th> Status </th> </tr> </thead> <tbody>"
                        second += "<tr><td>" & code & "</td><td>" & name & "</td><td>" & fathname & "</td><td>" & hname & "</td><td>" & pofice & "</td><td>" & distr & "</td><td>" & state & "</td><td>" & pin & "</td><td>" & lm & "</td><td>" & dob & "</td><td>" & doj & "</td><td>" & age & "</td><td>" & gen & "</td><td>" & mar & "</td><td>" & bg & "</td><td>" & des & "</td><td>" & descat & "</td><td>" & catcode & "</td><td>" & post & "</td><td>" & dep & "</td><td>" & qual & "</td><td>" & dephd & "</td><td><a href='javascript:passpage2(" & code & ")'>" & tlmgr & "</a></td><td>" & tlmgr2 & "</td><td>" & cate & "</td><td>" & email & "</td><td>" & offmail & "</td><td>" & contno & "</td><td>" & res & "</td><td>" & bpay & "</td><td>" & vda & "</td><td><a href='javascript:passpage1(" & code & ")'>" & tatot & "</a></td><td>" & gross & "</td><td>" & bonex & "</td><td>" & epf & "</td><td>" & eesi & "</td><td>" & ctc & "</td><td>" & aexp & "</td><td>" & expm & "</td><td>" & texp & "</td><td>" & bnkacno & "</td><td>" & bnkname & "</td><td>" & ifsc & "</td><td>" & esino & "</td><td>" & uanno & "</td><td>" & level & "</td><td>" & poscat & "</td><td>" & idprof & "</td><td>" & idname & "</td><td>" & pan & "</td><td>" & drs & "</td><td>" & epexit & "</td><td>" & resreas & "</td><td>" & ctcadj & "</td>      <td>" & skil & "</td><td>" & ofe & "</td><td>" & incr & "</td> <td>" & promo & "</td> <td>" & pfs & "</td><td>" & ofdoj & "</td><td>" & source & "</td> <td>" & crrntstartdte & "</td>  <td>" & stat & "</td><td><a href='javascript:passpage(" & code & "," & pin & ")' class='animated-button1'><span/><span/><span/><span/> </a></td></tr>"
