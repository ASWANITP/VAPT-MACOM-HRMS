    ...
    <div style="text-align: center">
        <table>
            <tr>
                <td style="width: 25px; height: 1192px;">
                    <table border="1" style="text-align: center; background-color: transparent;">
                        ...
                        <tr>
                            <td colspan="4" style="text-align: center; height: 28px; background-color: moccasin; width: 1180px;">&nbsp;
                                <asp:Label ID="Label20" runat="server" Font-Bold="True" Text="BASIC DETAILS" BackColor="Transparent" Style="border-bottom: #ff9933 thin dotted" ForeColor="DimGray"></asp:Label>
                            </td>
                        </tr>
                        <tr>
          ...
          Post Office
                                            ...
                                            <td style="width: 110px; text-align: left; height: 118px;">Pincode </td>
                                            <td style="height: 118px">
          ...
          Land mark 
                                            ...
                                            <td style="width: 110px; text-align: left; height: 44px;">State
                                            </td>
          ...
          state
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align: center; height: 38px; background-color: moccasin; width: 1180px;">&nbsp;
                                                <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="PERSONAL DETAILS" BackColor="Transparent" Style="border-bottom: #ff9933 thin dotted" ForeColor="DimGray"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
          ...
          Pan No.&nbsp;
                                            ...
                                            <td style="width: 110px; text-align: left; height: 101px;">Contact No </td>
                                            <td style="height: 101px">
          ...
          Blood Group 
                                            ...
                                            <td style="width: 110px; height: 39px; text-align: left">ID Proof No. </td>
                                            <td style="height: 39px">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 146px; text-align: left; height: 48px;">
                                                <asp:TextBox ID="textepmail" runat="server" Width="245px" ReadOnly="True" onblur="return chkemail(this.id);" MaxLength="25" onchange="emailValidate(this.value)"></asp:TextBox>
                                            </td>
           ...
           ID Proof No.  
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align: center; height: 28px; background-color: moccasin; width: 1180px;">&nbsp;
                                                <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="EMPLOYMENT DETAILS" BackColor="Transparent" Style="border-bottom: #ff9933 thin dotted" ForeColor="DimGray"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <TD style="WIDTH: 87px; TEXT-ALIGN: left">
              ...
              <asp:DropDownList ID="Dropdh" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dropdh_SelectedIndexChanged" TabIndex="26" Width="181px" Font-Names="Verdana"></asp:DropDownList>
                                            ...
                                            <td style="text-align: left; height: 80px;">
                                                <asp:TextBox ID="textoffmail" runat="server" Width="245px" ReadOnly="True" MaxLength="30" onblur="return chkemail(this.id);" onchange="emailValidate(this.value)"></asp:TextBox>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 109px; text-align: left; height: 59px;">Status</td>
                                            ...
                                            <td style="width: 119px; text-align: left; height: 59px;">Second Line Manager</td>
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align: center; height: 76px; background-color: moccasin; width: 1180px;">&nbsp;
                                                <asp:Label ID="Label5" runat="server" Font-Bold="True" Text="SALARY DETAILS" BackColor="Transparent" Style="border-bottom: #ff9933 thin dotted" ForeColor="DimGray"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 110px; text-align: left; height: 28px;">
         ...
         Medical Reimbursement 
          ...
          Employer PF
           ...
           Bank Name   
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align: center; height: 19px; background-color: moccasin; width: 1180px;">&nbsp;
                                                <asp:Label ID="Label4" runat="server" Font-Bold="True" Text="BANK DETAILS" BackColor="Transparent" Style="border-bottom: #ff9933 thin dotted" ForeColor="DimGray"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <%--
          ...
          Date Of Resignation Submitted 
                                            ...
                                            <td style="width: 109px; height: 51px; text-align: left">
                                            *Bank Account no
         ...
         position category
                                            ...
                                            <td style="width: 110px; height: 51px; text-align: left">*IFSC </td>
                                            <td style="width: 173px; height: 51px;">
                        ...
                        Display="Dynamic" ErrorMessage="CHECK IFSC CODE" SetFocusOnError="True" ValidationExpression="^[0-9a-zA-Z;/?'*@-]*"></asp:RegularExpressionValidator>--%>
                                        ...
                                        <tr>
                                            <td colspan="9" style="text-align: center; height: 10px; background-color: moccasin; width: 1180px;">&nbsp;
                                                <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="RESIGNATION DETAILS" BackColor="Transparent" Style="border-bottom: #ff9933 thin dotted" ForeColor="DimGray"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="16" style="text-align: center; height: 28px; background-color: moccasin; width: 1180px;">&nbsp;
                                                <asp:Label ID="Label8" runat="server" Font-Bold="True" Text="ANOTHER DETAILS" BackColor="Transparent" Style="border-bottom: #ff9933 thin dotted" ForeColor="DimGray"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            &nbsp;<td style="width: 109px; height: 72px; text-align: left">
                                            Doj of Previous Group Company 
                                            <td style="width: 173px; height: 72px;">
