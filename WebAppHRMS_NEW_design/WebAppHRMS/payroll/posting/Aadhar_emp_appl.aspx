...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <table id="tab_01" border="1" style="width: 80%" align="center">
        <tr>
            ...
            <td colspan="4" style="height: 27px; text-align: left">&nbsp;&nbsp;
                <input id="Rado_ad" runat="server" name="aaa" type="radio" style="color: #ff0066" onclick="return adhar()" /><span
                    style="color: #ff0066"> <span style="font-size: 14pt">Aadhar Application</span></span></td>
        ...
        <tr id="Tr1">
            <td colspan="1" style="height: 10px; text-align: left; width: 233px;">Enter Aadhar No :</td>
        ...
        <tr>
            <td colspan="1" style="text-align: left; height: 28px; width: 233px;">Name  <span style="color: #000000"></span><span style="color: #ff0000"></span><span style="color: #ff0000"><span style="color: #000000"></span><span
        ...
        <tr id="Tr2">
            <td colspan="1" style="height: 10px; text-align: right; width: 233px;"></td>
        ...
        <tr>
            <td style="width: 233px">Contact No :</td>
            <td style="width: 311px">
        ...
        <tr>
            <td style="width: 233px; height: 27px;">Email ID:
            </td>
        ...
        <tr>
            <td style="width: 233px">Father/Husband&nbsp;Name :
            </td>
            <td style="width: 311px">
            ...
            <td colspan="4" style="text-align: center; height: 198px;">
                <div style="text-align: center">
                    <table style="width: 840px; height: 386px;" border="1">
                        <tr>
                            <td style="width: 122px; text-align: left">Gender : &nbsp;</td>
                            ...
                            <td style="width: 100px; text-align: left">
                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" TabIndex="16"
                        ...
                        <tr id="row3" runat="server">
                            <td style="width: 122px; text-align: left">Spouse :
                            </td>
                            <td style="width: 190px; text-align: left">
                        ...
                        <tr>
                            <td style="width: 122px; text-align: left; height: 16px;">Date&nbsp;of&nbsp;Birth&nbsp;<span style="color: #ff0033">*</span>&nbsp;:&nbsp;</td>
                        ...
                        <tr>
                            <td style="width: 122px; text-align: left;">Religion :&nbsp;</td>
                            <td style="width: 190px; text-align: left;">
                        ...
                        <tr>
                            <td style="width: 122px; text-align: left;">ID Proof&nbsp; :&nbsp;
                            </td>
                            <td style="width: 190px; text-align: left;">
                        ...
                        <tr>
                            <td style="width: 122px; text-align: left">Blood Group :&nbsp;
                            </td>
                            <td style="width: 190px; text-align: left">
