<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" EnableEventValidation="false" CodeBehind="emp_appln1.aspx.vb" Inherits="WebAppHRMS.payroll_posting_emp_appln1_77b999516175" Title="Untitled Page" %>
...
if  (document.getElementById("Checkbox3").checked==true)
{
 ...
 document.getElementById(cont[0]+"cmb_perm_district").options.length = 0;
                    document.getElementById(cont[0]+"cmb_perm_post").options.length=0;
                    document.getElementById(cont[0]+"cmb_perm_state").options.length=0;
...
if  (document.getElementById("Checkbox4").checked==true)
{
                    ...
                    document.getElementById(cont[0]+"cmb_pres_state").options.length=0;
                    document.getElementById(cont[0]+"cmb_pres_district").options.length=0;
                    document.getElementById(cont[0]+"cmb_pres_post").options.length=0;
...
// ]]>
    ...
    <table border="1" style="width: 806px;" align="center">
        <tr>
        ...
        <tr id="row6" style="display: none">
            ...
            <td colspan="2" style="height: 10px; text-align: left">
                <input id="txt_Appln_no" maxlength="10" style="width: 162px" type="text" onchange="return filleditdata()" runat="server" /></td>
        </tr>
        <tr>
            ...
            <td colspan="2" style="text-align: left; height: 28px;">
                <input id="txt_name" runat="server" maxlength="75" style="width: 319px" type="text" onkeyup="return string1('txt_name')" /></td>
        </tr>
        <tr>
            <td colspan="2" style="height: 164px; text-align: right">
                <span style="color: #000099"><strong>Select State,District &amp; Post.</strong></span></td>
            <td colspan="2" style="height: 164px; text-align: left">
                <table border="1" style="width: 330px; height: 208px;">
                    <tr>
                        <td colspan="5" style="text-align: center">
                            <strong><span style="color: #cc3300">Permanant/Present selection</span></strong></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 209px; height: 13px; text-align: left">
                            <strong><span style="color: #ff0000">Select category</span></strong></td>
                        <td colspan="3" style="width: 292px; height: 13px">&nbsp;
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="width: 292px; height: 13px">
                            <asp:TextBox ID="txt_Perm_hs_select" runat="server" Height="24px" MaxLength="50"
                                onkeyup="string1('txt_Perm_hs_select')" TabIndex="2" Width="216px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 209px; text-align: left">
                            <asp:Label ID="Label3" runat="server" Text="state :" Width="64px"></asp:Label></td>
                        <td colspan="3" style="width: 292px; text-align: left">
                            <asp:DropDownList ID="cmb_state_select" runat="server" onchange="return perm_state_change()"
                                TabIndex="3" Width="224px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 209px; text-align: left">
                        ...
                        <td colspan="3" style="width: 292px; text-align: left">
                            <asp:DropDownList ID="cmb_dist_select" runat="server" onchange="return perm_district_change()"
                                TabIndex="4" Width="224px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 209px; height: 12px; text-align: left">
                        ...
                        <td colspan="3" style="width: 292px; height: 12px; text-align: left">
                            <asp:DropDownList ID="cmb_post_select" runat="server" onchange="return perm_post_change()"
                                TabIndex="5" Width="224px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 209px; height: 12px; text-align: left">
                        ...
                        <td colspan="3" style="width: 292px; height: 12px; text-align: left">
                            <asp:TextBox ID="Txt_pin_select" runat="server" ReadOnly="True" Width="216px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 209px; height: 24px; text-align: left"></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="width: 292px; height: 27px">
                            <asp:TextBox ID="txt_Perm_hs_name" runat="server" Height="24px" MaxLength="50"
                                TabIndex="2" Width="193px"></asp:TextBox></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="width: 289px; text-align: left">
                            <asp:TextBox ID="txt_Pres_hs_name" runat="server" Height="28px" MaxLength="50" onkeyup="string1('txt_Pres_hs_name')"
                                TabIndex="7" Width="197px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td style="width: 101px; text-align: left">
            ...
            <td colspan="4" style="text-align: center; height: 198px;">
                <div style="text-align: center">
                    <table style="width: 802px" border="1">
                        <tr>
                            <td style="width: 139px; text-align: left">Gender : &nbsp;</td>
                        ...
                        <tr>
                            <td style="width: 139px; text-align: left; height: 16px;">Date&nbsp;of&nbsp;Birth&nbsp;<span style="color: #ff0033">*</span>&nbsp;:&nbsp;</td>
                            <td style="width: 95px; height: 16px; text-align: left;">
                                <asp:TextBox ID="txt_dob" runat="server" onkeypress="return check_null()"
                                    Onchange="txt_dob_TextChanged()" TabIndex="21" Width="173px"></asp:TextBox></td>
                            <td style="width: 98px; height: 16px; text-align: left;">Age :&nbsp;</td>
                            <td style="width: 100px; height: 16px; text-align: left;">
                                <asp:TextBox ID="txt_age" runat="server" ReadOnly="True" Width="65px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 139px; text-align: left;">Religion :&nbsp;</td>
                            <td style="width: 95px; text-align: left;">
                                <asp:DropDownList ID="cmb_religion" runat="server" TabIndex="22" Width="181px">
                                </asp:DropDownList></td>
                            ...
                            <td style="width: 100px; text-align: left;">
                                <asp:TextBox ID="txt_caste" runat="server" MaxLength="15" onkeyup="string1('txt_caste')"
                                    TabIndex="23" Width="268px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 139px; text-align: left;">ID Proof&nbsp; :&nbsp;
                            </td>
                            <td style="width: 95px; text-align: left;">
                            ...
                            <td style="width: 100px; text-align: left;">
                                <asp:TextBox ID="txt_idno" runat="server" MaxLength="25" onkeyup="string1('txt_idno')"
                                    TabIndex="25" Width="269px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 139px; text-align: left">Blood Group :&nbsp;
                            </td>
                            <td style="width: 95px; text-align: left">
                                <asp:DropDownList ID="cmb_bloodgp" runat="server" TabIndex="26" Width="181px">
                                </asp:DropDownList></td>
                            <td style="width: 98px; text-align: left">SSLC No :
                            </td>
                            <td style="width: 100px; text-align: left">
                                <asp:TextBox ID="txt_sslc" runat="server" AutoCompleteType="Disabled" MaxLength="40"
                                    onkeyup="string1('txt_sslc')" TabIndex="19" Width="173px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 139px; text-align: left;"></td>
                        ...
                        <tr id="row2" style="display: none">
                            <td colspan="2" style="text-align: left">If Other Specify :</td>
                            <td colspan="2" style="text-align: left">
        ...
        <tr>
            <td colspan="4" style="text-align: center">
                <table>
                    <tr>
                        <td style="width: 100px">
                            <asp:Button ID="cmd_confirm" runat="server" Text="ADD" Width="68px" OnClientClick="return checkbeforeconfirm()" /></td>
                        <td style="width: 100px">
                            <asp:Button ID="cmd_edit" runat="server" Text="EDIT" Width="74px" /></td>
                        <td style="width: 100px">
                            <input id="Button1" style="width: 69px" type="button"
