<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" EnableEventValidation="false" CodeBehind="emp_enrollment.aspx.vb" Inherits="WebAppHRMS.payroll_posting_emp_enrollment_771140627393" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateNumber(a, b) {//debugger; 
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 642px; height: 264px">
            <tr>
                ...
                <td colspan="3" style="text-align: left">
                    <input id="txt_applnno" onkeyup="correct('txt_applnno')" style="width: 241px" onchange="return fillname()  " type="text" runat="server" maxlength="8" />&nbsp;
                &nbsp;&nbsp;
                </td>
            </tr>
            <tr>
                <td colspan="3" style="height: 23px; text-align: right">Name</td>
            ...
            <tr>
                ...
                <td style="text-align: left" colspan="2">
                    <input id="txt_period" onkeypress="ValidateNumber('txt_period',2)" style="width: 250px" type="text" runat="server" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 154px; text-align: left">Pay :
                </td>
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_pay" runat="server" onchange="basicfill()" Width="250px">
                    </asp:DropDownList></td>
                <td style="width: 5762px; text-align: left">Basic&nbsp;Pay :</td>
                <td style="text-align: left" colspan="2">
                    <asp:DropDownList ID="cmb_basic" runat="server" onchange="totfill()" Width="250px">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 154px; height: 10px; text-align: left">Variable&nbsp;DA :
                </td>
                ...
                <td style="width: 5762px; height: 10px; text-align: left">Total&nbsp;Salary :</td>
                <td style="height: 10px; text-align: left" colspan="2">
                    <input id="txt_total" style="width: 250px; background-color: #efffff;" type="text" readonly="readOnly" /></td>
            </tr>
            <tr>
                <td style="width: 154px; height: 5px; text-align: left">ESI :</td>
                ...
                <td style="width: 5762px; height: 5px; text-align: left">Provident&nbsp;Fund :</td>
            ...
            <tr>
                <td style="width: 154px; text-align: left">Medical Claim :</td>
                ...
                <td style="width: 5762px; text-align: left">Rtd Professionals :&nbsp;
                </td>
                <td colspan="2" style="text-align: left">
                    <input id="chk_retired" runat="server" type="checkbox" />Yes</td>
            </tr>
            <tr>
                <td style="width: 154px; text-align: left">Security Deposit :</td>
                <td style="width: 3625px; text-align: left">
            ...
            <tr id="row1">
                <td style="width: 154px; text-align: left">Security&nbsp;Deposit :
                </td>
                <td colspan="2" style="text-align: left">
                    <input id="txt_sec" runat="server" onkeypress="ValidateNumber('txt_sec',5)" style="width: 250px" type="text" /></td>
                <td style="width: 5762px; text-align: left">Deposit Amount :
                </td>
                <td style="text-align: left" colspan="2">
                    <input id="txt_dep" onkeypress="ValidateNumber('txt_dep',5)" runat="server" style="width: 250px" type="text" /></td>
            </tr>
            <tr id="row2">
                <td style="width: 154px; text-align: left">No.Of&nbsp;Installments :
                </td>
                <td colspan="2" style="text-align: left">
                    <input id="txt_installments" runat="server" onkeypress="ValidateNumber('txt_installments',2)" style="width: 250px; height: 16px" type="text" /></td>
                <td style="width: 5762px; text-align: left">Installment&nbsp;Amount :</td>
                <td style="text-align: left" colspan="2">
                    <input id="txt_installment_amount" onkeypress="ValidateNumber('txt_installment_amount',4)" runat="server" style="width: 250px" type="text" /></td>
            </tr>
            <tr>
                <td style="width: 154px; text-align: left">Bond :
                </td>
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="cmb_bond" onclick="showbondrow()" runat="server" Width="250px">
            ...
            <tr id="row3" style="display: none">
                <td style="width: 154px; text-align: left; height: 3px;">Bond&nbsp;Amount :
                </td>
                ...
                <td style="width: 5762px; text-align: left; height: 3px;">Bond Period :</td>
                <td style="text-align: left; height: 3px;" colspan="2">&nbsp;<asp:TextBox ID="txt_bond_period" runat="server"></asp:TextBox>&nbsp;
                </td>
            </tr>
        ...
        <input id="hid_mediflag" runat="server" checked="checked" style="width: 11px" type="hidden" /><br />
        <input id="hid_esi" checked="checked" runat="server" style="width: 11px" type="hidden" />
