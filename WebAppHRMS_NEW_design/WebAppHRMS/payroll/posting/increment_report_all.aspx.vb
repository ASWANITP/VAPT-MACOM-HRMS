...
Partial Class payroll_Posting_increment_report_e1522ac71324
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        tr18d.Font.Size = 8
        tr18d.Attributes.Add("width", "50%")
        tc18d.ColumnSpan = 3
        tc18d.HorizontalAlign = HorizontalAlign.Left
        tc18d.Text = "<font size=2 color=darkblue>Remark&nbsp;</font>"
        tr18d.Controls.Add(tc18d)

        Dim tc18e As New TableCell
        tc18e.Attributes.Add("width", "50%")
        tc18e.ColumnSpan = 1
        tc18e.HorizontalAlign = HorizontalAlign.Center
        tc18e.Text = "<font size=2 color=darkblue>-</font>"
        tr18d.Controls.Add(tc15e)

        Dim tc18f As New TableCell
        tc18f.Attributes.Add("width", "50%")
        tc18f.ColumnSpan = 7
        tc18f.HorizontalAlign = HorizontalAlign.Left
        tc18f.Text = "<font size=2 color=darkblue> " & Request.QueryString("remark") & " </font>"
        tr18d.Controls.Add(tc18f)
