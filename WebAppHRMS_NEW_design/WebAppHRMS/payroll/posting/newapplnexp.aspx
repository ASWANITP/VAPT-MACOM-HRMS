...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <asp:UpdatePanel ID="upnl_qual" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table align="center" style="width: 532px" border="1">
                <tr>
                    <td style="width: 100px; text-align: center">Qualification</td>
                    <td style="width: 100px; text-align: center">Institution</td>
                    <td style="width: 100px; text-align: center">University</td>
                    <td style="width: 100px; text-align: center">Percentage</td>
                    <td style="width: 100px; text-align: center">Year of Passing</td>
                </tr>
                <tr>
        ...
        <tr>
            <td colspan="5" style="text-align: center">&nbsp;<asp:UpdatePanel ID="upnl_exp" runat="server">
                <ContentTemplate>
                    <table align="center" style="width: 788px" border="1">
                        <tr>
                            <td style="width: 233px; height: 28px; text-align: left">Name of Organization</td>
                    ...
                    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy" TargetControlID="txt_expfrom"></cc1:CalendarExtender>
                    <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy" TargetControlID="txt_expto"></cc1:CalendarExtender>
                </ContentTemplate>
            </asp:UpdatePanel>
                &nbsp;&nbsp;
            </td>
