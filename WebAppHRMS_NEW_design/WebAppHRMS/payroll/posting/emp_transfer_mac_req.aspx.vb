...
Public Class emp_transfer_mac_req
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        Else
            ...
            If (Me.txt_tfrjoiningdate.Text = "" Or Me.txt_releivingdate.Text = "" Or Me.txt_reportingdate.Text = "") Then
                ...
                Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "client script", msgbx1.ToString, True)
            Else
                'Dim' sql As String = "select count(*) from employ_transfer_dtl_temp where emp_code='" & Me.cmb_select.Text & "' and to_dt is null and status_id<>1 and enter_dt=to_date(sysdate) and branch_id='" & Me.cmb_newbranch.SelectedValue & "'"
                Dim sql As String = "select count(*) from employ_transfer_dtl_temp where emp_code='" & Me.cmb_select.Text & "' and status=0 and to_dt is null and enter_dt=to_date(sysdate) and branch_id='" & Me.cmb_newbranch.SelectedValue & "'"
                ...
                Else
                    ...
                    Else
                        ...
                        Else
                            ...
                            cl_script1.Append("  alert('TRANSFER REQUESTED SUCCESSFULLY!!!!');")
                            ...
                            cl_script1.Append("window.open('emp_transfer_mac_req.aspx','_self');")
    ...
    Protected Sub txt_releivingdate_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_releivingdate.TextChanged
        ...
        Else
            ...
            dt22 = oh.ExecuteDataSet("select to_date(from_dt) from employ_transfer_dtl_temp where to_dt is null and emp_code=" & Me.cmb_select.Text & " and status_id<>1").Tables(0)
    ...
    Protected Sub txt_reportingdate_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        rpdt = Me.txt_reportingdate.Text
        If Me.txt_releivingdate.Text <> "" Then
            jdt = CDate(Me.txt_releivingdate.Text)
        End If
    ...
    Protected Sub cmd_vewrepo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_vewrepo.Click
        ...
        Else
            ...
            Else
                'Dim sql As String = "select count(*) from employ_transfer_dtl_temp where emp_code='" & Me.cmb_select.Text & "' and status_id<>1 and to_dt is null and enter_dt=to_date(sysdate) and branch_id='" & Me.cmb_newbranch.SelectedValue & "'"
                Dim sql As String = "select count(*) from employ_transfer_dtl_temp where emp_code='" & Me.cmb_select.Text & "' and status_id<>1  and enter_dt=to_date(sysdate) and branch_id='" & Me.cmb_newbranch.SelectedValue & "'"
                dt2 = oh.ExecuteDataSet(sql).Tables(0)
                If (dt2.Rows(0)(0) = 1) Then
                    Me.lbl_msg.Text = " This Employee is already Transfered today!"
                    clr()
