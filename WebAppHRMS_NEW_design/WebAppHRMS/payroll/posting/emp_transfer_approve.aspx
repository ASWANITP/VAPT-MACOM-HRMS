<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/edp.Master" CodeBehind="emp_transfer_approve.aspx.vb" Inherits="WebAppHRMS.emp_transfer_approve" %>
                        ...
                        <tr>
                            <td colspan="4" style="height: 13px; text-align: center; background-color: #ffe654;">
                                <table border="1" style="width: 807px; border-left-color: #ffffff; border-bottom-color: #ffffff; border-top-style: dotted; border-top-color: #ffffff; border-right-style: dotted; border-left-style: dotted; border-right-color: #ffffff; border-bottom-style: dotted;">
                                    ...
                                    <asp:DropDownList ID="cmb_select" runat="server" MaxLength="6" Width="331px" AutoPostBack="True">
                                 </asp:DropDownList></td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <table style="border-left-color: #ffcc33; border-bottom-color: #ffcc33; border-top-style: ridge; border-top-color: #ffcc33; border-right-style: ridge; border-left-style: ridge; text-align: center; border-right-color: #ffcc33; border-bottom-style: ridge" border="1">
                                        <tbody>
                                            <tr>
                                                ...
                                                <asp:TextBox ID="cmb_newbranch" runat="server" Width="317px" AutoPostBack="True" ReadOnly="True"></asp:TextBox></td>
                                                ...
                                                <td style="width: 104px; height: 13px; text-align: left">
                                                    <asp:TextBox ID="cmb_newdept" runat="server" Width="317px" AutoPostBack="True" ReadOnly="True"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 85px; height: 18px" text-align: left">
                                                   <asp:TextBox ID="cmb_newpost" runat="server" Width="317px" AutoPostBack="True" ReadOnly="True"></asp:TextBox></td>
                                                ...
                                                <td style="width: 104px; height: 18px; text-align: left">
                                                    <asp:TextBox ID="txt_releivingdate"  runat="server" Width="155px" AutoPostBack="True" ReadOnly="True"></asp:TextBox>&nbsp; </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 85px; height: 14px; text-align: left">
                                                    <asp:TextBox ID="txt_tfrjoiningdate"  runat="server" Width="143px" AutoPostBack="True" ReadOnly="True"></asp:TextBox>&nbsp; </td>
                                                ...
                                                <td style="width: 104px; height: 14px; text-align: left">
                                                    <asp:TextBox ID="txt_reportingdate" runat="server" Width="156px" AutoPostBack="True" ReadOnly="True" ></asp:TextBox>&nbsp; </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="height: 23px; text-align: left" colspan="3">
                                                   <asp:TextBox ID="cmb_report_person" runat="server" Width="516px" AutoPostBack="True" ReadOnly="True"  BackColor="LemonChiffon" ForeColor="Black" Font-Bold="True"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="width: 65px; height: 24px; text-align: left">
                                                                                                        <asp:TextBox ID="cmb_cat" runat="server" Width="226px" AutoPostBack="True" ReadOnly="True"></asp:TextBox></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
                                                                                    ...
                                                                                    <td style="width: 100px; height: 24px; text-align: left">
                                                                                        <asp:TextBox ID="cmb_hostel" runat="server" Width="346px" AutoPostBack="True" ReadOnly="True"></asp:TextBox></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="height: 9px; text-align: left" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; State&nbsp;&nbsp;
                                                                                    <asp:TextBox ID="cmb_state" runat="server" Width="214px" AutoPostBack="True" ReadOnly="True"></asp:TextBox></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="height: 19px; text-align: left" colspan="2">
                                                    <asp:TextBox ID="Txt_dis" ReadOnly="True" runat="server" MaxLength="5"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                ...
                                <table style="width: 690px">
                                    <tr>
                                        ...
                                        <td style="width: 100px; height: 19px;">
                                            <asp:Button ID="cmd_confirm" runat="server" Text="APPROVE" Width="112px" BackColor="SeaShell" BorderColor="#FFC0C0" Font-Bold="True" Height="31px" BorderStyle="Dashed" /></td>
                                        <td style="width: 24px; height: 19px;"></td>
                                        <%--<td style="width: 65px; height: 19px;"></td>--%>
                                 <td style="width: 100px; height: 19px;">
                                            <asp:Button ID="cmd_reject" runat="server" Text="REJECT" Width="112px" BackColor="SeaShell" BorderColor="#FFC0C0" Font-Bold="True" Height="31px" BorderStyle="Dashed" /></td>
                                <td style="width: 24px; height: 19px;"></td>
                                        <td style="width: 100px; height: 19px;">
