...
Partial Class Appointment_Order_appointmentorder_e89e90662913
    ...
    Protected Sub cmd_appletter_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_appletter.Click
        dts1 = oh.ExecuteDataSet("select query from hrm_report_master where firm_id=99 and query_id=104").Tables(0)
        Dim str() As String = dts1.Rows(0)(0).ToString.Split("#")
        Dim _filename As String = ("FORM BB-" + Me.cmb_code.SelectedValue + ".doc")
        ...
        If dts2.Rows.Count > 0 Then
            ...
            htmlRaw = htmlRaw.Replace("myfathus", dts2.Rows(0)(1))
            htmlRaw = htmlRaw.Replace("myage", dts2.Rows(0)(2))
            htmlRaw = htmlRaw.Replace("Myaddress1", dts2.Rows(0)(3))
            htmlRaw = htmlRaw.Replace("Myaddress2", dts2.Rows(0)(4))
            htmlRaw = htmlRaw.Replace("Myaddress3", dts2.Rows(0)(5))
            htmlRaw = htmlRaw.Replace("Myaddress4", dts2.Rows(0)(6))
            htmlRaw = htmlRaw.Replace("mygen", dts2.Rows(0)(7))
            htmlRaw = htmlRaw.Replace("myserv", dts2.Rows(0)(8))
            htmlRaw = htmlRaw.Replace("mycat", dts2.Rows(0)(9))
            htmlRaw = htmlRaw.Replace("mypay", dts2.Rows(0)(10))
            htmlRaw = htmlRaw.Replace("myda", dts2.Rows(0)(11))
            htmlRaw = htmlRaw.Replace("myemo", dts2.Rows(0)(12))
            htmlRaw = htmlRaw.Replace("myret", dts2.Rows(0)(13))
