<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="employ_enrollmant.aspx.vb" Inherits="WebAppHRMS.payroll_Posting_employ_enrollmant_e5781d5f3864" title="Untitled Page" %>
...
<asp:ListItem Value="4">PART TIME</asp:ListItem>
                                        ...
                                        <asp:ListItem Value="T">Yes</asp:ListItem>
                                        <asp:ListItem Value="F">No</asp:ListItem>
                                    </asp:RadioButtonList></TD><TD style="WIDTH: 100px">Designation</TD><TD style="WIDTH: 100px"><asp:DropDownList id="cmb_desigation" runat="server" Width="264px"></asp:DropDownList></TD></TR><TR><TD style="WIDTH: 150px">Retired Professionals</TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"><asp:RadioButtonList id="rd_retired" runat="server" Width="144px" RepeatDirection="Horizontal" __designer:wfdid="w2"><asp:ListItem Value="1">Yes</asp:ListItem>
<asp:ListItem Selected="True" Value="0">No</asp:ListItem>
                                    ...
                                    </asp:DropDownList></TD></TR><TR><TD style="TEXT-ALIGN: center" colSpan=4><asp:Panel id="pnl_bond" runat="server" Width="125px" Height="50px">
