...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 80%">
            <tr>
                <td style="width: 21%; text-align: left">Application Number</td>
                ...
                <td style="width: 18%; text-align: left">Applicants Name</td>
            ...
            <tr>
                <td style="width: 20%; height: 9px; text-align: left;">Enter Year Of Passing</td>
                ...
                <td style="width: 20%; height: 9px; text-align: left;">Enter Percentage Of Mark</td>
            ...
            <tr>
                <td style="text-align: left;" colspan="2">Name of Organization</td>
                <td style="text-align: left;" colspan="2">
            ...
            <tr>
                <td style="width: 21%; height: 23px; text-align: left">Period From Date</td>
                ...
                <td style="width: 18%; height: 23px; text-align: left">Period To Date</td>
            ...
            <tr>
                <td style="width: 21%; text-align: left">Nature Of Duty</td>
            ...
            <tr>
                ...
                <td style="width: 18%; text-align: left">Contact No.</td>
                <td style="width: 22%; text-align: left">
