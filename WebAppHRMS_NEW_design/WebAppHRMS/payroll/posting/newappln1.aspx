...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <table align="center" border="1" style="width: 674px; height: 831px">
        ...
        <tr>
            <td style="width: 1048px; height: 793px; text-align: center">&nbsp;<span style="color: #ff0000"> </span>
                ...
                <table style="width: 623px; height: 728px;">
                    ...
                    <tr style="color: #000000">
                        ...
                        <td colspan="2" style="color: #000000">
                            <table border="1">
                                <tr>
                                    <td colspan="5" style="text-align: center">Permanant</td>
                                </tr>
                                <tr>
                        ...
                        <td colspan="2">
                            <table border="1">
                                <tr>
                                    <td colspan="5" style="text-align: center">Present</td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td colspan="2" style="height: 11px">Land Mark<span style="color: #ff0000">*</span></td>
                    ...
                    <tr>
                        <td colspan="2">Phone No(Residence)<span style="color: #ff0000">*</span></td>
                    ...
                    <tr>
                        ...
                        <td colspan="2">&nbsp;<table style="width: 339px">
                            <tr>
                                <td style="width: 99px">Date of Birth <span style="color: #ff0000">*</span></td>
                                <td style="width: 99px">
                    ...
                    <tr>
                        <td colspan="3" style="height: 24px">Information Source of Vacancy</td>
                        <td colspan="3" style="height: 24px; text-align: center">
                        ...
                        <td colspan="6" style="text-align: center">
                            <asp:Panel ID="pnl_vacancy" runat="server" Height="50px" Visible="False" Width="125px">
                                <table border="1" style="width: 596px">
                                    <tr>
                                        <td style="width: 291px; height: 26px; text-align: left">Employee Code &amp; Name</td>
                            ...
                            <asp:Panel ID="pnl_other" runat="server" Height="50px" Visible="False" Width="125px">
                                <table border="1" style="width: 596px">
                                    <tr>
                                        <td style="width: 266px; height: 17px; text-align: left">If Other Specify
                                        </td>
        ...
        <tr>
            <td align="center" style="width: 1048px; height: 55px">
                <table style="width: 371px">
                    <tr>
                        <td style="width: 100px; height: 26px; text-align: center">&nbsp;<asp:Button ID="cmd_confirm" runat="server" Text="Next" Width="65px" /></td>
