...
Partial Class payroll_posting_emp_appln1_77b999515466
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'If ("home.aspx" = previousPageName) Then
        If fid = 8 Then
            Response.Redirect("enrollment_new.aspx")
            Exit Sub
            End If
        'End If
        '---appu
    ...
    Public Sub RaiseCallbackEvent(ByVal eventArgument As String) Implements System.Web.UI.ICallbackEventHandler.RaiseCallbackEvent
        ...
        Select Case (x)
            ...
            Case "10"
                Dim sr() As String
                sr = str(1).Split("#")
                emp_dt = oh.ExecuteDataSet("select t.emp_code||'!'||t.emp_code||'-'||t.emp_name from employee_master t join employ_firm f on f.emp_code=t.emp_code and f.firm_id=" & fid & "where t.emp_code>9999 and t.status_id=1 order by t.emp_code").Tables(0)
