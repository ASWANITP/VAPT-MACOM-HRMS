...
Partial Class Payroll_Transfer_edf39a098459
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim dt, dt1, dt2, dt3, dt4, dt6, dt11, dt9, dt12, dt8, dt25, dt27 As New DataTable
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim details, hostel, empno, cr_dtl, firm_id As String
        Dim dtls(), cr_dt(), fir(), dd(), hos() As String
        Dim frID = Session("firm_ID").ToString
        Dim frm = Session("firm_name").ToString
        dt27 = oh.ExecuteDataSet("SELECT F.FIRM_ABBR,f.firm_name,f.firm_address FROM firm_view F WHERE F.FIRM_id=" & frID & "").Tables(0)
        ...
        cr_dtl = HttpUtility.UrlDecode(Request.QueryString("cr_dt"))
        ...
        dtq = oh.ExecuteDataSet("select h.post from employee_master e, hrm_assign_delegate h,designation_master d where e.designation_id=d.designation_id and h.module_id=3 and d.grade_id between h.assign_grade_from and h.assign_grade_to and h.firm_id = " & Session("firm_id") & " and e.emp_code=" & dtls(1)).Tables(0)

        Dim ddd As Date = CDate(cr_dt(5))
        '-------------------Formatting table---------------------------------'
        Dim tb As New Table
        ...
        td0.Text = "<font size=3 color=darkblue>" & dt27.Rows(0)(2) & " </font>"
        ...
        dt3 = oh.ExecuteDataSet(sql3).Tables(0)
        Dim Sql5 As String = "select value from da_index where to_dt is null and firm_id=" & frd & " "
        ...
        'dt25 = oh.ExecuteDataSet("select count(emp_code) from employee_master where emp_code=" & dtls(1) & " and emp_type=1 and to_number(to_date('" & dtls(3) & "', 'DD-MM-YYYY')-to_date(join_dt), 'DD-MM-YYYY')>365").Tables(0)
        dt25 = oh.ExecuteDataSet("SELECT COUNT(emp_code) FROM employee_master WHERE emp_code = " & dtls(1) & " AND emp_type = 1 AND TO_DATE('" & dtls(3) & "', 'DD-MM-YYYY') - TO_DATE((join_dt), 'DD-MM-YYYY') > 365").Tables(0)
        ...
        If (dt1.Rows(0)(1) <= 18 Or dt1.Rows(0)(1) = 101) Then
            ...
            td89.Text = "<font size=3 color=darkblue>" & dt27.Rows(0)(2) & "</font>"
            ...
            If hos(1) > 0 Then
                ...
                ht4.Text = "<font size=3 color=darkblue>" & dt27.Rows(0)(2) & "</font>"
