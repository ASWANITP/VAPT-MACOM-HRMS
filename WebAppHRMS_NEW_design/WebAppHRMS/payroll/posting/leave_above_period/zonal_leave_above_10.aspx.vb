...
Partial Class leave_above_10_zonal_leave_above_10_2889ae879616
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim zonal_table As New Table
        zonal_table.Attributes.Add("width", "100%")

        des = Me.Request.QueryString("designation")
        post = Me.Request.QueryString("post")
        ...
        zonal_table.Controls.Add(header)
        ...
        zonal_table.Controls.Add(sheader)
        ...
        pheadercell.Text = "<body align=center ><b><font size=3> Zonalwise list of employees having  " & Me.Request.QueryString("leaveno") & " or more leaves </font></b>"
        pheader.Controls.Add(pheadercell)
        zonal_table.Controls.Add(pheader)
        ...
        zonal_table.Controls.Add(pheaderq)
        ...
        zonal_table.Controls.Add(line1)
        ...
        f2.Text = "<b><font size=2>Zonal Name</font></b>"
        ...
        zonal_table.Controls.Add(field)
        ...
        zonal_table.Controls.Add(linek)
        ...
        For Each dr In dt.Rows
            ...
            '<a href=subreport.aspx?emp_code=" & dr(0) & "><font size=2>" & dr(0) & "***" & dr(1) & "</font></a>"" & Me.Request.QueryString("leaveno") & "
            v1.Text = "<a href=reg_leave_above.aspx?status=" & Me.Request.QueryString("status") & "&zonalid=" & dr(0) & "&designation=" & Me.des & "&post=" & Me.post & "&leaveno=" & Me.Request.QueryString("leaveno") & "><font size=2>" & dr(1) & "</font></a>"
            val.Controls.Add(v1)
        ...
        zonal_table.Controls.Add(linee)
        ...
        zonal_table.Controls.Add(totrow)


        Panel_Zonal.Controls.Add(zonal_table)
