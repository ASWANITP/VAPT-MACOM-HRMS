...
Partial Class leave_above_10_areawise_leave_aefe3b665722
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim area_table As New Table
        area_table.Attributes.Add("width", "100%")
        ...
        area_table.Controls.Add(header)
        ...
        area_table.Controls.Add(sheader)
        ...
        pheadercell.Text = "<body align=center ><b><font size=3> Areawise list of employees having  " & Me.Request.QueryString("leaveno") & " or more leaves </font></b>"
        pheader.Controls.Add(pheadercell)
        area_table.Controls.Add(pheader)
        ...
        area_table.Controls.Add(pheaderq)
        ...
        For Each dr In dt.Rows
            ...
            v1.Text = "<a href=branchwise_leave.aspx?status=" & Me.Request.QueryString("status") & "&areaid=" & dr(0) & "&designation=" & Me.Request.QueryString("designation") & "&post=" & Me.Request.QueryString("post") & "&leaveno=" & Me.Request.QueryString("leaveno") & "><font size=2>" & dr(1) & "</font></a>"
            val.Controls.Add(v1)
        ...
        area_table.Controls.Add(totrow)


        Panel_Area.Controls.Add(area_table)
    End Sub
