...
Partial Class leave_above_10_report_77c307816808
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.Request.QueryString("status") = 0 Then
            ...
            If Me.Request.QueryString("designation") <> 0 Then
                ...
                str1 = "select em.emp_code,em.emp_name,bd.BRANCH_NAME,dm.dep_name,sum(el.leave_days) as Total_Leave from employee_master em,employ_leave_dtl el ,branch_detail bd,department_mst dm where em.branch_id=bd.branch_id and em.emp_code=el.emp_code and em.department_id=dm.dep_id and em.designation_id=" & Me.Request.QueryString("designation") & " and  to_date(el.leave_frdate)>=to_date('1-jan-'||to_char(sysdate,'yyyy')) and el.leave_process_id in (1,2) and el.status=1 and em.status_id not in (3,5) and bd.branch_id=" & Me.Request.QueryString("branchid") & " group by em.branch_id,em.emp_code,em.emp_name,dm.dep_name,bd.branch_name having sum(el.leave_days)>=" & Me.Request.QueryString("leaveno") & " order by em.emp_code"

            ElseIf Me.Request.QueryString("post") <> 0 Then

                str1 = "select em.emp_code,em.emp_name,bd.BRANCH_NAME,dm.dep_name,sum(el.leave_days) as Total_Leave from employee_master em,employ_leave_dtl el ,branch_detail bd,department_mst dm where em.branch_id=bd.branch_id and em.emp_code=el.emp_code and em.department_id=dm.dep_id and em.post_id=" & Me.Request.QueryString("post") & " and  to_date(el.leave_frdate)>=to_date('1-jan-'||to_char(sysdate,'yyyy')) and el.leave_process_id in (1,2) and el.status=1 and em.status_id not in (3,5) and bd.branch_id=" & Me.Request.QueryString("branchid") & " group by em.branch_id,em.emp_code,em.emp_name,dm.dep_name,bd.branch_name having sum(el.leave_days)>=" & Me.Request.QueryString("leaveno") & " order by em.emp_code"
        ...
        ElseIf Me.Request.QueryString("status") = 1 Then
            ...
            If Me.Request.QueryString("designation") <> 0 Then
                ...
                str1 = "select em.emp_code,em.emp_name,bd.BRANCH_NAME,dm.dep_name,sum(el.leave_days) as Total_Leave from employee_master em,employ_leave_dtl el ,branch_detail bd,department_mst dm where em.branch_id=bd.branch_id and em.emp_code=el.emp_code and em.department_id=dm.dep_id and em.designation_id=" & Me.Request.QueryString("designation") & " and  to_date(el.leave_frdate)>=to_date('1-jan-'||to_char(sysdate,'yyyy')) and el.leave_process_id in (1,2) and el.status=1 and em.status_id not in (3,5) and em.emp_type=1 and bd.branch_id=" & Me.Request.QueryString("branchid") & " group by em.branch_id,em.emp_code,em.emp_name,dm.dep_name,bd.branch_name having sum(el.leave_days)>=" & Me.Request.QueryString("leaveno") & " order by em.emp_code"
        ...
        ElseIf Me.Request.QueryString("status") = 2 Then
            ...
            If Me.Request.QueryString("designation") <> 0 Then
                ...
                str1 = "select em.emp_code,em.emp_name,bd.BRANCH_NAME,dm.dep_name,sum(el.leave_days) as Total_Leave from employee_master em,employ_leave_dtl el ,branch_detail bd,department_mst dm where em.branch_id=bd.branch_id and em.emp_code=el.emp_code and em.department_id=dm.dep_id and em.designation_id=" & Me.Request.QueryString("designation") & " and  to_date(el.leave_frdate)>=to_date('1-jan-'||to_char(sysdate,'yyyy')) and el.leave_process_id in (1,2) and el.status=1 and em.status_id not in (3,5) and em.emp_type=2 and bd.branch_id=" & Me.Request.QueryString("branchid") & " group by em.branch_id,em.emp_code,em.emp_name,dm.dep_name,bd.branch_name having sum(el.leave_days)>=" & Me.Request.QueryString("leaveno") & " order by em.emp_code"
