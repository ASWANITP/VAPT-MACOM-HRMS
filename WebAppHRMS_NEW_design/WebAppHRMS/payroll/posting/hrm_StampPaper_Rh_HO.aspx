...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 80%">
            <tr>
                <td colspan="2" style="text-align: left">Select Employee</td>
                <td colspan="2" style="text-align: left">
                    <asp:DropDownList ID="ddlEcode" runat="server" Width="97%" onchange="ddlOnchange()">
                    </asp:DropDownList></td>
            </tr>
            <tr>
                <td style="width: 15%; text-align: left;">Employee Code</td>
                <td style="width: 15%">
            ...
            <tr>
                ...
                <td style="width: 15%; height: 23px; text-align: left;">Joining Date</td>
                <td style="width: 15%; height: 23px">
            ...
            <tr id="rowRes">
                <td colspan="2" style="height: 23px; text-align: left">Reject Reason</td>
