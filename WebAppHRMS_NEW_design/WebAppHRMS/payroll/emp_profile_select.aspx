...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 80%; font-family: 'Bookman Old Style'; font-variant: small-caps;">
            <tr>
                <td style="width: 21%; text-align: left;">Enter Employee Code</td>
                <td style="width: 14%; text-align: left;">
                    <asp:TextBox ID="txtEmpCode" onkeyup="EmpCodeKeyUp()" onchange="EmpCodeFind()" runat="server" Style="font-family: 'Bookman Old Style'; text-align: center"
                        MaxLength="6"></asp:TextBox></td>
                <td style="width: 17%; text-align: left;">Employee Name</td>
