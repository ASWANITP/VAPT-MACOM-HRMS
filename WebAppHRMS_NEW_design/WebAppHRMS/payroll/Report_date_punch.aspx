...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1">
            <tr>
                <td colspan="4">NOT PUNCH IN REPORTING DATE<asp:ScriptManager ID="ScriptManager1" runat="server">
                </asp:ScriptManager>
            ...
            <tr>
                <td style="width: 100px; height: 23px">FROM DATE</td>
                ...
                <td style="width: 100px; height: 23px">TO DATE</td>
                <td style="width: 100px; height: 23px; text-align: left">
