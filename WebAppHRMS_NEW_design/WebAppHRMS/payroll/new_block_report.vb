...
Public Class new_block_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.new_block_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachednew_block_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As new_block_report = New new_block_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
