...
Public Class Crptproposaltran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.Crptproposaltran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrptproposaltran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crptproposaltran = New Crptproposaltran()
        rpt.Site = Me.Site
        Return rpt
    End Function
