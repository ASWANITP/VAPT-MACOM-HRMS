...
Partial Class Emp_Current_divisionemp_current_184a69df8003
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.Request.QueryString("status") = 0 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Divisionwise list of All(excluding Resigned & Terminated) employees</font></b>"
        ElseIf Me.Request.QueryString("status") = 1 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Divisionwise list of Normal employees</font></b>"
        ElseIf Me.Request.QueryString("status") = 3 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Divisionwise list of Resigned employees</font></b>"
        ElseIf Me.Request.QueryString("status") = 4 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Divisionwise list of Suspended employees</font></b>"
        ElseIf Me.Request.QueryString("status") = 6 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Divisionwise list of employees in Long Leave</font></b>"
        ElseIf Me.Request.QueryString("status") = 10 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Divisionwise list of employees in Maternity Leave</font></b>"
        ElseIf Me.Request.QueryString("status") = 5 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Divisionwise list of Terminated employees</font></b>"

        End If
        pheader.Controls.Add(pheadercell)
        divtable.Controls.Add(pheader)


        If Me.Request.QueryString("status") = 0 Then
            str = "select bd.division_id,bd.DIV_NAME,count(ec.emp_code),sum(nvl(ec.exp_day,0))as Total_exp from branch_detail bd,employee_current ec where ec.status_id not in (3,5) and bd.reg_id=" & Me.Request.QueryString("regionid") & " and ec.branch_id=bd.BRANCH_ID group by bd.division_id,bd.DIV_NAME"
        Else
            str = "select bd.division_id,bd.DIV_NAME,count(ec.emp_code),sum(nvl(ec.exp_day,0))as Total_exp from branch_detail bd,employee_current ec where ec.status_id=" & Me.Request.QueryString("status") & " and bd.reg_id=" & Me.Request.QueryString("regionid") & " and ec.branch_id=bd.BRANCH_ID group by bd.division_id,bd.DIV_NAME"
        End If
        ...
        For Each dr In dt.Rows
            ...
            v1.Text = "<a href=areaemp_current.aspx?status=" & Me.Request.QueryString("status") & "&divid=" & dr(0) & "><font size=2>" & dr(1) & "</font></a>"
            val.Controls.Add(v1)
        ...
        divtable.Controls.Add(totrow)

        Panel_Div.Controls.Add(divtable)
    End Sub
End Class
