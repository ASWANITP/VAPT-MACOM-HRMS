<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" EnableEventValidation="false" CodeBehind="RELEASE_BLOCK.aspx.vb" Inherits="WebAppHRMS.RELEASE_BLOCK_7afc91a78273" Title="Untitled Page" %>
        ...
        <table style="width: 649px">
            <tr>
                <td colspan="4" style="height: 21px">
                    <strong><span style="color: #ff0033">RELEASE BLOCK<asp:ScriptManager ID="ScriptManager1"
                        runat="server">
                    </asp:ScriptManager>
                    </span></strong></td>
            </tr>
            ...
            <tr>
                ...
                <td style="width: 100px; text-align: center;">
                    <input id="txt_del" onclick="del()" style="font-weight: bold; font-family: 'Courier New'; background-color: gainsboro"
            ...
            <tr>
                <td style="width: 102px; height: 21px;"></td>
                <td colspan="2" style="height: 21px">
                    <asp:Button ID="Cmd_confirm" runat="server" Font-Bold="True" Text="RELEASE BLOCK"
                        Width="205px" /></td>
                <td style="width: 100px; height: 21px;">
                    <asp:Button ID="Button1" runat="server" Font-Bold="True" Text="Report" Width="79px" /></td>
            </tr>
        </table>
    </div>
</asp:Content>
