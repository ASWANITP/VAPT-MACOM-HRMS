    ...
    <form id="form1" runat="server">
        ...
        <table style="width: auto">
            ...
            <tr>
                ...
                <td style="width: 201.5px; color: Red">PRE
                </td>
                <td style="width: 201.5px; color: Red">3M
                </td>
                <td style="width: 201.5px; color: Red">6M

                </td>

                <td style="width: 201.5px; color: Red">9M
                </td>


                <td style="width: 201.5px; color: Red">1YR
