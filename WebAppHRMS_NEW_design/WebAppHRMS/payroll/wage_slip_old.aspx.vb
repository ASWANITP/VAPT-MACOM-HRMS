...
Partial Class salaryreport_wage_slip_5584e1976243
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If frm = 8 Then
            Response.Redirect("wage_slip_Macom_Macom.aspx")
            Exit Sub
        End If
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        If (Me.chk_bran.Checked = True) Then
            Server.Transfer("wage_slip_report_ol.aspx?&br=" & Me.cmb_bran.SelectedValue & "&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 1)
        End If
        If (Me.chk_firm.Checked = True) Then
            Server.Transfer("wage_slip_report_ol.aspx?&fr=" & Me.cmb_firm.SelectedValue & "&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 2)
        End If
        If (Me.chk_emp.Checked = True) Then
            Server.Transfer("wage_slip_report_ol.aspx?&em=" & Me.cmb_emp.SelectedValue & "&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 3)
        End If
        If (Me.chk_branch.Checked = True) Then
            Server.Transfer("wage_slip_report_ol.aspx?&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 4)
        End If
        If (Me.chk_allfirm.Checked = True) Then
            Server.Transfer("wage_slip_report_ol.aspx?&dt='" & Me.cmb_date.SelectedValue & "'&a=" & 5)
        End If
    End Sub
