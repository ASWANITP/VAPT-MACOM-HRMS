...
Public Class crpt_esi_form6
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.crpt_esi_form6.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_esi_form6
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_esi_form6 = New crpt_esi_form6()
        rpt.Site = Me.Site
        Return rpt
    End Function
