...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <cc1:CalendarExtender ID="CalendarExtender1" Format="dd/MMM/yyyy" TargetControlID="new_join" runat="server"></cc1:CalendarExtender>
            <table border="2" style="left: 200px; width: 29%; position: relative; top: -6px; height: 1px" id="TABLE1" onclick="return TABLE1_onclick()">
                ...
                <tr align="right">
                    <td style="width: 53%; height: 5px; vertical-align: top" align="center">Employee Code</td>
                    <td style="width: 14%; height: 5px; vertical-align: top" align="center">
                        <asp:TextBox ID="txtecode" runat="server" Style="left: 0px; position: relative; top: 0px"
                            Width="240px" OnTextChanged="txtecode_TextChanged" AutoPostBack="True"></asp:TextBox></td>
                    <td style="width: 14%; height: 5px; vertical-align: top" align="center">Employee Name</td>
                    <td style="width: 14%; height: 5px; vertical-align: top" align="center">
                        <asp:TextBox ID="txtename" runat="server" Style="position: relative" Width="240px" ReadOnly="True"></asp:TextBox></td>
                </tr>
                <tr align="right">
                    <td style="width: 53%; height: 12px; vertical-align: top" align="center">Current Date</td>
                    ...
                    <td style="width: 14%; height: 12px; vertical-align: top" align="center">New Date</td>
                    <td style="width: 14%; height: 12px; vertical-align: top" align="center">
                        <asp:TextBox ID="new_join" runat="server" Width="240px"></asp:TextBox></td>
                </tr>
                <tr align="center">
                    <td style="height: 10px; vertical-align: top" colspan="4" align="center"></td>
                </tr>
                <tr align="right">
                    <td style="height: 10px; vertical-align: top" colspan="4" align="center">

                        <asp:Button ID="btnConfrm" runat="server" Style="left: 32px; position: relative; top: 80px"
                            Text="CONFIRM" /><input id="btnExit" onclick="return btnExit_onclick()"
