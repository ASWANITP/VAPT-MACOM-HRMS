        ...
        <table border="1" style="width: 825px">
            ...
            <tr>
                <td style="width: 172px; height: 26px;">
                    <span style="font-family: Georgia">Select Employee</span></td>
            ...
            <tr>
                <td style="width: 172px">
                    <span style="font-family: Georgia">Select Effective Date</span></td>
                <td style="width: 83px">
                    <asp:TextBox ID="Txt_effdt" runat="server" ForeColor="Black" BackColor="Azure"></asp:TextBox></td>
                <td style="width: 84px">
                    <span style="font-family: Georgia">Select Shift</span></td>
                ...
                <td colspan="4" style="height: 55px">
                    <table style="width: 438px">
                        <tr>
                            ...
                            <td style="width: 125px; height: 26px; text-align: center"></td>
