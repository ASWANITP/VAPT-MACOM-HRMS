<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="wage_slip_Macom.aspx.vb" Inherits="WebAppHRMS.wage_slip_Macom_2f30cef05036" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1">
            ...
            <tr>
                <td style="width: 85px">
                    <asp:LinkButton ID="LinkButton1" PostBackUrl="wage_slip_old_Macom.aspx" runat="server">Previous Month</asp:LinkButton></td>
