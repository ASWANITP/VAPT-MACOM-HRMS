...
Partial Class Employee_Punching_myreportm_e8ba7a3f8193
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '    Me.SliderValue.Focus()
        'End If


        Dim SliderValue As Integer
        If Integer.TryParse(SliderValue, SliderValue) Then
            ' Successfully parsed the value, now check if it's equal to 0
        ...
        Panel0.Controls.Add(hotable)

    End Sub

    Protected Sub txt_CHA_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ElseIf (SliderValue.Text) = 1 Then
            Me.TextBox1.Text = "3"
            ...
            line2.Controls.Add(linecell2)
            hotable.Controls.Add(line2)
            Panel2.Controls.Add(hotable)

        ElseIf (SliderValue.Text) = 2 Then
            ...
            line2.Controls.Add(linecell2)
            hotable.Controls.Add(line2)
            Panel3.Controls.Add(hotable)


        ElseIf (SliderValue.Text) = 3 Then
            ...
            line2.Controls.Add(linecell2)
            hotable.Controls.Add(line2)
            Panel4.Controls.Add(hotable)


        ElseIf (SliderValue.Text) = 4 Then
            Me.TextBox1.Text = "12"
            Panel0.Visible = False
            Panel2.Visible = False
            Panel3.Visible = False
