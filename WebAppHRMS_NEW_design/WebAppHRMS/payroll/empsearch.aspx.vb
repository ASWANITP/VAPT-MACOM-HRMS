...
Partial Class raj_empsearch_f1c626619061
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        CType(Me.Master, WebAppHRMS.edp).Subtitle = "Employee Search : Using Employee Code or Name"
    ...
    Protected Sub cmdConfirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdConfirm.Click
        ...
        End If
        Me.Server.Transfer("rpt_empserach.aspx?rdb=" & rdb & "&code=" & code & "&name=" & name)
    End Sub
End Class
