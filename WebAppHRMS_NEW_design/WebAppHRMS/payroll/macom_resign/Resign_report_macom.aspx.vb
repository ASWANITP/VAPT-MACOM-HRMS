...
Imports CrystalDecisions.CrystalReports.Engine
    Partial Class Resign_report_macom
        ...
        'Dim emp As String = Context.Items("Ecode").ToString()

        '  Dim emp As String = 101261

        Dim empcode As String = Request.QueryString("Ecode")
        ' 1) Load your data-table as you already do:
        Dim dt As DataTable = oh.ExecuteDataSet("select attach from macdms.m_resign_appl_image_temp where emp_code='" & empcode & "'").Tables(0)
