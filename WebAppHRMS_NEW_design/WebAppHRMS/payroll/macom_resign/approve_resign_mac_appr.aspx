<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/edp.Master" CodeBehind="approve_resign_mac_appr.aspx.vb" Inherits="WebAppHRMS.approve_resign_mac_appr" %>
    ...
    <div style="text-align: center">
     ...
     <td style="height: 23px; text-align: left" colspan="3">
         ...
         <asp:Label ID="lbl1" runat="server" Width="580px"></asp:Label></td>
                                    ...
                                    <tr>
                                        <td style="width: 2773px; text-align: left"><strong>Employee&nbsp;Resigning&nbsp;Date</strong></td>
                                        <td style="text-align: left" colspan="3">
  ...
  <tr>
      ...
      <td align="left"  style="width: 142px; height: 5px;">
          <span style="color: #0000cc">
              <asp:Label ID="Label3" runat="server" Text="Employee Last Working Day"></asp:Label></span></td>
