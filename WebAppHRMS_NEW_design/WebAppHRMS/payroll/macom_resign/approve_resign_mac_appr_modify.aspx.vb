...
Public Class approve_resign_mac_appr_modify
    ...
    Protected Sub cmd_reject_Click(sender As Object, e As EventArgs) Handles cmd_reject.Click
        ...
        Else
            ...
            If parameter(4).Value = 1 Then
                ...
                'cl_script1.Append("window.open('approve_resign_mac_appr.aspx','_self');")
                Response.Redirect("approve_resign_mac_appr.aspx")
                Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "client script", cl_script1.ToString, True)
                'Exit Sub
            End If
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        Else
            ...
            parameter(3) = New OracleParameter("start_dt", OracleType.DateTime, 150)
            parameter(3).Direction = ParameterDirection.Input
            parameter(3).Value = Me.TextBox1.Text
            parameter(4) = New OracleParameter("end_dt", OracleType.DateTime, 150)
            parameter(4).Direction = ParameterDirection.Input
            parameter(4).Value = Me.TextBox2.Text

            parameter(5) = New OracleParameter("msg", OracleType.Number, 150)
            parameter(5).Direction = ParameterDirection.Output
            oh.ExecuteNonQuery("M_RESIGNING_SAN_MAC_modify", parameter)
