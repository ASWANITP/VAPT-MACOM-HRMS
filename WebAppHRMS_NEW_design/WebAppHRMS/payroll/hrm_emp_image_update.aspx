...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1" style="width: 624px">
            ...
            <tr>
                <td style="width: 353px; text-align: left">Select Employee :
                </td>
            ...
            <tr>
                <td style="width: 353px; text-align: left">Qualification Category :</td>
                <td colspan="2" style="text-align: left">
                    <input id="txt_category" size="20" style="width: 377px" type="text" runat="server" /></td>
            </tr>
            <tr>
                <td style="width: 353px; text-align: left; height: 28px;">Qualification:
                </td>
            ...
            <tr>
                <td style="width: 353px; text-align: left">Marks Obtained :
                </td>
                <td colspan="2" style="text-align: left">
            ...
            <tr>
                <td style="width: 353px; text-align: left">Total Marks :
                </td>
                <td colspan="2" style="text-align: left">
            ...
            <tr>
                <td style="width: 353px; text-align: left">Photo :
                </td>
                <td colspan="2" style="text-align: left">
                    <asp:FileUpload ID="FileUpload1" runat="server" Width="378px" /></td>
            </tr>
            <tr>
                <td style="width: 353px; text-align: left">Final
                    Certificate&nbsp; :</td>
                <td colspan="2" style="text-align: left">
            ...
            <tr>
                ...
                <td style="width: 182px; text-align: right"></td>
                <td style="width: 100px; text-align: left">
