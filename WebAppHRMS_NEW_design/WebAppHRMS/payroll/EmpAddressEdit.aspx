...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function call_receiver(arg1) { //debugger;
        ...
        <div>
            <div style="text-align: center">
                ...
                <table border="1" style="width: 52%; text-transform: capitalize; font-family: 'Bookman Old Style';">
                    <tr>
                        <td colspan="2" style="height: 10px; text-align: center">Permanant Address</td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: left;">&nbsp;Permanant House Name</td>
                    ...
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;State</td>
                        <td style="width: 40%; text-align: left">
                            <asp:DropDownList ID="cmbPermState" onchange="PermStateChange()" runat="server" Style="text-transform: uppercase; cursor: hand; font-family: 'Bookman Old Style'"
                                Width="242px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;District</td>
                        <td style="width: 40%; text-align: left">
                            <asp:DropDownList ID="cmbPermDistrict" onchange="PermDistChange()" runat="server" Style="text-transform: uppercase; cursor: hand; font-family: 'Bookman Old Style'"
                                Width="242px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;Post Office</td>
                        <td style="width: 40%; text-align: left">
                            <asp:DropDownList ID="cmbPermPost" onchange="PermPostChange()" runat="server" Style="text-transform: uppercase; cursor: hand; font-family: 'Bookman Old Style'"
                                Width="242px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;P.I.N Code</td>
                        <td style="width: 40%; text-align: left">
                            <asp:TextBox ID="txtPermPin" runat="server" ReadOnly="True" Style="text-transform: uppercase; font-family: 'Bookman Old Style'; text-align: center"
                                Width="237px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center">Present Address</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;Present House Name</td>
                        <td style="width: 40%; text-align: left">
                    ...
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;State</td>
                        <td style="width: 40%; text-align: left">
                            <asp:DropDownList ID="cmbPresState" onchange="PresStateChange()" runat="server" Style="text-transform: uppercase; cursor: hand; font-family: 'Bookman Old Style'"
                                Width="242px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;District</td>
                        <td style="width: 40%; text-align: left">
                            <asp:DropDownList ID="cmbPresDistrict" onchange="PresDisChange()" runat="server" Style="text-transform: uppercase; cursor: hand; font-family: 'Bookman Old Style'"
                                Width="242px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;Post Office</td>
                        <td style="width: 40%; text-align: left">
                            <asp:DropDownList ID="cmbPresPost" onchange="PrePostChange()" runat="server" Style="text-transform: uppercase; cursor: hand; font-family: 'Bookman Old Style'"
                                Width="242px">
                            </asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td style="width: 40%; text-align: left">&nbsp;P.I.N Code</td>
                        <td style="width: 40%; text-align: left">
                            <asp:TextBox ID="txtPresPin" runat="server" ReadOnly="True" Style="text-transform: uppercase; font-family: 'Bookman Old Style'; text-align: center"
                                Width="237px"></asp:TextBox></td>
                    </tr>
                    <tr>
                ...
                <input id="hidPrePin" runat="server" style="width: 5px" type="hidden" />
            </div>
