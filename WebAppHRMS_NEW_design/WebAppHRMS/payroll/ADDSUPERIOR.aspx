                    ...
                    <div style="text-align: center">
                        ...
                        <table border="1" style="width: 88%; height: 206px;">
                            ...
                            <tr>
                                ...
                                <td colspan="2">&nbsp;<asp:DropDownList ID="cmb_Select" onclick="FillEmployDetails()" runat="server" Width="450px">
                                </asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td style="width: 17%; text-align: left">&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;Emp Code</td>
                                <td style="width: 15%">
                            ...
                            <tr>
                                <td style="width: 17%; text-align: left">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Designation&nbsp;</td>
                                <td style="width: 15%">
                            ...
                            <tr>
                                <td style="width: 17%; height: 28px; text-align: left;">&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;Post</td>
                            ...
                            <tr>
                                <td colspan="2" style="height: 23px">Select Superior ID</td>
                                <td colspan="2" style="height: 23px">&nbsp;<asp:DropDownList ID="cmb_Superior" runat="server" Width="452px">
                                </asp:DropDownList></td>
                            </tr>
                            <tr>
