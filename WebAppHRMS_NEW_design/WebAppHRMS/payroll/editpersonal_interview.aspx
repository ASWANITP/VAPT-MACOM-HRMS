                ...
                <tbody>
                    <tr>
                        ...
                        <td style="height: 26px; text-align: left" colspan="2">
                            <asp:DropDownList ID="cmb_appno" runat="server" Width="366px" AutoPostBack="True" __designer:wfdid="w6"></asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td style="width: 186px; height: 28px; text-align: left">Name :</td>
                        <td style="height: 28px; text-align: left" colspan="3">
                            <asp:TextBox ID="txt_name" runat="server" Width="374px" BackColor="Ivory" ForeColor="Red" Font-Bold="True" __designer:wfdid="w7" ReadOnly="True"></asp:TextBox>
                            <cc1:ListSearchExtender ID="ListSearchExtender1" runat="server" __designer:wfdid="w4" TargetControlID="cmb_appno"></cc1:ListSearchExtender>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="height: 216px; text-align: left" colspan="3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 102px; height: 28px">
                                                    <asp:TextBox ID="txt_house1" runat="server" Width="264px" AutoPostBack="True" __designer:wfdid="w8"></asp:TextBox></td>
                                                <td style="width: 88px; height: 28px">House Name : </td>
                                                <td style="width: 100px; height: 28px">
                                                    <asp:TextBox ID="txt_house2" runat="server" Width="252px" AutoPostBack="True" __designer:wfdid="w9"></asp:TextBox></td>
                                            </tr>
                                            <tr>
                                                <td style="width: 96px">State : </td>
                                                <td style="width: 102px">
                                                    <asp:DropDownList ID="cmb_state1" runat="server" Width="210px" AutoPostBack="True" __designer:wfdid="w10">
                                                    </asp:DropDownList></td>
                                                <td style="width: 88px">State : </td>
                                                <td style="width: 100px">
                                                    <asp:DropDownList ID="cmb_state2" runat="server" Width="210px" AutoPostBack="True" __designer:wfdid="w11">
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td style="width: 96px; height: 26px">District :</td>
                                                <td style="width: 102px; height: 26px">
                                                    <asp:DropDownList ID="cmb_district1" runat="server" Width="210px" AutoPostBack="True" __designer:wfdid="w12">
                                                    </asp:DropDownList></td>
                                                <td style="width: 88px; height: 26px">District :</td>
                                                <td style="width: 100px; height: 26px">
                                                    <asp:DropDownList ID="cmb_district2" runat="server" Width="210px" AutoPostBack="True" __designer:wfdid="w13">
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td style="width: 96px">Post : </td>
                                                <td style="width: 102px">
                                                    <asp:DropDownList ID="cmb_post1" runat="server" Width="210px" AutoPostBack="True" __designer:wfdid="w14">
                                                    </asp:DropDownList></td>
                                                <td style="width: 88px">Post : </td>
                                                <td style="width: 100px">
                                                    <asp:DropDownList ID="cmb_post2" runat="server" Width="210px" AutoPostBack="True" __designer:wfdid="w15">
                                                    </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                            ...
                            <asp:CheckBox ID="chk_same" runat="server" Width="405px" Text="Present Address Same As Permanant Address" Font-Bold="True" AutoPostBack="True" __designer:wfdid="w18"></asp:CheckBox></td>
                    </tr>
                    <tr>
                        <td style="width: 186px; text-align: left">Land Mark :</td>
                        <td style="text-align: left" colspan="3">
                            <asp:TextBox ID="txt_lmark" runat="server" Width="756px" AutoPostBack="True" __designer:wfdid="w19"></asp:TextBox></td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 392px; height: 13px; text-align: left">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" __designer:wfdid="w22" ValidationExpression='^([0-9"-"\s])*$' ErrorMessage="Please Enter Correctly" EnableTheming="True" ControlToValidate="txt_phone"></asp:RegularExpressionValidator></td>
                        ...
                        <td style="width: 100px; height: 13px; text-align: left">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Width="155px" __designer:wfdid="w24" ValidationExpression='^([0-9"-"\s])*$' ErrorMessage="Please Enter Correctly" ControlToValidate="txt_contact"></asp:RegularExpressionValidator></td>
                    </tr>
                    <tr>
                        <td style="width: 186px; height: 23px; text-align: left">Email :<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" __designer:wfdid="w25" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ErrorMessage="Please Enter Correctly" ControlToValidate="txt_email"></asp:RegularExpressionValidator></td>
                        ...
                        <td style="width: 100px; height: 23px; text-align: left">
                            <asp:DropDownList ID="cmb_bg" runat="server" Width="154px" AutoPostBack="True" __designer:wfdid="w27"></asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td style="width: 186px; text-align: left">ID Proof :</td>
                        <td style="width: 392px; text-align: left">
                            <asp:DropDownList ID="cmb_idproof" runat="server" Width="218px" AutoPostBack="True" __designer:wfdid="w28"></asp:DropDownList></td>
