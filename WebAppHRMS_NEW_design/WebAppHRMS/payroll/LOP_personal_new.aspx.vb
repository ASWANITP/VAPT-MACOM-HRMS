...
Partial Class LOP_to_Personal_Account_LOP_personal_new_c0c23f151910
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        CType(Me.Master, WebAppHRMS.edp).Subtitle = "LOP TO PERSONAL ACCOUNT - ADD"
        ...
        If Me.Session("access_id") = 33 Then
            If Not IsPostBack Then
                Dim dt As DataTable = oh.ExecuteDataSet("select distinct e.emp_code,e.emp_code || ' - ' || e.emp_name from employee_master e,employ_leave_dtl em,employ_firm f where e.emp_code=f.emp_code and f.firm_id=" & fid & " and e.emp_code>9999 and e.emp_code=em.emp_code and em.leave_process_id=1 and em.leave_id=4 order by e.emp_code").Tables(0)
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        oh.ExecuteNonQuery("loppersonalac_new", param)
    ...
    Public Sub RaiseCallbackEvent(ByVal eventArgument As String) Implements System.Web.UI.ICallbackEventHandler.RaiseCallbackEvent
        ...
        Select Case (x)
            ...
            Case "2"
                ...
                dt2 = oh.ExecuteDataSet("select distinct e.emp_code|| '*' ||e.leave_frdate || '*' || e.leave_todate as frdate from employ_leave_dtl e where e.leave_id=4 and e.leave_process_id=1 and e.emp_code='" & str(1) & "' order by frdate").Tables(0)
                Dim dr As DataRow
