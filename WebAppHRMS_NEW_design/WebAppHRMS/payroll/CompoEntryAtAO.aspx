...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div id="divTotal" style="text-align: center">
        ...
        <table id="rowDetails" border="1" style="width: 80%; font-family: 'Book Antiqua'; height: 231px;">
            ...
            <tr>
                <td style="width: 25%; font-size: 11pt;">Applied On</td>
            ...
            <tr>
                ...
                <td style="width: 25%; height: 22px; text-align: left"></td>
            ...
            <tr>
                <td style="width: 25%; height: 38px; font-size: 11pt;">Compo off taken &nbsp;date</td>
            ...
            <tr>
                ...
                <td colspan="3" style="height: 20px; text-align: left"></td>
            </tr>
            <tr>
        ...
        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtFromDt" Format="dd/MMM/yyyy"></cc1:CalendarExtender>
        ...
        <table border="1" style="width: 22%">
            <tr>
                ...
                <td style="width: 50%">
                    <input id="btnExit" style="width: 88px; cursor: hand; font-family: 'Book Antiqua'; height: 26px"
