...
Partial Class itemwiserpt_for_hrm_38dedf086467
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim s As String = oh.ExecuteDataSet("select all_name from incentives_allowances_master where all_id=" & Me.Request.QueryString("allid")).Tables(0).Rows(0)(0)

        str = "select ad.emp_code,em.emp_name,nvl(ad.all_amount,0) from incentives_allowances_dtl ad,employee_master em,employ_firm f where ad.emp_code=em.emp_code and em.emp_code=f.emp_code and f.firm_id=" & Session("firm_id") & " and ad.all_id=" & Me.Request.QueryString("allid") & " having ad.all_amount<>0 group by ad.emp_code,em.emp_name,ad.all_amount order by ad.emp_code"
        ...
        back3.Text = "<a href=test_hrm_confirm.aspx><= Back</a>"
        back.Controls.Add(back3)
        itemtable.Controls.Add(back)

        Panel_itemwise.Controls.Add(itemtable)
    End Sub
End Class
