...
Partial Class reg_emp_current_a71414456041
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.Request.QueryString("status") = 0 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Regionwise list of All employees(excludig Res and Terminated Employees)</font></b>"
        ElseIf Me.Request.QueryString("status") = 1 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Regionwise list of Normal employees</font></b>"
        ElseIf Me.Request.QueryString("status") = 3 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Regionwise list of Resigned employees</font></b>"
        ElseIf Me.Request.QueryString("status") = 4 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Regionwise list of Suspended employees</font></b>"
        ElseIf Me.Request.QueryString("status") = 6 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Regionwise list of employees in Long Leave</font></b>"
        ElseIf Me.Request.QueryString("status") = 10 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Regionwise list of employees in Maternity Leave</font></b>"
        ElseIf Me.Request.QueryString("status") = 5 Then
            pheadercell.Text = "<body align=center ><b><font size=3> Regionwise list of Terminated employees</font></b>"
        ...
        If Me.Request.QueryString("status") = 0 Then
            str = "select bd.reg_id,bd.REG_NAME,count(ec.emp_code),sum(nvl(ec.exp_day,0))as Total_exp from branch_detail bd,employee_current ec where ec.status_id not in (3,5) and bd.zonal_id=" & Me.Request.QueryString("zonalid") & " and ec.branch_id=bd.BRANCH_ID group by bd.reg_id,bd.REG_NAME"
        Else
            str = "select bd.reg_id,bd.REG_NAME,count(ec.emp_code),sum(nvl(ec.exp_day,0))as Total_exp from branch_detail bd,employee_current ec where ec.status_id=" & Me.Request.QueryString("status") & "and bd.zonal_id=" & Me.Request.QueryString("zonalid") & " and ec.branch_id=bd.BRANCH_ID group by bd.reg_id,bd.REG_NAME"
        End If
        ...
        For Each dr In dt.Rows
            ...
            v1.Text = "<a href=divisionemp_current.aspx?status=" & Me.Request.QueryString("status") & "&regionid=" & dr(0) & "><font size=2>" & dr(1) & "</font></a>"
            val.Controls.Add(v1)
        ...
        t1.Text = "<b><font size=2> Total Employees:&nbsp;" & Me.total & " and Total Experience Days=" & Me.exptotal & "</font></b>"
