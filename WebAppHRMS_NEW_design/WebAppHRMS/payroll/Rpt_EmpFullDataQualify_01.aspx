...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function btn_confirm_onclick() {
            ...
            if (Min == "") { alert("Enter Minimum Marks ..!!!"); document.getElementById("Text1").focus(); return false; }
            if (Max == "") { alert("Enter Maximam Marks ..!!!"); document.getElementById("Text2").focus(); return false; }
            var Class = Min + '-' + Max;
    ...
    <div style="text-align: center">
        <table border="1" style="width: 50%; font-family: Courier New">
            ...
            <tr>
                <td style="width: 20%">Marks/Class</td>
                <td style="width: 20%; text-align: left">
