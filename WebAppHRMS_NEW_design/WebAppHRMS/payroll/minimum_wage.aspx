<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="minimum_wage.aspx.vb" Inherits="WebAppHRMS.jewel_minimum_wage_1420c7683669" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="Transparent" BorderStyle="Solid"
            BorderWidth="1px" Height="330px" Width="500px" BorderColor="Black">
            ...
            <table border="1" style="width: 280px; height: 117px">
                ...
                <tr>
                    <td colspan="2">
                        <asp:Label ID="lbl_hd" runat="server" Font-Bold="True" Font-Size="Large" Font-Underline="True"
                            ForeColor="red" Height="32px" Text="STATE WISE MINIMUM WAGE UPDATION" Width="416px"></asp:Label><br />
                    </td>
                </tr>

                <tr>
                    <td style="width: 205px; text-align: justify; height: 27px;">Select&nbsp;Designation  :</td>
                    <td style="width: 233px; text-align: justify; height: 27px;">
                        <asp:DropDownList ID="cmb_des" AutoPostBack="true" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td style="width: 205px; text-align: justify; height: 27px;">Select&nbsp;State :</td>
                    <td style="width: 233px; text-align: justify; height: 27px;">
                ...
                <%-- 
             <tr>
                <td style="width: 205px; text-align: justify; height: 27px;">
                ...
                <tr>
                    <td style="width: 162px; text-align: left">Present&nbsp;Minimum&nbsp;Wage&nbsp; :
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 162px; text-align: left; height: 28px;">New&nbsp;Minimum&nbsp;Wage&nbsp; :
                    </td>
                ...
                <tr>
                    <td style="width: 205px; text-align: center">
                        <asp:Button ID="Btn_confirm" runat="server" Text="CONFIRM" Height="24px" Width="83px" Style="cursor: hand" OnClientClick="return dt_check()" /></td>
                    <td style="width: 205px; text-align: center">
                        <input id="Btn_exit" style="width: 73px; cursor: hand;" type="button" value="EXIT" onclick="return cmd_exit_onclick()" />
