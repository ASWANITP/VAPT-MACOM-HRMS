...
Partial Class EXTRAFORMS_HRM_SALARY_cd0a3f603800
    ...
    Public Sub DataFill()
        ...
        dt = oh.ExecuteDataSet("select e.emp_code,e.emp_name,sum(h.amount) ,'TOTAL',h.sd_no,f.firm_abbr,h.rec_firm from  employee_master e,hrm_sd_confirmation h,firm_master f where e.emp_code=h.emp_code and h.firm_id=f.firm_id and h.given_status=1 and h.process_status=0 group by e.emp_code,e.emp_name,h.sd_no,f.firm_abbr,h.rec_firm  order by e.emp_code").Tables(0)
