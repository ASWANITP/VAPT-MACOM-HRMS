...
Public Class crpt_emp_image
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.crpt_emp_image.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcrpt_emp_image
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpt_emp_image = New crpt_emp_image()
        rpt.Site = Me.Site
        Return rpt
    End Function
