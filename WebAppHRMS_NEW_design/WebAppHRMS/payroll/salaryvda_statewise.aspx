<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="salaryvda_statewise.aspx.vb" Inherits="WebAppHRMS.salaryvda_b9f3103f2291" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function check_dt_mod() {
            debugger;
            if (isNaN(document.getElementById(cs[0] + "dt_effect").value) || document.getElementById(cs[0] + "dt_effect").value == "") {
                alert("'Please Select Date Using Calendar..!!'");
                document.getElementById(cs[0] + "dt_effect").value = ""
                document.getElementById(cs[0] + "dt_effect").focus()
                return false;
            }
        }
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Assuming you have an input element with an id "dateInput"
            var dateInput = document.getElementById("dt_effect");

            // Set the value of the input to the 1st day of the current month
    ...
    <div style="text-align: center">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="Transparent" BorderStyle="Solid"
            BorderWidth="1px" Height="357px" Width="461px" BorderColor="Black">
            ...
            <table border="1" style="width: 280px; height: 117px">
                <tr>
                    <td colspan="2">
                        <asp:Label ID="lbl_hd" runat="server" Font-Bold="True" Font-Size="Large" Font-Underline="True"
                            ForeColor="Maroon" Height="32px" Text="JEWELLER VDA STATE WISE" Width="416px"></asp:Label><br />
                    </td>
                </tr>
                <tr>
                    <td style="width: 208px; text-align: justify; height: 27px;">Select State :</td>
                    <td style="width: 233px; text-align: justify; height: 27px;">
                        <asp:DropDownList ID="cmb_State" AutoPostBack="true" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <%-- <tr>
                ...
                <tr>
                    <td style="width: 208px; text-align: left">Present DA :
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 208px; text-align: left; height: 28px;">New DA &nbsp; &nbsp; :
                    </td>
                ...
                <tr>
                    <td style="width: 208px; height: 23px; text-align: left">Effect Date &nbsp;: 
                    </td>

                    <td style="width: 233px; height: 23px; text-align: left">
                        <asp:TextBox ID="dt_effect" runat="server" onkeydown="return check_dt_mod()"></asp:TextBox></td>
                ...
                <tr>
                    <td style="width: 208px; text-align: right; height: 34px;">
                        <asp:Button ID="Btn_confirm" runat="server" Text="CONFIRM" Height="28px" Width="93px" Style="cursor: hand" OnClientClick="return dt_check()" /></td>
                    <td style="width: 205px; text-align: LEAFT; height: 34px;">
                        <asp:Button ID="Button1" runat="server" Text="EXIT" Width="93px" Height="28px" />&nbsp;</td>
                </tr>
            </table>
