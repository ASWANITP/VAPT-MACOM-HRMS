...
Partial Class PROMOTION_promotion_effdtwise_report_2db4937b2419
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        sql = "select a.emp_code,c.emp_name,a.FROM_DT,nvl(a.BASIC_PAY,0),nvl(b.designation,'NA'),nvl(a.da_flag,'NA'),a.TO_DT,a.designation_id  from employ_promotion_dtl a,designation_master b,employee_master c  where to_dt is null and a.designation_id=b.designation_id and to_date(a.from_dt)>='" & arr(0) & "' and to_date(a.from_dt)<= '" & arr(1) & "' and to_date(a.FROM_DT) <> c.JOIN_DT and  a.emp_code=c.emp_code order by a.emp_code,to_date(a.from_dt)"
