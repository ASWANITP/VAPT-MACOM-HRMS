...
Partial Class transferreport_transfer_report_2dded1574234
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        Server.Transfer("transfer_display_report.aspx?emp=" & Me.cmb_select.SelectedValue & "&f_dt=" & Me.txt_fdt.Text & "&t_dt=" & Me.txt_tdt.Text)
    End Sub
