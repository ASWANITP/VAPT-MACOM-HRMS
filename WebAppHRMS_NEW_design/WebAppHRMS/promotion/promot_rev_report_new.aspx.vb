...
Partial Class PROMOTION_prom_rev_report_neww_8c1612c74065
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        emp_code = Request.QueryString("emp")
        ...
        tc4.Text = "<font size=3 color=darkblue><b>PROMOTION&nbsp;&nbsp;/&nbsp;REVERTING&nbsp;DETAILS</b></font>"
        ...
        If dt2.Rows.Count > 0 Then
            ...
            If dt3.Rows.Count > 0 Then
                ...
                If saldiff < 0 Then
                    ...
                    tc111a.Text = "<font size=3 color=darkblue>" & saldiff & "(DECREMENT) </font>"
                Else
                    saldiff = saldiff
                    tc111a.Text = "<font size=3 color=darkblue>" & saldiff & "(INCREMENT)</font>"
                End If
