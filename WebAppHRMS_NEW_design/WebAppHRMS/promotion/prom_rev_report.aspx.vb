...
Partial Class PROMOTION_prom_rev_report_f6cc97c56540
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("firm_id") = 2 Then
            tc1.Text = "<font size=3 color=darkblue>Maben Nidhi LTD&nbsp;&nbsp;&nbsp;Buliding No.IV-709 B,&nbsp;First Floor,&nbsp;&nbsp;&nbsp;JP Mart.,&nbsp;&nbsp;Near High school Junction,&nbsp;&nbsp;Valappad P.O,Thrissur DT.Kerala 680567,CIN:U65991KL1993PLC007584, GSTIN:32AABCM5733E1ZW</font>"
        Else
