<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="emprep.aspx.vb" Inherits="WebAppHRMS.salary_report_sal_wage_rpt_4cd638811005" %>
...
<body onload="startTime()">
    <form id="form1" runat="server">
        <div style="text-align: right; background-color: #ffffff;">
            <br />
            <asp:Panel ID="Panel1" runat="server" Height="2px" Width="100%" BorderColor="Black" BorderStyle="Solid" BorderWidth="0px">
            </asp:Panel>
