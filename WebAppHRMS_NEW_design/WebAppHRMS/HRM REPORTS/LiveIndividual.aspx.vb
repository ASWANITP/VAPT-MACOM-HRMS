...
Partial Class HRM_ResignedIndividual_18319a941650
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack() Then
            ...
            Dim sql As String = ""
            If Status = 1 Then
                'sql = "select a.emp_code,substr(a.emp_name,1,17),substr(c.designation,1,15),substr(d.dep_name,1,16),a.join_dt from employee_master a,designation_master c,department_mst d where a.branch_id=" & BranchID & " and a.status_id=1 and to_date(a.join_dt)>='" & FromDt & "' and to_date(a.join_dt)<='" & ToDt & "' and a.designation_id=c.designation_id and a.department_id=d.dep_id and a.emp_code in (select emp_code from examination_dtl where status='P')"
                sql = "select a.emp_code,substr(a.emp_name,1,17),substr(c.designation,1,15),substr(d.dep_name,1,16),a.join_dt from employee_master a,designation_master c,department_mst d where a.branch_id=" & BranchID & " and a.status_id=1 and  a.designation_id=c.designation_id and a.department_id=d.dep_id and a.emp_code in (select emp_code from examination_dtl where status='P')"
                dt = oh.ExecuteDataSet(sql).Tables(0)
            Else
                'sql = "select a.emp_code,substr(a.emp_name,1,17),substr(c.designation,1,15),substr(d.dep_name,1,16),a.join_dt from employee_master a,designation_master c,department_mst d where a.branch_id=" & BranchID & " and a.status_id=1 and to_date(a.join_dt)>='" & FromDt & "' and to_date(a.join_dt)<='" & ToDt & "' and a.designation_id=c.designation_id and a.department_id=d.dep_id and a.emp_code in (select emp_code from examination_dtl where status='F') union all select a.emp_code,substr(a.emp_name,1,17),substr(c.designation,1,15),substr(d.dep_name,1,16),a.join_dt from employee_master a,designation_master c,department_mst d where a.branch_id=" & BranchID & " and a.status_id=1 and to_date(a.join_dt)>='" & FromDt & "' and to_date(a.join_dt)<='" & ToDt & "' and a.designation_id=c.designation_id and a.department_id=d.dep_id and a.emp_code not in (select emp_code from examination_dtl)"
                sql = "select a.emp_code,substr(a.emp_name,1,17),substr(c.designation,1,15),substr(d.dep_name,1,16),a.join_dt from employee_master a,designation_master c,department_mst d where a.branch_id=" & BranchID & " and a.status_id=1 and a.designation_id=c.designation_id and a.department_id=d.dep_id and a.emp_code in (select emp_code from examination_dtl where status='F') union all select a.emp_code,substr(a.emp_name,1,17),substr(c.designation,1,15),substr(d.dep_name,1,16),a.join_dt from employee_master a,designation_master c,department_mst d where a.branch_id=" & BranchID & " and a.status_id=1  and a.designation_id=c.designation_id and a.department_id=d.dep_id and a.emp_code not in (select emp_code from examination_dtl)"
                dt = oh.ExecuteDataSet(sql).Tables(0)
            End If
    ...
    Public Sub Head_print()
        ...
        If Status = 1 Then
            tr05_01.Text = "TRAINED EXISTING EMPLOYEES REPORT OF BRANCH :- " & BranchName & " "
        Else
            tr05_01.Text = "UNTRAINED EXISTING EMPLOYEES REPORT OF BRANCH :- " & BranchName & " "
        End If
        ...
        tr08_05.Attributes.Add("width", "10%")
    ...
    Public Sub Data_print()
        ...
        For Each dr In dt.Rows
            ...
            tr010_02.ColumnSpan = 3
            tr010_02.Attributes.Add("width", "25%")
            ...
            tr010_03.Attributes.Add("width", "30%")
            ...
            tr010_05.Attributes.Add("width", "10%")
