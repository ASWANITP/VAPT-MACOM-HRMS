...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="server">
    <table style="width: 100%;">
        ...
        <tr>
            <td align="center" colspan="6" style="height: 18px"></td>
        </tr>
        <tr>
            <td align="center" colspan="6" style="height: 18px">
        ...
        <tr>
            ...
            <td style="width: 130px;">
                <asp:RadioButton ID="RdoRecommendation" OnCheckedChanged="RdoRecommendation_CheckedChanged" AutoPostBack="true" Checked="true" GroupName="grp1" Text="Recommendation " runat="server" /></td>
            <td style="width: 90px;">
            ...
            <td>
                <asp:Button ID="ButnExcel" runat="server" Text="Export to Excel" Enabled="False" /></td>
            <td>
