...
Partial Class HRM_ResignedBranch_e6c1e81e2128
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack() Then
            ...
            If Status = 1 Then
                dt = oh.ExecuteDataSet("select d.branch_id,d.branch_name,count(*) as count from employee_master a,employee_master_dtl b,examination_dtl c,branch_detail d where d.area_id=" & AreaID & "  and a.status_id=3 and a.emp_code=b.emp_code and b.discont_dt is not null and to_date(b.discont_dt)>='" & FromDt & "' and to_date(b.discont_dt)<='" & ToDt & "' and c.status='P' and a.emp_code=c.emp_code and b.emp_code=c.emp_code and a.branch_id=d.branch_id group by d.branch_id,d.branch_name").Tables(0)
            Else
    ...
    Public Sub Head_print()
        ...
        If Status = 1 Then
            tr05_01.Text = "BRANCHWISE TRAINED RESIGNED EMPLOYEES REPORT "
        Else
            tr05_01.Text = "BRANCHWISE UNTRAINED RESIGNED EMPLOYEES REPORT "
        End If
