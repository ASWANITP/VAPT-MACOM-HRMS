<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="taformat.aspx.vb" Inherits="WebAppHRMS.new_view_punch_report_37f555f65187" Title="Untitled Page" %>
        ...
        <table>
            <tr>
                <td colspan="4" style="height: 47px">
                    <strong><span style="color: #ff0033">TA STATUS REPORT 
            ...
            <tr>
                ...
                <td style="width: 120px; text-align: left">Employ Wise<asp:CheckBox AutoPostBack="true" ID="CheckBox1" Checked="true" runat="server" />
                </td>
            ...
            <tr id="Tr1" runat="server">
                <td style="width: 110px; text-align: left">Select Employee</td>
