<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="TA_aprv.aspx.vb" Inherits="WebAppHRMS.TA_TA_aprv_7af713d18717" Title="Untitled Page" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <table align="center">
        ...
        <asp:GridView ID="Grid_view1" runat="server" AutoGenerateColumns="False" DataKeyNames="ta_id"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="rec_amnt" HeaderText="Recomend amount" />
    ...
    <table align="center">
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="ta_id"
            OnRowCommand="GridView2_RowCommand" align="center">
            <Columns>
                <asp:BoundField DataField="ta_id" HeaderText="TA id" />
                <asp:BoundField DataField="ta_date" HeaderText="TA date" />
                <asp:BoundField DataField="district" HeaderText="District" />
                ...
                <asp:BoundField DataField="fare" HeaderText="Fare" />
                <asp:BoundField DataField="bata" HeaderText="Bata" />
                <asp:BoundField DataField="total_ta" HeaderText="Actual TA" />
                <asp:BoundField DataField="remark" HeaderText="Remark" />
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" Text="Edit" runat="server" CommandArgument="<%# Container.DataItemIndex %>"></asp:LinkButton>
    ...
    <div runat="server" align="center" id="Div3">
        ...
        <table border="1" style="width: 70%; height: 50%">
            <tr>
                <th colspan="1" style="text-align: center">SL_no</th>
                <th colspan="1" style="text-align: center">TA Date</th>
                <th colspan="1" style="text-align: center">District</th>
                ...
                <th colspan="1" style="text-align: center">TA Amount</th>
                <th colspan="1" style="text-align: center">Remark</th>
            </tr>
            <tr>
                <td>
    ...
    <div runat="server" align="center" id="buttons" visible="false">
        ...
        <asp:Button ID="btn_cnfrm" runat="server" Text="REJECT" Width="109px" />&nbsp;
