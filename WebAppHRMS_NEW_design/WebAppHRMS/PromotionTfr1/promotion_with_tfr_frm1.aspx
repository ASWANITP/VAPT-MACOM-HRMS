<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="promotion_with_tfr_frm1.aspx.vb" Inherits="WebAppHRMS.Video_Recording_Branch_Video_Format_2bf6da0f4754" Title="Untitled Page" %>
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="border-left-color: #330066; border-bottom-color: #330066; border-top-color: #330066; border-right-color: #330066;" width="60%">
            ...
            <tr style="font-family: Times New Roman">
                <td style="width: 64%; height: 23px; text-align: left">
                    <strong></strong><span style="font-size: 11pt">Emp Name,Dept
                        &amp; Post</span></td>
            ...
            <tr style="font-family: Times New Roman">
                <td style="height: 28px; text-align: left" colspan="2">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    ...
                    <asp:Button ID="Cmd_Confirm" runat="server" Font-Bold="False" Font-Names="Times New Roman"
                        Height="34px" Text="CONFIRM" Width="80px" /><input id="Cmd_exit" style="font-weight: normal; width: 80px; font-family: 'Times New Roman'; height: 34px"
                            type="button" value="EXIT" onclick="return Cmd_exit_onclick()" /></td>
            </tr>
            <tr style="font-family: Times New Roman">
                <td colspan="2" style="height: 28px; text-align: left"></td>
            </tr>
        </table>
    </div>
    <asp:ScriptManager ID="ScriptManager1" runat="server">
    </asp:ScriptManager>
    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="Txt_empcode"></cc1:FilteredTextBoxExtender>
</asp:Content>
