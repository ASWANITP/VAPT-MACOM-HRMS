...
Partial Class promotiontfr_promotion_with_tfr_frm_0a274a971704
    ...
    Sub branch_fill()
        ...
        sql = "SELECT DISTINCT branch_name, branch_id FROM branch_master WHERE firm_id = 8 UNION SELECT DISTINCT branch_name, branch_id FROM branch_master WHERE branch_id = 0 ORDER BY branch_name"
        'Else
    ...
    Sub department_fill()
        ...
        sql = "SELECT dep_name, dep_id || '*' || dep_name FROM department_mst WHERE dep_name LIKE '%MACTECH%' ORDER BY dep_name"
        dt = oh.ExecuteDataSet(sql).Tables(0)
        If dt.Rows.Count > 0 Then
    ...
    Protected Sub cmd_Exit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_Exit.Click
        ...
        Response.Redirect("promotion_with_tfr_frm1.aspx")
    End Sub
            ...
            Else
                ...
                Else
                    ...
                    If ap = 1 Then
                        ...
                        ClientScript.RegisterStartupScript(Me.GetType(), "alert", "alert('PROMOTION WITH TRANSFER CONFIRMED SUCCESSFULLY!!!!');", True)
                        clear()
