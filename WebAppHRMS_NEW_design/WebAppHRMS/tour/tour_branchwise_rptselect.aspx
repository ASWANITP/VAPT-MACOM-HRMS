                ...
                <tr>
                    <td style="width: 100px; text-align: left">
                        <table border="0" style="width: 389px">
                            <tr>
                                <td style="width: 597px; height: 21px; text-align: left">&nbsp;<strong>Select Branch&nbsp; :</strong></td>
                                <td colspan="2" style="height: 21px; text-align: left">
                                    <asp:DropDownList ID="Cmb_Branch" runat="server" Width="262px">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td style="width: 597px; height: 21px; text-align: left"></td>
                            ...
                            <tr>
                                <td style="width: 597px; height: 21px; text-align: left">&nbsp;<strong>From Date &nbsp; &nbsp; &nbsp; :</strong></td>
                                <td colspan="2" style="height: 21px; text-align: left">
                                    <asp:TextBox ID="Txt_FromDate" onkeyup="return checkdate('Txt_FromDate')" runat="server" Width="153px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 597px; height: 21px; text-align: left">&nbsp;<strong>To Date &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;:</strong></td>
                                <td colspan="2" style="height: 21px; text-align: left">
