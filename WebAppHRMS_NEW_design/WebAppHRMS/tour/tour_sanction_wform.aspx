                        ...
                        <td>
                            ...
                            <table id='t1' runat="server" border="1" style="display: none;" width="100%">
                                ...
                                <tr id="b2" style="display: block">
                                    <td colspan="2" style="text-align: left; width: 122px;">
                                        <strong style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'">Branch Name</strong></td>
                                    <td colspan="2" style="width: 112px; text-align: left">
                                ...
                                <tr id="b3" style="display: block">
                                    ...
                                    <td colspan="2" style="text-align: left; width: 256px;">
                                        <strong style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'">Post Name</strong></td>
                                    <td colspan="2" style="text-align: left; width: 248px;">
                                ...
                                <tr id="b5" style="display: block">
                                    <td colspan="2" style="text-align: left; width: 122px;">
                                        <strong style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'">Tour Place</strong></td>
                                    <td colspan="2" style="width: 112px; text-align: left">
                                    ...
                                    <td colspan="2" style="text-align: left; width: 256px;">
                                        <strong style="font-weight: normal; font-size: 11pt; font-family: 'Courier New'">Tour Purpose</strong></td>
                                    <td colspan="2" style="text-align: left; width: 248px;">
            ...
            <table border="1">
                <tr>
                    ...
                    <td style="width: 57px; text-align: left">
                        <asp:Button ID="cmd_rec" runat="server" Text="RECOMMEND" Width="92px" Style="cursor: hand" Font-Bold="True" /></td>
