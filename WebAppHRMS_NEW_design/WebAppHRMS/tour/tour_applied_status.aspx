...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1" style="width: 503px; height: 99px">
            ...
            <tr>
                <td rowspan="2" style="width: 186px; text-align: right">Tour From Date :&nbsp;
                </td>
                <td style="width: 16px; height: 13px; text-align: right">From :
                </td>
            ...
            <tr>
                <td style="width: 16px; height: 4px; text-align: right">To :
                </td>
