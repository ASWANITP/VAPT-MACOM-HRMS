<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="new_tour_sanction_wformMacom.aspx.vb" Inherits="WebAppHRMS.Tour_Sanction_tour_sanction_wform_8621ff0f3769" Title="Tour Sanction/Rejection" %>
                                ...
                                <tr id="b1" style="display: none">
                                    ...
                                    <td colspan="2" style="width: 248px; text-align: left; height: 30px;">
                                        <asp:TextBox ID="Txt_EmpCode" runat="server" Width="119px" ReadOnly="True" Font-Bold="False"
                                            ForeColor="Black" Style="cursor: hand; font-weight: normal; font-size: 11pt; font-family: 'Courier New';"
