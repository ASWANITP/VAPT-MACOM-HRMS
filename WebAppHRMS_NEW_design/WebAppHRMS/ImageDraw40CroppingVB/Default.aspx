            ...
            <table border="1" style="width: 656px; height: 72px">
                <tr>
                    <td colspan="4" style="height: 34px">
                        <strong><span style="font-size: 14pt; color: #990099; font-family: Courier New; text-decoration: underline;">EMPLOYEE ID-CARD CREATION</span></strong></td>
                </tr>
                <tr>
                    <td colspan="4" style="height: 24px">
                        <span style="font-size: 11pt; font-family: Courier New">SELECT EMPLOYEE : </span>
                        <asp:DropDownList ID="mydrop" runat="server" AutoPostBack="true" Width="300px"></asp:DropDownList></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="4" style="width: 100%; height: 7px; text-align: center">
                        ...
                        <asp:Panel ID="pnlCropped" runat="server" Visible="false">
                            ...
                            <asp:Image ID="imgCropped" runat="server" /><br />
                            <br />
