<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="PresentReportB.aspx.vb" Inherits="WebAppHRMS.Attendence_Report_PresentReportB_0e8de44c4422" %>
...
<body style="text-align: center">
    <form id="form1" runat="server">
        <script type="text/javascript">
            function next(bid, frdate) {

                window.open('PresentReportE.aspx?brid=' + bid + '&fdate=' + frdate, '_self');
