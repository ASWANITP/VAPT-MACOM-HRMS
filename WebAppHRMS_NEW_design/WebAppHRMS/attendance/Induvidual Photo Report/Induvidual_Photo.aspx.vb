...
Partial Class HRM_Punching_Report_Induvidual_Photo_0e0b060f9152
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (dt1.Rows(0)(0) = Session("firm_id")) Then
            Server.Transfer("Display_punch_report.aspx?Fdt=" & txtfdt.Text & "&Tdt=" & txttdt.Text & "&Ecode=" & txtcode.Text)
        Else
