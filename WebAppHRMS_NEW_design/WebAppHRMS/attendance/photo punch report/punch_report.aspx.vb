...
Partial Class new_view_punch_report_2b45d0536780
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            '============
            ft = oh.ExecuteDataSet("select t.query from hrm_report_master t where t.query_id=149 and t.firm_id=99").Tables(0)
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        Else
            ...
            End If
            Server.Transfer("show_report.aspx?fdt=" & Me.Txt_fdt.Text & "&tdt=" & Me.Txt_tdt.Text & "&type=" & ttype & "")
        End If
    End Sub
