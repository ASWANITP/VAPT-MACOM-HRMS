...
Partial Class Auction_Listed_pledges_d40b1d3c4410
        ...
        Else
            ...
            Try
                If menu(0) = 1 Then
                    ...
                    str_tkn.Append("@")
                    sql = "select t.query from HRM_REPORT_MASTER t where query_id = 149 and firm_id=99"
                    dt = oh.ExecuteDataSet(sql).Tables(0)
                    If Request.QueryString("type").ToString.Split("!")(1) = "B" Then
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        Dim cl_script1 As New StringBuilder
        cl_script1.Append("    window.open('punch_report.aspx','_self');")
        Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "inv", cl_script1.ToString, True)
    End Sub
End Class
