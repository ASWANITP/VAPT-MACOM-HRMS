...
Partial Class new_view_punch_report_2b45d0532587
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            '============
            ft = oh.ExecuteDataSet("select t.query from hrm_report_master t where t.query_id=159 and t.firm_id=99").Tables(0)
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        If (Me.cmb_branch.SelectedValue = "") AndAlso Me.CheckBox2.Checked = True Then
            ...
            Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "inv", cl_script9.ToString, True)
            Exit Sub
        ElseIf (Me.DropDownList2.SelectedValue = "-1") AndAlso Me.CheckBox1.Checked = True Then

            cl_script9.Append(" alert('Select Any Employee');")
            Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "inv", cl_script9.ToString, True)
            Exit Sub
        Else
            If Me.CheckBox1.Checked = True And Me.DropDownList2.SelectedValue <> "0" Then
                ttype = Me.DropDownList2.SelectedValue + "!E"
            ElseIf Me.CheckBox1.Checked = True And Me.DropDownList2.SelectedValue = "0" Then
                ttype = "0" + "!A"
            ElseIf Me.CheckBox2.Checked = True Then
                ttype = Me.cmb_branch.SelectedValue + "!B"
            End If
            Server.Transfer("mfshow_report.aspx?fdt=" & Me.Txt_fdt.Text & "&tdt=" & Me.Txt_tdt.Text & "&type=" & ttype & "")
        End If
    End Sub
