...
Partial Class new_Branchview_punch_report_97a0b0c23898
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            dt = oh.ExecuteDataSet("select count(*) from form_accessibility s,employee_master e where e.status_id=1 and s.form_id=1745 and s.emp_id=e.post_id and e.emp_code=" & sf(0) & "").Tables(0)
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        If (CDate(Me.Txt_fdt.Text) > CDate(Me.Txt_tdt.Text)) Then
            ...
            Exit Sub
        Else
            Server.Transfer("BranchDisplay_punch_report.aspx?fdt=" & Me.Txt_fdt.Text & "&tdt=" & Me.Txt_tdt.Text & "")
        End If
