<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_ShiftChange_Mageeth.aspx.vb" Inherits="WebAppHRMS.macom_shift_change_hrm_ShiftChange_Mageeth_0400af3c8025" %>
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 80%">
            ...
            <tr>
                ...
                <td style="width: 20%; text-align: left">Department</td>
                <td style="width: 20%">
                    <asp:TextBox ID="txtDep" runat="server" Width="95%" ReadOnly="True"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 20%; text-align: left">Post</td>
                <td style="width: 20%">
