                    ...
                    <table border="1" style="width: 600px; position: static; background-color: #ffcc99; text-align: center;">
                        <tr>
                            <td colspan="4" style="height: 30px">
                                ...
                                <strong><span style="font-size: 14pt; color: #ff0033"></span></strong></td>
                        </tr>
                        <tr>
                            <td colspan="4" style="height: 30px">
                        ...
                        <tr>
                            <td colspan="4" style="height: 123px">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline">
                                    <ContentTemplate>
                                        <table style="width: 593px" border="1">
                                            <tbody>
                                                <tr>
                                                    <td colspan="2"><strong>SELECT DEPARTMENT</strong></td>
                                                    <td style="width: 316px; text-align: left" colspan="2">
                                                        <asp:DropDownList ID="cmb_dep" runat="server" Width="285px" AutoPostBack="True" EnableTheming="True"></asp:DropDownList></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <cc1:ListSearchExtender ID="ListSearchExtender1" runat="server" TargetControlID="cmb_dep"></cc1:ListSearchExtender>
                                    </ContentTemplate>
                                    <Triggers>
                        ...
                        <tr>
                            <td style="width: 323px; height: 27px"></td>
                            ...
                            <td style="width: 153px; height: 27px"></td>
                        </tr>
                    </table>
                </td>
            </tr>
