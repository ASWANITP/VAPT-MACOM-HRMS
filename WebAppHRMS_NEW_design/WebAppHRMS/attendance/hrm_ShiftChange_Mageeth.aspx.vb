...
Partial Class macom_shift_change_hrm_ShiftChange_Mageeth_0400af3c8025
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Else
                ...
                dt2 = oh.ExecuteDataSet("select -1 as in_time ,'-----Select-----' as sname  from dual union all select t.shift_id, t.shift|| ' --> ' || t.in_time || ' -- ' || t.out_time from time_tab t where t.shift_id in (152,153,154,155,156,157,158,159,160,161,162,163,164,165,166,172,173,174,175,176,177,178,179,180,182,183) order by in_time").Tables(0)
    ...
    Public Sub RaiseCallbackEvent(ByVal eventArgument As String) Implements System.Web.UI.ICallbackEventHandler.RaiseCallbackEvent
        ...
        Select Case (x)
            ...
            Case "1"
                ...
                dt2 = oh.ExecuteDataSet("select a.emp_name || ' * ' || c.dep_name || ' * ' || b.post_name || ' * ' || d.designation || ' * ' || e.shift  from employee_master a,post_mst b , department_mst c, designation_master d,time_tab e where a.post_id = b.post_id and a.department_id = c.dep_id and a.designation_id = d.designation_id and a.shift_id=e.shift_id and a.emp_code = " & str(1) & "").Tables(0)
