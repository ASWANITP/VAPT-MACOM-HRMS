...
Partial Class attend_attend_emp_5a3dba754441
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim dt As New DataTable
        Dim arun As String = "select em.emp_name,a.emp_code,a.curr_date,a.m_time,a.e_time from attend a,employee_master em where a.branch_id=em.branch_id and a.emp_code=em.emp_code and to_date(curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(curr_date)<='" & Request.QueryString.Get("tdate") & "' and ( not a.m_time is null and not a.e_time is null) and a.branch_id=" & Request.QueryString.Get("id") & " and a.shift_id=" & Request.QueryString.Get("shift") & " union all select em.emp_name,da.emp_code,da.curr_date,da.m_time,da.e_time from daily_attend da,employee_master em where da.branch_id=em.branch_id and da.emp_code=em.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and ( not da.m_time is null and not da.e_time is null) and da.branch_id=" & Request.QueryString.Get("id") & " and da.shift_id=" & Request.QueryString.Get("shift") & ""
        ...
        tct3.ColumnSpan = 4
        tct3.Text = "<b><font size=2 > Attendence Report Punched Employee </font></b>"
