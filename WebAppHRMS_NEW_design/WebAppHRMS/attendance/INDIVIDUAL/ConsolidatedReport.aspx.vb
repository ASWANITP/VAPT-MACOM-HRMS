...
Partial Class ConsolidatedReport_96d5385c5614
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        tdd31.Text = "<font size=4><b>Consolidated Attendance Report (Audit)</b></font>"
        ...
        If dt.Rows.Count > 0 Then
            dept = dt.Rows(0)("dep_name")
            Dim trr6 As New TableRow
            trr6.BackColor = Drawing.Color.SteelBlue
            trr6.ForeColor = Drawing.Color.White
            Dim tdd61 As New TableCell
            tdd61.Attributes.Add("width", "100%")
            tdd61.ColumnSpan = 100
            tdd61.HorizontalAlign = HorizontalAlign.Left
            tdd61.Text = "<font size=3>" & dept & "</font>"
            trr6.Controls.Add(tdd61)
            tb.Controls.Add(trr6)
        End If

        For Each dr In dt.Rows

            If dept <> dr("dep_name") Then
                dept = dr("dep_name")
                Dim trrr6 As New TableRow
                trrr6.BackColor = Drawing.Color.SteelBlue
                trrr6.ForeColor = Drawing.Color.White
                Dim tddd61 As New TableCell
                tddd61.Attributes.Add("width", "100%")
                tddd61.ColumnSpan = 100
                tddd61.HorizontalAlign = HorizontalAlign.Left
                tddd61.Text = "<font size=3>" & dept & "</font>"
                trrr6.Controls.Add(tddd61)
                tb.Controls.Add(trrr6)
            End If
