...
Partial Class hploanandchits_areareport_bf6d85676859
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        tt1.Text = "<b><font size=2>&nbsp;HP&nbsp;/&nbsp;BUSINESS&nbsp;&nbsp;LOAN&nbsp;/&nbsp;PERSONAL&nbsp;&nbsp;LOAN&nbsp;/&nbsp;CHITS&nbsp;&nbsp;Norms&nbsp;&nbsp;and&nbsp;&nbsp;shortages&nbsp;&nbsp;Areawise&nbsp;&nbsp;Report&nbsp;</font></b>"
        tt.Controls.Add(tt1)
        areatable.Controls.Add(tt)
        ...
        'areatable.Controls.Add(line)

        Dim ss As String = ""
        ss = oh.ExecuteDataSet("select div_name from division_master where division_id=" & Request.QueryString("div_id")).Tables(0).Rows(0)(0)
        ...
        zone1.Text = "<b><font size=2>" & ss & "&nbsp;&nbsp;Division</font></b>"
        zone1.HorizontalAlign = HorizontalAlign.Center
        zone.Controls.Add(zone1)
        areatable.Controls.Add(zone)
        ...
        f1.Text = "<b><font size=2>&nbsp;&nbsp;Area&nbsp;&nbsp;</font></b>"
        ...
        '                  1            2              3                  4                    5                                                    6                                                                                                                7                                                                                     8
        str = "select ad.area_id,am.area_name,count(st.branch_id),sum(st.fldstaff_loan),sum(st.fldstaff_loan_avbl),sum(case when st.fldstaff_loan-st.fldstaff_loan_avbl>0 then st.fldstaff_loan-st.fldstaff_loan_avbl else 0 end)as hp_short,sum(case when st.fldstaff_loan_avbl-st.fldstaff_loan>0 then st.fldstaff_loan_avbl-st.fldstaff_loan else 0 end)as hp_surplus,sum(st.bpc) from division_detail dd,area_detail ad,area_master am,staff_required st where dd.area_id =ad.area_id and ad.area_id=am.area_id And ad.branch_id = st.branch_id and st.branch_id<>0 and dd.div_id=" & Request.QueryString("div_id") & " group by ad.area_id,am.area_name order by ad.area_id,am.area_name"
        ...
        For Each dr In dt.Rows
            ...
            v1.Text = "<a href=brreport.aspx?area_id=" & dr(0) & "><font size=2>&nbsp;" & dr(1) & "&nbsp;</font></a>"
            value.Controls.Add(v1)
            areatable.Controls.Add(value)
        ...
        areatable.Controls.Add(line3)



        Panelarea.Controls.Add(areatable)
