...
Partial Class staffnorms_oth_employees_1e5de3307392
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim dt As New DataTable
    Dim dr As DataRow
    Dim str As String
    Dim othtable As New Table
    Dim i As Integer = 0

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '                  0           1             2              3           4           5          6
        str = "select em.emp_code,em.emp_name,em.branch_id,bm.branch_name,dm.designation,dp.dep_name,pm.post_name from employee_master em left outer join branch_master bm on(em.branch_id=bm.branch_id)left outer join designation_master dm on(em.designation_id=dm.designation_id) left outer join department_mst dp on(em.department_id=dp.dep_id)left outer join post_mst pm on(em.post_id=pm.post_id) where em.emp_code not in(select emp_code from employee_involve) and em.status_id=1 and em.branch_id>=0 and em.emp_code>9999 and em.shift_id not in(4,5)order by em.emp_code"
        ...
        If dt.Rows.Count > 0 Then
            ...
            q.Text = "<font size=2>Total:&nbsp;<b>" & Me.i & "</b>&nbsp;Employee(s)<font>"
            qlast.Controls.Add(q)
            othtable.Controls.Add(qlast)
        ...
        Else
            ...
            othtable.Controls.Add(warn)

        End If

        Panel_Others.Controls.Add(othtable)
