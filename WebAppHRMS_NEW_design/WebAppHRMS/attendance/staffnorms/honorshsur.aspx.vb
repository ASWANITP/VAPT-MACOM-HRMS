...
Partial Class honormsandshort_honorshsur_a02a88b86023
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If frm = 27 Then
            Response.Redirect("other_norm_branch_maf.aspx")
            Exit Sub
        End If
        ...
        tt1.Text = "<b><font size=2>&nbsp;&nbsp;&nbsp;Staff&nbsp;Shortages&nbsp;and&nbsp;Surplus&nbsp;Report&nbsp;Of&nbsp;Head&nbsp;Office,&nbsp;valapad&nbsp;&nbsp;&nbsp;</font></b>"
        tt.Controls.Add(tt1)
        ...
        f3.Text = "<b><font size=2>&nbsp;&nbsp;Required&nbsp;&nbsp;</font></b>"
        field.Controls.Add(f3)

        f4.ColumnSpan = 1
        f4.HorizontalAlign = HorizontalAlign.Center
        f4.Text = "<b><font size=2>&nbsp;&nbsp;Actual&nbsp;&nbsp;</font></b>"
        ...
        sum2.Width = 8
        s3.ColumnSpan = 8
        s3.Text = "<font size=2>At this time,no of staffs in Head Office&nbsp;:&nbsp;" & c2 & "&nbsp;</font>"
