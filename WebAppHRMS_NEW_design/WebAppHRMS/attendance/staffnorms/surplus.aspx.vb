...
Partial Class staff_noms_surplus_4a197d1e6286
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'Dim oh As New Helper.Oracle.OracleHelper
        'Dim dt As New DataTable
        'dt = oh.ExecuteDataSet("select nvl(st.sr_bh_avbl-st.sr_bh,0),nvl(st.bh_avbl-st.bh,0),nvl(st.abh_avbl-st.abh,0),nvl(st.jr_asst_avbl-st.jr_asst,0),nvl(st.sweeper_avbl-st.sweeper,0) from staff_required st where st.branch_id=" & Request.QueryString("br_id")).Tables(0)
        ...
        'tabc1.Text = "STAFF SHORT IN BRANCH REPORT"
        'tabr1.Controls.Add(tabc1)
        'tab.Controls.Add(tabr1)

        'Dim tabrb As New TableRow
        'Dim tabrb1 As New TableCell
        'tabrb.Width = 24
        'tabrb1.ColumnSpan = 24
        'tabrb1.Text = "<hr>"
        'tabrb.Controls.Add(tabrb1)
        'tab.Controls.Add(tabrb)
        'Dim tabr2 As New TableRow
        'tabr2.Width = 2

        'Dim tabr2c1, tabr2c2 As New TableCell
        'tabr2c1.ColumnSpan = 1
        'tabr2c2.ColumnSpan = 1

        'tabr2c1.Text = "<font size=2>" & "SR.BH" & "</font>"
        'tabr2c2.Text = "<font size=2>" & dt.Rows(0)(0) & "</font>"
        ...
        'tabr3c1.ColumnSpan = 1
        'tabr3c2.ColumnSpan = 1

        'tabr3c1.Text = "<font size=2>" & "BH" & "</font>"
        'tabr3c2.Text = "<font size=2>" & dt.Rows(0)(1) & "</font>"
        ...
        'tabr4c1.ColumnSpan = 1
        'tabr4c2.ColumnSpan = 1

        'tabr4c1.Text = "<font size=2>" & "ABH" & "</font>"
        'tabr4c2.Text = "<font size=2>" & dt.Rows(0)(2) & "</font>"
        ...
        'tabr5c1.Text = "<font size=2>" & "JR.ASST" & "</font>"
        'tabr5c2.Text = "<font size=2>" & dt.Rows(0)(3) & "</font>"
        ...
        'tabr6c1.Text = "<font size=2>" & "SWEEPER" & "</font>"
        ...
        dt = oh.ExecuteDataSet("select nvl(st.bh_avbl-st.bh,0),nvl(st.abh_avbl-st.abh,0),nvl(st.jr_asst_avbl-st.jr_asst,0),nvl(st.sweeper_avbl-st.sweeper,0),nvl(st.jo_avbl-st.jo,0) from staff_required st where st.branch_id=" & Request.QueryString("br_id")).Tables(0)
        Dim tab As New Table
        tab.Attributes.Add("width", "100%")
        ...
        tdr1.Text = "<font size=2><b> SURPLUS(TOT) REPORT </b></font>"
