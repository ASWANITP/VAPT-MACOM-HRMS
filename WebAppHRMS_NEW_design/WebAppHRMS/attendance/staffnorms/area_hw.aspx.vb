...
Imports System.Data
Partial Class staff_norms_hw_lg_ins_area_hw_e94b15874042
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        sql = "select count(sr.branch_id),ad.area_id,am.area_name,count(distinct ad.area_id) as hw_norms,sum(sr.hardware) as hw_Act,sum(sr.life_ins) as lins_act,sum(sr.general_ins)as gins_act from division_detail dd,area_detail ad,area_master am,staff_required sr where dd.area_id=ad.area_id and ad.area_id=am.area_id and ad.branch_id=sr.branch_id and sr.branch_id<>0 and dd.div_id=" & Request.QueryString("divisionid") & " group by ad.area_id,am.area_name order by ad.area_id,am.area_name"
