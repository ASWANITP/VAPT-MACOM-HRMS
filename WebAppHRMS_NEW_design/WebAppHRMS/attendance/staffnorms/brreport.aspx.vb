...
Partial Class hploanandchits_brreport_fc8c92e31689
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        tt1.Text = "<b><font size=2>&nbsp;HP&nbsp;/&nbsp;BUSINESS&nbsp;&nbsp;LOAN/PERSONAL&nbsp;&nbsp;LOAN&nbsp;/&nbsp;CHITS&nbsp;&nbsp;Norms&nbsp;&nbsp;and&nbsp;&nbsp;shortages&nbsp;&nbsp;Branchwise&nbsp;&nbsp;Report&nbsp;</font></b>"
        tt.Controls.Add(tt1)
        branch.Controls.Add(tt)
        ...
        'branch.Controls.Add(line)


        Dim ss As String = oh.ExecuteDataSet("select area_name from area_master where area_id=" & Request.QueryString("area_id")).Tables(0).Rows(0)(0)
        Dim zone As New TableRow
        zone.Width = 11
        zone.BackColor = Drawing.Color.Wheat
        Dim zone1 As New TableCell
        zone1.ColumnSpan = 11
        zone1.Text = "<b><font size=2>&nbsp;Area&nbsp;&nbsp;" & ss & "&nbsp;&nbsp;</font></b>"
        zone1.HorizontalAlign = HorizontalAlign.Center
        zone.Controls.Add(zone1)
        branch.Controls.Add(zone)
        ...
        branch.Controls.Add(line1)
        '                  1            2              3                  4                    5                                                    6                                                                                                                7                                                                                     8
        str = "select st.branch_id,bm.branch_name,st.fldstaff_loan,st.fldstaff_loan_avbl,case when st.fldstaff_loan-st.fldstaff_loan_avbl>0 then st.fldstaff_loan-st.fldstaff_loan_avbl else 0 end as hp_short,case when st.fldstaff_loan_avbl-st.fldstaff_loan>0 then st.fldstaff_loan_avbl-st.fldstaff_loan else 0 end as hp_surplus,st.bpc  from area_detail ad,staff_required st,branch_master bm where ad.branch_id = st.branch_id and st.branch_id=bm.branch_id and st.branch_id<>0 and ad.area_id=" & Request.QueryString("area_id") & " order by st.branch_id,bm.branch_name"
        ...
        bb.ColumnSpan = 2
        bb.HorizontalAlign = HorizontalAlign.Center
        ...
        branch.Controls.Add(line3)

        'Dim back As New TableRow
        'Dim back1 As New TableCell
        'back1.ColumnSpan = 11
        'back1.HorizontalAlign = HorizontalAlign.Center
        'back1.Text = "<a href=areareport.aspx?div_id="&&"><font size=2>Back</font></a>"
        'back.Controls.Add(back1)
        'branch.Controls.Add(back)



        PanelBranch.Controls.Add(branch)
    End Sub
End Class
