...
Partial Class staff_noms_notopened_branch_staff_48cb23773741
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim i As Integer = 0
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim dt As DataTable
        dt = oh.ExecuteDataSet("select e.emp_code,e.emp_name,bc.branch_name,e.post,e.department,e.designation,e.join_dt,e.qualification from employee_current e,before_completion bc where e.branch_id=bc.old_id and e.status_id=1 order by e.emp_code").Tables(0)
        ...
        tdr1.Text = "<font size=4><b><u>STAFF IN NOT OPENED BRANCHES</u></b></font>"
        ...
        tabh.Width = 15
        Dim tabh1, tabh2, tabh3, tabh4, tabh5, tabh6, tabh7, tabh8 As New TableCell
        ...
        tabh3.Text = "<font size=2><B>BRANCH&nbsp;&nbsp;</B></font>"
        tabh4.Text = "<font size=2><B>POST&nbsp;&nbsp;</B></font>"
        tabh5.Text = "<font size=2><B>DEPARTMENT&nbsp;&nbsp;</B></font>"
        tabh6.Text = "<font size=2><B>DESIGNATION&nbsp;&nbsp;</B></font>"
        tabh7.Text = "<font size=2><B>JOIN DATE&nbsp;&nbsp;</B></font>"
        tabh8.Text = "<font size=2><B>QUALIFICATION&nbsp;&nbsp;</B></font>"
        ...
        For Each dr In dt.Rows
            ...
            Dim tabrc1, tabrc2, tabrc3, tabrc4, tabrc5, tabrc6, tabrc7, tabrc8 As New TableCell
            tabr.Width = 14
            ...
            tabrc6.Text = "<font size=2>" & dr(5) & "&nbsp;&nbsp;&nbsp;&nbsp;</font>"
            tabrc7.Text = "<font size=2>" & Format(dr(6), "dd/MMM/yyyy") & "&nbsp;&nbsp;&nbsp;&nbsp;</font>"
        ...
        last1.Text = "<font size=2><b>Total&nbsp;Employees&nbsp;:&nbsp;</b>" & Me.i & "&nbsp;</font>"
