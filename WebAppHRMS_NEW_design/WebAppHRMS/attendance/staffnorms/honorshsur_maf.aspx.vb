...
Partial Class honormsandshort_honorshsur_a02a88b85407
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strs = strd(2).Replace("mybranch", Request.QueryString("branch"))
        ...
        str = strd(3).Replace("mybranch", Request.QueryString("branch"))
        ...
        For Each dr In dt.Rows
            ...
            v4.Text = "<font size=2>&nbsp;<a href='split_maf.aspx?depid=" & dr(1) & "&brid=" & dr(2) & "'>" & dr(4) & "</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>"
