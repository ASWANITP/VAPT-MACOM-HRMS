...
Partial Class Attendence_Report_PresentReportE_9703487c8351
    ...
    Dim category, type, id, depid As Integer
    Dim cat As String
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        depid = Request.QueryString.Get("dp")
        ...
        Select Case type
            Case 1
                ...
                Select Case category
                    ...
                    Case 1
                        sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.emp_code=" & Request.QueryString.Get("id") & " and (da.m_time is not null or da.e_time is not null or pay_id in (50,51,52,7)) order by day"
                        cat = "PRESENT"
                    Case 2
                        sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.emp_code=" & Request.QueryString.Get("id") & " and da.m_time is  null and da.e_time is  null and da.pay_id not in (50,51,52,7) order by day"
                        cat = "ABSENT"
                    Case 3
                        sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.emp_code=" & Request.QueryString.Get("id") & " And da.m_time > tt.in_time and da.e_time is not null and da.pay_id not in (50,52,7) order by day"
                        cat = "LATE"
                    Case 4
                        sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.emp_code=" & Request.QueryString.Get("id") & " And da.e_time < tt1.out_time and da.pay_id not in (51,52,7) order by day"
                        cat = "EARLY GOING"
                    Case 5
                        sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.emp_code=" & Request.QueryString.Get("id") & " and (((da.m_time is  null and da.pay_id<>50 ) or (da.e_time is  null and da.pay_id<>51)) AND NOT(DA.M_TIME IS NULL AND DA.E_TIME IS NULL) and da.pay_id not in (52)) order by day"
                        cat = "NON MARKING"
                End Select
            ...
            Case 2
                ...
                If id = 0 Then
                    ...
                    Select Case category
                        ...
                        Case 1
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch  and em.department_id = " & Request.QueryString.Get("dp") & " and da.branch_id=" & Request.QueryString.Get("id") & " and (da.m_time is not null or da.e_time is not null or pay_id in (50,51,52,7)) order by emp_code,day"
                            cat = "PRESENT"
                        Case 2
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch  and em.department_id = " & Request.QueryString.Get("dp") & " and da.branch_id=" & Request.QueryString.Get("id") & " and da.m_time is  null and da.e_time is  null and da.pay_id not in (50,51,52,7) order by emp_code,day"
                            cat = "ABSENT"
                        Case 3
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch    and em.department_id = " & Request.QueryString.Get("dp") & " and da.branch_id=" & Request.QueryString.Get("id") & " And da.m_time > tt.in_time and da.e_time is not null and da.pay_id not in (50,52,7) order by emp_code,day"
                            cat = "LATE"
                        Case 4
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch    and em.department_id = " & Request.QueryString.Get("dp") & " and da.branch_id=" & Request.QueryString.Get("id") & " And da.e_time < tt1.out_time and da.pay_id not in (51,52,7) order by emp_code,day"
                            cat = "EARLY GOING"
                        Case 5
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch      and em.department_id = " & Request.QueryString.Get("dp") & " and da.branch_id=" & Request.QueryString.Get("id") & " and (((da.m_time is  null and da.pay_id<>50 ) or (da.e_time is  null and da.pay_id<>51)) AND NOT(DA.M_TIME IS NULL AND DA.E_TIME IS NULL) and da.pay_id not in (52)) order by emp_code,day"
                            cat = "NON MARKING"
                    End Select
                ...
                Else
                    ...
                    Select Case category
                        ...
                        Case 1
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.branch_id=" & Request.QueryString.Get("id") & " and (da.m_time is not null or da.e_time is not null or pay_id in (50,51,52,7)) order by emp_code,day"
                            cat = "PRESENT"
                        Case 2
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.branch_id=" & Request.QueryString.Get("id") & " and da.m_time is  null and da.e_time is  null and da.pay_id not in (50,51,52,7) order by emp_code,day"
                            cat = "ABSENT"
                        Case 3
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.branch_id=" & Request.QueryString.Get("id") & " And da.m_time > tt.in_time and da.e_time is not null and da.pay_id not in (50,52,7) order by emp_code,day"
                            cat = "LATE"
                        Case 4
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.branch_id=" & Request.QueryString.Get("id") & " And da.e_time < tt1.out_time and da.pay_id not in (51,52,7) order by emp_code,day"
                            cat = "EARLY GOING"
                        Case 5
                            sql = "select to_date(curr_date) as day,em.emp_code as emp_code,upper(substr(em.emp_name,0,19)) as Name,decode(da.m_time,NULL,'----------',da.m_time) as morning_time,decode(bm1.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm1.branch_name,0,12)) as Morning_Branch,decode(e_time,NULL,'----------',e_time) as evening_time,decode(bm2.branch_name,'A.O.VALAPAD','HEADOFFICE',substr(bm2.branch_name,0,12)) as Evening_Branch,case when (da.m_time is null and da.pay_id not in (50,52)) and (da.pay_id not in (51,52) and da.e_time is null) then 'Absent' else case when da.pay_id in (50) and da.e_time is not null then 'Morning-REG' else case when da.pay_id in (51) and da.m_time is not null then 'Evening-REG' else case when da.pay_id in (52) then 'BOTH-REG'  else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and (da.e_time is null and da.pay_id not in (51,52,7)) then 'Late & Non-Marking' else case when da.m_time<=tt.in_time and (da.e_time is null and da.pay_id not in (51,52)) then 'Non-Marking Evening' else case when (da.m_time is null and da.pay_id not in (50,52,7)) and da.e_time <tt1.out_time then 'Non-Marking Morning & Early-Going' else case when (da.m_time is null and da.pay_id not in (50,52)) and da.e_time >=tt1.out_time then 'Non-Marking Morning' else case when da.m_time<=tt.in_time and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Early-Going' else case when (da.m_time>tt.in_time and da.pay_id not in (50,52,7) ) and (da.e_time<tt1.out_time and da.pay_id not in (51,52,7)) then 'Late & Early Going' else case when (da.m_time>tt.in_time and da.m_time<>'TOUR' and da.m_time<>'COMPEN' and da.pay_id not in (50,52,7)) and da.e_time>=tt1.out_time then 'Late' else case when da.pay_id in (50) and da.E_TIME is null then  'REG-Morning & Non-Marking Evening'   else case when da.pay_id in (51) and da.M_TIME is null then 'REG-Morning & Non-Marking Morning'  else  case  when da.pay_id in (50) and da.e_time<>'TOUR' and da.e_time<>'COMPEN'  and da.E_TIME <tt1.out_time then 'REG-Morning & Early-Going'  else  case  when da.pay_id in (51) and da.m_time<>'TOUR' and da.m_time<>'COMPEN'  and da.M_TIME>tt.in_time then  'REG-Evening & Late' else case when da.pay_id in (52) then 'REG-Morning & Evening'   else '' end end end end end end end end end end end end end end end end as remarks from ATTENDANCE da, employee_master em,branch_master bm1, branch_master bm2, time_tab tt, time_tab tt1 where  em.emp_code=da.emp_code and to_date(da.curr_date)>='" & Request.QueryString.Get("fdate") & "' and to_date(da.curr_date)<='" & Request.QueryString.Get("tdate") & "' and da.m_shift=tt.shift_id and da.e_shift=tt1.shift_id and bm1.branch_id=da.m_branch and bm2.branch_id=da.e_branch and da.branch_id=" & Request.QueryString.Get("id") & " and (((da.m_time is  null and da.pay_id<>50 ) or (da.e_time is  null and da.pay_id<>51)) AND NOT(DA.M_TIME IS NULL AND DA.E_TIME IS NULL) and da.pay_id not in (52)) order by emp_code,day"
                            cat = "NON MARKING"
                    End Select
        ...
        td41.Text = "<font size=3><b>" & cat & " &nbspReport From :&nbsp" & fdate & " &nbsp To :" & tdate & " </b></font>"
