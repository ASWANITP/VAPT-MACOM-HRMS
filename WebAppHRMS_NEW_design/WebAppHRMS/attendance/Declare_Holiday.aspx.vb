...
Partial Class Prem_Declare_Holiday_3f7b7b537409
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim dept As DataTable = oh.ExecuteDataSet("select count(*)from employee_master t where t.DEPARTMENT_ID in(748,825) and t.emp_code=" & sf(0) & "").Tables(0)
        If dept.Rows(0)(0) = 1 Then
            Response.Redirect("School_Holiday.aspx")
        End If
        ''-----70009846
    ...
    Sub past_holidays()
        ...
        dt1 = oh.ExecuteDataSet("select distinct hol_day as Holidays from common_holiday where state_id=" & Me.DDL_state.SelectedValue & " order by hol_day").Tables(0)
    ...
    Protected Sub btn_submit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_submit.Click
        Try
            Dim parm_coll1(3) As OracleParameter
