                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width: 100px; text-align: left">
                                <asp:TextBox ID="txt_ecode" onkeyup="number('txt_ecode')" runat="server" Width="152px" OnTextChanged="txt_ecode_TextChanged" AutoPostBack="True" MaxLength="6"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td style="width: 100px; text-align: left">
                        ...
                        <tr>
                            ...
                            <td style="width: 100px; text-align: left">
                                <asp:TextBox ID="txt_date" runat="server" Width="152px" OnTextChanged="txt_date_TextChanged" AutoPostBack="True" onkeyup="return correct('txt_date',event)"></asp:TextBox>
                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_date" Format="dd/MMM/yyyy"></cc1:CalendarExtender>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 100px; height: 28px; text-align: left">
                                <asp:TextBox ID="txt_reason" runat="server" Width="256px" MaxLength="36"></asp:TextBox></td>
                        </tr>
                        <tr>
