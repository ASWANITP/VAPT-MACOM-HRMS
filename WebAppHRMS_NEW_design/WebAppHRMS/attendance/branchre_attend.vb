...
Public Class branchre_attend
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.branchre_attend.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedbranchre_attend
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As branchre_attend = New branchre_attend()
        rpt.Site = Me.Site
        Return rpt
    End Function
