...
Partial Class attendance_DRILL_DOWN_Block_Details_7c51d4426140
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        shi = "select distinct t.emp_name from employee_master t, employee_block_dtl_his b where t.emp_code=b.emp_code and b.emp_code= " & Me.Logger & " union all select distinct t.emp_name from employee_master t, employee_block_dtl b where t.emp_code=b.emp_code and b.emp_code= " & Me.Logger & ""
        ...
        strHTML.Append("<tr> <td>" & dt1 & "</td>  <td>" & Me.Logger & "</td><td>" & nam & "</td> </tr>")
