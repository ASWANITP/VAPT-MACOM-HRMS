...
Public Class leave_rep_period
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.leave_rep_period.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedleave_rep_period
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As leave_rep_period = New leave_rep_period()
        rpt.Site = Me.Site
        Return rpt
    End Function
