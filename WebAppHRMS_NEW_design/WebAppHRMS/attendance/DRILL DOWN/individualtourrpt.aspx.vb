...
Partial Class specificempattend_individualreport_c3abaf027752
    Inherits System.Web.UI.Page
    Dim dt, dt1, dt6, dt7, dt8, dt9, dt10, dt11 As New DataTable
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If dt1.Rows.Count > 0 Then
            ...
            Dim td60 As New TableCell
            td60.Attributes.Add("width", "15%")
            td60.ColumnSpan = 7
            td60.HorizontalAlign = HorizontalAlign.Left
            td60.Text = "<font size=2.5><b></b></font>"
            tr5.Controls.Add(td60)

            Dim td59 As New TableCell
            td59.Attributes.Add("width", "25%")
            td59.ColumnSpan = 15
            td59.HorizontalAlign = HorizontalAlign.Center
            td59.Text = "<font size=2.5><b>IN BRANCH</b></font>"
            tr5.Controls.Add(td59)
            tb.Controls.Add(tr5)
            tb.Controls.Add(tr5)

            Dim td611 As New TableCell
            td611.Attributes.Add("width", "15%")
            td611.ColumnSpan = 7
            td611.HorizontalAlign = HorizontalAlign.Left
            td611.Text = "<font size=2.5><b></b></font>"
            tr5.Controls.Add(td611)

            Dim td591 As New TableCell
            td591.Attributes.Add("width", "25%")
            td591.ColumnSpan = 15
            td591.HorizontalAlign = HorizontalAlign.Center
            td591.Text = "<font size=2.5><b>OUT BRANCH</b></font>"
            tr5.Controls.Add(td591)
            tb.Controls.Add(tr5)
            tb.Controls.Add(tr5)
