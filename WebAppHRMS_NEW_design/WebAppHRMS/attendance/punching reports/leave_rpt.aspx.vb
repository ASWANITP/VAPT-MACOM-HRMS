...
Partial Class leave_leave_rpt_db6829b44502
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("branch_id") = 0 Then
            Dim name As String = "select a.leave_frdate,a.leave_todate,a.leave_days,b.leave_type,a.leave_reason from employ_leave_dtl a,leave_master b where a.leave_id=b.leave_id and a.leave_process_id in (1,2) and a.status=1 and a.emp_code=" & Request.QueryString.Get("emp_code") & "and to_date(leave_frdate)>='" & Request.QueryString.Get("fdt") & "' and to_date(leave_todate)<='" & Request.QueryString.Get("tdt") & "' order by to_date(leave_frdate)"
