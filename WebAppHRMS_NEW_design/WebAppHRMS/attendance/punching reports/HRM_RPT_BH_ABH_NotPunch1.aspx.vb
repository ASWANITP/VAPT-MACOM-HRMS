...
Partial Class HRM_SECURITY_HRM_RPT_BH_ABH_NotPunch1_ce6bc5c69959
    Inherits System.Web.UI.Page
    Dim oh As New Helper.Oracle.OracleHelper
    Dim dt, dt2 As New DataTable
    Dim dt1 As New DataTable
    Dim ZoneID, BranchID As Integer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        RH.Heading(Session("branch_id"), Session("branch_name"), Session("firm_name"), tb, "BH ABH NOT PUNCH REPORT ", 20)
        Dim tr07 As New TableRow
        Dim tr07_01, tr07_02, tr07_03, tr07_04 As New TableCell
        RH.AddColumn(tr07, tr07_01, 5, 10, "l", "ZONE&nbsp;&nbsp;NAME ")
        ...
        For Each dr In dt.Rows
            ...
            Else
                ...
                RowBG = 0
            End If
            RH.AddColumn(tr09, tr09_01, 5, 10, "l", "<a href=javascript:nextpage('" & dr(0) & "'," & BrID & ")>" & dr(1) & "")
