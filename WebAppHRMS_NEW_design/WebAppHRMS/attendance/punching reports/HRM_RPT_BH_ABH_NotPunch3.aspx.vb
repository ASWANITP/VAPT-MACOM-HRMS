...
Partial Class HRM_SECURITY_HRM_RPT_BH_ABH_NotPunch3_baedd9008843
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Dim arid As Integer = Request.QueryString.Get("id")
        'Dim zone As Integer = Request.QueryString.Get("zone")
        ...
        dt = oh.ExecuteDataSet("select reg_name from region_master where reg_id=" & arid & "").Tables(0)
        Dim REG_NAME As String = dt.Rows(0)(0)
        RH.Heading(Session("branch_id"), Session("branch_name"), Session("firm_name"), tb, "BH ABH NOT PUNCH REPORT OF " & REG_NAME & "-REGION", 20)
        Dim tr07 As New TableRow
        Dim tr07_01, tr07_02, tr07_03, tr07_04 As New TableCell
        RH.AddColumn(tr07, tr07_01, 5, 10, "l", "AREA&nbsp;&nbsp;NAME")
