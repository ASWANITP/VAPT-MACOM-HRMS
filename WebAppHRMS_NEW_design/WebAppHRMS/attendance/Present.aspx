...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1">
            <tr>
                <td colspan="2" style="font-weight: bold; height: 20px">CONSOLIDATED REPORT<asp:ScriptManager ID="ScriptManager1" runat="server">
                </asp:ScriptManager>
            ...
            <tr>
                <td colspan="2" style="height: 79px">From Date &nbsp;&nbsp;
