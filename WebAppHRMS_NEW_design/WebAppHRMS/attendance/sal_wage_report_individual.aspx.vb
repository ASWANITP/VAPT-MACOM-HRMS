...
Partial Class salary_report_sal_wage_report_individual_1929f92f7860
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim s As String = oh.ExecuteDataSet("select distinct to_char(to_date(sal_dt),'MONTH, yyyy') from m_wage").Tables(0).Rows(0)(0)
        ...
        '=-=-=-=-=-=- Code for Back Link Buttoan

        'Panel1.Controls.Add(tab)
        'Dim rback As New TableRow
        'rback.Width = 7
        'Dim b1 As New TableCell
        'b1.HorizontalAlign = HorizontalAlign.Left
        'b1.ColumnSpan = 7
        'b1.Text = "<a href=../home.aspx><b><font size=2><=Back</font></b></a>"
        'rback.Controls.Add(b1)
        'tab.Controls.Add(rback)
