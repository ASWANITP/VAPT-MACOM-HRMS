...
Partial Class leave_Leave_sanction2_978d56b37917
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        str = dt1.Rows(0)(0).ToString.Split("#")(3)
        ...
        Me.Text6.Value = dt.Rows(0)(2)
        Me.Text7.Value = dt.Rows(0)(3)

        Me.Text4.Value = dt.Rows(0)(4)
        Me.Text8.Value = dt.Rows(0)(5)

        Me.Text5.Value = dt.Rows(0)(6)
        Me.Text9.Value = dt.Rows(0)(7)

        Me.Text10.Value = dt.Rows(0)(8)

        Me.Text11.Value = dt.Rows(0)(9)
