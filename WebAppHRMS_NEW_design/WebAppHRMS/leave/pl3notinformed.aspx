                ...
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label1" runat="server" BackColor="BlanchedAlmond" Font-Bold="True"
                            Font-Size="Large" ForeColor="Maroon" Text="NOT INFROMED PL3" Width="444px"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                            ...
                            <table border="1" style="width: 330px">
                                <tr>
                                    ...
                                    <td style="width: 90px; height: 28px; text-align: left">
                                        <asp:TextBox ID="Txt_fdate" runat="server" Width="155px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
