  ...
  if (SeleIndex==IntCount) 
   {
    ...
    <div style="text-align: center">
        <table border="1" style="width: 1px; height: 1px">
            ...
            <tr>
                <td colspan="10" style="color: #cc0000; height: 19px">
                    <asp:RadioButton ID="rdbRec1" Checked="true" runat="server" AutoPostBack="True" GroupName="rdboptn"
            ...
            <tr>
                <td colspan="10" style="color: #cc0000; height: 19px">&nbsp;<asp:DropDownList ID="cmb_leave" runat="server" Width="610px" OnChange="return emp_fill()" onblur="emp_fill()" onfocus="emp_fill()" Style="font-size: 11pt; font-family: 'Courier New'" AutoPostBack="True">
                </asp:DropDownList></td>
            </tr>
            <tr>
                <td colspan="10" style="color: #cc0000; height: 19px"></td>
