        ...
        <tr>
            <td colspan="2" style="text-align: center">
                <asp:Label ID="Label1" runat="server" Width="403px"></asp:Label>&nbsp;<table style="width: 516px" border="1">
                    <tr>
                        <td style="width: 100px; text-align: left;">Employee</td>
                        <td colspan="3">
                        ...
                        <td colspan="4" style="text-align: center">
                            <asp:Panel ID="Panel1" runat="server" Height="50px" Width="125px">
                                <table border="1" style="width: 504px">
                                    <tr>
                                        <td style="width: 230px; text-align: left">Return Date</td>
                                        <td style="width: 100px">
                            ...
                            <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy"
                                TargetControlID="txt_returndt"></cc1:CalendarExtender>
