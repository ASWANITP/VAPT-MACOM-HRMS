...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    <table style="width: 855px; height: 220px; left: 58px; position: relative; top: 0px;" border="1">
        ...
        <tr>
            <td style="width: 149px; height: 26px">&nbsp;Select</td>
            <td colspan="3" style="height: 26px">
                <asp:DropDownList ID="cmb_ecode" runat="server" Width="308px" AutoPostBack="True" Height="2px">
                </asp:DropDownList></td>
        </tr>
        <tr>
            <td style="width: 149px; height: 26px;">&nbsp;Employ Name</td>
        ...
        <tr>
            <td style="width: 149px; height: 21px">&nbsp;Sanctioned Person</td>
