<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="rej_res_ho_mpro.aspx.vb" Inherits="WebAppHRMS.leave_rej_res_ho_7faf59db1324" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Button1_onclick() {
            if ((document.getElementById("txt_rej").value) != "") {
                ...
                window.close("rej_res_ho_mpro.aspx");
