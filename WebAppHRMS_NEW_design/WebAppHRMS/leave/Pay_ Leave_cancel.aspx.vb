...
Partial Class Payroll_LeaveUpdation_1dc57b007771
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Me.Session("access_id") = 33 Then
            CType(Me.Master, WebAppHRMS.edp).Subtitle = "Leave Cancellation "
    ...
    Sub employee_fill()
        ...
        If (Me.txt_id.Text = "") Then
            ...
            Me.hf_eid.Value = 0
        Else
            str1 = "select e.emp_code,e.emp_name,b.branch_name from employee_master e ,branch_master b,employ_firm f where e.emp_code=f.emp_code and e.emp_code=" & Me.txt_id.Text & "and f.firm_id=" & ff & " and e.emp_code>'9999'and e.branch_id=b.branch_id"
            ...
            Else
                ...
                TABLE2.Visible = True
                Me.lbl_name.ForeColor = Drawing.Color.Blue
    ...
    End Sub
    Sub fill_leave_dtl()
        str2 = "select d.leave_seq,d.leave_frdate||' * '||d.leave_todate||' * '||m.leave_type||' * '||d.leave_days||'-Days'  from employ_leave_dtl d,leave_master m,general_parameter g where d.emp_code=" & Me.txt_id.Text & " and m.leave_id=d.leave_id and d.leave_process_id in(1,2) and to_date(d.leave_frdate)>add_months(to_date(sysdate),-g.parmtr_value) and g.parmtr_id=777 and d.leave_id in(4,3,2,1) order by d.leave_frdate desc,d.leave_id"
    ...
    End Sub
    Sub remaining_fill()
        str4 = "select lm.leave_type,m.leave_days from employ_leave_master m,leave_master lm where m.emp_code=" & Me.txt_id.Text & "and m.leave_id=lm.leave_id"
    ...
    Protected Sub btn_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_confirm.Click
        ...
        If (validate_date() = 0) Then
            Exit Sub
        End If
        Dim parm_coll1(6) As OracleParameter
        ...
        oh.ExecuteNonQuery("upd_cancel_leave", parm_coll1)
        ...
        Else
            ...
            cl_script0.Append("         window.open('Pay_ Leave_cancel.aspx','_self');")
            Page.ClientScript.RegisterClientScriptBlock(Me.GetType, "client script", cl_script0.ToString, True)
        End If
    End Sub
End Class