...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <table border="1">
            <tr>
                <td style="width: 123px; text-align: left">Select Earlygoing :
                </td>
            ...
            <tr>
                <td style="width: 123px; text-align: left">Employee Code&nbsp; :</td>
                <td style="width: 100px; text-align: left">
                    <input id="txt_fromdt" runat="server" type="text" /></td>
            </tr>
            <tr>
                <td style="width: 123px; text-align: left">Earlygoing Date :
                </td>
                <td style="width: 100px; text-align: left">
                    <input id="txt_todt" runat="server" type="text" /></td>
            </tr>
            <tr>
                <td style="width: 123px; text-align: left">Earlygoing Reason :
                </td>
                <td style="width: 100px; text-align: left">
