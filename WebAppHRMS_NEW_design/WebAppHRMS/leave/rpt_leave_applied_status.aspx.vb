...
Partial Class Leave_Module_rpt_leave_applied_status_86b9fe5d5380
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            Dim kt As DataTable = oh.ExecuteDataSet("select emp_code || ' - ' || emp_name from employee_master e where e.emp_code =" & empCodeValue).Tables(0)
