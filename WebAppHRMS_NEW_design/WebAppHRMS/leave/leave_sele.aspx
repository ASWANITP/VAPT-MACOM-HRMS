<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="leave_sele.aspx.vb" Inherits="WebAppHRMS.test_leave_sele_33ff34cf4895" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ClientCheck() {
            debugger;
            var hid = document.getElementById(cont[0] + "hidEmpCode").value
            if ((document.getElementById(cont[0] + "hidEmpCode").value == "") || (document.getElementById(cont[0] + "hidEmpCode").value == 0) || (document.getElementById("txtEmpCode").value == "")) {
        ...
        function call_receiver(arg1) {
            ...
            if (arg2[0] == 11) {
                ...
                else {       //em.emp_code||'*'||em.emp_name||'*'||dm.designation||'*'||dp.dep_name||'*'||bm.branch_name||'*'||pm.post_name||'*'||case
                    dat = arg2[1].split("*");
    ...
    <div style="text-align: center">
        ...
        <table style="width: 93%; font-family: 'Bookman Old Style'">
            <tr>
                <td style="width: 100%">
                    <div style="text-align: center">
                        <table border="1" style="width: 95%; font-family: 'Bookman Old Style';">
                            <tr>
                                <td style="width: 25%; height: 7px; text-align: left;">&nbsp;Type Employee Code</td>
                                <td style="width: 11%; height: 7px; text-align: center;">
                                    <asp:TextBox ID="txtEmpCode" onkeyup="return EmpCodeKeyUp()" onchange="return EmpNameFind()" runat="server" Style="font-family: 'Bookman Old Style'; text-align: center"
                                        Width="103px"></asp:TextBox></td>
                                <td style="width: 25%; height: 7px; text-align: left;">&nbsp;Employee Name</td>
                                <td style="width: 25%; height: 7px; text-align: left;">
                                    <asp:TextBox ID="txtEmpName" runat="server" Style="font-family: 'Bookman Old Style'; font-variant: small-caps" MaxLength="6" ReadOnly="True" Width="97%"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="width: 25%; height: 7px; text-align: left">&nbsp;Leave From Date</td>
                                <td style="width: 11%; height: 7px; text-align: center">
                                    <asp:TextBox ID="txtLeaveFrom" onkeyup="return KeyUps('txtLeaveFrom')" onchange="Fill_Dateto()" runat="server" Style="font-family: 'Bookman Old Style'; text-align: center"
                                        Width="103px"></asp:TextBox></td>
                                <td style="width: 25%; height: 7px; text-align: left">&nbsp;Leave To Date</td>
                                <td style="width: 25%; height: 7px; text-align: left">
                                    <asp:TextBox ID="txtLeaveToDate" onkeyup="return KeyUps1('txtLeaveToDate')" onchange="Fill_Dateto()" runat="server" Style="font-family: 'Bookman Old Style'; text-align: center"
                                        Width="103px"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td colspan="4" style="height: 7px; text-align: center">
                                    <div style="text-align: center">
            ...
            <tr>
                <td style="width: 100px">
                    <asp:Label ID="Label1" runat="server" Height="24px" Style="font-weight: bold; font-family: 'Bookman Old Style'; font-variant: small-caps"
                        Width="820px"></asp:Label></td>
            </tr>
        </table>
    </div>
    <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy" TargetControlID="txtLeaveFrom"></cc1:CalendarExtender>
    <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy" TargetControlID="txtLeaveToDate"></cc1:CalendarExtender>
