...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    <table style="width: 934px; height: 78px" border="2">
        <tr>
            <td colspan="5" style="text-align: center">&nbsp;<asp:Label ID="Lbl_msg" runat="server" ForeColor="Red"></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 148px; height: 24px">&nbsp;Select</td>
            <td colspan="3" style="height: 24px">
                <asp:DropDownList ID="cmb_ecode" runat="server" Width="725px" AutoPostBack="True">
                </asp:DropDownList></td>
        </tr>
        <tr>
            <td style="width: 148px; height: 24px">&nbsp;Employee Name</td>
