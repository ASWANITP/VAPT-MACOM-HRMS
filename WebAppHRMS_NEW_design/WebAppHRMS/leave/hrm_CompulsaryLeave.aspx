<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="hrm_CompulsaryLeave.aspx.vb" Inherits="WebAppHRMS.Compulsary_Leave_hrm_CompulsaryLeave_12b9105a2174" Title="Untitled Page" %>
        ...
        <div style="text-align: center">
            <div style="text-align: center">
                ...
                <table border="1" style="width: 60%">
                    ...
                    <tr id="row3">
                        <td colspan="2" style="text-align: right">Remarks :
                        </td>
                        <td colspan="2" style="text-align: left">
