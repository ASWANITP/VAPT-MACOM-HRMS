...
Public Class leave_authrpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebAppHRMS.leave_authrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedleave_authrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As leave_authrpt = New leave_authrpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
