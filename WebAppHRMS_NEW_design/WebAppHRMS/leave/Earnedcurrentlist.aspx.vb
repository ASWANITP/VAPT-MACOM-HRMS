...
Partial Class Earnedcurrentlist_7ddcb5c81407
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        RH.Heading(Session("branch_id"), Session("branch_name"), Session("firm_name"), tb, "EARNED LEAVE LIST", 30)
        'rh.Heading(
        ...
        RH.AddColumn(tr07, tr07_06, 2, 10, "c", "EARNED&nbsp;LEAVE&nbsp;COUNT")
        RH.AddColumn(tr07, tr07_07, 2, 10, "c", "&nbsp;&nbsp;STATUS")
        tb.Controls.Add(tr07)
        RH.DrawLine(tb, 30)
        dt = oh.ExecuteDataSet("select a.emp_code,b.emp_name,c.branch_name,case when b.post_id in (select post_id from post_mst) then (select post_name from post_mst p where p.post_id = b.post_id) else 'NIL' end as post,a.leave_days,e.remark from employ_leave_master a,employee_master  b,branch_master c,status_mst e, employ_firm  ef where a.emp_code = b.emp_code And b.branch_id = c.branch_id and a.leave_id=3 and b.status_id = e.status_id and b.emp_code = ef.emp_code  and ef.firm_id = '" & Session("firm_id") & "' order by e.remark, b.emp_code").Tables(0)
