    ...
    <div style="text-align: center">
        ...
        <div style="text-align: center">
            <table border="1" style="width: 50%">
                <tr>
                    <td style="width: 50%">Select Category</td>
                ...
                <tr>
                    ...
                    <td style="width: 50%; text-align: left">
                        <input id="Butn_Exit" style="font-weight: bold; width: 71px; font-family: 'Courier New'; height: 28px"
                            type="button" value="EXIT" onclick="return Butn_Exit_onclick()" /></td>
                </tr>
                <tr>
