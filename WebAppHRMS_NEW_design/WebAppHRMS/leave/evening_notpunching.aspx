                ...
                <table border="0" style="width: 274px; height: 163px; text-align: left">
                    <tr>
                        <td colspan="2" style="border-bottom: olive thin solid; text-align: center;">
                            <span style="color: #990000"><span style="background-color: #ffe0c9"><span style="text-decoration: underline">EVENING NOT
                    ...
                    <tr>
                        <td style="width: 400px; text-align: right; height: 6px;">&nbsp; &nbsp;&nbsp; Select Date :
                        </td>
                    ...
                    <tr>
                        <td colspan="2" style="height: 23px; text-align: right">&nbsp; &nbsp;<asp:Button ID="cmd_report" runat="server" Height="24px" Text="REPORT"
