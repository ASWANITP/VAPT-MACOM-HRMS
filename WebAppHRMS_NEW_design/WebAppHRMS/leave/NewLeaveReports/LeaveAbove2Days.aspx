...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <br />
        <table style="border-right: darkslategray 1px outset; table-layout: fixed; border-top: darkslategray 1px outset; border-left: darkslategray 1px outset; width: 615px; border-bottom: darkslategray 1px outset; border-collapse: separate; height: auto">
            <tr style="height: 30px;">
                <td colspan="4" style="background-color: #5d7b9d; color: white;">&nbsp;<strong><span>MORE THAN 2
