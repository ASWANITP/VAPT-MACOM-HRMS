...
Partial Class leave_long_leaveaplln_73eb66c66879
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Request.QueryString.Get("l_id") = 1 Then
                If fr = 8 Then
                    Response.Redirect("long_leaveaplln_Macom.aspx?l_id=1")
                    Exit Sub
                End If
            ...
            ElseIf Request.QueryString.Get("l_id") = 2 Then
                If fr = 8 Then
                    Response.Redirect("long_leaveaplln_Macom.aspx?l_id=2")
                    Exit Sub
                End If
                'ElseIf Request.QueryString.Get("l_id") = 2 Then
    ...
    Sub fill()
        ...
        If Me.cmb_emp.Items.Count > 0 Then
            If Session("firm_id") = 24 Then
                dt1 = oh.ExecuteDataSet("select a.emp_code,b.designation,c.dep_name,d.branch_name,e.post_name,a.status_id from employee_master a,designation_master b,department_mst c,branch_master d,post_mst_jwell e where a.designation_id=b.designation_id and a.department_id=c.dep_id and a.branch_id=d.branch_id and a.post_id=e.post_id and a.emp_code=" & Me.cmb_emp.SelectedValue).Tables(0)
            Else
    ...
    Protected Sub cmd_confirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_confirm.Click
        ...
        op(0) = New OracleParameter("l_id", OracleType.Number, 5)
        op(0).Value = CInt(Request.QueryString.Get("l_id"))
        op(0).Direction = ParameterDirection.Input
        op(1) = New OracleParameter("empcode", OracleType.Number, 5)
        ...
        op(2).Value = CDate(Me.txt_fromdt.Text)
        ...
        op(7) = New OracleParameter("flag", OracleType.Number)
        ...
        oh.ExecuteNonQuery("long_leaveappln", op)
