...
Partial Class leave_leave_rpt_1ebc980d9674
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim pq As DataTable = oh.ExecuteDataSet("select t.*  from emp_new_old_code t where (t.new_code=" & Request.QueryString.Get("emp_code") & " or t.old_code=" & Request.QueryString.Get("emp_code") & " )").Tables(0)
