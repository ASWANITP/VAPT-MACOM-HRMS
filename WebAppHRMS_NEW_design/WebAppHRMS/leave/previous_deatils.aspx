<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="previous_deatils.aspx.vb" Title="Previous Leave Details" Inherits="WebAppHRMS.leave_Leave_sanction1_2b08b5ad6617" %>
    ...
    <form id="form1" runat="server">
        <div style="text-align: center">
            <table border="1" style="width: 650px; height: 113px">
                <caption>
                    <h4 style="width: 100%;">EMPLOYEE PREVIOUS DETAILS</h4>
                </caption>
                <%--  <tr<%-->
          ...
          <%--  </tr>--%>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td colspan="5" style="height: 17px; text-align: left">
                        <input id="Text1" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                ...
                <td colspan="5" style="height: 17px; text-align: left">
                    <input id="Text2" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                        type="text" maxlength="50" /></td>
                ...
                <tr>
                    ...
                    <tr>
                        <td style="width: 325px; height: 1px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL LEAVES SANCTIONED</span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text3" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>
                    ...
                    <tr>
                        <td style="width: 325px; height: 1px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL LEAVES TO BE RECOMMENDED</span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text6" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>

                    </tr>
                    <tr>
                        <td style="width: 325px; height: 1px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL LEAVES RECOMMENDED</span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text7" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>
                    ...
                    <tr>
                        <td style="width: 325px; height: 1px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL EARLY GOING TO BE RECOMMENDED
                            </span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text4" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>
                    ...
                    <tr>
                        <td style="width: 325px; height: 1px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL EARLY GOING RECOMMENDED</span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text8" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>
                    ...
                    <tr>
                        ...
                        <td style="width: 325px; height: 17px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL COMPENSATORY TO BE RECOMMENDED</span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text5" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>
                    ...
                    <tr>
                        ...
                        <td style="width: 325px; height: 1px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL COMPENSATORY RECOMMENDED</span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text9" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>
                    ...
                    <tr>
                        ...
                        <td style="width: 325px; height: 1px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL TOUR TO BE RECOMMENDED</span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text10" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>
                    ...
                    <tr>
                        ...
                        <td style="width: 325px; height: 1px; text-align: left">
                            <span style="font-size: 10pt; font-family: Courier New">TOTAL TOUR RECOMMENDED</span></td>
                        <td colspan="5" style="height: 17px; text-align: left">
                            <input id="Text11" runat="server" readonly="readonly" style="font-size: 11pt; width: 100%; font-family: 'Courier New'"
                                type="text" maxlength="50" /></td>
