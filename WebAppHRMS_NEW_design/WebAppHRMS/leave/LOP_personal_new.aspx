<%@ Page Language="VB" MasterPageFile="~/edp.master" AutoEventWireup="false" CodeBehind="LOP_personal_new.aspx.vb" Inherits="WebAppHRMS.LOP_to_Personal_Account_LOP_personal_new_ecdabe286697" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 514px; height: 74px">
            <tr>
                <td style="width: 206px; text-align: right">Select Employee:&nbsp;
                </td>
            ...
            <tr id="row1">
                <td colspan="4" style="text-align: left">
                    <asp:Panel ID="pnl1" runat="server" Height="24px" Style="position: relative">
                    </asp:Panel>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 100px; text-align: left">&nbsp;<asp:Button ID="cmd_confirm" runat="server" Text="CONFIRM" OnClientClick="return btnsend_onclick()" /></td>
            </tr>
        </table>
