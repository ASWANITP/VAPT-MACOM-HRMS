...
Partial Class leave_leave_rpt_1ebc980d6465
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim name As String = "select a.leave_frdate as frdt,a.leave_todate,a.leave_days,b.leave_abbr,a.leave_reason,a.leave_id from employ_leave_dtl a,leave_master b where a.leave_process_id in (1,2,8) and a.leave_id=b.leave_id and a.emp_code=" & Request.QueryString.Get("emp_code") & " and to_date(leave_frdate)>='" & fdt & "' and to_date(leave_todate)<='" & tdt & "' union select a.leave_frdate as frdt,a.leave_todate,a.leave_days,b.leave_abbr,a.leave_reason,a.leave_id from employ_leave_dtl a,leave_master b,employee_master_dtl em  where a.leave_process_id in (1,2,8) and a.leave_id=b.leave_id and em.new_empcode=" & Request.QueryString.Get("emp_code") & " and em.emp_code=a.emp_code and to_date(leave_frdate)>='" & fdt & "' and to_date(leave_todate)<='" & tdt & "' order by frdt"
        ...
        'End If
        Dim pq As New DataTable
        pq = oh.ExecuteDataSet("select t.*  from emp_new_old_all t where (t.new_code=" & Me.Request.QueryString("emp_code") & " or t.old_code=" & Me.Request.QueryString("emp_code") & " )").Tables(0)
        ...
        tct1.Text = "<b><font size=4 >  MANAPPURAM GROUP OF COMPANIES  </font></b>"
        ...
        Dim tot12, tot22, tot32, tot42 As New TableCell
        tot12.ColumnSpan = 7
        tot22.ColumnSpan = 7
        tot32.ColumnSpan = 7
        tot42.ColumnSpan = 7

        tot12.Text = "<font size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Casual Leave - " & FormatNumber(casual, 0) & "</font>"
        tot22.Text = "<font size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sick Leave - " & FormatNumber(sick, 0) & "</font>"
        tot32.Text = "<font size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Earned Leave -" & FormatNumber(earn, 0) & "</font>"
        tot42.Text = "<font size=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Loss OF Pay - " & FormatNumber(lop, 0) & "</font>"
        ...
        Dim months As DataTable = oh.ExecuteDataSet("select sum(days) from (select nvl(sum(leave_days),0) as days from employ_leave_dtl el where el.leave_process_id in (1,2,8) and el.status=1 and el.emp_code=" & Me.Request.QueryString("emp_code") & " and el.leave_frdate>=sysdate-365 union select nvl(sum(leave_days),0) as days from employ_leave_dtl el,employee_master_dtl em  where el.leave_process_id in (1,2,8) and el.status=1 and el.emp_code=em.emp_code and em.new_empcode=" & Me.Request.QueryString("emp_code") & " and el.leave_frdate>=sysdate-365)").Tables(0)
        ...
        Dim sqlleave As String
        Dim dtl As DataTable
        sqlleave = "select ll.emp_code,ll.cl,ll.sl,ll.el from(select x1.emp_code,                nvl(x1.leave_days,0) cl,                nvl(x2.leave_days,0) sl,                nvl(x3.leave_days,0) el           from (select a.emp_code, a.leave_days                   from employ_leave_master a                  where a.leave_id = 1) x1                left join (select a.emp_code, a.leave_days                   from employ_leave_master a                  where a.leave_id = 2) x2 on x1.emp_code = x2.emp_code                left join (select a.emp_code, a.leave_days                   from employ_leave_master a                  where a.leave_id = 3) x3 on x1.emp_code = x3.emp_code        where x1.emp_code=" & Me.Request.QueryString("emp_code") & ")ll "
        'sqlleave = "select ll.emp_code,ll.cl,ll.sl,ll.el from (select x1.emp_code, x1.leave_days cl, x2.leave_days sl, x3.leave_days el from (select a.emp_code, a.leave_days   from employ_leave_master a   where a.leave_id = 1) x1,  (select a.emp_code, a.leave_days   from employ_leave_master a   where a.leave_id = 2) x2,  (select a.emp_code, a.leave_days   from employ_leave_master a   where a.leave_id = 3) x3 where x1.emp_code = x2.emp_code  and x1.emp_code = x3.emp_code)ll where ll.emp_code=" & Me.Request.QueryString("emp_code") & ""
        dtl = oh.ExecuteDataSet(sqlleave).Tables(0)

        Dim tot1a, tot2a, tot3a, tot4a As New TableRow
        Dim tot12a, tot22a, tot32a, tot42a As New TableCell
        tot12a.ColumnSpan = 7
        tot22a.ColumnSpan = 7
        tot32a.ColumnSpan = 7
        tot42a.ColumnSpan = 7

        tot12a.Text = "<font size=2 color='red'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Balance Casual Leave - " & dtl.Rows(0)(1) & "</font>"
        tot22a.Text = "<font size=2 color='red'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Balance Sick Leave - " & dtl.Rows(0)(2) & "</font>"
        tot32a.Text = "<font size=2 color='red'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Balance Earned Leave -" & dtl.Rows(0)(3) & "</font>"
         tot1a.Controls.Add(tot12a)
        tot2a.Controls.Add(tot22a)
        tot3a.Controls.Add(tot32a)
         assettab.Controls.Add(tot1a)
        assettab.Controls.Add(tot2a)
        assettab.Controls.Add(tot3a)
        Me.pnl_leav.Controls.Add(assettab)
        Dim line110a As New TableRow
        Dim line1101a As New TableCell
        line1101a.ColumnSpan = 7
        line1101a.Text = "<hr align=center width=100% >"
        line110a.Controls.Add(line1101a)
        assettab.Controls.Add(line110a)
