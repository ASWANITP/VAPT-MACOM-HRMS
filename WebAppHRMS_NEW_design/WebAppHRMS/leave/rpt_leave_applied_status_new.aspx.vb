...
Partial Class Leave_Module_rpt_leave_applied_status_86b9fe5d8741
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("firm_id") <> 2 Then
            ...
            tabc1.ColumnSpan = 17
            tabc1.Text = "<body align=center ><b><font size=4> " & firm & "</font></b></body>"
        ...
        ElseIf Session("firm_id") = 2 Then  '--------Firm id :2
            ...
            Dim str As String
            If pdt.Rows.Count = 0 Then
                str = "select to_char(e.leave_frdate, 'DD-MM-YYYY') From_Date, to_char(e.leave_todate, 'DD-MM-YYYY') To_Date, to_char(e.leave_apply_date,'DD-MM-YYYY') leave_apply_date, e.leave_days, lm.leave_abbr, m.category_name, d.reason_name, decode(e.status_id, 1, 'SANCTIONED', 0, 'APPLIED', 2, 'REJECTED', 3, 'CANCELLED', 4, 'RECOMMENDED', 5, 'RECOMMENDED', 7,'FIRST RECOMMEND' , 8,'FIRST LEVEL RECOMMENDED' ) as status, case when e.first_recom_person is not null then (select emp_code || ' - ' || emp_name from employee_master where emp_code = e.first_recom_person) end as First_rec_person,to_char(e.first_recom_date,'DD-MM-YYYY') first_recom_date, case when e.recom_person is not null then (select emp_code || ' - ' || emp_name from employee_master where emp_code = e.recom_person) end as rec_person, to_char(e.recom_date,'DD-MM-YYYY') recom_date, e.reject_reason, case when e.sanc_person is not null then (select emp_code || ' - ' || emp_name from employee_master where emp_code = e.sanc_person) end as sanc_person, to_char(e.sanc_date,'DD-MM-YYYY') sanc_date from hrm_leave_apply_sanction e, hrm_category_master m, hrm_category_dtl d, leave_master lm where ( e.emp_code = " & Me.Request.QueryString("empcode") & " ) and e.leave_apply_date between ('" & Request.QueryString("fromdt") & "') and ('" & Request.QueryString("todt") & "') and e.category_id = m.category_id and m.category_id = d.category_id and e.leave_id = lm.leave_id and e.reason_id = d.reason_id order by e.leave_frdate"
            Else
                str = "select to_char(e.leave_frdate, 'DD-MM-YYYY') From_Date, to_char(e.leave_todate, 'DD-MM-YYYY') To_Date, to_char(e.leave_apply_date,'DD-MM-YYYY') leave_apply_date, e.leave_days, lm.leave_abbr, m.category_name, d.reason_name, decode(e.status_id, 1, 'SANCTIONED', 0, 'APPLIED', 2, 'REJECTED', 3, 'CANCELLED', 4, 'RECOMMENDED', 5, 'RECOMMENDED', 7,'FIRST RECOMMEND' , 8,'FIRST LEVEL RECOMMENDED' ) as status, case when e.first_recom_person is not null then (select emp_code || ' - ' || emp_name from employee_master where emp_code = e.first_recom_person) end as First_rec_person,to_char(e.first_recom_date,'DD-MM-YYYY') first_recom_date, case when e.recom_person is not null then (select emp_code || ' - ' || emp_name from employee_master where emp_code = e.recom_person) end as rec_person, to_char(e.recom_date,'DD-MM-YYYY') recom_date, e.reject_reason, case when e.sanc_person is not null then (select emp_code || ' - ' || emp_name from employee_master where emp_code = e.sanc_person) end as sanc_person, to_char(e.sanc_date,'DD-MM-YYYY') sanc_date from hrm_leave_apply_sanction e, hrm_category_master m, hrm_category_dtl d, leave_master lm where (e.emp_code = " & Me.Request.QueryString("empcode") & " or e.emp_code = " & pdt.Rows(0)(0) & ") and e.leave_apply_date between ('" & Request.QueryString("fromdt") & "') and ('" & Request.QueryString("todt") & "') and e.category_id = m.category_id and m.category_id = d.category_id and e.leave_id = lm.leave_id and e.reason_id = d.reason_id order by e.leave_frdate"
            ...
            '3RD ROW
            Dim tabrr3 As New TableRow
            'tabrr3.Attributes.Add("bgcolor", "silver")
            ...
            tabcc3.ColumnSpan = 5
            tabcc3.Attributes.Add("align", "left")
            tabcc3.Text = "<b><font size=2>DATE: " & Format(Now.Date, "dd/MMM/yyyy") & " </font></b>"
            tabcc3.ForeColor = Drawing.Color.Maroon
            tabrr3.Controls.Add(tabcc3)
            tab1.Controls.Add(tabrr3)
            ...
            tabcc4.Text = "<b><font size=2>TIME: " & hr.ToString & ":" & Date.Now.Minute & ":" & Date.Now.Second & " " & dat & "</font></b>"
            tabcc4.ForeColor = Drawing.Color.Maroon
            tabrr3.Controls.Add(tabcc4)
            tab1.Controls.Add(tabrr3)
            ...
            'tabr5.Width = 19
            'tabr5.ForeColor = Drawing.Color.DarkRed
            'Dim tabr5c1, tabr5c2, tabr5c3, tabr5c4, tabr5c5, tabr5c6, tabr5c7, tabr5c8, tabr5c9, tabr5c10, tabr5c11, tabr5c12, tabr5c13, tabrnew1, tabrnew2 As New TableCell
            ...
            'tabr5c7.ColumnSpan = "2"
            'tabr5c8.ColumnSpan = "1"
            'tabrnew1.ColumnSpan = "2"
            'tabrnew2.ColumnSpan = "1"
            'tabr5c9.ColumnSpan = "2"
            'tabr5c10.ColumnSpan = "1"
            'tabr5c11.ColumnSpan = "2"
            'tabr5c12.ColumnSpan = "2"
            ...
            'tabrnew1.HorizontalAlign = HorizontalAlign.Left
            'tabrnew1.HorizontalAlign = HorizontalAlign.Left
            ...
            'tabrnew1.Text = "<b><font size=2.5>FIRST RECOMM. BY</font></b>"
            'tabrnew2.Text = "<b><font size=2.5>FIRST RECOMM. DATE</font></b>"
            ...
            'tabr5.Controls.Add(tabrnew1)
            'tabr5.Controls.Add(tabrnew2)
            ...
            '    tabr6.Width = 19
            '    tabr6.Attributes.Add("bgcolor", colors)
            '    Dim tabr6c1, tabr6c2, tabr6c3, tabr6c4, tabr6c5, tabr6c6, tabr6c7, tabr6c8, tabr6c9, tabr6c10, tabr6c11, tabr6c12, tabr6c13, tabr6new1, tabr6new2 As New TableCell
            '    tabr6c1.ColumnSpan = "1"
            '    tabr6c2.ColumnSpan = "1"
            '    tabr6c3.ColumnSpan = "1"
            '    tabr6c4.ColumnSpan = "1"
            ...
            '    tabr6new1.ColumnSpan = "2"
            '    tabr6new2.ColumnSpan = "1"
            ...
            '    tabr6new1.HorizontalAlign = HorizontalAlign.Left
            '    tabr6new2.HorizontalAlign = HorizontalAlign.Left
            '    tabr6c9.HorizontalAlign = HorizontalAlign.Left
            '    tabr6c10.HorizontalAlign = HorizontalAlign.Left
            '    tabr6c11.HorizontalAlign = HorizontalAlign.Left
            '    tabr6c13.HorizontalAlign = HorizontalAlign.Left
            ...
            '    tabr6c7.Text = "<font size=2>" & dr(6) & "&nbsp;</font>"
            '    tabr6c8.Text = "<font size=2>" & dr(7) & "</font>"
            '    tabr6new1.Text = "<font size=2>" & dr(8) & "</font>"
            '    If IsDBNull(dr(9)) Then
            '        tabr6new2.Text = "<font size=2>&nbsp;</font>"
            '    Else
            '        tabr6new2.Text = "<font size=2>" & Format(dr(9), "dd/MMM/yyyy") & "&nbsp;</font>"
            '    End If


            '    tabr6c9.Text = "<font size=2>" & dr(10) & "&nbsp;</font>"
            '    If IsDBNull(dr(11)) Then
            '        tabr6c10.Text = "<font size=2>&nbsp;</font>"
            '    Else
            '        tabr6c10.Text = "<font size=2>" & Format(dr(11), "dd/MMM/yyyy") & "&nbsp;</font>"
            '    End If
            ...
            '        tabr6c13.Text = "<font size=2>&nbsp;</font>"
            '    Else
            '        tabr6c13.Text = "<font size=2>" & Format(dr(14), "dd/MMM/yyyy") & "&nbsp;</font>"
            '    End If
            ...
            '    tabr6.Controls.Add(tabr6c7)
            '    tabr6.Controls.Add(tabr6c8)
            '    tabr6.Controls.Add(tabr6new1)
            '    tabr6.Controls.Add(tabr6new2)
            '    tabr6.Controls.Add(tabr6c9)
            '    tabr6.Controls.Add(tabr6c10)
            '    tabr6.Controls.Add(tabr6c11)
            '    tabr6.Controls.Add(tabr6c12)
