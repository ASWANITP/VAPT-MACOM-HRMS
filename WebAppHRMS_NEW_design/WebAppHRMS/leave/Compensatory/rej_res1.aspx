<%@ Page Language="VB" AutoEventWireup="false" CodeBehind="rej_res1.aspx.vb" Inherits="WebAppHRMS.leave_rej_res_bf15cd918537" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Button1_onclick() {
            if ((document.getElementById("txt_rej").value) != "") {
                ...
                opener.document.forms[0].action = "new_compensatory_sanction.aspx"
                window.opener.chk_data1()
                window.close("rej_res1.aspx");
    ...
    <form id="form1" runat="server" style="background-color: antiquewhite">
        <div>
            <div style="text-align: left">
                ...
                <table>
                    <tr>
                        <td style="width: 183px">Enter Reason for Rejection</td>
