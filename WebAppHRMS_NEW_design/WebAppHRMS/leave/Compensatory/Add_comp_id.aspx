        ...
        <table border="1" style="width: 898px; height: 200px;">
            <caption>
                ...
                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy"
                    TargetControlID="txt_calender"></cc1:CalendarExtender>
                <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy"
                    TargetControlID="txt_exp"></cc1:CalendarExtender>
            </caption>
            <tr>
            ...
            <tr>
                <td style="width: 308px; height: 26px; text-align: left"></td>
            ...
            <tr>
                <td style="width: 308px; text-align: left; height: 25px;"></td>
            ...
            <tr>
                <td style="width: 308px; text-align: right; height: 28px;">&nbsp;<asp:Button ID="Button" runat="server" Text="CONFIRM" Width="105px" /></td>
