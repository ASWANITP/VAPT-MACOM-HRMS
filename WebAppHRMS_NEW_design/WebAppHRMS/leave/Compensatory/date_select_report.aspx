...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        <div style="text-align: center">
            ...
            <table border="1">
                <tr>
                    <td colspan="2" style="font-family: 'Courier New'"></td>
                </tr>
                <tr>
                    <td style="width: 200px; font-family: 'Courier New';">FROM</td>
                    <td style="width: 200px; font-family: 'Courier New';">TO</td>
                </tr>
                <tr>
            ...
            <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy"
                TargetControlID="txt_from_dt"></cc1:CalendarExtender>
            <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd/MMM/yyyy"
                TargetControlID="txt_to_dt"></cc1:CalendarExtender>
        </div>
    </div>
</asp:Content>
