...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <table style="width: 73%;">
        ...
        <tr>
            ...
            <td style="width: 90px;">&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="TxtEmpcode" ValidationGroup="grp1" runat="server" ValidationExpression="^(\d{5,8})" ErrorMessage="Numbers Only" Font-Size="12px"></asp:RegularExpressionValidator><%--  onclick="cleargrv()"--%></td>
            <td style="width: 11px">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtEmpcode"
                    ValidationGroup="grp1" ErrorMessage="*"></asp:RequiredFieldValidator>
            </td>
            <td>
                <asp:Label ID="Label2" Text="Emp.Code:" runat="server" Font-Bold="True" Font-Size="12px"></asp:Label></td>
            <td>
            ...
            <td>
                <asp:Label ID="Label3" Text="From:" runat="server" Font-Bold="True" Font-Size="12px"></asp:Label></td>
            <td>
            ...
            <td>
                <asp:Label ID="Label4" Text="To:" runat="server" Font-Bold="True" Font-Size="12px"></asp:Label><br />
            </td>
            <td>
                <asp:TextBox ID="txtTodate" runat="server"></asp:TextBox>
            </td>
            <td>
                <asp:Button ID="ButnExcel" runat="server" ValidationGroup="grp1" Text="Search" Width="80px" />
            </td>
            <td>
    ...
    <cc1:CalendarExtender ID="CalendarExtender3" TargetControlID="txtTodate" Format="dd-MMM-yyyy" runat="server"></cc1:CalendarExtender>
    <cc1:CalendarExtender ID="CalendarExtender2" TargetControlID="txtFromdate" Format="dd-MMM-yyyy" runat="server"></cc1:CalendarExtender>
                    ...
                    <asp:GridView ID="GrvCompLeave" runat="server" AutoGenerateColumns="False" Width="944px">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Approval">
                                <ItemTemplate>
                                    <%-- apprv_sts, compnstry lv reqst is aprvd or not  0 apl 1 app 2 rec 3 rej --%>
                    ...
                    <asp:Panel ID="Panel1" runat="server"
                        ...
                        <div style="text-align: center">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="Server" Text="Date:" ID="imageTitle" /></td>
                                    <td>
                                        <cc1:CalendarExtender ID="CalendarExtender1" TargetControlID="TxtExtDate" Format="dd-MMM-yyyy" runat="server"></cc1:CalendarExtender>
                                    ...
                                    <td>
                                        <asp:Button ID="ButSubmit" ValidationGroup="grp2" runat="server" Text="Submit" /></td>
                                    <td>
                                        <asp:Button ID="CancelButton" runat="server" Text="Cancel" CssClass="submit_btn" /></td>
                                </tr>
                            </table>
