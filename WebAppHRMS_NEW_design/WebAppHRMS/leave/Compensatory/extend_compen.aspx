    ...
    <div style="text-align: center">
        <table border="1" style="width: 935px; height: 104px;">
            <caption>
                ...
                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MMM/yyyy" TargetControlID="txt_cal"></cc1:CalendarExtender>
                <strong>
            ...
            <tr>
                <td style="width: 276px; height: 23px"></td>
                <td style="height: 23px; text-align: center;" colspan="2"></td>
                <td style="width: 92px; height: 23px"></td>
            </tr>
            <tr>
                <td style="width: 276px; height: 28px;"></td>
                ...
                <td style="width: 92px; height: 28px;"></td>
            </tr>
        </table>
    </div>
</asp:Content>
