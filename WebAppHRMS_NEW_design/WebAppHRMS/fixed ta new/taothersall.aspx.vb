...
Partial Class fixed_TA_New_taothersall_c348e8c94902
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        str = "select br.BRANCH_ID,  br.BRANCH_NAME,  a.emp_code,  em.emp_name,  dm.designation,  pm.post_name,  a.from_dt,  a.to_dt,  nvl(a.days, 0) days,  nvl(a.leave_days, 0) as Leave_days,  nvl(a.ta_limit, 0) as Ta_Limit,  nvl(a.ta_amt, 0) as Ta_Amount  from hr_fixed_ta        a,  employee_master    em,  post_mst           pm,  designation_master dm,  branch             br,  employ_firm f  where a.emp_code = em.emp_code  and em.emp_code=f.emp_code  and f.firm_id=" & Session("firm_id") & "  and a.post_id = pm.post_id  and a.desig_id = dm.designation_id  and a.branch_id = br.BRANCH_ID  and a.post_id not in (10, 136)  and a.emp_code not in (select emp_code from hrm_ta_constant_employees)  order by br.BRANCH_ID, a.from_dt, a.emp_code"
        ...
        If dt.Rows.Count > 0 Then
            ...
            newcell.Text = "<b><font size=2>Fixed TA for Employees Other than BH(G) and AM(G) Detailed Report of " & dtdet & "</font></b>"
            ...
            For Each dr In dt.Rows
                ...
                v1.Text = "<a href=empwisefxta.aspx?empcode=" & dr(2) & "><font size=2>" & dr(2) & "&nbsp;</font>"
        ...
        End If
        Panel_FxTAOthers.Controls.Add(fixedtatable)
    End Sub
End Class
