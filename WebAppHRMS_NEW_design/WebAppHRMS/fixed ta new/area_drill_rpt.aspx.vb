...
Partial Class fixed_TA_New_area_drill_rpt_e77826149682
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        str = "select a.emp_code,em.emp_name,dm.designation,pm.post_name,a.from_dt,a.to_dt,nvl(a.days,0) days,nvl(a.leave_days,0) as Leave_days,nvl(a.ta_limit,0) as Ta_Limit,nvl(a.ta_amt,0) as Ta_Amount,br.BRANCH_ID,br.BRANCH_NAME from hr_fixed_ta a,employee_master em,post_mst pm,designation_master dm,branch br where a.emp_code=em.emp_code and a.post_id=pm.post_id and a.desig_id=dm.designation_id and a.branch_id=br.BRANCH_ID and a.post_id = 136 and nvl(a.ta_limit,0) <> 0 and a.area_id = " & Me.Request.QueryString("areaid") & "and a.emp_code not in (select emp_code from hrm_ta_employees where all_id=1)  order by a.from_dt,a.emp_code"
        ...
        If dt.Rows.Count > 0 Then
            ...
            newcell.Text = "<b><font size=2>Fixed TA for Area Managers Detailed Report of " & dtdet & "</font></b>"
            ...
            subcell2.Text = "<font size=2>A.M Fixed TA : <b>" & aname & "</b> <font>"
        ...
        End If
        Panel_Area_Drill.Controls.Add(fixedtatable)
    End Sub
End Class
