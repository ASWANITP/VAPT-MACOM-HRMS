...
Partial Class fixed_TA_New_empwisetotal_ec3a916a2708
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        '                   0          1             2                                   3                                       4                                    5     
        str = "select a.emp_code,  em.emp_name,  sum(nvl(a.days, 0)) as work_days,  sum(nvl(a.leave_days, 0)) as leave_days,  sum(nvl(a.ta_limit, 0)) as ta_maxlim,  case  when sum(nvl(a.ta_amt, 0)) > 0 then  sum(nvl(a.ta_amt, 0))  else  0  end as ta_eligible  from hr_fixed_ta a, employee_master em, employ_firm f  where a.emp_code = em.emp_code  and em.emp_code = f.emp_code  and f.firm_id = " & Session("firm_id") & "  having sum(nvl(a.ta_limit, 0)) <> 0  group by a.emp_code, em.emp_name  order by emp_code"
        ...
        If dt.Rows.Count > 0 Then
            ...
            newcell.Text = "<b><font size=2>Fixed TA Employeewise Detailed Report of " & dtdet & "</font></b>"
            ...
            'Dim aname As String = oh.ExecuteDataSet("select upper(area_name) from area_master where area_id=" & Me.Request.QueryString("areaid") & "").Tables(0).Rows(0)(0)
            subcell2.ColumnSpan = 2
            subcell2.HorizontalAlign = HorizontalAlign.Center
            subcell2.Text = "<font size=2> </b> <font>"
            ...
            'r9.Text = "<b><font size=2>Circ.TA Maximum&nbsp;</font></b>"
            ...
            'r11.ColumnSpan = 1
            'r11.HorizontalAlign = HorizontalAlign.Left
            'r11.Text = "<b><font size=2>Station&nbsp;BrID&nbsp;</font></b>"
            'row2.Controls.Add(r11)

            'r12.ColumnSpan = 1
            'r12.HorizontalAlign = HorizontalAlign.Left
            'r12.Text = "<b><font size=2>Station&nbsp;Branch&nbsp;</font></b>"
            ...
            For Each dr In dt.Rows
                ...
                value.Width = 6  'v3, v4, v5, v6,
                Dim v1, v2, v7, v8, v9, v10 As New TableCell

                Dim a As Integer = oh.ExecuteDataSet("select count(*) from hrm_ta_constant_employees where emp_code=" & dr(0) & "").Tables(0).Rows(0)(0)
                ...
                Else
                    v1.Text = "<a href=empwisefxta.aspx?empcode=" & dr(0) & "><font size=2>" & dr(0) & "&nbsp;</font>"
                End If
        ...
        End If
        Panel_FxTATotal.Controls.Add(fixedtatable)
    End Sub
End Class
