        ...
        <table border="1" style="width: 656px; height: 72px">
            <tr>
                <td colspan="4" style="height: 34px">
                    <strong><span style="font-size: 14pt; color: #990099; font-family: Courier New; text-decoration: underline;">REGULARISATION
                        RECOMMENDATION</span></strong></td>
            </tr>
        </table>
        <table border="1">
            <caption>
            ...
            <tr>
                ...
                <td colspan="2" style="width: 90px; height: 26px; text-align: left">
                    <asp:DropDownList ID="Ddldate" runat="server" Width="200px" AutoPostBack="True">
                    </asp:DropDownList></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 244px; height: 28px;"></td>
            ...
            <tr>
                ...
                <td colspan="2" style="width: 135px; height: 19px"></td>
            </tr>
            <tr>
                <td colspan="2" style="width: 275px; height: 19px"></td>
            ...
            <tr>
                ...
                <td colspan="2" style="height: 19px; width: 135px; text-align: center;">&nbsp;<input id="btn_exit" style="width: 96px" type="button" value="Exit" onclick="return btn_exit_onclick()" /></td>
            </tr>
            <tr>
                <td colspan="5">&nbsp;
                </td>
