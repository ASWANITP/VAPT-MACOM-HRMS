                ...
                <table border="1" style="width: 55%">
                    <tr>
                        <td colspan="3" style="text-align: left; height: 31px; width: 402px;">
                            <strong>Select Date To be Regularised :</strong></td>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: left; width: 402px;"></td>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: left; width: 402px;">
                            <strong>Document Upload :</strong></td>
                        <td style="text-align: left">
                            <asp:FileUpload ID="file_support1" runat="server" Width="280px" BackColor="Snow" ForeColor="Black" />
