                    ...
                    <td colspan="4" style="height: 102px">
                        <div style="text-align: left">
                            <table border="1" style="width: 100%; height: 1px;">
                                <tr>
                                    <td colspan="2" style="width: 210px; height: 29px; text-align: center;">Select&nbsp;Employee&nbsp;Code</td>
                                ...
                                <tr>
                                    <td colspan="2" style="width: 210px; text-align: center;">Assigned&nbsp;OFF&nbsp;Day</td>
                                ...
                                <tr>
                                    <td colspan="2" style="width: 210px; text-align: center; height: 31px;">Date</td>
                                ...
                                <tr>
                                    <td colspan="2" style="width: 210px; height: 31px; text-align: center">Enter Reason</td>
                    ...
                    <td colspan="4" style="text-align: left">
                        <div style="text-align: left">
                            <table border="1" style="width: 79%; height: 41px;">
                                <tr>
                                    <td colspan="2" style="text-align: center; height: 29px;">Select First Employee Code</td>
                                    <td style="text-align: left; height: 29px;" colspan="2">
                                        <asp:DropDownList ID="cmb_Code1" onchange="OnChangeCode1()" runat="server" Width="251px" Font-Names="Times New Roman" Font-Size="Medium">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                                    <td style="height: 5px; text-align: center;" colspan="2">Assigned OFF Day</td>
                                ...
                                <tr>
                                    <td colspan="2" style="height: 5px; text-align: center;">Select&nbsp;Second&nbsp;Employee&nbsp;Code</td>
                                ...
                                <tr>
                                    <td colspan="2" style="height: 5px; text-align: center;">Assigned OFF Day</td>
                                    <td colspan="2" style="height: 5px; text-align: left">
                                ...
                                <tr>
                                    <td colspan="2" style="height: 5px; text-align: center">Enter Reason</td>
