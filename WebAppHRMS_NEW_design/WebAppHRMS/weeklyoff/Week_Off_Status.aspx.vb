...
Partial Class HRM_Week_Off_Status_7a8e7a395996
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            dt = oh.ExecuteDataSet("select h.from_dt as From_Date,h.to_dt To_Date,decode(h.holiday,'1', 'SUNDAY','2', 'MONDAY','3','TUESDAY','4', 'WEDNESDAY','5','THURSDAY','6', 'FRIDAY', '7', 'SATURDAY') as HOLIDAY,  case  when  h.from_dt > h.to_dt then  'CANCELLED'  else  decode(h.status, '0','closed', '1','Live','2','Recommened','3','AM Approved','4', 'AM Rejected') end as STATUS from hrm_7days_off_day h where h.emp_code ='" & eid & "'order by h.from_dt").Tables(0)
    ...
    Protected Sub crys1_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles crys1.Unload
        repo.Clone()
        repo.Dispose()
        GC.Collect()
