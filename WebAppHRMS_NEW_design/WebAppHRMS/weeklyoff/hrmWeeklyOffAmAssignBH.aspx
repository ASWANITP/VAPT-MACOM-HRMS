...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_edp" runat="Server">
    ...
    <div style="text-align: center">
        ...
        <table border="1" style="width: 60%">
            <tr>
                <td colspan="2" style="text-align: left">Select Day</td>
            ...
            <tr>
                <td colspan="2" style="text-align: left">&nbsp;Select Post</td>
                <td colspan="2" style="text-align: left">
            ...
            <tr>
                <td colspan="2" style="text-align: left">Select Employee 
                </td>
                <td colspan="2" style="text-align: left">
            ...
            <tr>
                <td style="width: 15%; text-align: left; height: 28px;">Post</td>
                <td style="width: 15%; height: 28px;">
                    <asp:TextBox ID="txtPost" runat="server" Width="97%"></asp:TextBox></td>
                <td style="width: 15%; text-align: left; height: 28px;">Department</td>
                <td style="width: 15%; height: 28px;">
                    <asp:TextBox ID="txtDept" runat="server" Width="97%"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left">Date Of &nbsp;Holiday Change</td>
                <td colspan="2" style="text-align: left">
                    <asp:TextBox ID="txtDate" runat="server" Width="95%" ReadOnly="True"></asp:TextBox></td>
            </tr>
            <tr>
                <td colspan="2" style="height: 23px; text-align: left">Reason For Change</td>
